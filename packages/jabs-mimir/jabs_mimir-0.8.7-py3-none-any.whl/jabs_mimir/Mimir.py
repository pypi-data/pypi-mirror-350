...
class Mimir:
    ...
    def switchView(self, newFrameFunc, gridOptions=None, **kwargs):
        warnings.warn("switchVies is deprecated. Use renderView instead", UserWarning, stacklevel=2)
        """
        Replaces the current view with a new frame returned by `newFrameFunc`.
    ...
    def createPaginator(self, items: list, itemsPerPage: int = 5, parent=None):
        """
        ...
        """
        return MimirPaginator(items, itemsPerPage, parent or self.app)
