...
class MimirPaginator:
    def __init__(self, items: List, itemsPerPage: int, parent: tk.Widget, themeManager):
        self.items = items
        ...
        print(f"[Subscribe] ThemeManager instance id: {id(self.themeManager)}")
    ...
    def setupStyle(self, tree):
        ...
        self.style.configure("Treeview", font=(rowFont, 16))
        self.style.configure("Treeview.Heading", font=(headerFont, 13))
