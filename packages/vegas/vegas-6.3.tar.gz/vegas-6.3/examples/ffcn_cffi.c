...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 7), // void()(double *, double *, int, int)
...
static const struct _cffi_global_s _cffi_globals[] = {
  { "batch_fcn", (void *)_cffi_f_batch_fcn, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_batch_fcn },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_ffcn_cffi(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_ffcn_cffi(void) { return NULL; }
#  else
     initffcn_cffi(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit_ffcn_cffi(void)
{
  return _cffi_init("ffcn_cffi", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initffcn_cffi(void)
{
  _cffi_init("ffcn_cffi", 0x2601, &_cffi_type_context);
}
#endif
