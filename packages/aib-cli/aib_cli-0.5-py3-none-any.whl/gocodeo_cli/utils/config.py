...
def get_github_api_key() -> Optional[str]:
    """Get GitHub Copilot API key from environment variables."""
    return os.getenv("GITHUB_API_KEY")

def get_github_token() -> Optional[str]:
    """Get GitHub Models API token from environment variables."""
...
def set_github_api_key(key: str) -> None:
    """Set GitHub Copilot API key in environment variables."""
    os.environ["GITHUB_API_KEY"] = key

def set_github_token(key: str) -> None:
    """Set GitHub Models API token in environment variables."""
...
def prompt_for_api_key(model_type: str) -> str:
    ...
    elif model_type.startswith("github"):
        key_name = "GitHub Copilot"
        key_env = "GITHUB_API_KEY"
        key = get_github_api_key()
    else:
        key_name = "Unknown"
