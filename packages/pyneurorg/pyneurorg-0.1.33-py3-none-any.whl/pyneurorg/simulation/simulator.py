...
class Simulator:
    ...
    def add_stimulus(self, electrode_id: int, stimulus_waveform: b2.TimedArray,
                     ...
                     target_current_var: str = 'I_stimulus'): # Default changed to 'I_stimulus'
        """
        ...
        try:
            ...
            # Ensure variable is initialized (best done at NeuronGroup creation)
            # if not np.any(variable_to_set[:]): variable_to_set[:] = 0 * b2.amp
