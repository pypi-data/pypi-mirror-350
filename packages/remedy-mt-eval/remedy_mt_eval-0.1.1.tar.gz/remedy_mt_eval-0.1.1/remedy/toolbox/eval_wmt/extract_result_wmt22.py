...
def main():
    ...
    parser.add_argument('--mqm_folder', default='wmt22-mqm/sigmoid', help='MQM folder name (default: wmt22-mqm)')
    parser.add_argument('--da_folder', default='wmt22-da/sigmoid', help='DA folder name (default: wmt22-da)')
