...
class Arguments:
  cs_uk: str = dataclasses.field(metadata={"help": "The cs-uk input file."})
  en_cs: str = dataclasses.field(metadata={"help": "The en-cs input file."})
  en_es: str = dataclasses.field(metadata={"help": "The en-es input file."})
  en_hi: str = dataclasses.field(metadata={"help": "The en-hi input file."})
  en_is: str = dataclasses.field(metadata={"help": "The en-is input file."})
  en_ja: str = dataclasses.field(metadata={"help": "The en-ja input file."})
  en_ru: str = dataclasses.field(metadata={"help": "The en-ru input file."})
  en_uk: str = dataclasses.field(metadata={"help": "The en-uk input file."})
  en_zh: str = dataclasses.field(metadata={"help": "The en-zh input file."})
...
scores = {
      "cs-uk": load_score_from_text(f'{result_dir}/cs-uk/{metric_name}-refA.seg.score', segment_counts_per_lp["cs-uk"]),
      "en-cs": load_score_from_text(f'{result_dir}/en-cs/{metric_name}-refA.seg.score', segment_counts_per_lp["en-cs"]),
      "en-es": load_score_from_text(f'{result_dir}/en-es/{metric_name}-refA.seg.score', segment_counts_per_lp["en-es"]),
      "en-hi": load_score_from_text(f'{result_dir}/en-hi/{metric_name}-refA.seg.score', segment_counts_per_lp["en-hi"]),
      "en-is": load_score_from_text(f'{result_dir}/en-is/{metric_name}-refA.seg.score', segment_counts_per_lp["en-is"]),
      "en-ja": load_score_from_text(f'{result_dir}/en-ja/{metric_name}-refA.seg.score', segment_counts_per_lp["en-ja"]),
      "en-ru": load_score_from_text(f'{result_dir}/en-ru/{metric_name}-refA.seg.score', segment_counts_per_lp["en-ru"]),
      "en-uk": load_score_from_text(f'{result_dir}/en-uk/{metric_name}-refA.seg.score', segment_counts_per_lp["en-uk"]),
      "en-zh": load_score_from_text(f'{result_dir}/en-zh/{metric_name}-refA.seg.score', segment_counts_per_lp["en-zh"]),
  }
