    ...
    def send_message(self, phone_number: str, message: str) -> dict:
        ...
        try:
            ...
            if hasattr(response, 'data') and response.data:
                ...
                # If response.data is None but no exception was raised, it might still be successful
                return {
                    'success': True,
                    'message_id': 'Unknown',
                    'phone_number': phone_number,
            ...
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        "phone_number": {
                            "type": "string",
                            "description": "Phone number to send message to (e.g., '923701098577' or '92701098577')"
                        },
                        "message": {
                            "type": "string",
    ...
    async def handle_call_tool(
        ...
        try:
            ...
            if name == "send_whatsapp_message":
                ...
                if result['success']:
                    response_text = "✅ WhatsApp MESSAGE SENT SUCCESSFULLY!\n\n"
                    response_text += f"📱 Phone: {result['phone_number']}\n"
                    ...
                    response_text += f"📋 Raw Response: {result.get('raw_response', 'N/A')}"
                else:
