from .utils.webdriver import start_webdriver, get_cloudscraper
...
if __name__ == "__main__":
    scraper = NGInvestingScraper()
    search_results = scraper.search("Nvidia")
    print("Search Results:")
    for result in search_results:
        print(result)
    

    stock_data = scraper.get_stock_data( search_results[0]["url"], "2023-01-01", "2023-10-01")
    print("\nStock Data:")
    print(stock_data)
