"""
VectorDBCloud Python SDK Setup
"""
...
setup(
    ...
    description="Official Python SDK for VectorDBCloud API",
    ...
    keywords="vectordb database api sdk python",
    project_urls={
        "Bug Reports": "https://github.com/VectorDBCloud/python-sdk/issues",
