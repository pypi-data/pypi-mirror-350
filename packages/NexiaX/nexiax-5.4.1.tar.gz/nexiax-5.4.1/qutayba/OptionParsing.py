...
parser.add_option(
    ...
    default=False,
    github_action=False,
    help="Enable Devil encryption algorithm for Python source code before compilation.",
)
...
parser.add_option(
    ...
    default=False,
    github_action=False,
    help="Enable Nexia encryption Python source code before compilation. Ultra",
)
...
parser.add_option(
    ...
    default=False,
    github_action=False,
    help="The best encryption of all encryptions. Create By Nasr",
)
