...
class ApiOutputCalculationResultPoint:
    ...
    def sort_output_phases(self, sort_key: str, ascending: bool = False) -> None:
        ...
        self.phases = [system_phase] + output_phases

    def phases_to_calculation_composition(self) -> Dict[str, List[CalculationComposition]]:
        """Convert `ApiOutputCalculationResultPoint.phases` to calculation compositions.
