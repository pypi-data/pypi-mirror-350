...
class ApiFluidComponentBlock:
    ...
    sle_hss:           float = UNSET
    # Heat capacity coefficients
    pc_saft_cp_ig_poly_c0: float = UNSET
    pc_saft_cp_ig_poly_c1: float = UNSET
    pc_saft_cp_ig_poly_c2: float = UNSET
    pc_saft_cp_ig_poly_c3: float = UNSET
    pc_saft_cp_ig_poly_c4: float = UNSET
    pc_saft_cp_ig_poly_c5: float = UNSET
    pc_saft_cp_ig_poly_c6: float = UNSET
    pc_saft_cp_ig_poly_c7: float = UNSET
    pc_saft_cp_ig_dippr_c0: float = UNSET
    pc_saft_cp_ig_dippr_c1: float = UNSET
    pc_saft_cp_ig_dippr_c2: float = UNSET
    pc_saft_cp_ig_dippr_c3: float = UNSET
    pc_saft_cp_ig_dippr_c4: float = UNSET
    pc_saft_cp_ig_dippr_c5: float = UNSET
    pc_saft_cp_ig_dippr_c6: float = UNSET
    # Thermodynamic constants
