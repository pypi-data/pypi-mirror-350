...
def get_predefined_url_category_override(config_type: Optional[builtins.str] = None,
...
def get_predefined_url_category_override_output(config_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
