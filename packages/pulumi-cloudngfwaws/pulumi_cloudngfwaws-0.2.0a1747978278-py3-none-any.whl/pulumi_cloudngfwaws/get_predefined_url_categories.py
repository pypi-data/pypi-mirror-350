...
def get_predefined_url_categories(max_results: Optional[builtins.int] = None,
...
def get_predefined_url_categories_output(max_results: Optional[pulumi.Input[Optional[builtins.int]]] = None,
