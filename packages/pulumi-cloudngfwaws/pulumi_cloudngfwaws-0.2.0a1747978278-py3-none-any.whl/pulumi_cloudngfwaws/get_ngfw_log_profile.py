...
class GetNgfwLogProfileResult:
    ...
    def advanced_threat_log(self) -> builtins.bool:
        """
    ...
    def cloud_watch_metric_namespace(self) -> builtins.str:
        """
    ...
    def cloudwatch_metric_fields(self) -> Sequence[builtins.str]:
        """
...
def get_ngfw_log_profile(account_id: Optional[builtins.str] = None,
                         ngfw: Optional[builtins.str] = None,
    ...
    * `Firewall`
    ...
    :param builtins.str ngfw: The name of the NGFW.
    """
    __args__ = dict()
...
def get_ngfw_log_profile_output(account_id: Optional[pulumi.Input[builtins.str]] = None,
