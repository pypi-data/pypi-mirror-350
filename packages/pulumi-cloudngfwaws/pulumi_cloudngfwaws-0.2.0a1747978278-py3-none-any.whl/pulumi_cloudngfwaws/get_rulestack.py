...
class GetRulestackResult:
    ...
    def account_group(self) -> builtins.str:
        """
        Account group.
        """
    ...
    def lookup_x_forwarded_for(self) -> builtins.str:
        """
    ...
    def minimum_app_id_version(self) -> builtins.str:
        """
...
def get_rulestack(config_type: Optional[builtins.str] = None,
...
def get_rulestack_output(config_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
