...
class GetNgfwResult:
    ...
    def app_id_version(self) -> builtins.str:
        """
    ...
    def automatic_upgrade_app_id_version(self) -> builtins.bool:
        """
    ...
    def global_rulestack(self) -> builtins.str:
        """
    ...
    def multi_vpc(self) -> builtins.bool:
        """
...
def get_ngfw(account_id: Optional[builtins.str] = None,
    ...
    * `Firewall`
    ...
    :param builtins.str account_id: The account ID. This field is mandatory if using multiple accounts.
...
def get_ngfw_output(account_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
