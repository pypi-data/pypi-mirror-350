...
class GetAccountResult:
    ...
    def trusted_account(self) -> builtins.str:
        """
...
def get_account(account_id: Optional[builtins.str] = None,
    ...
    * `Global Rulestack` (for `scope="Global"`)
    ...
    :param builtins.str cft_url: The CFT URL.
    :param builtins.str external_id: The external ID of the account
    :param builtins.str onboarding_status: The Account onboarding status
    :param builtins.str origin: Origin of account onboarding
    :param builtins.str service_account_id: The account ID of cloud NGFW service
    :param builtins.str sns_topic_arn: The SNS topic ARN
    :param builtins.str trusted_account: The trusted account ID
    """
    __args__ = dict()
...
def get_account_output(account_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       cft_url: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       external_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       onboarding_status: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       ...
                       sns_topic_arn: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       trusted_account: Optional[pulumi.Input[Optional[builtins.str]]] = None,
