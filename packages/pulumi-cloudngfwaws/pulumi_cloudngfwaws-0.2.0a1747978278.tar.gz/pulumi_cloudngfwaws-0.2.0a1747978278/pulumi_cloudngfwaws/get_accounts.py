...
class GetAccountsResult:
    ...
    @property
    @pulumi.getter
    def describe(self) -> Optional[builtins.bool]:
        """
...
def get_accounts(account_details: Optional[Sequence[Union['GetAccountsAccountDetailArgs', 'GetAccountsAccountDetailArgsDict']]] = None,
                 ...
                 describe: Optional[builtins.bool] = None,
    ...
    * `Global Rulestack` (for `scope="Global"`)
    ...
    :param Sequence[builtins.str] account_ids: List of account ids.
    :param builtins.bool describe: Flag to include account details while listing accounts. Defaults to `false`.
    """
    __args__ = dict()
...
def get_accounts_output(account_details: Optional[pulumi.Input[Optional[Sequence[Union['GetAccountsAccountDetailArgs', 'GetAccountsAccountDetailArgsDict']]]]] = None,
                        account_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                        describe: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
