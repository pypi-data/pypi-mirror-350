...
class GetNgfwsResult:
    ...
    @property
    @pulumi.getter
    def rulestack(self) -> Optional[builtins.str]:
        """
...
def get_ngfws(rulestack: Optional[builtins.str] = None,
    ...
    * `Firewall`
    ...
    :param builtins.str rulestack: The rulestack to filter on.
    :param Sequence[builtins.str] vpc_ids: List of vpc ids to filter on.
    """
    __args__ = dict()
...
def get_ngfws_output(rulestack: Optional[pulumi.Input[Optional[builtins.str]]] = None,
