...
class GetCountryResult:
    ...
    @property
    @pulumi.getter
    def codes(self) -> Mapping[str, builtins.str]:
        """
...
def get_country(max_results: Optional[builtins.int] = None,
...
def get_country_output(max_results: Optional[pulumi.Input[Optional[builtins.int]]] = None,
