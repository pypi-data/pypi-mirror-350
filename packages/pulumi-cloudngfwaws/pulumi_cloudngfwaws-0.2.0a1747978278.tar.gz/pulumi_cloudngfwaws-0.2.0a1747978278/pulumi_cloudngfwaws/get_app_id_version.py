...
def get_app_id_version(max_results: Optional[builtins.int] = None,
    ...
    * `Rulestack`
    ...
    :param builtins.int max_results: Max results. Defaults to `100`.
    :param builtins.str token: Pagination token.
    :param builtins.str version: The AppId version.
    """
    __args__ = dict()
...
def get_app_id_version_output(max_results: Optional[pulumi.Input[Optional[builtins.int]]] = None,
