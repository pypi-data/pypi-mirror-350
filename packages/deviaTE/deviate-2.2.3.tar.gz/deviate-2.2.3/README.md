...
old plotting:
intdels are written as start:end:abundance,start:end:abundance
for y coords, take the coverage at that point, or the mean in a little window
...
write tests for the internal deletions
- utils.py
- paf.py
- reference.py
- plot.py
