...
class Download(MagmaVar):
    ...
    def _extracted(date: str, description: str, event_name: str = None, count: int = None,
                   amplitudo: str = None, sp_time: str = None, duration: str = None, ):
    ...
    def extract(self) -> Self:
        ...
        for event in self.events:
            ...
            name_match = re.search(r'gempa\s+(.+?)\s+dengan', text)
            ...
            try:
                if count_match and name_match and amp_match and duration_match:
                    data = {
