...
_lr_productions = [
  ...
  ('query -> expression','query',1,'p_query','search.py',240),
  ('expression -> expression AND expression','expression',3,'p_expression_binary','search.py',246),
  ('expression -> expression OR expression','expression',3,'p_expression_binary','search.py',247),
  ('expression -> expression NOT expression','expression',3,'p_expression_binary','search.py',248),
  ('expression -> NOT expression','expression',2,'p_expression_not','search.py',292),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','search.py',307),
  ('expression -> URL_FIELD','expression',1,'p_expression_url_field','search.py',313),
  ('value -> TERM','value',1,'p_value','search.py',333),
  ('value -> WILDCARD','value',1,'p_value','search.py',334),
  ('value -> QUOTED_STRING','value',1,'p_value','search.py',335),
  ('expression -> value','expression',1,'p_expression_term','search.py',349),
  ('expression -> FIELD COLON COMP_OP value','expression',4,'p_expression_field_search','search.py',362),
  ('expression -> FIELD COLON value','expression',3,'p_expression_field_search','search.py',363),
  ('expression -> FIELD COMPARATOR value','expression',3,'p_expression_field_search','search.py',364),
]
