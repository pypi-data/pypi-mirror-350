...
if platform.system() == "Windows":
    cmake_path = os.path.join(sys.exec_prefix, "Scripts", "cmake.exe") # sys.exec_prefix points to your Python's base dir
else:
    # On Linux or Mac, just call cmake from PATH
    cmake_path = shutil.which("cmake")
    if cmake_path is None:
        raise RuntimeError("cmake executable not found in PATH")

print("Using cmake path:", cmake_path)
...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        cmake_args = [
            ...
            "-DPYTHON_EXECUTABLE={0}".format(sys.executable),  # Optional: for backwards
        ]
