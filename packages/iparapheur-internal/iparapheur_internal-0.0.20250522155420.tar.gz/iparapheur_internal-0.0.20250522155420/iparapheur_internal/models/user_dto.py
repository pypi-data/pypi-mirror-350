...
class UserDto(BaseModel):
    ...
    administered_desks: Optional[List[DeskRepresentation]] = Field(default=None, alias="administeredDesks")
    administered_desk_ids: Optional[List[Optional[StrictStr]]] = Field(default=None, alias="administeredDeskIds")
    associated_desks: Optional[List[DeskRepresentation]] = Field(default=None, alias="associatedDesks")
    associated_desk_ids: Optional[List[Optional[StrictStr]]] = Field(default=None, alias="associatedDeskIds")
    supervised_desks: Optional[List[DeskRepresentation]] = Field(default=None, alias="supervisedDesks")
    supervised_desk_ids: Optional[List[Optional[StrictStr]]] = Field(default=None, alias="supervisedDeskIds")
    delegation_managed_desks: Optional[List[DeskRepresentation]] = Field(default=None, alias="delegationManagedDesks")
