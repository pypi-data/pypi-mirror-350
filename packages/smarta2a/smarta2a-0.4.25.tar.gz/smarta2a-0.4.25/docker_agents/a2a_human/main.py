...
agent_description = os.getenv("AGENT_DESCRIPTION", "A friendly human that can help with tasks or queries - note a response will take time so don't assume no response to mean a failure to respond.")
