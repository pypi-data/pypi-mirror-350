...
class GetLicensingSubscriptionSubscriptionsResult:
    ...
    def organization_ids(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def subscription_ids(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_licensing_subscription_subscriptions(end_date: Optional[builtins.str] = None,
                                             ending_before: Optional[builtins.str] = None,
                                             organization_ids: Optional[Sequence[builtins.str]] = None,
                                             ...
                                             subscription_ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param builtins.str end_date: endDate query parameter. Filter subscriptions by end date, ISO 8601 format. To filter with a range of dates, use 'endDate[
           ]=?' in the request. Accepted options include lt, gt, lte, gte.
    :param builtins.str ending_before: endingBefore query parameter. A token used by the server to indicate the end of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
    :param Sequence[builtins.str] organization_ids: organizationIds query parameter. Organizations to get associated subscriptions for
    ...
    :param Sequence[builtins.str] product_types: productTypes query parameter. List of product types that returned subscriptions need to have entitlements for.
    :param builtins.str start_date: startDate query parameter. Filter subscriptions by start date, ISO 8601 format. To filter with a range of dates, use 'startDate[
           ]=?' in the request. Accepted options include lt, gt, lte, gte.
    :param builtins.str starting_after: startingAfter query parameter. A token used by the server to indicate the start of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
    :param Sequence[builtins.str] statuses: statuses query parameter. List of statuses that returned subscriptions can have
    :param Sequence[builtins.str] subscription_ids: subscriptionIds query parameter. List of subscription ids to fetch
    """
    __args__ = dict()
...
def get_licensing_subscription_subscriptions_output(end_date: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                    ending_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                    organization_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                                    ...
                                                    start_date: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                    ...
                                                    subscription_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
