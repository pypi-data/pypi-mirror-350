...
class GetLicensingSubscriptionEntitlementsResult:
    ...
    @property
    @pulumi.getter
    def skuses(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_licensing_subscription_entitlements(skuses: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] skuses: skus query parameter. Filter to entitlements with the specified SKUs
    """
    __args__ = dict()
...
def get_licensing_subscription_entitlements_output(skuses: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
