...
def get_sm_users(emails: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] emails: emails query parameter. Filter users by email(s).
    :param Sequence[builtins.str] ids: ids query parameter. Filter users by id(s).
    :param builtins.str network_id: networkId path parameter. Network ID
    :param Sequence[builtins.str] scopes: scope query parameter. Specifiy a scope (one of all, none, withAny, withAll, withoutAny, withoutAll) and a set of tags.
    :param Sequence[builtins.str] usernames: usernames query parameter. Filter users by username(s).
    """
    __args__ = dict()
...
def get_sm_users_output(emails: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                        ...
                        usernames: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
