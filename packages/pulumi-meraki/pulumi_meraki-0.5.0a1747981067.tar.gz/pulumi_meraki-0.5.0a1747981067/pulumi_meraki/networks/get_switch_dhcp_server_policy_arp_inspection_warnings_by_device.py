...
def get_switch_dhcp_server_policy_arp_inspection_warnings_by_device(ending_before: Optional[builtins.str] = None,
...
def get_switch_dhcp_server_policy_arp_inspection_warnings_by_device_output(ending_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
