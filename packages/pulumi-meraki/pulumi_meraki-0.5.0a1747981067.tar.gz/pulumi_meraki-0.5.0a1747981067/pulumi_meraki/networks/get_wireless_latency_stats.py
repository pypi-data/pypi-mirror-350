...
def get_wireless_latency_stats(ap_tag: Optional[builtins.str] = None,
...
def get_wireless_latency_stats_output(ap_tag: Optional[pulumi.Input[Optional[builtins.str]]] = None,
