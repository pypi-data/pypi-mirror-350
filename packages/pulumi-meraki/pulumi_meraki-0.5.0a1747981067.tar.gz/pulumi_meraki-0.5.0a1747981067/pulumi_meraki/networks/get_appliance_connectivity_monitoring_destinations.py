...
def get_appliance_connectivity_monitoring_destinations(network_id: Optional[builtins.str] = None,
...
def get_appliance_connectivity_monitoring_destinations_output(network_id: Optional[pulumi.Input[builtins.str]] = None,
