...
def get_appliance_firewall_one_to_many_nat_rules(network_id: Optional[builtins.str] = None,
...
def get_appliance_firewall_one_to_many_nat_rules_output(network_id: Optional[pulumi.Input[builtins.str]] = None,
