...
def get_wireless_ssids_traffic_shaping_rules(network_id: Optional[builtins.str] = None,
...
def get_wireless_ssids_traffic_shaping_rules_output(network_id: Optional[pulumi.Input[builtins.str]] = None,
