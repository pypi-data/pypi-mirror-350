...
def get_pii_sm_owners_for_key(bluetooth_mac: Optional[builtins.str] = None,
...
def get_pii_sm_owners_for_key_output(bluetooth_mac: Optional[pulumi.Input[Optional[builtins.str]]] = None,
