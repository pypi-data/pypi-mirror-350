...
class GetAppliancePrefixesDelegatedStaticsResult:
    ...
    def static_delegated_prefix_id(self) -> Optional[builtins.str]:
        """
...
def get_appliance_prefixes_delegated_statics(network_id: Optional[builtins.str] = None,
                                             static_delegated_prefix_id: Optional[builtins.str] = None,
    ...
    :param builtins.str static_delegated_prefix_id: staticDelegatedPrefixId path parameter. Static delegated prefix ID
    """
    __args__ = dict()
...
def get_appliance_prefixes_delegated_statics_output(network_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                    static_delegated_prefix_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
