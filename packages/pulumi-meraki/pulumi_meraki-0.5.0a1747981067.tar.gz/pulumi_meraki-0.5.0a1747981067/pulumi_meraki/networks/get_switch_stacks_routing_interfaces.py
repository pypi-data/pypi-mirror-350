...
class GetSwitchStacksRoutingInterfacesResult:
    ...
    def interface_id(self) -> Optional[builtins.str]:
        """
...
def get_switch_stacks_routing_interfaces(interface_id: Optional[builtins.str] = None,
    ...
    :param builtins.str interface_id: interfaceId path parameter. Interface ID
...
def get_switch_stacks_routing_interfaces_output(interface_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
