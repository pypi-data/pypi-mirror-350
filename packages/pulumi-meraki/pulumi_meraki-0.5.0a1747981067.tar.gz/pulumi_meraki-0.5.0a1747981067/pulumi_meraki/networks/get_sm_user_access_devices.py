...
def get_sm_user_access_devices(ending_before: Optional[builtins.str] = None,
...
def get_sm_user_access_devices_output(ending_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
