...
class GetCameraWirelessProfilesResult:
    ...
    def wireless_profile_id(self) -> Optional[builtins.str]:
        """
...
def get_camera_wireless_profiles(network_id: Optional[builtins.str] = None,
                                 wireless_profile_id: Optional[builtins.str] = None,
    ...
    :param builtins.str wireless_profile_id: wirelessProfileId path parameter. Wireless profile ID
    """
    __args__ = dict()
...
def get_camera_wireless_profiles_output(network_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        wireless_profile_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
