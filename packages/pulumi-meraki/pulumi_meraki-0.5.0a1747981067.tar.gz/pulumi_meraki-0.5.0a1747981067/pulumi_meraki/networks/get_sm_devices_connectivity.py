...
def get_sm_devices_connectivity(device_id: Optional[builtins.str] = None,
...
def get_sm_devices_connectivity_output(device_id: Optional[pulumi.Input[builtins.str]] = None,
