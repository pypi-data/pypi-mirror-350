...
def get_switch_dscp_to_cos_mappings(network_id: Optional[builtins.str] = None,
...
def get_switch_dscp_to_cos_mappings_output(network_id: Optional[pulumi.Input[builtins.str]] = None,
