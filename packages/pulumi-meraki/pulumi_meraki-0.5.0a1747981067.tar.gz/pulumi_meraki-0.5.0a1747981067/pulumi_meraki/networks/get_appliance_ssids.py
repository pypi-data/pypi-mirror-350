...
def get_appliance_ssids(network_id: Optional[builtins.str] = None,
...
def get_appliance_ssids_output(network_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
