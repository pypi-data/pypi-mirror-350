...
def get_sm_trusted_access_configs(ending_before: Optional[builtins.str] = None,
...
def get_sm_trusted_access_configs_output(ending_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
