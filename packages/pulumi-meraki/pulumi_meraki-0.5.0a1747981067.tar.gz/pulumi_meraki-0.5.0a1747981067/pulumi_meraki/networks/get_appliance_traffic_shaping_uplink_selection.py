...
def get_appliance_traffic_shaping_uplink_selection(network_id: Optional[builtins.str] = None,
...
def get_appliance_traffic_shaping_uplink_selection_output(network_id: Optional[pulumi.Input[builtins.str]] = None,
