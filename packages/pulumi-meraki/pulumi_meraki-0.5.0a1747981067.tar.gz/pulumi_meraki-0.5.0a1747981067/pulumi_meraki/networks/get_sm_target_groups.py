...
class GetSmTargetGroupsResult:
    ...
    def target_group_id(self) -> Optional[builtins.str]:
        """
    ...
    def with_details(self) -> Optional[builtins.bool]:
        """
...
def get_sm_target_groups(network_id: Optional[builtins.str] = None,
                         target_group_id: Optional[builtins.str] = None,
                         with_details: Optional[builtins.bool] = None,
    ...
    :param builtins.str target_group_id: targetGroupId path parameter. Target group ID
    :param builtins.bool with_details: withDetails query parameter. Boolean indicating if the the ids of the devices or users scoped by the target group should be included in the response
    """
    __args__ = dict()
...
def get_sm_target_groups_output(network_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                target_group_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                with_details: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
