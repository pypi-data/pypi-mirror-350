...
def get_group_policies(group_policy_id: Optional[builtins.str] = None,
    ...
    :param builtins.str group_policy_id: groupPolicyId path parameter. Group policy ID
...
def get_group_policies_output(group_policy_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
