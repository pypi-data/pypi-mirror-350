...
def get_pii_requests(network_id: Optional[builtins.str] = None,
    ...
    :param builtins.str request_id: requestId path parameter. Request ID
    """
    __args__ = dict()
...
def get_pii_requests_output(network_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
