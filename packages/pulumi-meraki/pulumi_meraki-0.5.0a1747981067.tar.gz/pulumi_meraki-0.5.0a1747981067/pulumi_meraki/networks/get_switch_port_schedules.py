...
def get_switch_port_schedules(network_id: Optional[builtins.str] = None,
...
def get_switch_port_schedules_output(network_id: Optional[pulumi.Input[builtins.str]] = None,
