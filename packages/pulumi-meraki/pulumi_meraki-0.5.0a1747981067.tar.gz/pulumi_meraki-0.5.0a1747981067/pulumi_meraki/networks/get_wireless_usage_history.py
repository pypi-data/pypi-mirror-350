...
def get_wireless_usage_history(ap_tag: Optional[builtins.str] = None,
    ...
    :param builtins.str ap_tag: apTag query parameter. Filter results by AP tag; either :clientId or :deviceSerial must be jointly specified.
    ...
    :param builtins.str client_id: clientId query parameter. Filter results by network client to return per-device AP usage over time inner joined by the queried client's connection history.
    :param builtins.str device_serial: deviceSerial query parameter. Filter results by device. Requires :band.
...
def get_wireless_usage_history_output(ap_tag: Optional[pulumi.Input[Optional[builtins.str]]] = None,
