...
def get_appliance_security_intrusion(network_id: Optional[builtins.str] = None,
...
def get_appliance_security_intrusion_output(network_id: Optional[pulumi.Input[builtins.str]] = None,
