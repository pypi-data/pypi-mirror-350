...
class GetSmDevicesResult:
    ...
    def system_types(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter
    def uuids(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_sm_devices(ending_before: Optional[builtins.str] = None,
                   ...
                   system_types: Optional[Sequence[builtins.str]] = None,
                   uuids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] fields: fields query parameter. Additional fields that will be displayed for each device.
           The default fields are: id, name, tags, ssid, wifiMac, osName, systemModel, uuid, and serialNumber. The additional fields are: ip,
           systemType, availableDeviceCapacity, kioskAppName, biosVersion, lastConnected, missingAppsCount, userSuppliedAddress, location, lastUser,
           ownerEmail, ownerUsername, osBuild, publicIp, phoneNumber, diskInfoJson, deviceCapacity, isManaged, hadMdm, isSupervised, meid, imei, iccid,
           simCarrierNetwork, cellularDataUsed, isHotspotEnabled, createdAt, batteryEstCharge, quarantined, avName, avRunning, asName, fwName,
           isRooted, loginRequired, screenLockEnabled, screenLockDelay, autoLoginDisabled, autoTags, hasMdm, hasDesktopAgent, diskEncryptionEnabled,
           hardwareEncryptionCaps, passCodeLock, usesHardwareKeystore, androidSecurityPatchVersion, cellular, and url.
    :param Sequence[builtins.str] ids: ids query parameter. Filter devices by id(s).
    ...
    :param Sequence[builtins.str] scopes: scope query parameter. Specify a scope (one of all, none, withAny, withAll, withoutAny, or withoutAll) and a set of tags.
    :param Sequence[builtins.str] serials: serials query parameter. Filter devices by serial(s).
    :param builtins.str starting_after: startingAfter query parameter. A token used by the server to indicate the start of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
    :param Sequence[builtins.str] system_types: systemTypes query parameter. Filter devices by system type(s).
    :param Sequence[builtins.str] uuids: uuids query parameter. Filter devices by uuid(s).
    :param Sequence[builtins.str] wifi_macs: wifiMacs query parameter. Filter devices by wifi mac(s).
    """
    __args__ = dict()
...
def get_sm_devices_output(ending_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                          ...
                          system_types: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                          uuids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                          wifi_macs: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
