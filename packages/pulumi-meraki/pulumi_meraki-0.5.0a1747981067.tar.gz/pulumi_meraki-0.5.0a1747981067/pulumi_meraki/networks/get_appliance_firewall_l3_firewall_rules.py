...
def get_appliance_firewall_l3_firewall_rules(network_id: Optional[builtins.str] = None,
...
def get_appliance_firewall_l3_firewall_rules_output(network_id: Optional[pulumi.Input[builtins.str]] = None,
