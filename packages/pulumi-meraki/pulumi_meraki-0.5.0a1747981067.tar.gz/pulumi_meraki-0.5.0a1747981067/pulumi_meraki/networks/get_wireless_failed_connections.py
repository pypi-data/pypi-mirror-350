...
def get_wireless_failed_connections(ap_tag: Optional[builtins.str] = None,
    ...
    :param builtins.str client_id: clientId query parameter. Filter by client MAC
    :param builtins.str network_id: networkId path parameter. Network ID
    :param builtins.str serial: serial query parameter. Filter by AP
...
def get_wireless_failed_connections_output(ap_tag: Optional[pulumi.Input[Optional[builtins.str]]] = None,
