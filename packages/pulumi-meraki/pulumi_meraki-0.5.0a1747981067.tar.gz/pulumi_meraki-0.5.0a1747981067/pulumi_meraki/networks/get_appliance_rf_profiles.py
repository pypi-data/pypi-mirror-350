...
def get_appliance_rf_profiles(network_id: Optional[builtins.str] = None,
...
def get_appliance_rf_profiles_output(network_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
