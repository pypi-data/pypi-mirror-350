...
def get_sm_devices_device_command_logs(device_id: Optional[builtins.str] = None,
...
def get_sm_devices_device_command_logs_output(device_id: Optional[pulumi.Input[builtins.str]] = None,
