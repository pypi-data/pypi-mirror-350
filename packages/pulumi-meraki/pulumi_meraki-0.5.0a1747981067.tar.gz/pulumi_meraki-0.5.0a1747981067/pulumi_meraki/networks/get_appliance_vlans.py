...
def get_appliance_vlans(network_id: Optional[builtins.str] = None,
    ...
    :param builtins.str vlan_id: vlanId path parameter. Vlan ID
    """
    __args__ = dict()
...
def get_appliance_vlans_output(network_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
