...
class GetWebhooksWebhookTestsResult:
    ...
    def webhook_test_id(self) -> builtins.str:
        """
...
def get_webhooks_webhook_tests(network_id: Optional[builtins.str] = None,
                               webhook_test_id: Optional[builtins.str] = None,
    ...
    :param builtins.str webhook_test_id: webhookTestId path parameter. Webhook test ID
    """
    __args__ = dict()
...
def get_webhooks_webhook_tests_output(network_id: Optional[pulumi.Input[builtins.str]] = None,
                                      webhook_test_id: Optional[pulumi.Input[builtins.str]] = None,
