...
def get_wireless_ssids_splash_settings(network_id: Optional[builtins.str] = None,
...
def get_wireless_ssids_splash_settings_output(network_id: Optional[pulumi.Input[builtins.str]] = None,
