...
class GetCellularGatewayUplinkStatusesResult:
    ...
    @property
    @pulumi.getter
    def iccids(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_cellular_gateway_uplink_statuses(ending_before: Optional[builtins.str] = None,
                                         iccids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] iccids: iccids query parameter. A list of ICCIDs. The returned devices will be filtered to only include these ICCIDs.
    :param Sequence[builtins.str] network_ids: networkIds query parameter. A list of network IDs. The returned devices will be filtered to only include these networks.
    ...
    :param Sequence[builtins.str] serials: serials query parameter. A list of serial numbers. The returned devices will be filtered to only include these serials.
...
def get_cellular_gateway_uplink_statuses_output(ending_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                iccids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
