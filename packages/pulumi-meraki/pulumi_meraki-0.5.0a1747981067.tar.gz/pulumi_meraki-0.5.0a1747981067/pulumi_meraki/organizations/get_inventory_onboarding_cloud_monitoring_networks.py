...
def get_inventory_onboarding_cloud_monitoring_networks(device_type: Optional[builtins.str] = None,
    ...
    :param builtins.str device_type: deviceType query parameter. Device Type switch or wireless controller
    ...
    :param builtins.str search: search query parameter. Optional parameter to search on network name
...
def get_inventory_onboarding_cloud_monitoring_networks_output(device_type: Optional[pulumi.Input[builtins.str]] = None,
