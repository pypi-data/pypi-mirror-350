...
def get_wireless_devices_ethernet_statuses(ending_before: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] network_ids: networkIds query parameter. A list of Meraki network IDs to filter results to contain only specified networks. E.g.: networkIds[]=N*12345678&networkIds[]=L*3456
    :param builtins.str organization_id: organizationId path parameter. Organization ID
    :param builtins.int per_page: perPage query parameter. The number of entries per page returned. Acceptable range is 3 1000. Default is 100.
...
def get_wireless_devices_ethernet_statuses_output(ending_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
