...
class GetSamlRolesResult:
    ...
    def saml_role_id(self) -> Optional[builtins.str]:
        """
...
def get_saml_roles(organization_id: Optional[builtins.str] = None,
                   saml_role_id: Optional[builtins.str] = None,
    ...
    :param builtins.str saml_role_id: samlRoleId path parameter. Saml role ID
    """
    __args__ = dict()
...
def get_saml_roles_output(organization_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                          saml_role_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
