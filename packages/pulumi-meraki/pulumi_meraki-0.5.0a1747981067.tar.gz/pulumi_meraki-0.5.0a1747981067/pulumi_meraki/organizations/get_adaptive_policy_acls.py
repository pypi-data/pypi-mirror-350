...
def get_adaptive_policy_acls(acl_id: Optional[builtins.str] = None,
    ...
    :param builtins.str acl_id: aclId path parameter. Acl ID
...
def get_adaptive_policy_acls_output(acl_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
