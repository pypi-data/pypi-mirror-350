...
def get_api_requests(admin_id: Optional[builtins.str] = None,
    ...
    :param builtins.str admin_id: adminId query parameter. Filter the results by the ID of the admin who made the API requests
    :param builtins.str ending_before: endingBefore query parameter. A token used by the server to indicate the end of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
    :param builtins.str method: method query parameter. Filter the results by the method of the API requests (must be 'GET', 'PUT', 'POST' or 'DELETE')
    :param Sequence[builtins.str] operation_ids: operationIds query parameter. Filter the results by one or more operation IDs for the API request
    :param builtins.str organization_id: organizationId path parameter. Organization ID
    :param builtins.str path: path query parameter. Filter the results by the path of the API requests
    :param builtins.int per_page: perPage query parameter. The number of entries per page returned. Acceptable range is 3 1000. Default is 50.
    :param builtins.int response_code: responseCode query parameter. Filter the results by the response code of the API requests
    :param builtins.str source_ip: sourceIp query parameter. Filter the results by the IP address of the originating API request
    ...
    :param builtins.float timespan: timespan query parameter. The timespan for which the information will be fetched. If specifying timespan, do not specify parameters t0 and t1. The value must be in seconds and be less than or equal to 31 days. The default is 31 days.
    :param builtins.str user_agent: userAgent query parameter. Filter the results by the user agent string of the API request
    :param builtins.int version: version query parameter. Filter the results by the API version of the API request
    """
    __args__ = dict()
...
def get_api_requests_output(admin_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            ...
                            response_code: Optional[pulumi.Input[Optional[builtins.int]]] = None,
