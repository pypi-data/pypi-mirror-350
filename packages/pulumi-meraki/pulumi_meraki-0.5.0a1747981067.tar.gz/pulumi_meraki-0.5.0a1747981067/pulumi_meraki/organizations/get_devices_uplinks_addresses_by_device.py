...
def get_devices_uplinks_addresses_by_device(ending_before: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] network_ids: networkIds query parameter. Optional parameter to filter device uplinks by network ID. This filter uses multiple exact matches.
    ...
    :param Sequence[builtins.str] product_types: productTypes query parameter. Optional parameter to filter device uplinks by device product types. This filter uses multiple exact matches.
...
def get_devices_uplinks_addresses_by_device_output(ending_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
