...
def get_wireless_devices_packet_loss_by_device(bands: Optional[Sequence[builtins.str]] = None,
...
def get_wireless_devices_packet_loss_by_device_output(bands: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
