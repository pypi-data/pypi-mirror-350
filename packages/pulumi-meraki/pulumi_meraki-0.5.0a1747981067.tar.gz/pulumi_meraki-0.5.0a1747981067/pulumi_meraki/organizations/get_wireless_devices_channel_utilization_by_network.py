...
def get_wireless_devices_channel_utilization_by_network(ending_before: Optional[builtins.str] = None,
    ...
    :param builtins.int interval: interval query parameter. The time interval in seconds for returned data. The valid intervals are: 300, 600, 3600, 7200, 14400, 21600. The default is 3600.
    ...
    :param builtins.float timespan: timespan query parameter. The timespan for which the information will be fetched. If specifying timespan, do not specify parameters t0 and t1. The value must be in seconds and be less than or equal to 90 days. The default is 7 days.
    """
    __args__ = dict()
...
def get_wireless_devices_channel_utilization_by_network_output(ending_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
