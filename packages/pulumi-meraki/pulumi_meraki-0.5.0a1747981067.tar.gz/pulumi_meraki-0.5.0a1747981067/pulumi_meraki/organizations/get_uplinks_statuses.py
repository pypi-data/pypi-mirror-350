...
def get_uplinks_statuses(ending_before: Optional[builtins.str] = None,
...
def get_uplinks_statuses_output(ending_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
