...
def get_camera_permissions(organization_id: Optional[builtins.str] = None,
    ...
    :param builtins.str permission_scope_id: permissionScopeId path parameter. Permission scope ID
    """
    __args__ = dict()
...
def get_camera_permissions_output(organization_id: Optional[pulumi.Input[builtins.str]] = None,
