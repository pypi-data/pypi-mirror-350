...
def get_appliance_uplinks_usage_by_network(organization_id: Optional[builtins.str] = None,
    ...
    :param builtins.str t1: t1 query parameter. The end of the timespan for the data. t1 can be a maximum of 14 days after t0.
    :param builtins.float timespan: timespan query parameter. The timespan for which the information will be fetched. If specifying timespan, do not specify parameters t0 and t1. The value must be in seconds and be less than or equal to 14 days. The default is 1 day.
    """
    __args__ = dict()
...
def get_appliance_uplinks_usage_by_network_output(organization_id: Optional[pulumi.Input[builtins.str]] = None,
