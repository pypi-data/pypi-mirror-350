...
def get_config_templates_switch_profiles_ports(config_template_id: Optional[builtins.str] = None,
    ...
    :param builtins.str config_template_id: configTemplateId path parameter. Config template ID
    :param builtins.str organization_id: organizationId path parameter. Organization ID
    :param builtins.str port_id: portId path parameter. Port ID
    :param builtins.str profile_id: profileId path parameter. Profile ID
    """
    __args__ = dict()
...
def get_config_templates_switch_profiles_ports_output(config_template_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
