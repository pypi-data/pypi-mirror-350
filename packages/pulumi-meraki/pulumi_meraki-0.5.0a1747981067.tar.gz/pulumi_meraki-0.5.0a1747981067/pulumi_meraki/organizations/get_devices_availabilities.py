...
def get_devices_availabilities(ending_before: Optional[builtins.str] = None,
...
def get_devices_availabilities_output(ending_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
