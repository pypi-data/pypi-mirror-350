...
class GetBrandingPoliciesResult:
    ...
    def branding_policy_id(self) -> Optional[builtins.str]:
        """
...
def get_branding_policies(branding_policy_id: Optional[builtins.str] = None,
    ...
    :param builtins.str branding_policy_id: brandingPolicyId path parameter. Branding policy ID
...
def get_branding_policies_output(branding_policy_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
