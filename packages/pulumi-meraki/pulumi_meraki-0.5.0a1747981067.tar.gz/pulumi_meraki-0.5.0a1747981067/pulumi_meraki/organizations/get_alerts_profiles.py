...
def get_alerts_profiles(organization_id: Optional[builtins.str] = None,
...
def get_alerts_profiles_output(organization_id: Optional[pulumi.Input[builtins.str]] = None,
