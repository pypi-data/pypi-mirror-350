...
def get_devices_uplinks_loss_and_latency(ip: Optional[builtins.str] = None,
    ...
    :param builtins.str ip: ip query parameter. Optional filter for a specific destination IP. Default will return all destination IPs.
    :param builtins.str organization_id: organizationId path parameter. Organization ID
    :param builtins.str t0: t0 query parameter. The beginning of the timespan for the data. The maximum lookback period is 60 days from today.
    :param builtins.str t1: t1 query parameter. The end of the timespan for the data. t1 can be a maximum of 5 minutes after t0. The latest possible time that t1 can be is 2 minutes into the past.
    :param builtins.float timespan: timespan query parameter. The timespan for which the information will be fetched. If specifying timespan, do not specify parameters t0 and t1. The value must be in seconds and be less than or equal to 5 minutes. The default is 5 minutes.
    :param builtins.str uplink: uplink query parameter. Optional filter for a specific WAN uplink. Valid uplinks are wan1, wan2, wan3, cellular. Default will return all uplinks.
    """
    __args__ = dict()
    __args__['ip'] = ip
...
def get_devices_uplinks_loss_and_latency_output(ip: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                ...
                                                uplink: Optional[pulumi.Input[Optional[builtins.str]]] = None,
