...
class GetCameraDetectionsHistoryByBoundaryByIntervalResult:
    ...
    def boundary_ids(self) -> Sequence[builtins.str]:
        """
    ...
    def boundary_types(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_camera_detections_history_by_boundary_by_interval(boundary_ids: Optional[Sequence[builtins.str]] = None,
                                                          boundary_types: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] boundary_ids: boundaryIds query parameter. A list of boundary ids. The returned cameras will be filtered to only include these ids.
    :param Sequence[builtins.str] boundary_types: boundaryTypes query parameter. The detection types. Defaults to 'person'.
    :param builtins.int duration: duration query parameter. The minimum time, in seconds, that the person or car remains in the area to be counted. Defaults to boundary configuration or 60.
    :param builtins.str organization_id: organizationId path parameter. Organization ID
    :param builtins.int per_page: perPage query parameter. The number of entries per page returned. Acceptable range is 1 1000. Defaults to 1000.
    :param Sequence[builtins.str] ranges: ranges query parameter. A list of time ranges with intervals
    """
    __args__ = dict()
...
def get_camera_detections_history_by_boundary_by_interval_output(boundary_ids: Optional[pulumi.Input[Sequence[builtins.str]]] = None,
                                                                 boundary_types: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                                                 duration: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                                                                 organization_id: Optional[pulumi.Input[builtins.str]] = None,
                                                                 per_page: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                                                                 ranges: Optional[pulumi.Input[Sequence[builtins.str]]] = None,
