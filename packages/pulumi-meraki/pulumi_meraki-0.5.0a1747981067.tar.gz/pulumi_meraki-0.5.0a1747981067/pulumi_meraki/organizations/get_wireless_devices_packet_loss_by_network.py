...
def get_wireless_devices_packet_loss_by_network(bands: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] serials: serials query parameter. Filter results by device.
...
def get_wireless_devices_packet_loss_by_network_output(bands: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
