...
def get_webhooks_callbacks_statuses(callback_id: Optional[builtins.str] = None,
    ...
    :param builtins.str callback_id: callbackId path parameter. Callback ID
...
def get_webhooks_callbacks_statuses_output(callback_id: Optional[pulumi.Input[builtins.str]] = None,
