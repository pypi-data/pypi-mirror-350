...
def get_licenses(license_id: Optional[builtins.str] = None,
    ...
    :param builtins.str license_id: licenseId path parameter. License ID
...
def get_licenses_output(license_id: Optional[pulumi.Input[builtins.str]] = None,
