...
class GetFirmwareUpgradesByDeviceResult:
    ...
    def firmware_upgrade_batch_ids(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter
    def upgradestatuses(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_firmware_upgrades_by_device(ending_before: Optional[builtins.str] = None,
                                    firmware_upgrade_batch_ids: Optional[Sequence[builtins.str]] = None,
                                    ...
                                    upgradestatuses: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] firmware_upgrade_batch_ids: firmwareUpgradeBatchIds query parameter. Optional parameter to filter by firmware upgrade batch ids.
    :param Sequence[builtins.str] macs: macs query parameter. Optional parameter to filter by one or more MAC addresses belonging to devices. All devices returned belong to MAC addresses that are an exact match.
    :param Sequence[builtins.str] network_ids: networkIds query parameter. Optional parameter to filter by network
    ...
    :param Sequence[builtins.str] serials: serials query parameter. Optional parameter to filter by serial number.  All returned devices will have a serial number that is an exact match.
    :param builtins.str starting_after: startingAfter query parameter. A token used by the server to indicate the start of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
    :param Sequence[builtins.str] upgradestatuses: upgradeStatuses query parameter. Optional parameter to filter by firmware upgrade statuses.
    """
    __args__ = dict()
...
def get_firmware_upgrades_by_device_output(ending_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                           firmware_upgrade_batch_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                           ...
                                           upgradestatuses: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
