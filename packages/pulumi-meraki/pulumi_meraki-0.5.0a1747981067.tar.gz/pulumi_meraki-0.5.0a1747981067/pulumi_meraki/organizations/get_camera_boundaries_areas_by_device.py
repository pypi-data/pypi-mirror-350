...
def get_camera_boundaries_areas_by_device(organization_id: Optional[builtins.str] = None,
...
def get_camera_boundaries_areas_by_device_output(organization_id: Optional[pulumi.Input[builtins.str]] = None,
