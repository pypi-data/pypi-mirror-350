...
def get_devices_provisioning_statuses(ending_before: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] network_ids: networkIds query parameter. Optional parameter to filter device by network ID. This filter uses multiple exact matches.
    ...
    :param Sequence[builtins.str] product_types: productTypes query parameter. Optional parameter to filter device by device product types. This filter uses multiple exact matches.
    ...
    :param builtins.str status: status query parameter. An optional parameter to filter devices by the provisioning status. Accepted statuses: unprovisioned, incomplete, complete.
    :param Sequence[builtins.str] tags: tags query parameter. An optional parameter to filter devices by tags. The filtering is case-sensitive. If tags are included, 'tagsFilterType' should also be included (see below). This filter uses multiple exact matches.
...
def get_devices_provisioning_statuses_output(ending_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
