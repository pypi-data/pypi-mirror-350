...
def get_appliance_vpn_vpn_firewall_rules(organization_id: Optional[builtins.str] = None,
...
def get_appliance_vpn_vpn_firewall_rules_output(organization_id: Optional[pulumi.Input[builtins.str]] = None,
