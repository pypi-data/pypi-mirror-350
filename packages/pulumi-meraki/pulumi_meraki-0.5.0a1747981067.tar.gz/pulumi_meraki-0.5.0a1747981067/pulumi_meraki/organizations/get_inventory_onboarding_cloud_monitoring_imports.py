...
class GetInventoryOnboardingCloudMonitoringImportsResult:
    ...
    def import_ids(self) -> Sequence[builtins.str]:
        """
...
def get_inventory_onboarding_cloud_monitoring_imports(import_ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] import_ids: importIds query parameter. import ids from an imports
...
def get_inventory_onboarding_cloud_monitoring_imports_output(import_ids: Optional[pulumi.Input[Sequence[builtins.str]]] = None,
