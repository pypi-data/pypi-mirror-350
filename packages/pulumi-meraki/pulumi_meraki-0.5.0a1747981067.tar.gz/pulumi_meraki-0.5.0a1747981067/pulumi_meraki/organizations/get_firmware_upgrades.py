...
def get_firmware_upgrades(ending_before: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] product_types: productTypes query parameter. Optional parameter to filter the upgrade by product type.
    :param builtins.str starting_after: startingAfter query parameter. A token used by the server to indicate the start of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
    :param Sequence[builtins.str] statuses: status query parameter. Optional parameter to filter the upgrade by status.
    """
    __args__ = dict()
...
def get_firmware_upgrades_output(ending_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
