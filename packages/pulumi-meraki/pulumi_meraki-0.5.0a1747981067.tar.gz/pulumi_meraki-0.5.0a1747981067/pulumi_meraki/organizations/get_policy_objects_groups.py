...
class GetPolicyObjectsGroupsResult:
    ...
    def policy_object_group_id(self) -> Optional[builtins.str]:
        """
...
def get_policy_objects_groups(ending_before: Optional[builtins.str] = None,
                              organization_id: Optional[builtins.str] = None,
                              per_page: Optional[builtins.int] = None,
                              policy_object_group_id: Optional[builtins.str] = None,
    ...
    :param builtins.int per_page: perPage query parameter. The number of entries per page returned. Acceptable range is 10 1000. Default is 1000.
    :param builtins.str policy_object_group_id: policyObjectGroupId path parameter. Policy object group ID
...
def get_policy_objects_groups_output(ending_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                     ...
                                     policy_object_group_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
