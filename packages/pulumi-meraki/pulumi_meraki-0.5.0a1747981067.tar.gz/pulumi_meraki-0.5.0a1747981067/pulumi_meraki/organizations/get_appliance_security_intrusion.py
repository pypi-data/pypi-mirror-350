...
def get_appliance_security_intrusion(organization_id: Optional[builtins.str] = None,
...
def get_appliance_security_intrusion_output(organization_id: Optional[pulumi.Input[builtins.str]] = None,
