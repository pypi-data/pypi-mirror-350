...
def get_organizations(ending_before: Optional[builtins.str] = None,
    ...
    :param builtins.int per_page: perPage query parameter. The number of entries per page returned. Acceptable range is 3 9000. Default is 9000.
...
def get_organizations_output(ending_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
