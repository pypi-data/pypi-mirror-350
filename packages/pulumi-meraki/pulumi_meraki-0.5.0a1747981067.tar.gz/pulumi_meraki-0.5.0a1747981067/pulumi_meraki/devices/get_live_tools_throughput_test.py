...
def get_live_tools_throughput_test(serial: Optional[builtins.str] = None,
                                   throughput_test_id: Optional[builtins.str] = None,
    ...
    :param builtins.str throughput_test_id: throughputTestId path parameter. Throughput test ID
    """
    __args__ = dict()
...
def get_live_tools_throughput_test_output(serial: Optional[pulumi.Input[builtins.str]] = None,
