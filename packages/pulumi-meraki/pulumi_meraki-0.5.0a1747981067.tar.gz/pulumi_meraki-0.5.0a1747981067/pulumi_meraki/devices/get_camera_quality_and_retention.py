...
def get_camera_quality_and_retention(serial: Optional[builtins.str] = None,
...
def get_camera_quality_and_retention_output(serial: Optional[pulumi.Input[builtins.str]] = None,
