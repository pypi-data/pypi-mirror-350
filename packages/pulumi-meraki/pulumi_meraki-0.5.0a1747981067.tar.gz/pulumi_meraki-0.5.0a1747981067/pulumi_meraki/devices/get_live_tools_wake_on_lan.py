...
def get_live_tools_wake_on_lan(serial: Optional[builtins.str] = None,
                               wake_on_lan_id: Optional[builtins.str] = None,
    ...
    :param builtins.str wake_on_lan_id: wakeOnLanId path parameter. Wake on lan ID
    """
    __args__ = dict()
...
def get_live_tools_wake_on_lan_output(serial: Optional[pulumi.Input[builtins.str]] = None,
