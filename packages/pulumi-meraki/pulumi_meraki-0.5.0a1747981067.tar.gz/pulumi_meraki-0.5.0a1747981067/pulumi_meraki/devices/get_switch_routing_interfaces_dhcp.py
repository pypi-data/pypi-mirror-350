...
def get_switch_routing_interfaces_dhcp(interface_id: Optional[builtins.str] = None,
...
def get_switch_routing_interfaces_dhcp_output(interface_id: Optional[pulumi.Input[builtins.str]] = None,
