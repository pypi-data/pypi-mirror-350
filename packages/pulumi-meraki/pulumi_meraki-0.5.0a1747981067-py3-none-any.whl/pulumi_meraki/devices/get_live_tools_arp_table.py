...
def get_live_tools_arp_table(arp_table_id: Optional[builtins.str] = None,
    ...
    :param builtins.str arp_table_id: arpTableId path parameter. Arp table ID
...
def get_live_tools_arp_table_output(arp_table_id: Optional[pulumi.Input[builtins.str]] = None,
