...
def get_camera_wireless_profiles(serial: Optional[builtins.str] = None,
...
def get_camera_wireless_profiles_output(serial: Optional[pulumi.Input[builtins.str]] = None,
