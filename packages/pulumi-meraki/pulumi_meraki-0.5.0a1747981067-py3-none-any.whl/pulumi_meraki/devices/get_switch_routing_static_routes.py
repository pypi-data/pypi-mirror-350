...
def get_switch_routing_static_routes(serial: Optional[builtins.str] = None,
...
def get_switch_routing_static_routes_output(serial: Optional[pulumi.Input[Optional[builtins.str]]] = None,
