...
def get_switch_routing_interfaces(interface_id: Optional[builtins.str] = None,
...
def get_switch_routing_interfaces_output(interface_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
