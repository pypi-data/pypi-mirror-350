...
def get_camera_video_link(serial: Optional[builtins.str] = None,
    ...
    :param builtins.str timestamp: timestamp query parameter. [optional] The video link will start at this time. The timestamp should be a string in ISO8601 format. If no timestamp is specified, we will assume current time.
    """
    __args__ = dict()
...
def get_camera_video_link_output(serial: Optional[pulumi.Input[builtins.str]] = None,
                                 timestamp: Optional[pulumi.Input[Optional[builtins.str]]] = None,
