...
def get_webhooks_logs(ending_before: Optional[builtins.str] = None,
    ...
    :param builtins.str url: url query parameter. The URL the webhook was sent to
    """
    __args__ = dict()
...
def get_webhooks_logs_output(ending_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
