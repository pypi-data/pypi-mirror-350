...
def get_camera_roles(organization_id: Optional[builtins.str] = None,
...
def get_camera_roles_output(organization_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
