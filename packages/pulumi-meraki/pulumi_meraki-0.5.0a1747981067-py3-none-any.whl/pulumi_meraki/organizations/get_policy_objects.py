...
class GetPolicyObjectsResult:
    ...
    def policy_object_id(self) -> Optional[builtins.str]:
        """
...
def get_policy_objects(ending_before: Optional[builtins.str] = None,
                       organization_id: Optional[builtins.str] = None,
                       per_page: Optional[builtins.int] = None,
                       policy_object_id: Optional[builtins.str] = None,
    ...
    :param builtins.int per_page: perPage query parameter. The number of entries per page returned. Acceptable range is 10 5000. Default is 5000.
    :param builtins.str policy_object_id: policyObjectId path parameter. Policy object ID
...
def get_policy_objects_output(ending_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              ...
                              policy_object_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
