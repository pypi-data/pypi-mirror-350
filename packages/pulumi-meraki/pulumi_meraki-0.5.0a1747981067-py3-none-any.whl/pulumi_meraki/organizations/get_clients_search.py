...
def get_clients_search(ending_before: Optional[builtins.str] = None,
    ...
    :param builtins.str mac: mac query parameter. The MAC address of the client. Required.
    :param builtins.str organization_id: organizationId path parameter. Organization ID
    :param builtins.int per_page: perPage query parameter. The number of entries per page returned. Acceptable range is 3 5. Default is 5.
...
def get_clients_search_output(ending_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
