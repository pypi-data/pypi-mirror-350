...
class GetInsightMonitoredMediaServersResult:
    ...
    def monitored_media_server_id(self) -> Optional[builtins.str]:
        """
...
def get_insight_monitored_media_servers(monitored_media_server_id: Optional[builtins.str] = None,
    ...
    :param builtins.str monitored_media_server_id: monitoredMediaServerId path parameter. Monitored media server ID
...
def get_insight_monitored_media_servers_output(monitored_media_server_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
