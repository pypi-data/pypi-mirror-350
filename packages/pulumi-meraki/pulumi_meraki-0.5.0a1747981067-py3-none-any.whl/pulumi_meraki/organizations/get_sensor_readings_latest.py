...
def get_sensor_readings_latest(ending_before: Optional[builtins.str] = None,
...
def get_sensor_readings_latest_output(ending_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
