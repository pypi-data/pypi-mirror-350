...
class GetWirelessDevicesPacketLossByClientResult:
    ...
    @property
    @pulumi.getter
    def ssids(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_wireless_devices_packet_loss_by_client(bands: Optional[Sequence[builtins.str]] = None,
                                               ...
                                               ssids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] bands: bands query parameter. Filter results by band. Valid bands are: 2.4, 5, and 6.
    :param builtins.str ending_before: endingBefore query parameter. A token used by the server to indicate the end of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
    :param Sequence[builtins.str] macs: macs query parameter. Filter results by client mac address(es).
    :param Sequence[builtins.str] network_ids: networkIds query parameter. Filter results by network.
    ...
    :param Sequence[builtins.str] ssids: ssids query parameter. Filter results by SSID number.
    :param builtins.str starting_after: startingAfter query parameter. A token used by the server to indicate the start of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
    :param builtins.str t0: t0 query parameter. The beginning of the timespan for the data. The maximum lookback period is 90 days from today.
    :param builtins.str t1: t1 query parameter. The end of the timespan for the data. t1 can be a maximum of 90 days after t0.
    :param builtins.float timespan: timespan query parameter. The timespan for which the information will be fetched. If specifying timespan, do not specify parameters t0 and t1. The value must be in seconds and be greater than or equal to 5 minutes and be less than or equal to 90 days. The default is 7 days.
    """
    __args__ = dict()
...
def get_wireless_devices_packet_loss_by_client_output(bands: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                                      ...
                                                      ssids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
