...
def get_saml_idps(idp_id: Optional[builtins.str] = None,
    ...
    :param builtins.str idp_id: idpId path parameter. Idp ID
...
def get_saml_idps_output(idp_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
