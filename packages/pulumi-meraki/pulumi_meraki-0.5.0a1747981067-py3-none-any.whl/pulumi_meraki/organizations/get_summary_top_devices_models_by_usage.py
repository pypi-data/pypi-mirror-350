...
def get_summary_top_devices_models_by_usage(organization_id: Optional[builtins.str] = None,
    ...
    :param builtins.float timespan: timespan query parameter. The timespan for which the information will be fetched. If specifying timespan, do not specify parameters t0 and t1. The value must be in seconds and be greater than or equal to 8 hours and be less than or equal to 31 days. The default is 1 day.
    """
    __args__ = dict()
...
def get_summary_top_devices_models_by_usage_output(organization_id: Optional[pulumi.Input[builtins.str]] = None,
