...
def get_sm_admins_roles(ending_before: Optional[builtins.str] = None,
    ...
    :param builtins.str role_id: roleId path parameter. Role ID
...
def get_sm_admins_roles_output(ending_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
