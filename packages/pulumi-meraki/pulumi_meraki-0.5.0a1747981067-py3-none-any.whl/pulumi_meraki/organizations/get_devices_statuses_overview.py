...
def get_devices_statuses_overview(network_ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] network_ids: networkIds query parameter. An optional parameter to filter device statuses by network.
...
def get_devices_statuses_overview_output(network_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
