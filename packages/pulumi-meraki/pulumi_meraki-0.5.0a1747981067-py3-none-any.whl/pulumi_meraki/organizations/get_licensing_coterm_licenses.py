...
def get_licensing_coterm_licenses(ending_before: Optional[builtins.str] = None,
    ...
    :param builtins.bool expired: expired query parameter. Filter for licenses that are expired
    :param builtins.bool invalidated: invalidated query parameter. Filter for licenses that are invalidated
...
def get_licensing_coterm_licenses_output(ending_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                         expired: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                         invalidated: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
