...
def get_adaptive_policy_policies(id: Optional[builtins.str] = None,
...
def get_adaptive_policy_policies_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
