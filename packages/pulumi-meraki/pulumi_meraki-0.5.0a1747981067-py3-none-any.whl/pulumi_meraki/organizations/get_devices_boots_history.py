...
class GetDevicesBootsHistoryResult:
    ...
    def most_recent_per_device(self) -> Optional[builtins.bool]:
        """
...
def get_devices_boots_history(ending_before: Optional[builtins.str] = None,
                              most_recent_per_device: Optional[builtins.bool] = None,
    ...
    :param builtins.bool most_recent_per_device: mostRecentPerDevice query parameter. If true, only the most recent boot for each device is returned.
    ...
    :param Sequence[builtins.str] serials: serials query parameter. Optional parameter to filter device by device serial numbers. This filter uses multiple exact matches.
    :param builtins.str sort_order: sortOrder query parameter. Sorted order of entries. Order options are 'ascending' and 'descending'. Default is 'descending'.
    :param builtins.str starting_after: startingAfter query parameter. A token used by the server to indicate the start of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
    :param builtins.str t0: t0 query parameter. The beginning of the timespan for the data.
    :param builtins.str t1: t1 query parameter. The end of the timespan for the data. t1 can be a maximum of 730 days after t0.
    :param builtins.float timespan: timespan query parameter. The timespan for which the information will be fetched. If specifying timespan, do not specify parameters t0 and t1. The value must be in seconds and be less than or equal to 730 days.
    """
    __args__ = dict()
...
def get_devices_boots_history_output(ending_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                     most_recent_per_device: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
