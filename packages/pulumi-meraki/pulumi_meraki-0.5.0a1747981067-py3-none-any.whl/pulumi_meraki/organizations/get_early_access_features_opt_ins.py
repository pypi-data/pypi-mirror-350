...
class GetEarlyAccessFeaturesOptInsResult:
    ...
    def opt_in_id(self) -> Optional[builtins.str]:
        """
...
def get_early_access_features_opt_ins(opt_in_id: Optional[builtins.str] = None,
    ...
    :param builtins.str opt_in_id: optInId path parameter. Opt in ID
...
def get_early_access_features_opt_ins_output(opt_in_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
