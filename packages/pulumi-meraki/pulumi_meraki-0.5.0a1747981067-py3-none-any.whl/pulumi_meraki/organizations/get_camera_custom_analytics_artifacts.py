...
def get_camera_custom_analytics_artifacts(artifact_id: Optional[builtins.str] = None,
    ...
    :param builtins.str artifact_id: artifactId path parameter. Artifact ID
...
def get_camera_custom_analytics_artifacts_output(artifact_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
