...
def get_summary_top_appliances_by_utilization(organization_id: Optional[builtins.str] = None,
    ...
    :param builtins.float timespan: timespan query parameter. The timespan for which the information will be fetched. If specifying timespan, do not specify parameters t0 and t1. The value must be in seconds and be greater than or equal to 25 minutes and be less than or equal to 31 days. The default is 1 day.
    """
    __args__ = dict()
...
def get_summary_top_appliances_by_utilization_output(organization_id: Optional[pulumi.Input[builtins.str]] = None,
