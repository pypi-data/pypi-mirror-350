...
class GetConfigTemplatesSwitchProfilesResult:
    ...
    def config_template_id(self) -> builtins.str:
        """
...
def get_config_templates_switch_profiles(config_template_id: Optional[builtins.str] = None,
...
def get_config_templates_switch_profiles_output(config_template_id: Optional[pulumi.Input[builtins.str]] = None,
