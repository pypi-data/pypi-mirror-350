...
def get_openapi_spec(organization_id: Optional[builtins.str] = None,
    ...
    :param builtins.int version: version query parameter. OpenAPI Specification version to return. Default is 2
    """
    __args__ = dict()
...
def get_openapi_spec_output(organization_id: Optional[pulumi.Input[builtins.str]] = None,
