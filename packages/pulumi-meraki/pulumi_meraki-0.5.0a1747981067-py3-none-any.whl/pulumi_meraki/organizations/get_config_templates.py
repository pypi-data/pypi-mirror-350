...
def get_config_templates(config_template_id: Optional[builtins.str] = None,
...
def get_config_templates_output(config_template_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
