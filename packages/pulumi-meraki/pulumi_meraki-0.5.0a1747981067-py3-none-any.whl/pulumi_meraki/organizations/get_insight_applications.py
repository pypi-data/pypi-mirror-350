...
def get_insight_applications(organization_id: Optional[builtins.str] = None,
...
def get_insight_applications_output(organization_id: Optional[pulumi.Input[builtins.str]] = None,
