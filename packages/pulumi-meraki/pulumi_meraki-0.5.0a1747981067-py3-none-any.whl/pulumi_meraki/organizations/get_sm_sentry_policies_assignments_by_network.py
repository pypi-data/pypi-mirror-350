...
def get_sm_sentry_policies_assignments_by_network(ending_before: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] network_ids: networkIds query parameter. Optional parameter to filter Sentry Policies by Network Id
...
def get_sm_sentry_policies_assignments_by_network_output(ending_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
