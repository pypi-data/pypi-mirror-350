...
def get_summary_top_networks_by_status(ending_before: Optional[builtins.str] = None,
    ...
    :param builtins.int per_page: perPage query parameter. The number of entries per page returned. Acceptable range is 3 5000.
...
def get_summary_top_networks_by_status_output(ending_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
