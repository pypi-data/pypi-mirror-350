...
def get_clients_overview(organization_id: Optional[builtins.str] = None,
...
def get_clients_overview_output(organization_id: Optional[pulumi.Input[builtins.str]] = None,
