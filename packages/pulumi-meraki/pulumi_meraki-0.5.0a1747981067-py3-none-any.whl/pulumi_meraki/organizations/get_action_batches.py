...
class GetActionBatchesResult:
    ...
    def action_batch_id(self) -> Optional[builtins.str]:
        """
...
def get_action_batches(action_batch_id: Optional[builtins.str] = None,
    ...
    :param builtins.str action_batch_id: actionBatchId path parameter. Action batch ID
    :param builtins.str organization_id: organizationId path parameter. Organization ID
    :param builtins.str status: status query parameter. Filter batches by status. Valid types are pending, completed, and failed.
    """
    __args__ = dict()
...
def get_action_batches_output(action_batch_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
