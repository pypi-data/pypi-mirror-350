...
def get_appliance_traffic_shaping_vpn_exclusions_by_network(ending_before: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] network_ids: networkIds query parameter. Optional parameter to filter the results by network IDs
...
def get_appliance_traffic_shaping_vpn_exclusions_by_network_output(ending_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
