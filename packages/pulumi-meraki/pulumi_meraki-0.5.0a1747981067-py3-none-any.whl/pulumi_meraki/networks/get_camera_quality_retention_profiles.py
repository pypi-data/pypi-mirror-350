...
class GetCameraQualityRetentionProfilesResult:
    ...
    def quality_retention_profile_id(self) -> Optional[builtins.str]:
        """
...
def get_camera_quality_retention_profiles(network_id: Optional[builtins.str] = None,
                                          quality_retention_profile_id: Optional[builtins.str] = None,
    ...
    :param builtins.str quality_retention_profile_id: qualityRetentionProfileId path parameter. Quality retention profile ID
    """
    __args__ = dict()
...
def get_camera_quality_retention_profiles_output(network_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                 quality_retention_profile_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
