...
def get_policies_by_client(ending_before: Optional[builtins.str] = None,
    ...
    :param builtins.float timespan: timespan query parameter. The timespan for which the information will be fetched. If specifying timespan, do not specify parameter t0. The value must be in seconds and be less than or equal to 31 days. The default is 1 day.
    """
    __args__ = dict()
...
def get_policies_by_client_output(ending_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
