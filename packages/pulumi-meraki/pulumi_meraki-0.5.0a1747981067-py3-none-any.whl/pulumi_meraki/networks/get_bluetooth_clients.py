...
class GetBluetoothClientsResult:
    ...
    def bluetooth_client_id(self) -> builtins.str:
        """
    ...
    def connectivity_history_timespan(self) -> Optional[builtins.int]:
        """
    ...
    def include_connectivity_history(self) -> Optional[builtins.bool]:
        """
...
def get_bluetooth_clients(bluetooth_client_id: Optional[builtins.str] = None,
                          connectivity_history_timespan: Optional[builtins.int] = None,
                          include_connectivity_history: Optional[builtins.bool] = None,
    ...
    :param builtins.str bluetooth_client_id: bluetoothClientId path parameter. Bluetooth client ID
    :param builtins.int connectivity_history_timespan: connectivityHistoryTimespan query parameter. The timespan, in seconds, for the connectivityHistory data. By default 1 day, 86400, will be used.
    :param builtins.bool include_connectivity_history: includeConnectivityHistory query parameter. Include the connectivity history for this client
...
def get_bluetooth_clients_output(bluetooth_client_id: Optional[pulumi.Input[builtins.str]] = None,
                                 connectivity_history_timespan: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                                 include_connectivity_history: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
