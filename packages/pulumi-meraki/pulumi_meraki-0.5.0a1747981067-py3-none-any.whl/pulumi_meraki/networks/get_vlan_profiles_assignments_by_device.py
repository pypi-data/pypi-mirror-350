...
def get_vlan_profiles_assignments_by_device(ending_before: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] product_types: productTypes query parameter. Optional parameter to filter devices by product types.
    :param Sequence[builtins.str] serials: serials query parameter. Optional parameter to filter devices by serials. All devices returned belong to serial numbers that are an exact match.
    :param Sequence[builtins.str] stack_ids: stackIds query parameter. Optional parameter to filter devices by Switch Stack ids.
...
def get_vlan_profiles_assignments_by_device_output(ending_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                   ...
                                                   stack_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
