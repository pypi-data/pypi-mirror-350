...
def get_alerts_history(ending_before: Optional[builtins.str] = None,
...
def get_alerts_history_output(ending_before: Optional[pulumi.Input[Optional[builtins.str]]] = None,
