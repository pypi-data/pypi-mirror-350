...
def get_cellular_gateway_dhcp(network_id: Optional[builtins.str] = None,
...
def get_cellular_gateway_dhcp_output(network_id: Optional[pulumi.Input[builtins.str]] = None,
