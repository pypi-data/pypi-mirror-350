...
def get_appliance_traffic_shaping_uplink_bandwidth(network_id: Optional[builtins.str] = None,
...
def get_appliance_traffic_shaping_uplink_bandwidth_output(network_id: Optional[pulumi.Input[builtins.str]] = None,
