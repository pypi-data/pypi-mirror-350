...
class GetSensorMqttBrokersResult:
    ...
    def mqtt_broker_id(self) -> Optional[builtins.str]:
        """
...
def get_sensor_mqtt_brokers(mqtt_broker_id: Optional[builtins.str] = None,
    ...
    :param builtins.str mqtt_broker_id: mqttBrokerId path parameter. Mqtt broker ID
...
def get_sensor_mqtt_brokers_output(mqtt_broker_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
