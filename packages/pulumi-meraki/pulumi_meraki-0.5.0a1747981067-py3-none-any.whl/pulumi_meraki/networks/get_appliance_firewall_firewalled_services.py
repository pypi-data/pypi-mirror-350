...
def get_appliance_firewall_firewalled_services(network_id: Optional[builtins.str] = None,
    ...
    :param builtins.str service: service path parameter.
    """
    __args__ = dict()
...
def get_appliance_firewall_firewalled_services_output(network_id: Optional[pulumi.Input[builtins.str]] = None,
