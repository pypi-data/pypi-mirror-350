...
class GetWirelessChannelUtilizationHistoryResult:
    ...
    def auto_resolution(self) -> Optional[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter
    def resolution(self) -> Optional[builtins.int]:
        """
...
def get_wireless_channel_utilization_history(ap_tag: Optional[builtins.str] = None,
                                             auto_resolution: Optional[builtins.bool] = None,
                                             ...
                                             resolution: Optional[builtins.int] = None,
    ...
    :param builtins.str ap_tag: apTag query parameter. Filter results by AP tag to return AP channel utilization metrics for devices labeled with the given tag; either :clientId or :deviceSerial must be jointly specified.
    :param builtins.bool auto_resolution: autoResolution query parameter. Automatically select a data resolution based on the given timespan; this overrides the value specified by the 'resolution' parameter. The default setting is false.
    :param builtins.str band: band query parameter. Filter results by band (either '2.4', '5' or '6').
    :param builtins.str client_id: clientId query parameter. Filter results by network client to return per-device, per-band AP channel utilization metrics inner joined by the queried client's connection history.
    :param builtins.str device_serial: deviceSerial query parameter. Filter results by device to return AP channel utilization metrics for the queried device; either :band or :clientId must be jointly specified.
    :param builtins.str network_id: networkId path parameter. Network ID
    :param builtins.int resolution: resolution query parameter. The time resolution in seconds for returned data. The valid resolutions are: 600, 1200, 3600, 14400, 86400. The default is 86400.
...
def get_wireless_channel_utilization_history_output(ap_tag: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                    auto_resolution: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                                    band: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                    client_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                    device_serial: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                    network_id: Optional[pulumi.Input[builtins.str]] = None,
                                                    resolution: Optional[pulumi.Input[Optional[builtins.int]]] = None,
