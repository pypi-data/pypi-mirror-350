...
def get_sm_devices_wlan_lists(device_id: Optional[builtins.str] = None,
...
def get_sm_devices_wlan_lists_output(device_id: Optional[pulumi.Input[builtins.str]] = None,
