...
def get_wireless_ethernet_ports_profiles(network_id: Optional[builtins.str] = None,
...
def get_wireless_ethernet_ports_profiles_output(network_id: Optional[pulumi.Input[builtins.str]] = None,
