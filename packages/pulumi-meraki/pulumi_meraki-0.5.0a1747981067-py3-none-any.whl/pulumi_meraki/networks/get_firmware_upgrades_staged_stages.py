...
def get_firmware_upgrades_staged_stages(network_id: Optional[builtins.str] = None,
...
def get_firmware_upgrades_staged_stages_output(network_id: Optional[pulumi.Input[builtins.str]] = None,
