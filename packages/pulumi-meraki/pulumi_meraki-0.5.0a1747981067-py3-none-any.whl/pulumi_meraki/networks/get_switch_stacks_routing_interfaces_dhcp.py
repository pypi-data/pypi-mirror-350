...
class GetSwitchStacksRoutingInterfacesDhcpResult:
    ...
    def switch_stack_id(self) -> builtins.str:
        """
...
def get_switch_stacks_routing_interfaces_dhcp(interface_id: Optional[builtins.str] = None,
...
def get_switch_stacks_routing_interfaces_dhcp_output(interface_id: Optional[pulumi.Input[builtins.str]] = None,
