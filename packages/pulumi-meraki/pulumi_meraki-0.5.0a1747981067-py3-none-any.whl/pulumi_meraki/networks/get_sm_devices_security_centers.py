...
def get_sm_devices_security_centers(device_id: Optional[builtins.str] = None,
...
def get_sm_devices_security_centers_output(device_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
