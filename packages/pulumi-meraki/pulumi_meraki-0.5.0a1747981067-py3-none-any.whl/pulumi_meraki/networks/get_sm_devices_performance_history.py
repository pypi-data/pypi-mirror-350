...
def get_sm_devices_performance_history(device_id: Optional[builtins.str] = None,
...
def get_sm_devices_performance_history_output(device_id: Optional[pulumi.Input[builtins.str]] = None,
