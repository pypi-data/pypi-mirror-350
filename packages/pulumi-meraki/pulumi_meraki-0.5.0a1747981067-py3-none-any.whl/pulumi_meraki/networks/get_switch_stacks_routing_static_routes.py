...
class GetSwitchStacksRoutingStaticRoutesResult:
    ...
    def static_route_id(self) -> Optional[builtins.str]:
        """
    ...
    def switch_stack_id(self) -> Optional[builtins.str]:
        """
...
def get_switch_stacks_routing_static_routes(network_id: Optional[builtins.str] = None,
                                            static_route_id: Optional[builtins.str] = None,
                                            switch_stack_id: Optional[builtins.str] = None,
    ...
    :param builtins.str static_route_id: staticRouteId path parameter. Static route ID
    :param builtins.str switch_stack_id: switchStackId path parameter. Switch stack ID
    """
    __args__ = dict()
...
def get_switch_stacks_routing_static_routes_output(network_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                   static_route_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                   switch_stack_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
