...
class GetSmBypassActivationLockAttemptsResult:
    ...
    def attempt_id(self) -> builtins.str:
        """
...
def get_sm_bypass_activation_lock_attempts(attempt_id: Optional[builtins.str] = None,
    ...
    :param builtins.str attempt_id: attemptId path parameter. Attempt ID
...
def get_sm_bypass_activation_lock_attempts_output(attempt_id: Optional[pulumi.Input[builtins.str]] = None,
