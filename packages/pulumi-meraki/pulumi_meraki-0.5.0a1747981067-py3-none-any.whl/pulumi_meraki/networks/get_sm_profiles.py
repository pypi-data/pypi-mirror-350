...
class GetSmProfilesResult:
    ...
    def payload_types(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_sm_profiles(network_id: Optional[builtins.str] = None,
                    payload_types: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] payload_types: payloadTypes query parameter. Filter by payload types
    """
    __args__ = dict()
...
def get_sm_profiles_output(network_id: Optional[pulumi.Input[builtins.str]] = None,
                           payload_types: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
