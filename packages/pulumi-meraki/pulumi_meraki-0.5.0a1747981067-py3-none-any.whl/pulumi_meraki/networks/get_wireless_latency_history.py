...
class GetWirelessLatencyHistoryResult:
    ...
    def access_category(self) -> Optional[builtins.str]:
        """
...
def get_wireless_latency_history(access_category: Optional[builtins.str] = None,
                                 ap_tag: Optional[builtins.str] = None,
    ...
    :param builtins.str access_category: accessCategory query parameter. Filter by access category.
    ...
    :param builtins.str client_id: clientId query parameter. Filter results by network client.
    :param builtins.str device_serial: deviceSerial query parameter. Filter results by device.
    :param builtins.str network_id: networkId path parameter. Network ID
    :param builtins.int resolution: resolution query parameter. The time resolution in seconds for returned data. The valid resolutions are: 300, 600, 1200, 3600, 14400, 86400. The default is 86400.
    :param builtins.int ssid: ssid query parameter. Filter results by SSID number.
...
def get_wireless_latency_history_output(access_category: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        ap_tag: Optional[pulumi.Input[Optional[builtins.str]]] = None,
