...
class GetWirelessSsidsIdentityPsksResult:
    ...
    def identity_psk_id(self) -> Optional[builtins.str]:
        """
...
def get_wireless_ssids_identity_psks(identity_psk_id: Optional[builtins.str] = None,
    ...
    :param builtins.str identity_psk_id: identityPskId path parameter. Identity psk ID
    :param builtins.str network_id: networkId path parameter. Network ID
    :param builtins.str number: number path parameter.
    """
    __args__ = dict()
...
def get_wireless_ssids_identity_psks_output(identity_psk_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                            network_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                            number: Optional[pulumi.Input[Optional[builtins.str]]] = None,
