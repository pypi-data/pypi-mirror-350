...
def get_wireless_data_rate_history(ap_tag: Optional[builtins.str] = None,
...
def get_wireless_data_rate_history_output(ap_tag: Optional[pulumi.Input[Optional[builtins.str]]] = None,
