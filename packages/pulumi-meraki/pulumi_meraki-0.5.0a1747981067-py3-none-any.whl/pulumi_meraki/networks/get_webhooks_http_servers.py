...
class GetWebhooksHttpServersResult:
    ...
    def http_server_id(self) -> Optional[builtins.str]:
        """
...
def get_webhooks_http_servers(http_server_id: Optional[builtins.str] = None,
    ...
    :param builtins.str http_server_id: httpServerId path parameter. Http server ID
...
def get_webhooks_http_servers_output(http_server_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
