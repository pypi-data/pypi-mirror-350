...
def get_sm_users_device_profiles(network_id: Optional[builtins.str] = None,
    ...
    :param builtins.str user_id: userId path parameter. User ID
    """
    __args__ = dict()
...
def get_sm_users_device_profiles_output(network_id: Optional[pulumi.Input[builtins.str]] = None,
