...
def get_wireless_clients_latency_stats(ap_tag: Optional[builtins.str] = None,
    ...
    :param builtins.str client_id: clientId path parameter. Client ID
    :param builtins.str fields: fields query parameter. Partial selection: If present, this call will return only the selected fields of ["rawDistribution", "avg"]. All fields will be returned by default. Selected fields must be entered as a comma separated string.
...
def get_wireless_clients_latency_stats_output(ap_tag: Optional[pulumi.Input[Optional[builtins.str]]] = None,
