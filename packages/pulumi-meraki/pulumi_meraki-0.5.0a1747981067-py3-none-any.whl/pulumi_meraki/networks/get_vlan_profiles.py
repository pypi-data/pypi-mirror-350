...
def get_vlan_profiles(iname: Optional[builtins.str] = None,
    ...
    :param builtins.str iname: iname path parameter.
...
def get_vlan_profiles_output(iname: Optional[pulumi.Input[builtins.str]] = None,
