...
def get_licensing_subscription_subscriptions_compliance_statuses(organization_ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] organization_ids: organizationIds query parameter. Organizations to get subscription compliance information for
    :param Sequence[builtins.str] subscription_ids: subscriptionIds query parameter. Subscription ids
    """
    __args__ = dict()
...
def get_licensing_subscription_subscriptions_compliance_statuses_output(organization_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
