...
namespace ctre
{
    namespace phoenix
    {
        ...
        public:
            ...
            /**
             * \brief The requested signal is missing or not supported. Verify that the
             *        device firmware is up-to-date.
             */
            static constexpr int SignalNotSupportedOrMissing = -10042;
            ...
            constexpr const char *GetName() const
            {
                ...
                case -10042: return "SignalNotSupportedOrMissing";
                default:
            ...
            constexpr const char *GetDescription() const
            {
                ...
                case -10042: return "The requested signal is missing or not supported. Verify that the device firmware is up-to-date.";
                default:
                    /* because we return const char*, we cannot create
                     * a string with the status error code */
