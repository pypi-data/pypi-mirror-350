...
Welcome to `opensemantic.core` contributor's guide.
...
If you experience bugs or general issues with `opensemantic.core`, please have a look
...
You can help improve `opensemantic.core` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`opensemantic.core` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `opensemantic.core`'s files. While this mechanism can
...
```
conda create -n opensemantic.core python=3 six virtualenv pytest pytest-cov
conda activate opensemantic.core
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/opensemantic.core.git
   cd opensemantic.core
   ```
...
5. Install [pre-commit]:
   ...
   `opensemantic.core` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/opensemantic.core
[issue tracker]: https://github.com/<USERNAME>/opensemantic.core/issues
