...
from .nunchakupackdep_converter import to_nunchakupackdep
...
if __name__ == "__main__":
    ...
    if is_nunchakupackdep_format(args.lora_path):
        print("Already in nunchakupackdep format, no conversion needed.")
        exit(0)
