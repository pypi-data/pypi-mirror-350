...
namespace nunchakupackdep::ops {
    ...
    void gemm_w4a4(
        ...
        nunchakupackdep::kernels::gemm_w4a4(
            getTensor(act          ),
            getTensor(wgt          ),
            getTensor(out          ),
            getTensor(qout         ),
    ...
    void attention_fp16(
        ...
        nunchakupackdep::kernels::attention_fp16(
            from_torch(q),
            from_torch(k),
            from_torch(v),
            from_torch(o),
    ...
    {
        nunchakupackdep::kernels::test_rmsnorm_rope(
            from_torch(input),
            from_torch(output),
            from_torch(norm_q),
            from_torch(norm_k),
    ...
    void test_pack_qkv(
        ...
        int numTokens) 
    {
        nunchakupackdep::kernels::test_pack_qkv(
            from_torch(input),
            from_torch(out_q),
            from_torch(out_k),
            from_torch(out_v),
