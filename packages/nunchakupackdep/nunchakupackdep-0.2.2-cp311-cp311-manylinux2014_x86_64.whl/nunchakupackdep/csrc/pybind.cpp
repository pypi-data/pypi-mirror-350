...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def_submodule("ops")
        .def("gemm_w4a4", nunchakupackdep::ops::gemm_w4a4)
        .def("attention_fp16", nunchakupackdep::ops::attention_fp16)
        .def("gemm_awq", nunchakupackdep::ops::gemm_awq)
        .def("gemv_awq", nunchakupackdep::ops::gemv_awq)

        .def("test_rmsnorm_rope", nunchakupackdep::ops::test_rmsnorm_rope)
        .def("test_pack_qkv", nunchakupackdep::ops::test_pack_qkv)
    ;
    ...
    m.def_submodule("utils")
        ...
        .def("set_cuda_stack_limit", nunchakupackdep::utils::set_cuda_stack_limit)
        .def("disable_memory_auto_release", nunchakupackdep::utils::disable_memory_auto_release)
        .def("trim_memory", nunchakupackdep::utils::trim_memory)
        .def("set_faster_i2f_mode", nunchakupackdep::utils::set_faster_i2f_mode)
    ;
}
