...
class ReflowFile:
    ...
    def download_all_file():
        ...
        ReflowFile.download_zip_file(LanguageType.en_US)
        ReflowFile.download_zip_file(LanguageType.th_TH)
        ReflowFile.download_zip_file(LanguageType.zh_TW)
        ReflowFile.download_zip_file(LanguageType.zh_CN)
    ...
    def find_need_reflow_modules() -> dict:
        ...
        reqult_dict = ReflowFile._find_need_reflow_keys(
            LanguageType.en_US, json_dict, reqult_dict
        )
        reqult_dict = ReflowFile._find_need_reflow_keys(
            LanguageType.zh_TW, json_dict, reqult_dict
        )
        reqult_dict = ReflowFile._find_need_reflow_keys(
            LanguageType.zh_CN, json_dict, reqult_dict
        )
        reqult_dict = ReflowFile._find_need_reflow_keys(
            LanguageType.th_TH, json_dict, reqult_dict
        )
        return reqult_dict
