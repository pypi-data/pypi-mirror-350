...
class Generate123VideoRequest(BaseModel):
    """ Generate 123 video request data struct """
    templateVideoId: str = ""
...
class PlayControlParams(BaseModel):
    """ data struct """
    controlType: str = "SEGMENT_LOOP"
    startTimestamp: float = 0
    endTimestamp: float = 15
...
class Text2AudioStatusData(BaseModel):
    ...
    duration: Optional[int] = None
    textTimestamp: Optional[List[TimeStampInfo]] = None
    createTime: Optional[str] = None
    updateTime: Optional[str] = None
...
class MCPText2AudioStatusResponse(BaseDHResponse):
    ...
    audioUrl: Optional[str] = None
    duration: Optional[int] = None
    textTimestamp: List[TimeStampInfo]
    createTime: Optional[str] = None
    updateTime: Optional[str] = None
...
class MCPVideoBGCutoutResponse(BaseDHResponse):
    """ data struct """
    taskId: Optional[str] = None
    status: Optional[str] = None
    videoUrl: Optional[str] = None
    videoMaskId: Optional[str] = None
...
class DHApiClient:
    ...
    def __init__(self, api_key: str):
        ...
        try:
            self.version = importlib.metadata.version("dh-mcp")
    ...
    async def _handle_api_request(
        ...
        **kwargs,
        ...
        try:
            ...
            #logger.info(f'_handle_api_request {result}')
        ...
        try:
            ...
            if validated_response.code != 0 :
                error_details = {
                    ...
                    "message": validated_response.message._global,
                    "detail": "",
                }
