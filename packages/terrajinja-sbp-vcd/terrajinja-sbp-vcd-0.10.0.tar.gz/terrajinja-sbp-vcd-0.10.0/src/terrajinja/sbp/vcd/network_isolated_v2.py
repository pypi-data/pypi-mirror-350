...
from terrajinja.imports.vcd.network_isolated_v2 import NetworkIsolatedV2


class SbpVcdNetworkIsolatedV2(NetworkIsolatedV2):
    """SBP version of vcd.network_isolated_v2"""

    def __init__(self, scope: Construct, ns: str, cidr: str, dns: list = None, **kwargs):
        """Enhances the original vcd.network_isolated_v2
