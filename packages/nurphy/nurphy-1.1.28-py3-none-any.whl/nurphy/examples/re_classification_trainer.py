...
from nurphy.data_utils.relation_dataset import load_and_cache_examples
from nurphy.relation_classification.relation_trainer import Trainer
from nurphy.data_utils.utils import init_logger, load_tokenizer, set_seed
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_dir", default="../re_model", type=str, help="Path to model")
    parser.add_argument(
        "--eval_dir",
        default="../eval",
        type=str,
    ...
    parser.add_argument("--train_file", default="re_train.tsv", type=str, help="Train file")
    parser.add_argument("--test_file", default="re_test.tsv", type=str, help="Test file")
    parser.add_argument("--label_file", default="re_label.txt", type=str, help="Label file")
