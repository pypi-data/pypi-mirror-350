...
from nurphy.convAI import bert_mini_chatbot
import fire

from nurphy.convAI.bert_mini_chatbot import Config
from nurphy.convAI.export_question_embeddings import export_question_embeddings
