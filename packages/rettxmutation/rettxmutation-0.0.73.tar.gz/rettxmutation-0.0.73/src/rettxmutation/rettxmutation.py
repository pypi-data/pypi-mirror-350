...
class RettXDocumentAnalysis:
    ...
    def __init__(
        ...
        # Initialize the mutation tokenizer
        self.mutation_tokenizer = MutationTokenizer(rettx_doc_analysis=self)
    ...
    def tokenize_gene_mutation(self, gene_mutation: GeneMutation) -> str:
        ...
        This method extracts searchable tokens from all components of a GeneMutation
        including cDNA sequences, protein consequences, and embedding inputs.
        ...
        """
        return self.mutation_tokenizer.tokenize_gene_mutation(gene_mutation)

    def tokenize_cdna_mutation(self, transcript_mutation) -> str:
        """
        Tokenize cDNA mutation information for free text search.
        
        Args:
            transcript_mutation: TranscriptMutation object
            
        Returns:
            str: Space-separated tokens for searching cDNA mutations
        """
        return self.mutation_tokenizer._tokenize_cdna_mutation(transcript_mutation) or ""

    def tokenize_protein_mutation(self, transcript_mutation) -> str:
        """
        ...
        Returns:
            str: Space-separated tokens for searching protein mutations
        """
        return self.mutation_tokenizer._tokenize_protein_mutation(transcript_mutation) or ""

    def tokenize_embedding_input(self, embedding_input: str, gene_id: str = None, variant_type: str = None) -> str:
        """
        Tokenize embedding input string for free text search.
        
        Args:
            embedding_input (str): The embedding input string to tokenize
            gene_id (str, optional): Gene identifier to include in tokens
            variant_type (str, optional): Variant type to include in tokens
            
        Returns:
            str: Space-separated tokens for searching
        """
        return self.mutation_tokenizer._tokenize_embedding_input(embedding_input, gene_id, variant_type) or ""
