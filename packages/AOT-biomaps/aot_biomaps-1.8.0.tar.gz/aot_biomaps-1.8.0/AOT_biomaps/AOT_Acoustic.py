...
class AcousticField(ABC):
    ...
    def __init__(self, params):
        ...
        if params != None:
            ...
            if params.acoustic['f_AQ'] is "AUTO":
                fAQ = None
            else:
                fAQ = int(float(params.acoustic['f_AQ']))
            self.params = {
            ...
            self.burst = self._generate_burst_signalKWAVE()
    ...
    def _apply_delay(self):
        ...
        try:
            ...
            for i in range(total_grid_points):
                delays[i] = (element_positions[i] * np.tan(np.deg2rad(abs(self.params['angle'])))) / self.params['c0']  # Delay in seconds
