...
def create_app(
    ...
    # Register custom error handler for Unauthorized and Forbidden errors
    @app.errorhandler(Unauthorized)
    def handle_unauthorized(e: Exception) -> tuple[Response, int]:
        response = {
            "error": "unauthorized",
            "description": str(e),
    ...
    def handle_forbidden(e: Exception) -> tuple[Response, int]:
        response = {
            "error": "forbidden",
            "description": str(e),
            "type": e.__class__.__name__,
