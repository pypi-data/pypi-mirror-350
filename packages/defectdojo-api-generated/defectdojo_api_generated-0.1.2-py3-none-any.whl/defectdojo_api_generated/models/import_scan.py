...
class ImportScan(BaseModel):
    ...
    tags: Optional[List[StrictStr]] = Field(default=None, description='Add tags that help describe this scan.')
    ...
    version: Optional[StrictStr] = Field(default=None, description='Version that was scanned.')
    test: StrictInt
