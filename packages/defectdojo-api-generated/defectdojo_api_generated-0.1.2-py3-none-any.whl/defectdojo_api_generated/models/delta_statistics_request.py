...
class DeltaStatisticsRequest(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                'created': SeverityStatusStatisticsRequest.from_dict(obj['created'])
                if obj.get('created') is not None
                else None,
                'closed': SeverityStatusStatisticsRequest.from_dict(obj['closed'])
                if obj.get('closed') is not None
                else None,
