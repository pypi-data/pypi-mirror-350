...
class PaginatedQuestionnaireEngagementSurveyList(BaseModel):
    """
    ...
    results: List[QuestionnaireEngagementSurvey]
        ...
        _obj = cls.model_validate(
            {
                ...
                'results': [QuestionnaireEngagementSurvey.from_dict(_item) for _item in obj['results']]
