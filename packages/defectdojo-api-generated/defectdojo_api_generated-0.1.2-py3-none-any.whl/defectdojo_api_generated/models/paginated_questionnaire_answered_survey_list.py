...
class PaginatedQuestionnaireAnsweredSurveyList(BaseModel):
    """
    ...
    results: List[QuestionnaireAnsweredSurvey]
        ...
        _obj = cls.model_validate(
            {
                ...
                'results': [QuestionnaireAnsweredSurvey.from_dict(_item) for _item in obj['results']]
