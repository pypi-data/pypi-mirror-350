...
class PaginatedQuestionnaireGeneralSurveyList(BaseModel):
    """
    ...
    results: List[QuestionnaireGeneralSurvey]
        ...
        _obj = cls.model_validate(
            {
                ...
                'results': [QuestionnaireGeneralSurvey.from_dict(_item) for _item in obj['results']]
