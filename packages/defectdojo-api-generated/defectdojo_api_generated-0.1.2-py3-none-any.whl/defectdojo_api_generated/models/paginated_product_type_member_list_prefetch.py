...
class PaginatedProductTypeMemberListPrefetch(BaseModel):
    """
    PaginatedProductTypeMemberListPrefetch
    """  # noqa: E501

    product_type: Optional[Dict[str, ProductType]] = None
    role: Optional[Dict[str, Role]] = None
    user: Optional[Dict[str, UserStub]] = None
    __properties: ClassVar[List[str]] = ['product_type', 'role', 'user']
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of each value in product_type (dict)
        _field_dict = {}
        if self.product_type:
            for _key_product_type in self.product_type:
                if self.product_type[_key_product_type]:
                    _field_dict[_key_product_type] = self.product_type[_key_product_type].to_dict()
            _dict['product_type'] = _field_dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                'product_type': dict((_k, ProductType.from_dict(_v)) for _k, _v in obj['product_type'].items())
