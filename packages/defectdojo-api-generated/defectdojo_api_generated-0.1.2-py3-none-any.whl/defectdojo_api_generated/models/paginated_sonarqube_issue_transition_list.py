...
class PaginatedSonarqubeIssueTransitionList(BaseModel):
    """
    ...
    results: List[SonarqubeIssueTransition]
        ...
        _obj = cls.model_validate(
            {
                ...
                'results': [SonarqubeIssueTransition.from_dict(_item) for _item in obj['results']]
