...
class FindingTest(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of test_type
        if self.test_type:
            _dict['test_type'] = self.test_type.to_dict()
        ...
        _obj = cls.model_validate(
            {
                'id': obj.get('id'),
                'title': obj.get('title'),
                'test_type': FindingTestType.from_dict(obj['test_type']) if obj.get('test_type') is not None else None,
                'engagement': FindingEngagement.from_dict(obj['engagement'])
                if obj.get('engagement') is not None
                else None,
                'environment': FindingEnvironment.from_dict(obj['environment'])
