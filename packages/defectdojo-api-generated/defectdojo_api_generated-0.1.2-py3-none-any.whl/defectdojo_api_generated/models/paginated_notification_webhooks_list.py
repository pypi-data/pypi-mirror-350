...
class PaginatedNotificationWebhooksList(BaseModel):
    """
    ...
    results: List[NotificationWebhooks]
        ...
        _obj = cls.model_validate(
            {
                ...
                'results': [NotificationWebhooks.from_dict(_item) for _item in obj['results']]
