...
class ImportScanApi:
    ...
    def import_scan_create(
        ...
        tags: Annotated[
            ...
            Field(description='Add tags that help describe this scan.'),
        ] = None,
        ...
        version: Annotated[
            Optional[Annotated[str, Field(min_length=1, strict=True)]], Field(description='Version that was scanned.')
        ] = None,
        ...
        :param engagement:
        :type engagement: int
        :param tags: Add tags that help describe this scan.
        :type tags: List[str]
        :param close_old_findings: Select if old findings no longer present in the report get closed as mitigated when importing. If service has been set, only the findings for this service will be closed.
        :type close_old_findings: bool
        :param close_old_findings_product_scope: Select if close_old_findings applies to all findings of the same type in the product. By default, it is false meaning that only old findings of the same type in the engagement are in scope.
        :type close_old_findings_product_scope: bool
        :param version: Version that was scanned.
        :type version: str
    ...
    def _import_scan_create_serialize(
        ...
        if engagement is not None:
            _form_params.append(('engagement', engagement))
        if tags is not None:
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/import-scan/',
