...
if TYPE_CHECKING:
    ...
    from defectdojo_api_generated.models import QuestionnaireQuestion


class QuestionnaireQuestionsApi:
    ...
    def questionnaire_questions_list(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': 'PaginatedQuestionnaireQuestionList',
        }
    ...
    def _questionnaire_questions_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/questionnaire_questions/',
    ...
    def questionnaire_questions_retrieve(
        ...
        :param id: A unique integer value identifying this question. (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _questionnaire_questions_retrieve_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/questionnaire_questions/{id}/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
