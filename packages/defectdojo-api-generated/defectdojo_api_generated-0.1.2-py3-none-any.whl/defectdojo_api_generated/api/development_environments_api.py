...
if TYPE_CHECKING:
    ...
    from defectdojo_api_generated.models import DeletePreview, DevelopmentEnvironment


class DevelopmentEnvironmentsApi:
    ...
    def development_environments_create(
        ...
        :type development_environment_request: DevelopmentEnvironmentRequest
    ...
    def _development_environments_create_serialize(
        ...
        if development_environment_request is not None:
            _body_params = development_environment_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/development_environments/',
    ...
    def _development_environments_delete_preview_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/development_environments/{id}/delete_preview/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _development_environments_destroy_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/development_environments/{id}/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def development_environments_list(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': 'PaginatedDevelopmentEnvironmentList',
        }
        response_data = self.api_client.call_api(*_param, _request_timeout=_request_timeout)
        response_data.read()
        return self.api_client.response_deserialize(
    ...
    def development_environments_partial_update(
        ...
        patched_development_environment_request: Optional[PatchedDevelopmentEnvironmentRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        :param id: A unique integer value identifying this development_ environment. (required)
        :type id: int
        :param patched_development_environment_request:
        :type patched_development_environment_request: PatchedDevelopmentEnvironmentRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _development_environments_partial_update_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if patched_development_environment_request is not None:
            _body_params = patched_development_environment_request
