...
class ConfigurationPermissionsApi:
    ...
    def configuration_permissions_list(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': 'PaginatedConfigurationPermissionList',
        }
    ...
    def _configuration_permissions_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/configuration_permissions/',
    ...
    def _configuration_permissions_retrieve_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/configuration_permissions/{id}/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
