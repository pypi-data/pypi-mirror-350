...
if TYPE_CHECKING:
    ...
    from defectdojo_api_generated.models import BurpRawRequestResponseMulti, DeletePreview


class RequestResponsePairsApi:
    ...
    def request_response_pairs_create(
        ...
        :type burp_raw_request_response_multi_request: BurpRawRequestResponseMultiRequest
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': 'BurpRawRequestResponseMulti',
        }
    ...
    def _request_response_pairs_create_serialize(
        ...
        if burp_raw_request_response_multi_request is not None:
            _body_params = burp_raw_request_response_multi_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/request_response_pairs/',
    ...
    def _request_response_pairs_delete_preview_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/request_response_pairs/{id}/delete_preview/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _request_response_pairs_destroy_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/request_response_pairs/{id}/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def request_response_pairs_list(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': 'PaginatedBurpRawRequestResponseMultiList',
        }
        response_data = self.api_client.call_api(*_param, _request_timeout=_request_timeout)
        response_data.read()
        return self.api_client.response_deserialize(
    ...
    def request_response_pairs_partial_update(
        ...
        patched_burp_raw_request_response_multi_request: Optional[PatchedBurpRawRequestResponseMultiRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        :param id: A unique integer value identifying this burp raw request response. (required)
        :type id: int
        :param patched_burp_raw_request_response_multi_request:
        :type patched_burp_raw_request_response_multi_request: PatchedBurpRawRequestResponseMultiRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': 'BurpRawRequestResponseMulti',
        }
        response_data = self.api_client.call_api(*_param, _request_timeout=_request_timeout)
        response_data.read()
        return self.api_client.response_deserialize(
    ...
    def _request_response_pairs_partial_update_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if patched_burp_raw_request_response_multi_request is not None:
            _body_params = patched_burp_raw_request_response_multi_request
