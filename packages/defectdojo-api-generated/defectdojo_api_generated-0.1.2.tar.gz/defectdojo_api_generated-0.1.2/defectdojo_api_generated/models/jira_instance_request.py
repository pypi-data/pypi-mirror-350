...
class JIRAInstanceRequest(BaseModel):
    """
    JIRAInstanceRequest
    """  # noqa: E501
    ...
    info_mapping_severity: Annotated[str, Field(min_length=1, strict=True, max_length=200)] = Field(
        description="Maps to the 'Priority' field in Jira. For example: Info"
    )
    low_mapping_severity: Annotated[str, Field(min_length=1, strict=True, max_length=200)] = Field(
        description="Maps to the 'Priority' field in Jira. For example: Low"
    )
    medium_mapping_severity: Annotated[str, Field(min_length=1, strict=True, max_length=200)] = Field(
        description="Maps to the 'Priority' field in Jira. For example: Medium"
    )
    high_mapping_severity: Annotated[str, Field(min_length=1, strict=True, max_length=200)] = Field(
        description="Maps to the 'Priority' field in Jira. For example: High"
    )
    critical_mapping_severity: Annotated[str, Field(min_length=1, strict=True, max_length=200)] = Field(
