...
class QuestionnaireQuestion(BaseModel):
    ...
    optional: Optional[StrictBool] = Field(
        default=None, description="If selected, user doesn't have to answer this question"
    )
    text: Optional[StrictStr] = Field(default=None, description='The question text')
    __properties: ClassVar[List[str]] = ['id', 'created', 'modified', 'order', 'optional', 'text']
