...
class EngagementToNotes(BaseModel):
    """
    EngagementToNotes
    """  # noqa: E501
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.notes:
            ...
            _dict['notes'] = _items
        # set to None if engagement_id (nullable) is None
        # and model_fields_set contains the field
        if self.engagement_id is None and 'engagement_id' in self.model_fields_set:
            _dict['engagement_id'] = None
