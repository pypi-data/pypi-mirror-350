...
class PaginatedBurpRawRequestResponseMultiList(BaseModel):
    """
    ...
    results: List[BurpRawRequestResponseMulti]
        ...
        _obj = cls.model_validate(
            {
                ...
                'results': [BurpRawRequestResponseMulti.from_dict(_item) for _item in obj['results']]
