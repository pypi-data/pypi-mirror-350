...
class PaginatedProductTypeMemberList(BaseModel):
    """
    ...
    results: List[ProductTypeMember]
        ...
        _obj = cls.model_validate(
            {
                ...
                'results': [ProductTypeMember.from_dict(_item) for _item in obj['results']]
                if obj.get('results') is not None
                else None,
                'prefetch': PaginatedProductTypeMemberListPrefetch.from_dict(obj['prefetch'])
