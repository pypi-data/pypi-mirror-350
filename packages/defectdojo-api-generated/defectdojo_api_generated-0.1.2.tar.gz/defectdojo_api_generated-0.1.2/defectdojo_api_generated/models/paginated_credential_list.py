...
class PaginatedCredentialList(BaseModel):
    """
        ...
        _obj = cls.model_validate(
            {
                ...
                'results': [Credential.from_dict(_item) for _item in obj['results']]
                if obj.get('results') is not None
                else None,
                'prefetch': CredentialPrefetch.from_dict(obj['prefetch']) if obj.get('prefetch') is not None else None,
            }
        )
        return _obj
