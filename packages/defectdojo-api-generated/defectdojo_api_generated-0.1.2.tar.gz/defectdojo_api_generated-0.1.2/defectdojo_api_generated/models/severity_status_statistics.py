...
class SeverityStatusStatistics(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                'info': StatusStatistics.from_dict(obj['info']) if obj.get('info') is not None else None,
                'low': StatusStatistics.from_dict(obj['low']) if obj.get('low') is not None else None,
                'medium': StatusStatistics.from_dict(obj['medium']) if obj.get('medium') is not None else None,
                'high': StatusStatistics.from_dict(obj['high']) if obj.get('high') is not None else None,
                'critical': StatusStatistics.from_dict(obj['critical']) if obj.get('critical') is not None else None,
                'total': StatusStatistics.from_dict(obj['total']) if obj.get('total') is not None else None,
            }
        )
        return _obj
