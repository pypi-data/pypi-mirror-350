...
class PaginatedProductTypeGroupList(BaseModel):
    """
        ...
        _obj = cls.model_validate(
            {
                ...
                'results': [ProductTypeGroup.from_dict(_item) for _item in obj['results']]
                if obj.get('results') is not None
                else None,
                'prefetch': PaginatedProductTypeGroupListPrefetch.from_dict(obj['prefetch'])
