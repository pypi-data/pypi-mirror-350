...
if TYPE_CHECKING:
    ...
    from defectdojo_api_generated.models import QuestionnaireAnsweredSurvey
...
class QuestionnaireAnsweredQuestionnairesApi:
    ...
    def questionnaire_answered_questionnaires_list_iterator(
        self,
        limit: Annotated[Optional[StrictInt], Field(description='Number of results to return per page.')] = None,
        offset: Annotated[
            Optional[StrictInt], Field(description='The initial index from which to return the results.')
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> 'Generator[IteratorResult[QuestionnaireAnsweredSurvey, PaginatedQuestionnaireAnsweredSurveyList], None, None]':
        _params = locals()
        for page in get_all_pages(
            self.api_client,
            QuestionnaireAnsweredQuestionnairesApi.questionnaire_answered_questionnaires_list,
            **_params,
        ):
