...
if TYPE_CHECKING:
    ...
    from defectdojo_api_generated.models import SystemSettings
...
class SystemSettingsApi:
    ...
    def system_settings_list(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': 'PaginatedSystemSettingsList',
        }
    ...
    def _system_settings_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/system_settings/',
    ...
    def system_settings_partial_update(
        ...
        :type id: int
        :param patched_system_settings_request:
        :type patched_system_settings_request: PatchedSystemSettingsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _system_settings_partial_update_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if patched_system_settings_request is not None:
            _body_params = patched_system_settings_request
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/api/v2/system_settings/{id}/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def system_settings_update(
        ...
        :param id: A unique integer value identifying this system_ settings. (required)
        :type id: int
        :param system_settings_request:
        :type system_settings_request: SystemSettingsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _system_settings_update_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if system_settings_request is not None:
            _body_params = system_settings_request
