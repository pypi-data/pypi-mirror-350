...
if TYPE_CHECKING:
    ...
    from defectdojo_api_generated.models import DeletePreview, Language
...
class LanguagesApi:
    ...
    def _languages_create_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/languages/',
    ...
    def _languages_delete_preview_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/languages/{id}/delete_preview/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _languages_destroy_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/languages/{id}/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def languages_partial_update(
        ...
        :param id: A unique integer value identifying this languages. (required)
        :type id: int
        :param patched_language_request:
        :type patched_language_request: PatchedLanguageRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _languages_partial_update_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if patched_language_request is not None:
            _body_params = patched_language_request
