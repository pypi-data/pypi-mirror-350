...
if TYPE_CHECKING:
    ...
    from defectdojo_api_generated.models import DeletePreview, SonarqubeIssueTransition


class SonarqubeTransitionsApi:
    ...
    def sonarqube_transitions_create(
        ...
        :type sonarqube_issue_transition_request: SonarqubeIssueTransitionRequest
    ...
    def _sonarqube_transitions_create_serialize(
        ...
        if sonarqube_issue_transition_request is not None:
            _body_params = sonarqube_issue_transition_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/sonarqube_transitions/',
    ...
    def _sonarqube_transitions_delete_preview_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v2/sonarqube_transitions/{id}/delete_preview/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _sonarqube_transitions_destroy_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v2/sonarqube_transitions/{id}/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def sonarqube_transitions_list(
        ...
        sonarqube_status: Optional[StrictStr] = None,
        transitions: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        :param offset: The initial index from which to return the results.
        :type offset: int
        :param sonarqube_issue:
        :type sonarqube_issue: int
        :param sonarqube_status:
        :type sonarqube_status: str
        :param transitions:
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': 'PaginatedSonarqubeIssueTransitionList',
        }
        response_data = self.api_client.call_api(*_param, _request_timeout=_request_timeout)
        response_data.read()
        return self.api_client.response_deserialize(
    ...
    def _sonarqube_transitions_list_serialize(
        ...
        if finding_status is not None:
            _query_params.append(('finding_status', finding_status))
        ...
        if sonarqube_status is not None:
            _query_params.append(('sonarqube_status', sonarqube_status))

        if transitions is not None:
            _query_params.append(('transitions', transitions))
    ...
    def sonarqube_transitions_partial_update(
        ...
        patched_sonarqube_issue_transition_request: Optional[PatchedSonarqubeIssueTransitionRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        :param id: A unique integer value identifying this sonarqube_ issue_ transition. (required)
        :type id: int
        :param patched_sonarqube_issue_transition_request:
        :type patched_sonarqube_issue_transition_request: PatchedSonarqubeIssueTransitionRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _sonarqube_transitions_partial_update_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if patched_sonarqube_issue_transition_request is not None:
            _body_params = patched_sonarqube_issue_transition_request
