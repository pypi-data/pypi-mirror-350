...
class SectorAnalyzer:
    ...
    def identify_extreme_sectors(
        ...
        """
        overbought = [
            symbol for symbol, rsi in rsi_values.items() if rsi >= overbought_threshold
        ]
        oversold = [
            symbol for symbol, rsi in rsi_values.items() if rsi <= oversold_threshold
        ]
    ...
    def analyze_sectors(self) -> Dict[str, any]:
        ...
        try:
            ...
            overbought, oversold = self.identify_extreme_sectors(rsi_values)
...
def analyze_index_sectors():
    ...
    print("Oversold:", ", ".join(results["oversold_sectors"]) or "None")
