...
from swarms.agents.i_agent import IterativeReflectiveExpansion as IREAgent
...
class ReasoningAgentRouter:
    ...
    def select_swarm(self):
        ...
        """
        if self.swarm_type == "reasoning-duo" or self.swarm_type == "reasoning-agent":
            return ReasoningDuo(
        ...
        elif self.swarm_type == "ire" or self.swarm_type == "ire-agent":
            return IREAgent(
                agent_name=self.agent_name,
                description=self.description,
                model_name=self.model_name,
