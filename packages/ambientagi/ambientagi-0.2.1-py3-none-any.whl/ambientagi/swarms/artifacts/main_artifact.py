...
class FileVersion(BaseModel):
    ...
    version_number: int = Field(..., description="The version number of the file")
    content: str = Field(..., description="The content of the file version")
    timestamp: str = Field(
...
class Artifact(BaseModel):
    ...
    contents: str = Field(..., description="The contents of the file in string format")
