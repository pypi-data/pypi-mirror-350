...
class ModelRouter:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        try:
            ...
            raise RuntimeError(f"Failed to initialize ModelRouter: {str(e)}")
    ...
    def __str__(self):
        return (
            f"ModelRouter(max_tokens={self.max_tokens}, temperature={self.temperature})"
        )
    ...
    async def async_run(self, task: str, *args, **kwargs):
        ...
        """
        try:
            return asyncio.create_task(self.run(task, *args, **kwargs))
        except Exception as e:
