...
class AgentConfig(BaseModel):
    ...
    name: str = Field(description="The name of the agent", example="Research-Agent")
...
class AutoSwarmBuilder:
    ...
    def _create_agents(self, task: str, *args, **kwargs):
        ...
        self.max_loops = getattr(agents_dictionary)  # Default to 1 if not set

        logger.info(f"Swarm config: {self.name}, {self.description}, {self.max_loops}")
