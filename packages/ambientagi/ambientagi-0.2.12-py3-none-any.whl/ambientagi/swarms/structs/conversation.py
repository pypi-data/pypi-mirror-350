...
if TYPE_CHECKING:
    from swarms.structs.agent import \
        Agent  # Only imported during type checking
...
class Conversation(BaseStructure):
    ...
    def display_conversation(self, detailed: bool = False):
        ...
        for message in self.conversation_history:
            formatter.print_panel(f"{message['role']}: {message['content']}\n\n")
    ...
    def truncate_memory_with_tokenizer(self):
        ...
        for message in self.conversation_history:
            ...
            if total_tokens <= self.context_length:
                ...
                remaining_tokens = self.context_length - (total_tokens - count)
    ...
    def get_visible_messages(self, agent: "Agent", turn: int):
        ...
        prev_messages = [
            message for message in self.conversation_history if message["turn"] < turn
        ]
    ...
    def return_json(self):
        return json.dumps(self.return_messages_as_dictionary(), indent=4)
