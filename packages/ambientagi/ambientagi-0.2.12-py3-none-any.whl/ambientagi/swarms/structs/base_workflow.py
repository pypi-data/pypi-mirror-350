...
class BaseWorkflow(BaseStructure):
    ...
    def reset(self) -> None:
        ...
        try:
            ...
            formatter.print_panel(f"Error resetting workflow: {error}")
            raise error
    ...
    def get_task_results(self) -> Dict[str, Any]:
        ...
        try:
            ...
            formatter.print_panel(f"Error getting task results: {error}")
    ...
    def update_task(self, task: str, **updates) -> None:
        ...
        try:
            ...
            formatter.print_panel(f"Error updating task in workflow: {error}"),
