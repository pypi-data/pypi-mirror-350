...
class AgentEncryption:
    ...
    def create_session(self, agent_ids: List[str]) -> str:
        ...
        for agent_id in agent_ids:
            ...
            if agent_id == self.agent_id:
                ...
                agent_public_key = self.known_agents[agent_id].public_key
    ...
    def decrypt_message(self, message: EncryptedMessage) -> Union[str, dict]:
        ...
        # Decrypt the message
        decrypted_content = cipher.decrypt(message.encrypted_content).decode()
    ...
    def decrypt_at_rest(self, encrypted_data: bytes) -> Union[str, dict]:
    ...
    def decrypt_from_transit(self, data: Union[bytes, str]) -> Union[str, dict]:
    ...
    def get_public_key_pem(self) -> bytes:
        ...
        if not self.enable_transit_encryption and not self.enable_multi_agent:
            return b""
