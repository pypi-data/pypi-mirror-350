...
class ShortTermMemory:
    ...
    **kwargs: _description_
    ...
    def add(self, role: str = None, message: str = None, *args, **kwargs):
        ...
        """
        try:
            memory = self.short_term_memory.append({"role": role, "message": message})
                    ...
                    json.dump(
                        {
                            ...
                            "medium_term_memory": (self.medium_term_memory),
                        },
                        f,
                    )
    ...
    def load_from_file(self, filename: str, *args, **kwargs):
        ...
        try:
            with self.lock:
                ...
                self.medium_term_memory = data.get("medium_term_memory", [])
