...
# Create trees
diagnostic_tree = Tree(tree_name="Diagnostic Specialists", agents=diagnostic_agents)
treatment_tree = Tree(tree_name="Treatment Specialists", agents=treatment_agents)
followup_tree = Tree(tree_name="Follow-up and Monitoring", agents=followup_agents)

# Create the ForestSwarm
medical_forest = ForestSwarm(trees=[diagnostic_tree, treatment_tree, followup_tree])
