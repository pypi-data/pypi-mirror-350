    ...
    def search_properties(
        ...
        try:
            ...
            params = {
                "price_max": max_price,
                "property_types": (
                    [pt.value for pt in property_types] if property_types else None
                ),
                "page": page,
                "limit": limit,
                "for_sale": True,
            ...
            return [
                PropertyListing(
                    ...
                    zoning=prop["zoning"],
                    listing_date=datetime.fromisoformat(prop["list_date"]),
...
class CommercialRealEstateAgent:
    ...
    def __init__(
        ...
        logger.info("Commercial Real Estate Agent initialized successfully")
    ...
    def search_properties(
        ...
        try:
            ...
            logger.info(f"Successfully analyzed {len(analyzed_properties)} properties")
            return analyzed_properties

        except Exception as e:
            logger.error(f"Error in property search and analysis: {str(e)}")
            raise
