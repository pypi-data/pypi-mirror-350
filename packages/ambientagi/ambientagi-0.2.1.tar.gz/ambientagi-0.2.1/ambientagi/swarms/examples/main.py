...
class DataFetcher:
    ...
    async def get_market_data(self, limit: int = 20) -> List[CryptoData]:
            ...
            async with self.session.get(url, params=params) as response:
                ...
                for coin in data:
                    try:
                        ...
                        logger.error(f"Error processing coin data: {str(e)}")
                        continue

                logger.info(f"Successfully fetched data for {len(crypto_data)} coins")
                return crypto_data
...
class Cryptoswarmsystem:
    ...
    async def analyze_market(self) -> Dict:
        ...
        try:
            ...
            for agent_name, agent in self.agents.items():
                ...
                analysis = self._run_agent_analysis(agent, crypto_data)
    ...
    def _run_agent_analysis(self, agent: Agent, crypto_data: List[CryptoData]) -> str:
