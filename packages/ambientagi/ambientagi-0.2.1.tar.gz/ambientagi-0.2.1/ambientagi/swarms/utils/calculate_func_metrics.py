...
def profile_func(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        memory_usage = (end_mem - start_mem) / (1024**2)  # Convert bytes to MiB
...
def profile_all(func: Callable) -> Callable:
    ...
    def wrapper(*args: Any, **kwargs: Any) -> Any:
        ...
        if io_tracking_available:
            ...
            io_read_count = (
                final_io_counters.read_count - initial_io_counters.read_count
            )
            io_write_count = (
                final_io_counters.write_count - initial_io_counters.write_count
            )
        else:
