...
from ..types import batch_create_validation_task_params
...
class BatchesResource(SyncAPIResource):
    ...
    def create_validation_task(
        ...
        batch_id: str,
        *,
        body: Optional[Dict[str, object]] | NotGiven = NOT_GIVEN,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        return self._post(
            ...
            body=maybe_transform(body, batch_create_validation_task_params.BatchCreateValidationTaskParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
    ...
    async def create_validation_task(
        ...
        *,
        ...
        return await self._post(
            f"/batches/{batch_id}/validation-tasks",
            body=await async_maybe_transform(body, batch_create_validation_task_params.BatchCreateValidationTaskParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=BatchCreateValidationTaskResponse,
