...
from ...types.integrations import prefect_receive_notification_params
...
class PrefectResource(SyncAPIResource):
    ...
    def receive_notification(
        self,
        *,
        flow_run: prefect_receive_notification_params.FlowRun,
        ...
        return self._post(
            ...
            body=maybe_transform(
                {"flow_run": flow_run}, prefect_receive_notification_params.PrefectReceiveNotificationParams
            ),
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"queue_name": queue_name}, prefect_receive_notification_params.PrefectReceiveNotificationParams
                ),
            ),
            cast_to=object,
        )
...
class PrefectResourceWithRawResponse:
    def __init__(self, prefect: PrefectResource) -> None:
        ...
        self.receive_notification = to_raw_response_wrapper(
            prefect.receive_notification,
        )
...
class AsyncPrefectResourceWithRawResponse:
    def __init__(self, prefect: AsyncPrefectResource) -> None:
        ...
        self.receive_notification = async_to_raw_response_wrapper(
            prefect.receive_notification,
        )
...
class PrefectResourceWithStreamingResponse:
    def __init__(self, prefect: PrefectResource) -> None:
        ...
        self.receive_notification = to_streamed_response_wrapper(
            prefect.receive_notification,
        )
...
class AsyncPrefectResourceWithStreamingResponse:
    def __init__(self, prefect: AsyncPrefectResource) -> None:
        ...
        self.receive_notification = async_to_streamed_response_wrapper(
            prefect.receive_notification,
        )
