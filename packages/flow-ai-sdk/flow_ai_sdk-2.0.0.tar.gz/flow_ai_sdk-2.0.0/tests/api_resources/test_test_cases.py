...
class TestTestCases:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_retrieve_validation(self, client: FlowAISDK) -> None:
        test_case = client.test_cases.retrieve_validation(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_retrieve_validation(self, client: FlowAISDK) -> None:
        response = client.test_cases.with_raw_response.retrieve_validation(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_retrieve_validation(self, client: FlowAISDK) -> None:
        with client.test_cases.with_streaming_response.retrieve_validation(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip()
    @parametrize
    def test_path_params_retrieve_validation(self, client: FlowAISDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `test_case_id` but received ''"):
            client.test_cases.with_raw_response.retrieve_validation(
                "",
            )
...
class TestAsyncTestCases:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_retrieve_validation(self, async_client: AsyncFlowAISDK) -> None:
        test_case = await async_client.test_cases.retrieve_validation(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(object, test_case, path=["response"])
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_retrieve_validation(self, async_client: AsyncFlowAISDK) -> None:
        response = await async_client.test_cases.with_raw_response.retrieve_validation(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_retrieve_validation(self, async_client: AsyncFlowAISDK) -> None:
        async with async_client.test_cases.with_streaming_response.retrieve_validation(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_path_params_retrieve_validation(self, async_client: AsyncFlowAISDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `test_case_id` but received ''"):
            await async_client.test_cases.with_raw_response.retrieve_validation(
                "",
            )
