...
class TestBatches:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_create_validation_task_with_all_params(self, client: FlowAISDK) -> None:
        batch = client.batches.create_validation_task(
            batch_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            body={"foo": "bar"},
        )
...
class TestAsyncBatches:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_create_validation_task_with_all_params(self, async_client: AsyncFlowAISDK) -> None:
        batch = await async_client.batches.create_validation_task(
            batch_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            body={"foo": "bar"},
        )
