...
Please open a [new security advisory notice](https://github.com/CU-DBMI/onesentence/security/advisories/new) (using defaults or "n/a" where unable to fill in the form) to privately notify us of any incidents of this nature.
...
1. Open a GitHub issue: https://github.com/CU-DBMI/onesentence/issues
...
1. Please include the reason for your pull request and any background information which will assist in understanding the changes.
...
We publish source code by using [GitHub Releases](https://docs.github.com/en/repositories/releasing-projects-on-github/about-releases) available [here](https://github.com/CU-DBMI/onesentence/releases).
