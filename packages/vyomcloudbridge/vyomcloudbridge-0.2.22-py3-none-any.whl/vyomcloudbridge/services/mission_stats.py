...
class MissionStats(ServiceAbstract):
    ...
    def __init__(self):
        ...
        self.data_listing_publish_interval = 30
    ...
    def _get_last_data_mission_id(self) -> Optional[int]:
        """
    ...
    def delete_current_mission(self, mission_id):  # Note in use
        """
    ...
    def start_mission(
        ...
        Args:
            id (str, optional): Unique mission ID. Auto-generated if not provided.
        ...
        if mission_read_error is not None:
            self.logger.error(f"Error in checking existing mission -{mission_read_error}")
    ...
    def _publish_stats_to_hq(self, mission_id: int):  # PUBLISHER FUNCTION 1
        try:
...
def main():
    ...
    try:
        ...
        #     mission_id, 125000, "mp4", data_source, s3_dir_video
        # )

        # mission_stats_service.on_mission_data_arrive(
        #     mission_id, 130000, "mp4", data_source, s3_dir_video
        # )
        # mission_stats_service.on_mission_data_arrive(
        #     mission_id, 200000, "mkv", data_source, s3_dir_video
        # )
        ...
        # # Process log files
        # mission_stats_service.on_mission_data_arrive(
        #     mission_id,, 500, "log" data_source, s3_dir_file
        # )
        # mission_stats_service.on_mission_data_arrive(
        #     mission_id, 600, "log", data_source, s3_dir_file
        # )

        # # Process telemetry files
        # mission_stats_service.on_mission_data_arrive(
        #     mission_id, 2500, "json", data_source, s3_dir_file
        # )
