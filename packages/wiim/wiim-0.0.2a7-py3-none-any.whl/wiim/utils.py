...
from wiim.exceptions import LinkPlayInvalidDataException, LinkPlayRequestException
...
def create_unverified_context() -> ssl.SSLContext:
    ...
    dirs = AppDirs("python-wiim")
    mtls_certificate_path = os.path.join(dirs.user_data_dir, "wiim.pem")
