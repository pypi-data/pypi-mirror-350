...
UPNP_AV_TRANSPORT_SERVICE_ID = "urn:schemas-upnp-org:serviceId:AVTransport"
UPNP_RENDERING_CONTROL_SERVICE_ID = "urn:schemas-upnp-org:serviceId:RenderingControl"
# Custom WiiM UPnP Service ID (as specified by user)
UPNP_WIIM_PLAY_QUEUE_SERVICE_ID = "urn:wiimu-com:serviceId:PlayQueue"
