import { w as L, g as vt, a as Be, c as xt } from "./XProvider-Dv_EKlP2.js";
import { a as Ct, b as de, r as kt, c as Et } from "./Index-D2K20w0v.js";
...
const tn = /* @__PURE__ */ Be(Pt), rn = /* @__PURE__ */ He({
  ...
  ar_EG: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ar_EG-DZd0gzCc.js").then((e) => e.a), import("./ar-DYedE76Q.js").then((e) => e.a)]);
    return {
      antd: t,
      dayjs: "ar"
    };
  ...
  az_AZ: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./az_AZ-0O9TftIr.js").then((e) => e.a), import("./az-BfrSXUBd.js").then((e) => e.a)]);
    return {
      antd: t,
      dayjs: "az"
    };
  ...
  bg_BG: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./bg_BG-C6QB9dJ9.js").then((e) => e.b), import("./bg-Bb8v2AKF.js").then((e) => e.b)]);
    return {
      antd: t,
      dayjs: "bg"
    };
  ...
  bn_BD: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./bn_BD-BhjS5E2F.js").then((e) => e.b), import("./bn-D0yvtOkG.js").then((e) => e.b)]);
    return {
      antd: t,
      dayjs: "bn"
    };
  ...
  by_BY: async () => {
    const [{
      ...
      import("./by_BY-B0D771Nl.js").then((e) => e.b),
      import("./be-CPJ3HBdB.js").then((e) => e.b)
      // Belarusian (Belarus)
    ]);
    return {
      antd: t,
  ...
  ca_ES: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ca_ES-Bf1sUBQu.js").then((e) => e.c), import("./ca-DyYrcnzU.js").then((e) => e.c)]);
    return {
      antd: t,
      dayjs: "ca"
    };
  ...
  cs_CZ: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./cs_CZ-9tgz1L9B.js").then((e) => e.c), import("./cs-D_0gmfnS.js").then((e) => e.c)]);
    return {
      antd: t,
      dayjs: "cs"
    };
  ...
  da_DK: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./da_DK-BlC_FMcP.js").then((e) => e.d), import("./da-BYe5zHVH.js").then((e) => e.d)]);
    return {
      antd: t,
      dayjs: "da"
    };
  ...
  de_DE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./de_DE-Bfpfb4AF.js").then((e) => e.d), import("./de-8Y6yQm2Q.js").then((e) => e.d)]);
    return {
      antd: t,
      dayjs: "de"
    };
  ...
  el_GR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./el_GR-DzD4ipKJ.js").then((e) => e.e), import("./el-j4Zj6aCU.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "el"
    };
  ...
  en_GB: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./en_GB-ki_wRixZ.js").then((e) => e.e), import("./en-gb-DbHUA3ps.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "en-gb"
    };
  ...
  es_ES: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./es_ES-ZlNHG-rF.js").then((e) => e.e), import("./es-Cy9cxnx6.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "es"
    };
  ...
  et_EE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./et_EE-BNoYSKdw.js").then((e) => e.e), import("./et-BqL_Lbks.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "et"
    };
  ...
  eu_ES: async () => {
    const [{
      ...
      import("./eu_ES-SPSeXJI5.js").then((e) => e.e),
      import("./eu-CTJLrYnB.js").then((e) => e.e)
      // Basque
    ]);
    return {
      antd: t,
  ...
  fa_IR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fa_IR-BL1E5Gyn.js").then((e) => e.f), import("./fa-D66-_oG9.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fa"
    };
  ...
  fi_FI: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fi_FI-rZXcBymi.js").then((e) => e.f), import("./fi-DP6_S6cU.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fi"
    };
  ...
  fr_BE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fr_BE-Dpy3k6R1.js").then((e) => e.f), import("./fr-C9jCbTGF.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fr"
    };
  ...
  fr_CA: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fr_CA-CvIwXvb1.js").then((e) => e.f), import("./fr-ca-CKUmczLk.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fr-ca"
    };
  ...
  fr_FR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fr_FR-Ce1SKzv5.js").then((e) => e.f), import("./fr-C9jCbTGF.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fr"
    };
  ...
  ga_IE: async () => {
    const [{
      ...
      import("./ga_IE-B_-rWiJE.js").then((e) => e.g),
      import("./ga-tx4pylBa.js").then((e) => e.g)
      // Irish
    ]);
    return {
      antd: t,
  ...
  gl_ES: async () => {
    const [{
      ...
      import("./gl_ES-D0VWUec3.js").then((e) => e.g),
      import("./gl-DRBx0OYi.js").then((e) => e.g)
      // Galician
    ]);
    return {
      antd: t,
  ...
  he_IL: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./he_IL-JjfA9K49.js").then((e) => e.h), import("./he-CDmfpFlA.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "he"
    };
  ...
  hi_IN: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./hi_IN-BkSbq5s1.js").then((e) => e.h), import("./hi-z8dLUNra.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "hi"
    };
  ...
  hr_HR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./hr_HR-CJojuKYz.js").then((e) => e.h), import("./hr-BFhbUNXY.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "hr"
    };
  ...
  hu_HU: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./hu_HU-Dg4fKt4D.js").then((e) => e.h), import("./hu-DuQPsleP.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "hu"
    };
  ...
  hy_AM: async () => {
    const [{
      ...
      import("./hy_AM-4dCyOfNw.js").then((e) => e.h),
      import("./am-Cn7IQIfc.js").then((e) => e.a)
      // Armenian
    ]);
    return {
      antd: t,
  ...
  id_ID: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./id_ID-CJIvwjib.js").then((e) => e.i), import("./id-CMLMZJHm.js").then((e) => e.i)]);
    return {
      antd: t,
      dayjs: "id"
    };
  ...
  is_IS: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./is_IS-pBMExI2p.js").then((e) => e.i), import("./is-CsFOPapF.js").then((e) => e.i)]);
    return {
      antd: t,
      dayjs: "is"
    };
  ...
  it_IT: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./it_IT-DiT1mlhZ.js").then((e) => e.i), import("./it-CxIlKh_s.js").then((e) => e.i)]);
    return {
      antd: t,
      dayjs: "it"
    };
  ...
  ja_JP: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ja_JP-DYth7J1m.js").then((e) => e.j), import("./ja-DZAcDXvZ.js").then((e) => e.j)]);
    return {
      antd: t,
      dayjs: "ja"
    };
  ...
  ka_GE: async () => {
    const [{
      ...
      import("./ka_GE-DnU1GAwI.js").then((e) => e.k),
      import("./ka-eIM8j74V.js").then((e) => e.k)
      // Georgian
    ]);
    return {
      antd: t,
  ...
  kk_KZ: async () => {
    const [{
      ...
      import("./kk_KZ-CmQs_8_d.js").then((e) => e.k),
      import("./kk-e48Bcnjo.js").then((e) => e.k)
      // Kazakh
    ]);
    return {
      antd: t,
  ...
  km_KH: async () => {
    const [{
      ...
      import("./km_KH-B1SJ1jvl.js").then((e) => e.k),
      import("./km-79YjKDzE.js").then((e) => e.k)
      // Khmer
    ]);
    return {
      antd: t,
  ...
  kmr_IQ: async () => {
    const [t] = await Promise.all([
      import("./kmr_IQ-CO41tKSa.js").then((e) => e.k)
  ...
  kn_IN: async () => {
    const [{
      ...
      import("./kn_IN-WJHr5jJd.js").then((e) => e.k),
      import("./kn-j9zSp9Oo.js").then((e) => e.k)
      // Kannada
    ]);
    return {
      antd: t,
  ...
  ko_KR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ko_KR-COzxo0rI.js").then((e) => e.k), import("./ko-DcUQ9zO0.js").then((e) => e.k)]);
    return {
      antd: t,
      dayjs: "ko"
    };
  ...
  ku_IQ: async () => {
    const [{
      ...
      import("./ku_IQ-y7RiFb7g.js").then((e) => e.k),
      import("./ku-CSYDJODx.js").then((e) => e.k)
      // Kurdish (Central)
    ]);
    return {
      antd: t,
  ...
  lt_LT: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./lt_LT-Bs094mdW.js").then((e) => e.l), import("./lt-BguYIISC.js").then((e) => e.l)]);
    return {
      antd: t,
      dayjs: "lt"
    };
  ...
  lv_LV: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./lv_LV-CVJP3L-m.js").then((e) => e.l), import("./lv-BgzS4_zg.js").then((e) => e.l)]);
    return {
      antd: t,
      dayjs: "lv"
    };
  ...
  mk_MK: async () => {
    const [{
      ...
      import("./mk_MK-CogOGrUx.js").then((e) => e.m),
      import("./mk-C3QBpChr.js").then((e) => e.m)
      // Macedonian
    ]);
    return {
      antd: t,
  ...
  ml_IN: async () => {
    const [{
      ...
      import("./ml_IN-3KmLjMD9.js").then((e) => e.m),
      import("./ml-QRHuXk-0.js").then((e) => e.m)
      // Malayalam
    ]);
    return {
      antd: t,
  ...
  mn_MN: async () => {
    const [{
      ...
      import("./mn_MN-DG4OqUtQ.js").then((e) => e.m),
      import("./mn-Dyy3mHp7.js").then((e) => e.m)
      // Mongolian
    ]);
    return {
      antd: t,
  ...
  ms_MY: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ms_MY-BlRD-S5X.js").then((e) => e.m), import("./ms-BcqPFSYZ.js").then((e) => e.m)]);
    return {
      antd: t,
      dayjs: "ms"
    };
  ...
  my_MM: async () => {
    const [{
      ...
      import("./my_MM-4HFaZWrd.js").then((e) => e.m),
      import("./my-C6ylU9Iw.js").then((e) => e.m)
      // Burmese
    ]);
    return {
      antd: t,
  ...
  nb_NO: async () => {
    const [{
      ...
      import("./nb_NO-YgEVIlZJ.js").then((e) => e.n),
      import("./nb-RsdwDdlB.js").then((e) => e.n)
      // Norwegian Bokmål
    ]);
    return {
      antd: t,
  ...
  ne_NP: async () => {
    const [{
      ...
      import("./ne_NP-9WjTJvMu.js").then((e) => e.n),
      import("./ne-C6rtXaWW.js").then((e) => e.n)
      // Nepali
    ]);
    return {
      antd: t,
  ...
  nl_BE: async () => {
    const [{
      ...
      import("./nl_BE-CSyX-fsQ.js").then((e) => e.n),
      import("./nl-be-mb_Zy7hT.js").then((e) => e.n)
      // Dutch (Belgium)
    ]);
    return {
      antd: t,
  ...
  nl_NL: async () => {
    const [{
      ...
      import("./nl_NL-BFKoN9E7.js").then((e) => e.n),
      import("./nl-B-BzE6jZ.js").then((e) => e.n)
      // Dutch (Netherlands)
    ]);
    return {
      antd: t,
  ...
  pl_PL: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./pl_PL-C_Px45EN.js").then((e) => e.p), import("./pl-BbBjsRHW.js").then((e) => e.p)]);
    return {
      antd: t,
      dayjs: "pl"
    };
  ...
  pt_BR: async () => {
    const [{
      ...
      import("./pt_BR-BkmTMsWc.js").then((e) => e.p),
      import("./pt-br-B38Q3dwz.js").then((e) => e.p)
      // Portuguese (Brazil)
    ]);
    return {
      antd: t,
  ...
  pt_PT: async () => {
    const [{
      ...
      import("./pt_PT-CIR7OGvq.js").then((e) => e.p),
      import("./pt-CEG3b7qA.js").then((e) => e.p)
      // Portuguese (Portugal)
    ]);
    return {
      antd: t,
  ...
  ro_RO: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ro_RO-vT7EjTI6.js").then((e) => e.r), import("./ro-C3ct605S.js").then((e) => e.r)]);
    return {
      antd: t,
      dayjs: "ro"
    };
  ...
  ru_RU: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ru_RU-m2ra_8VR.js").then((e) => e.r), import("./ru-a2gaJGRa.js").then((e) => e.r)]);
    return {
      antd: t,
      dayjs: "ru"
    };
  ...
  si_LK: async () => {
    const [{
      ...
      import("./si_LK-BOZa7YLh.js").then((e) => e.s),
      import("./si-DiDVy4N5.js").then((e) => e.s)
      // Sinhala
    ]);
    return {
      antd: t,
  ...
  sk_SK: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./sk_SK-HPLDrE94.js").then((e) => e.s), import("./sk-Boaf8oeM.js").then((e) => e.s)]);
    return {
      antd: t,
      dayjs: "sk"
    };
  ...
  sl_SI: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./sl_SI-DO7pP3G7.js").then((e) => e.s), import("./sl-Cs36cJB-.js").then((e) => e.s)]);
    return {
      antd: t,
      dayjs: "sl"
    };
  ...
  sr_RS: async () => {
    const [{
      ...
      import("./sr_RS-KGGtozsi.js").then((e) => e.s),
      import("./sr-DQlfyO7j.js").then((e) => e.s)
      // Serbian
    ]);
    return {
      antd: t,
  ...
  sv_SE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./sv_SE-CJDpeKJ9.js").then((e) => e.s), import("./sv-nw_TGFai.js").then((e) => e.s)]);
    return {
      antd: t,
      dayjs: "sv"
    };
  ...
  ta_IN: async () => {
    const [{
      ...
      import("./ta_IN-DbPA1q_6.js").then((e) => e.t),
      import("./ta-BUPl3JAt.js").then((e) => e.t)
      // Tamil
    ]);
    return {
      antd: t,
  ...
  th_TH: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./th_TH-BVJJUbWj.js").then((e) => e.t), import("./th-C_1VgoWz.js").then((e) => e.t)]);
    return {
      antd: t,
      dayjs: "th"
    };
  ...
  tk_TK: async () => {
    const [{
      ...
      import("./tk_TK-B2Xb2EzX.js").then((e) => e.t),
      import("./tk-J3wYLsr_.js").then((e) => e.t)
      // Turkmen
    ]);
    return {
      antd: t,
  ...
  tr_TR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./tr_TR-MBBiswCt.js").then((e) => e.t), import("./tr-DIFq9kuS.js").then((e) => e.t)]);
    return {
      antd: t,
      dayjs: "tr"
    };
  ...
  uk_UA: async () => {
    const [{
      ...
      import("./uk_UA-fyZInWUB.js").then((e) => e.u),
      import("./uk-Cjkh4ZUX.js").then((e) => e.u)
      // Ukrainian
    ]);
    return {
      antd: t,
  ...
  ur_PK: async () => {
    const [{
      ...
      import("./ur_PK-qJfKP84I.js").then((e) => e.u),
      import("./ur-DOVN3uVR.js").then((e) => e.u)
      // Urdu
    ]);
    return {
      antd: t,
  ...
  uz_UZ: async () => {
    const [{
      ...
      import("./uz_UZ-DYsp3L8b.js").then((e) => e.u),
      import("./uz-6Hlcpt5L.js").then((e) => e.u)
      // Uzbek
    ]);
    return {
      antd: t,
  ...
  vi_VN: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./vi_VN-B9WZ4hyQ.js").then((e) => e.v), import("./vi-DX19utio.js").then((e) => e.v)]);
    return {
      antd: t,
      dayjs: "vi"
    };
  ...
  zh_CN: async () => {
    const [{
      ...
      import("./zh_CN-Csfe05C7.js").then((e) => e.z),
      import("./zh-cn-Bpcx4FHM.js").then((e) => e.z)
      // Chinese (Simplified)
    ]);
    return {
      antd: t,
  ...
  zh_HK: async () => {
    const [{
      ...
      import("./zh_HK-DiauyPUH.js").then((e) => e.z),
      import("./zh-hk-DZIAW6Y0.js").then((e) => e.z)
      // Chinese (Hong Kong)
    ]);
    return {
      antd: t,
  ...
  zh_TW: async () => {
    const [{
      ...
      import("./zh_TW-B5ygmSu8.js").then((e) => e.z),
      import("./zh-tw-ChdIMgk9.js").then((e) => e.z)
      // Chinese (Taiwan)
    ]);
    return {
      antd: t,
