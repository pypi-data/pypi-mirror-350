...
class CustomsExchangeCitesPermitType(BaseModel):
    ...
    def load_production(self, doc: CitesDocumentPrincipalType):
        ...
        self.date_issued = doc.issuing.date_issued
        self.date_valid = doc.document.date_valid
        ...
        self.id_no_internal_2 = doc.document.id_no_list[2] if len(doc.document.id_no_list) > 2 else None
        self.importer = PersonReducedType().load_extended(doc.document.importer)
        self.issuer = doc.issuing.issuer
...
class CustomsExchangeCitesGoodsType(BaseModel):
    ...
    def load_production(self, permit: CustomsExchangeCitesPermitType, goods: GoodsPrincipalType) -> CustomsExchangeCitesGoodsType:
        self.annex_eu = goods.species.regulation_eu
        self.appendix_cites = goods.species.regulation_cites
        ...
        self.country_last = goods.transaction_re_export.country
        self.country_origin = goods.transaction_origin.country
        self.customs = goods.goods_customs
        self.date_external = goods.transaction_origin.date_issued
        # self.date_external = goods.transaction_import.date_issued
        self.date_last = goods.transaction_re_export.date_issued
        self.date_origin = goods.transaction_origin.date_issued
        self.date_created = goods.metadata.date_created
        self.date_modified = goods.metadata.date_modified
        self.external = permit.external
        self.creator = goods.metadata.creator
        self.goods_code = goods.code
        self.goods_description = goods.field_description
        self.goods_additional = goods.goods_additional
        self.identifier = goods.metadata.identifier
        self.identifier_permit = permit.identifier
        self.id_no = permit.id_no
        self.order = goods.order
        self.origin = goods.origin
        self.permit_external = goods.transaction_origin.permit
        # self.permit_external = goods.transaction_import.permit
        self.permit_last = goods.transaction_re_export.permit
        self.permit_origin = goods.transaction_origin.permit
