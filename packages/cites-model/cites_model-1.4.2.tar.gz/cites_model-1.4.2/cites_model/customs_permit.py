...
class CustomsExchangeCitesGoodsType(BaseModel):
    ...
    def load_production(self, permit: CustomsExchangeCitesPermitType, goods: GoodsPrincipalType) -> CustomsExchangeCitesGoodsType:
        ...
        self.date_external = goods.transaction_origin.date_issued if goods.transaction_origin else None
        # self.date_external = goods.transaction_import.date_issued if goods.transaction_import else None
        self.date_last = goods.transaction_re_export.date_issued if goods.transaction_re_export else None
        self.date_origin = goods.transaction_origin.date_issued if goods.transaction_origin else None
