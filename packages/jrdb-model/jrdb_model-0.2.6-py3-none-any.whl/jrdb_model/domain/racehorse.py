...
class RacehorseData(db.Model):
    ...
    yobi1: Mapped[str] = mapped_column()
    yobi2: Mapped[str] = mapped_column()
    yobi3: Mapped[str] = mapped_column()
    ...
    yobi4: Mapped[str] = mapped_column()
    brinkers: Mapped[str] = mapped_column()
    ...
    trainer_shozoku: Mapped[str] = mapped_column()
    zenso_seiseki_key_1: Mapped[str] = mapped_column()
    zenso_seiseki_key_2: Mapped[str] = mapped_column()
    zenso_seiseki_key_3: Mapped[str] = mapped_column()
    zenso_seiseki_key_4: Mapped[str] = mapped_column()
    zenso_seiseki_key_5: Mapped[str] = mapped_column()
    zenso_racekey_1: Mapped[str] = mapped_column()
    zenso_racekey_2: Mapped[str] = mapped_column()
    zenso_racekey_3: Mapped[str] = mapped_column()
    zenso_racekey_4: Mapped[str] = mapped_column()
    zenso_racekey_5: Mapped[str] = mapped_column()
    waku: Mapped[int] = mapped_column()
    yobi5: Mapped[str] = mapped_column()
    ...
    yobi6: Mapped[str] = mapped_column()
    ...
    pace_predict: Mapped[str] = mapped_column()
    ...
    tenkai: Mapped[str] = mapped_column()
    ...
    yuso: Mapped[str] = mapped_column()
    soho: Mapped[int] = mapped_column()
    taikei_data: Mapped[str] = mapped_column()
