...
from hub.helpers.data.nrcan_construction_to_hub_window_co2 import NrcanConstructionToHubWindowCo2
from hub.helpers.data.nrcan_construction_to_hub_material_co2 import NrcanConstructionToHubMaterialCo2
...
class Dictionaries:
  ...
  @property
  def nrcan_construction_to_hub_window_co2(self):
    """
    Get NRCAN construction to Hub window co2 dictionary
    """
    return NrcanConstructionToHubWindowCo2().dictionary

  @property
  def nrcan_construction_to_hub_material_co2(self):
    """
    Get NRCAN construction to Hub material co2 dictionary
    """
    return NrcanConstructionToHubMaterialCo2().dictionary