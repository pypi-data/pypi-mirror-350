...
class _ScanIterator(ABC, metaclass=abc.ABCMeta):
    ...
    blacklist: Incomplete
    is_first_scan: bool
    def __init__(self, scan_url: _ScanUrl, extensions: Sequence[str], tag: str, blacklist_config: Sequence[_BlacklistExceptionHandler] | None, stop_event: threading.Event | None = None) -> None: ...
    @abstractmethod
