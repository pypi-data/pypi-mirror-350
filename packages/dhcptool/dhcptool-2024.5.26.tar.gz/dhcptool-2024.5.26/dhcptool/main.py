...
示例:
    # 正常发包
    dhcptool v6 -s 1000:0:0:21::18 -src 1000:0:0:21::22 -rf 1000:0:0:21::22
    # 携带duid进行发包
    dhcptool v6 -s 1000:0:0:21::18 -src 1000:0:0:21::22 -rf 1000:0:0:21::22 -duid dca52e9895d81212
"""

parser = argparse.ArgumentParser(conflict_handler='resolve', epilog=epilog, formatter_class=argparse.RawDescriptionHelpFormatter)
