...
class JobDetails(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "overall_status", "status", "passed_percentage", "failed_percentage", "progress", "created_at", "updated_at", "kind", "statuses", "errors", "duration", "duration_seconds"]
