...
class Collection(BaseModel):
    ...
    metadata_dict: Optional[Dict[str, Any]] = Field(default=None, description="Metadata for the collection")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "embedding_model", "document_count", "document_size", "updated_at", "user_count", "is_public", "username", "sessions_count", "prompt_template_id", "thumbnail", "metadata_dict"]
