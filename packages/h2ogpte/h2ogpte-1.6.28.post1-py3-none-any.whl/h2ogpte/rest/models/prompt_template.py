...
class PromptTemplate(BaseModel):
    ...
    user_count: Optional[StrictInt] = Field(default=None, description="A number of users having access to the prompt template.")
