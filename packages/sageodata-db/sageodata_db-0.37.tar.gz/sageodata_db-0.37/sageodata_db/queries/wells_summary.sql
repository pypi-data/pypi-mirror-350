SELECT dh.drillhole_no AS dh_no,     --col
       ...
       dh.state_asset               AS state_asset,               --col 'Y' if a SA Govt asset; 'N' if not; 'U' if unknown. This field is manually updated, so may be erroneous. It is used for asset management.
       dh.state_asset_status,
       dh.state_asset_retained, --col Not sure what this field means or whether it should be used.
       dh.state_asset_comments,
       dh.owner_code, -- col This indicates the organisation which owns the well - it is manually updated and therefore may be erroneous. It is used for asset management.
