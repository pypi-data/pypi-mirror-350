...
def test__get_permission_from_registered_model_name():
    with patch("mlflow_oidc_auth.validators.registered_model.get_request_param", return_value="modelA"), patch(
...
def test_validate_can_read_registered_model():
    with patch("mlflow_oidc_auth.validators.registered_model.get_request_param", return_value="modelA"):
