...
from ragformance.generators.tokenburner.config import TokenBurnerGeneratorConfig
from ragformance.models.corpus import DocModel
from ragformance.models.answer import AnnotatedQueryModel

# We will refactor TokenBurner.py to have a main callable function.
# Let's name it 'run_tokenburner_processing' for clarity.
...
class TokenBurnerGenerator(RAGformanceGeneratorInterface):
    def run(self, config: Dict) -> Tuple[List[DocModel], List[AnnotatedQueryModel]]:
        ...
        print(f"[TokenBurnerGenerator.run] TokenBurner processing complete. Files saved in {output_dir_str}")
