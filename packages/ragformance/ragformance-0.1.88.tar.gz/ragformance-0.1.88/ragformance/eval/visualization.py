...
from ragformance.generators.ragas.ragas_setup import get_configured_embeddings
...
def _get_litellm_embedding_model(embedding_config=None):
    if embedding_config is None:
        embedding_config = DEFAULT_EMBEDDING_CONFIG
    return get_configured_embeddings(embedding_config)
...
def visualize_semantic_F1(
    ...
    if embedding_model is None:
        embedding_model = _get_litellm_embedding_model(embedding_config)
    ...
    for a in answers:
        ...
        # Utilisation du wrapper Langchain pour obtenir les embeddings
        ...
        doc_embeddings = embedding_model.embed_documents(document_texts)
