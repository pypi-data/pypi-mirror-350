...
# Leer la versión desde el archivo __init__.py
with open('src/__init__.py', 'r', encoding='utf-8') as f:
    version_match = re.search(r"^__version__ = ['\"]([^'\"]*)['\"]", f.read(), re.M)
    if version_match:
        version = version_match.group(1)
    else:
        version = '0.1.0'  # Si no hay versión definida, usar 0.1.0
...
# Requisitos opcionales para los adaptadores
extras_require = {
    'flask': ['flask>=2.0.0'],
...
setup(
    name='logbee-sdk',
    version=version,
    description='SDK para integrar aplicaciones Python con Logbee',
