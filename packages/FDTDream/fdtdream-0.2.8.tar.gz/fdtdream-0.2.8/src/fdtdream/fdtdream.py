...
class FDTDream:
    ...
    def _update_materials(new_materials: str):
        ...
        # Add the documentation to the materials literal
        new_contents += textwrap.dedent(
            """
            A typing.Literal type including the available materials from the most recently loaded .fsp simulation file.
            This literal type provides type hinting for material arguments, making sure material management is straight forward.
            The literal is updated every time FDTDream creates a new simulation or loads a previous one.
            """ )
