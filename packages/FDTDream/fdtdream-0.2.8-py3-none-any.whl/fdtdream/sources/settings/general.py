...
class General(Module):
    ...
    def set_angle_theta(self, theta: float) -> None:
        """
        Sets the propagation angle theta for the source.
    ...
    def set_angle_phi(self, phi: float) -> None:
        """
        Sets the propagation angle phi for the source.
    ...
    def set_polarization_angle(self, angle: float) -> None:
        ...
        and the normal to the injection plane. A polarization angle of zero degrees is along the x-axis,
        regardless of the direction of propagation, while a
        polarization angle of 90 degrees is along the y-axis.
