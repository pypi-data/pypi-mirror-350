...
from ..FDTDiscover.dbPanel.models import DBObject
from src.fdtdream.database.handler import DatabaseHandler
from src.fdtdream.results.field_and_power_monitor import FieldAndPower


class FDTDiscover(TopLevel):
    ...
    def open(cls) -> None:
        ...
        window = cls()
        window.show()
        sys.exit(app.exec())  # Starts the event loop and blocks until the app is closed
