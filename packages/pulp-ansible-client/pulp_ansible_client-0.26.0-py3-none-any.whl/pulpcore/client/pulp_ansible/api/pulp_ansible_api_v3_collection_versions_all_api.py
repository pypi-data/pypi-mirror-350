...
class PulpAnsibleApiV3CollectionVersionsAllApi:
    ...
    def list(
        ...
        """ # noqa: E501
        warnings.warn("GET /pulp_ansible/galaxy/{path}/api/v3/collection_versions/all/ is deprecated.", DeprecationWarning)
    ...
    def _list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/pulp_ansible/galaxy/{path}/api/v3/collection_versions/all/',
