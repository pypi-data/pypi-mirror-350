...
class PulpAnsibleDefaultApiV3CollectionsVersionsDocsBlobApi:
    ...
    def read(
        ...
        """ # noqa: E501
        warnings.warn("GET /pulp_ansible/galaxy/default/api/v3/collections/{namespace}/{name}/versions/{version}/docs-blob/ is deprecated.", DeprecationWarning)
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CollectionVersionDocsResponse",
            '302': None,
        }
    ...
    def read_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CollectionVersionDocsResponse]:
        """(Deprecated) read
    ...
    def _read_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/pulp_ansible/galaxy/default/api/v3/collections/{namespace}/{name}/versions/{version}/docs-blob/',
