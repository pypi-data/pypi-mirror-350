...
class PulpAnsibleDefaultApiV3PluginAnsibleContentCollectionsArtifactsApi:
    ...
    def _download_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/pulp_ansible/galaxy/default/api/v3/plugin/ansible/content/{distro_base_path}/collections/artifacts/{filename}',
