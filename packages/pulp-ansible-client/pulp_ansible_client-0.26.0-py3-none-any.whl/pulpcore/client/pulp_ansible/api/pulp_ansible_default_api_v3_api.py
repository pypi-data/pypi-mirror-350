...
class PulpAnsibleDefaultApiV3Api:
    ...
    def read(
        ...
        """ # noqa: E501
        warnings.warn("GET /pulp_ansible/galaxy/default/api/v3/ is deprecated.", DeprecationWarning)
    ...
    def read_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RepoMetadataResponse]:
        """(Deprecated) read
    ...
    def _read_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/pulp_ansible/galaxy/default/api/v3/',
