...
class AnsibleGitRemoteResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ca_cert", "url", "client_cert", "download_concurrency", "sock_connect_timeout", "pulp_created", "proxy_url", "sock_read_timeout", "prn", "pulp_href", "connect_timeout", "tls_validation", "headers", "name", "total_timeout", "hidden_fields", "pulp_last_updated", "rate_limit", "max_retries", "pulp_labels", "metadata_only", "git_ref"]
