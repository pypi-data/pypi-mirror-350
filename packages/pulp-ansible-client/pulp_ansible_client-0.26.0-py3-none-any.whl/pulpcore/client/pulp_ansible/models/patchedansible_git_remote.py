...
class PatchedansibleGitRemote(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ca_cert", "url", "client_cert", "download_concurrency", "sock_connect_timeout", "proxy_url", "sock_read_timeout", "connect_timeout", "proxy_username", "tls_validation", "headers", "password", "name", "proxy_password", "total_timeout", "username", "client_key", "rate_limit", "max_retries", "pulp_labels", "metadata_only", "git_ref"]
