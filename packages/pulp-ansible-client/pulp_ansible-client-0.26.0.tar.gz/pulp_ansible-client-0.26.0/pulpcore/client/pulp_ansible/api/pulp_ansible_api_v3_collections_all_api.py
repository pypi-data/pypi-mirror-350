...
class PulpAnsibleApiV3CollectionsAllApi:
    ...
    def list(
        ...
        """ # noqa: E501
        warnings.warn("GET /pulp_ansible/galaxy/{path}/api/v3/collections/all/ is deprecated.", DeprecationWarning)
    ...
    def _list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/pulp_ansible/galaxy/{path}/api/v3/collections/all/',
