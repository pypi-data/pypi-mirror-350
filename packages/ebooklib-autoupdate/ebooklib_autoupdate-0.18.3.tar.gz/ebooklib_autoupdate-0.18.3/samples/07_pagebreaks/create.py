...
if __name__ == "__main__":
    ...
    c1.content = '<h1>Introduction</h1><p><span id="page1" epub:type="pagebreak">1</span>This chapter has a visible page number.</p><p><span id="page2" epub:type="pagebreak">2</span>Something else now.</p>'

    c2 = epub.EpubHtml(title="Chapter the Second", file_name="chap02.xhtml", lang="en")
    c2.content = "<html><head></head><body><h1>Chapter the Second</h1><p>This chapter has two page breaks, both with invisible page numbers.</p>"
