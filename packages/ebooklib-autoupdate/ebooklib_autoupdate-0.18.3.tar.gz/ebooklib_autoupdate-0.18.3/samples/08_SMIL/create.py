...
if __name__ == "__main__":
    ...
    book.add_metadata(
        ...
        "meta",
        "0:05:00.500",
        {"property": "media:duration", "refines": "#intro_overlay"},
    )
    book.add_metadata(
    ...
    c1.content = '<html><head></head><body><section epub:type="frontmatter colophon"><h1><span id="header_1">Introduction</span></h1><p><span id="para_1">Introduction paragraph where i explain what is happening.</span></p></section></body></html>'
