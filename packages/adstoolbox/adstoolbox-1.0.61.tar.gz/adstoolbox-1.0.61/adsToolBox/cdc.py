...
class _DataManager:
    ...
    def _capture_data_change(self):
        ...
        try:
            ...
            self.logger.exception(f"An error occurred during the data change capture: {e}")
            raise
    ...
    def _append(self):
        ...
        try:
            ...
            self.logger.exception(f"An error occurred during the append operation: {e}")
            raise
    ...
    def _scd(self):
        ...
        try:
            ...
            self.logger.exception(f"An error occurred during the SCD operation: {e}")
            raise
