...
from dtx.core.models.providers.hf import HFModels, HuggingFaceProvider, HuggingFaceTask
...
class HFModelsRepo:
    ...
    def _load_from_file(self) -> HFModels:
        ...
        return HFModels(
            huggingface=[HuggingFaceProvider(**model) for model in data.get("huggingface", [])]
        )

    def get_huggingface_model(self, model_name: str) -> HuggingFaceProvider:
        """Retrieve a HuggingFaceProvider instance by model name.
