...
from dtx.core.models.providers.litellm import LitellmProvider, LitellmProviderConfig
from dtx.core.models.providers.models_spec import (
    ModelSpec,
    ModelSpecRepo,
)
from dtx.core.models.providers.openai import OpenaiProvider, OpenaiProviderConfig
    ...
    def run(self) -> Optional[Union[OpenaiProvider, LitellmProvider]]:
        ...
        self.console.print(
            Panel(
                ...
                f"Provider: [bold]{provider_instance.id}[/bold]\n"
