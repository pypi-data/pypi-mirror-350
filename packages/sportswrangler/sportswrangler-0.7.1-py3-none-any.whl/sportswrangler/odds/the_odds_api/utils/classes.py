...
class StandardizationConfig(BaseModel):
    ...
    enabled: bool = True
    """Whether or not to enable standardization"""
    id_vars: list[str] = [
        "sport",
        "gameStartTime",
        "lastUpdatedAt",
...
class CommonParams(BaseModel):
    ...
    includeLinks: Literal["true", "false"] = Field(alias="include_links")
    dateFormat: Literal["unix", "iso"] = Field(alias="date_format")
