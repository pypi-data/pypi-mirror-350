...
def gen_plot_default(plot_settings,key_plot,plot_dic,gen_dic,data_dic):
    ...
    #Tick intervals
    plot_options['xmajor_int'] = None
    plot_options['xminor_int'] = None
    ...
    #    - default to stellar CCF mask, if provided
    ...
    if ('Fbal_corr' in key_plot) or ('FbalOrd_corr' in key_plot):
        ...
        if gen_dic['sequence']=='st_master_tseries':plot_options['gap_exp'] = 0.1
