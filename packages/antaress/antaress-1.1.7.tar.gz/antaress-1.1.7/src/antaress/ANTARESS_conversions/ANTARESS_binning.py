...
def process_bin_prof(mode,data_type_gen,gen_dic,inst,vis_in,data_dic,coord_dic,data_prop,system_param,theo_dic,plot_dic,ar_dic={},masterDIweigh=False):
    ...
    if data_type_gen=='DI':   
        ...
        if masterDIweigh or (vis_save not in list(prop_dic['prop_bin'][inst].keys())):        
            ...
            if gen_dic['sequence']=='st_master_tseries': 
                ...
                else:prop_dic['prop_bin'][inst][vis_save]={'bin_low':[0.],'bin_high':[1e9]} 
    ...
    if (calc_check):
        ...
        for isub,iexp_off in enumerate(idx_to_bin_unik):
            ...
            data_exp['tell'] = None
            if ('spec' in data_format) and gen_dic['corr_tell']:
                ...
                if calc_EFsc2:data_exp['tell'] = dataload_npz(data_inst[vis_bin]['tell_'+data_type_gen+'_data_paths'][iexp])['tell']  
