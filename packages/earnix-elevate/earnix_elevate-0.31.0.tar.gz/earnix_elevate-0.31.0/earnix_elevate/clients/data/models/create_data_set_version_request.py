...
class CreateDataSetVersionRequest(BaseModel):
    ...
    source_data_set_version_number: Optional[StrictInt] = Field(
        default=None,
        description="Optional. If null, the latest version will be used. if 0, an empty data set will be created.",
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"dataSetId": obj.get("dataSetId")})
        return _obj
