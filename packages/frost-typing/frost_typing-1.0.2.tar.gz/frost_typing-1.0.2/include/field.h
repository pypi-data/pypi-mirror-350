...
#define FIELD_VALUES                                                           \
    (FIELD_ALIAS | FIELD_TITLE | FIELD_DEFAULT | FIELD_EXAMPLES |              \
     FIELD_DEFAULT_FACTORY | FIELD_SERIALIZATION_ALIAS |                       \
     FIELD_JSON_SCHEMA_EXTRA | _FIELD_COMPUTED_FIELD | _FIELD_SERIALIZER |     \
     FIELD_ALIAS_GENERATOR)
...
#define FIELD_DEFAULTS                                                         \
    (FIELD_INIT | FIELD_REPR | FIELD_HASH | FIELD_DICT | FIELD_JSON |          \
     FIELD_COMPARISON | FIELD_CLASS_LOOKUP | FIELD_AUTO_ALIAS)
#define CONFIG_DEFAULTS                                                        \
    (FIELD_DEFAULTS | FIELD_ALLOW_INF_NAN | FAIL_ON_EXTRA_INIT)
...
#define FIELD_FIELD                                                            \
    (_FIELD_SERIALIZER | _FIELD_CONST_DEFAULT | _FIELD_SERIALIZER |            \
     _FIELD_COMPUTED_FIELD | FIELD_DEFAULT | FIELD_INIT | FIELD_REPR |         \
     FIELD_HASH | FIELD_DICT | FIELD_JSON | FIELD_KW_ONLY | FIELD_FROZEN |     \
     FIELD_COMPARISON | FIELD_CLASS_LOOKUP | FIELD_FROZEN_TYPE |               \
     FIELD_AUTO_ALIAS | FIELD_ALIAS | FIELD_TITLE | FIELD_EXAMPLES |           \
     FIELD_SERIALIZATION_ALIAS | FIELD_DEFAULT_FACTORY |                       \
     FIELD_JSON_SCHEMA_EXTRA)

#define FIELD_CONFIG                                                           \
    (FAIL_ON_EXTRA_INIT | FIELD_INIT | FIELD_REPR | FIELD_HASH | FIELD_DICT |  \
     FIELD_JSON | FIELD_STRICT | FIELD_KW_ONLY | FIELD_FROZEN |                \
     FIELD_COMPARISON | FIELD_CLASS_LOOKUP | FIELD_FROZEN_TYPE |               \
...
#define IS_FAIL_ON_EXTRA_INIT(f) (f & FAIL_ON_EXTRA_INIT)
...
#define _CTX_CONFIG_GET_FLAGS(config)                                          \
    IF_FIELD_CHECK(config,                                                     \
                   (FIELD_ALLOW_INF_NAN | FIELD_NUM_TO_STR | FIELD_STRICT))
...
extern Field *DefaultField, *DefaultFieldPrivate, *VoidField, *DefaultConfig,
  *DefaultConfigValid;
