...
PROJECT_URL = "https://github.com/jackdewinter/cookieslicer"
PROJECT_URLS = {
    "Change Log": "https://github.com/jackdewinter/cookieslicer/blob/main/changelog.md",
}

PACKAGE_NAME = "cookieslicer"
