    ...
    def _add_content_to_slide(
        ...
        if image_infos:
            for image in image_infos:
                ...
                # Convert image dimensions from pixels to EMU.
                img_width = self.to_emu(img_width)
                img_height = self.to_emu(img_height)

                # Attempt to insert into a placeholder if a valid placeholder_id is provided.
                ...
                if img_id in placeholder_map:
                    ...
                    try:
                        ...
                        # If insertion via placeholder fails, fall back to manual insertion.
                        ...
                        # Allow explicit width/height overrides.
                    ...
                    # No placeholder provided or found; add the image manually.
                    left = image.get("left", Inches(1))
                    top = image.get("top", Inches(2))
