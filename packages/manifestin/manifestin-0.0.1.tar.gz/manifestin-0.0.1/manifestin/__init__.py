...
Purpose:
This package is designed to simulate a non-existent Python package in order to study 
how often such packages are unintentionally downloaded from PyPI by users or automated tools.

Research Details:
- Institution: School of Computer Science and Technology, Tongji Un·iversity
...
def warning():
    raise RuntimeError(
        "This package is part of an academic experiment and is not intended for real use. "
        "Please uninstall it if installed by mistake."
    )
