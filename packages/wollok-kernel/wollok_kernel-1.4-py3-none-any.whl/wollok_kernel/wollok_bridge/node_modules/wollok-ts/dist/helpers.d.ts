...
import { NativeFunction, RuntimeObject, RuntimeValue } from 'wollok-ts/dist/interpreter/runtimeModel';
import { Class, CodeContainer, Entity, Environment, Expression, Field, Import, LiteralValue, Method, Module, Name, New, Node, Package, Parameter, ParameterizedType, Problem, Program, Reference, Referenciable, Send, Sentence, Singleton, Super, Test, Variable } from 'wollok-ts/dist/model';
...
export declare const targetSupertypes: (node: Class | Singleton) => (({
    ...
    readonly mixins: List<import("wollok-ts/dist/model").Mixin>;
    ...
    defaultValueFor(field: Field): {
        ...
        readonly id: string;
        readonly scope: import("wollok-ts/dist/model").Scope;
        readonly sourceMap?: import("wollok-ts/dist/model").SourceMap | undefined;
        readonly problems?: List<import("wollok-ts/dist/model").BaseProblem> | undefined;
        readonly metadata: List<import("wollok-ts/dist/model").Annotation>;
        ...
        readonly type: import("wollok-ts/dist/typeSystem/wollokTypes").WollokType;
        readonly parentPackage: Package | undefined;
        toString(verbose?: boolean): string;
        is<Q extends import("wollok-ts/dist/extensions").TypeDefinition<Node>>(kindOrCategory: Q): this is InstanceType<import("wollok-ts/dist/extensions").ConstructorFor<Q>>;
    ...
    readonly parentPackage: Package | undefined;
    toString(verbose?: boolean): string;
    is<Q_1 extends import("wollok-ts/dist/extensions").TypeDefinition<Node>>(kindOrCategory: Q_1): this is InstanceType<import("wollok-ts/dist/extensions").ConstructorFor<Q_1>>;
    copy(delta?: Record<string, unknown>): any;
    readonly children: List<Node>;
    siblings(): List<Node>;
    readonly descendants: List<Node>;
