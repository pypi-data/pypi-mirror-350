...
// CP51932 is the Code Page 51932 encoding.
var CP51932 encoding.Encoding = &cp51932

var cp51932 = internal.Encoding{
	Encoding: &internal.SimpleEncoding{
		Decoder: cp51932Decoder{},
		Encoder: cp51932Encoder{},
	},
	Name: "CP51932",
	MIB:  identifier.CP51932,
}

type cp51932Decoder struct{ transform.NopResetter }

func (cp51932Decoder) Transform(dst, src []byte, atEOF bool) (nDst, nSrc int, err error) {
	r, size := rune(0), 0
loop:
...
type cp51932Encoder struct{ transform.NopResetter }

func (cp51932Encoder) Transform(dst, src []byte, atEOF bool) (nDst, nSrc int, err error) {
	r, size := rune(0), 0
	for ; nSrc < len(src); nSrc += size {
		r = rune(src[nSrc])
