...
class NREPL:
    ...
    def _need_to_run_as_exec(self, __lazuli__last__code):
        ...
        # return isinstance(__lazuli__last__code, ast.FunctionDef) or \
        #     isinstance(__lazuli__last__code, ast.AsyncFunctionDef) or \
        #     isinstance(__lazuli__last__code, ast.ClassDef) or \
        #     isinstance(__lazuli__last__code, ast.Assign) or \
        #     isinstance(__lazuli__last__code, ast.AugAssign) or \
        #     isinstance(__lazuli__last__code, ast.For)
    ...
    def handle_eval(self, client_socket, request):
        ...
        try:
            ...
            if self._need_to_run_as_import(__lazuli__last__code, request):
                ...
                exec(compile(__lazuli__placeholder__row + ast.unparse(__lazuli__last__code), __lazuli__file__name, 'exec'), __lazuli__globals__vars, __lazuli__locals__vars)
                result = None #__lazuli__locals__vars[__lazuli__last__code.name]
            else:
