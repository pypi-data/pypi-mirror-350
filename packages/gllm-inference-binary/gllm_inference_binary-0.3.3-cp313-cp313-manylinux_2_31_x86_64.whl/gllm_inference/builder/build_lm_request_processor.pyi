...
from gllm_inference.builder.model_id import ModelId as ModelId
...
def build_lm_request_processor(model_id: str | ModelId, credentials: str, config: dict[str, Any] | None = None, system_template: str = '', user_template: str = '', output_parser: BaseOutputParser | None = None) -> LMRequestProcessor:
