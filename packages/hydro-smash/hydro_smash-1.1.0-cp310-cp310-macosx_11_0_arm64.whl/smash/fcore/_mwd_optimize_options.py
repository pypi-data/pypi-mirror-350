...
Defined at ../smash/fcore/derived_type/mwd_optimize_options.f90 lines 41-108
...
class Optimize_OptionsDT(f90wrap.runtime.FortranDerivedType):
    ...
    Defined at ../smash/fcore/derived_type/mwd_optimize_options.f90 lines 45-66
    ...
    def __init__(self, setup, handle=None):
        ...
        Defined at ../smash/fcore/derived_type/mwd_optimize_options.f90 lines 69-102
    ...
    def serr_sigma_parameters(self):
        ...
        Defined at ../smash/fcore/derived_type/mwd_optimize_options.f90 line 61
    ...
    def l_serr_sigma_parameters(self):
        ...
        Defined at ../smash/fcore/derived_type/mwd_optimize_options.f90 line 62
    ...
    def u_serr_sigma_parameters(self):
        ...
        Defined at ../smash/fcore/derived_type/mwd_optimize_options.f90 line 63
    ...
    def maxiter(self):
        ...
        Defined at ../smash/fcore/derived_type/mwd_optimize_options.f90 line 64
        
        """
        return _libfcore.f90wrap_optimize_optionsdt__get__maxiter(self._handle)
    
    @maxiter.setter
    def maxiter(self, maxiter):
        _libfcore.f90wrap_optimize_optionsdt__set__maxiter(self._handle, maxiter)
    
    @property
    def factr(self):
        """
        Element factr ftype=real(sp) pytype=float
        
        
        Defined at ../smash/fcore/derived_type/mwd_optimize_options.f90 line 65
        
        """
        return _libfcore.f90wrap_optimize_optionsdt__get__factr(self._handle)
    
    @factr.setter
    def factr(self, factr):
        _libfcore.f90wrap_optimize_optionsdt__set__factr(self._handle, factr)
    
    @property
    def pgtol(self):
        """
        Element pgtol ftype=real(sp) pytype=float
        
        
        Defined at ../smash/fcore/derived_type/mwd_optimize_options.f90 line 66
        
        """
        return _libfcore.f90wrap_optimize_optionsdt__get__pgtol(self._handle)
    
    @pgtol.setter
    def pgtol(self, pgtol):
        _libfcore.f90wrap_optimize_optionsdt__set__pgtol(self._handle, pgtol)
...
def optimize_optionsdt_copy(self):
    ...
    Defined at ../smash/fcore/derived_type/mwd_optimize_options.f90 lines 104-108
