    ...
    def process_data(self, vcf_lines, input_format='json'):
        ...
        if (self.genome_version == 'hg38') or (self.genome_version == 'GRCh38'):
            if input_format == 'vcf':
                ...
                keys = ['POS_hg19']
                annotations = vcfcli.tools.parse_vcf.extract_annotations_json(vcf_lines, conf_reader.variant_data_key, keys)
        ...
        while True:
            ...
            try:
                ...
                variants = ','.join(vcfcli.tools.filter_alternate_alleles(qids_refgen))
            except:
