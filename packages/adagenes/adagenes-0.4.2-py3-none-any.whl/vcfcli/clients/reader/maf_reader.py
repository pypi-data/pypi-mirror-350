...
class MAFReader(reader.Reader):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.maf_columns = vcfcli.tools.maf_mgt.maf_columns
        self.maf_indices = vcfcli.tools.maf_mgt.maf_column_indices
    ...
    def read_file(self, infile, genome_version=None, columns=None, max_length=None, sep="\t", mapping=None):
        ...
        json_obj = vcfcli.BiomarkerFrame(src_format='maf')
        json_obj.columns = []
        ...
        for line in infile:
            ...
            if len(fields) > 1:
                ...
                json_obj.data[qid][vcfcli.conf.read_config.variant_data_key]["CHROM"] = \
                    json_obj.data[qid]["info_features"]["Chromosome"].replace("chr","")
                json_obj.data[qid][vcfcli.conf.read_config.variant_data_key]["POS"] = \
                ...
                json_obj.data[qid][vcfcli.conf.read_config.variant_data_key]["ALT"] = \
