...
def liftover(bframe: vcfcli.BiomarkerFrame,
             lo_hg19=None, lo_hg38=None, target_genome=None) -> vcfcli.BiomarkerFrame:
    """
...
class LiftoverClient:
    ...
    def process_data(self, bframe, lo_hg19=None, lo_hg38=None, lo_t2t=None, target_genome=None) \
        ...
        isbframe = False
        if isinstance(bframe, vcfcli.BiomarkerFrame):
        ...
        vcfcli.tools.check_liftover_files(conf_reader.__LIFTOVER_DATA_DIR__)
        ...
        for var in variant_data.keys():
            ...
            if "CHROM" not in variant_data[var]["variant_data"]:
                chr, ref_seq, pos, ref, alt = vcfcli.tools.parse_genomic_data.parse_genome_position(var)
            ...
            try:
                ...
                chrom, ref_seq, pos, ref, alt = vcfcli.tools.parse_genomic_data.parse_genome_position(var)
