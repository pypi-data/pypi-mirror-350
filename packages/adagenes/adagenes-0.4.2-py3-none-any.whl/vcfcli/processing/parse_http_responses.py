...
def parse_module_response(q, variant_data, url_pattern, genome_version, srv_prefix):
    """
    ...
    """
    try:
        json_body = vcfcli.tools.module_requests.get_connection(q, url_pattern, genome_version)
