...
class GetSystemMrfFeatureResult:
    ...
    def enable_migration_to_mrf(self) -> builtins.str:
        """
...
def get_system_mrf_feature(feature_profile_id: Optional[builtins.str] = None,
...
def get_system_mrf_feature_output(feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
