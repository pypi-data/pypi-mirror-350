...
class GetHubAndSpokeTopologyPolicyDefinitionResult:
    ...
    def vpn_list_id(self) -> builtins.str:
        """
        VPN list ID
        """
    ...
    def vpn_list_version(self) -> builtins.int:
        """
        VPN list version
        """
...
def get_hub_and_spoke_topology_policy_definition(id: Optional[builtins.str] = None,
...
def get_hub_and_spoke_topology_policy_definition_output(id: Optional[pulumi.Input[builtins.str]] = None,
