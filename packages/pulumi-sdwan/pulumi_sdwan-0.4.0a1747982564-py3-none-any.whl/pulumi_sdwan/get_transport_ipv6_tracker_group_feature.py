...
def get_transport_ipv6_tracker_group_feature(feature_profile_id: Optional[builtins.str] = None,
...
def get_transport_ipv6_tracker_group_feature_output(feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
