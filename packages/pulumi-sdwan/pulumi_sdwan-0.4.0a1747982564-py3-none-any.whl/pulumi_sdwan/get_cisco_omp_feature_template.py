...
class GetCiscoOmpFeatureTemplateResult:
    ...
    def send_path_limit(self) -> builtins.int:
        """
    ...
    def send_path_limit_variable(self) -> builtins.str:
        """
        Variable name
        """
...
def get_cisco_omp_feature_template(id: Optional[builtins.str] = None,
...
def get_cisco_omp_feature_template_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
