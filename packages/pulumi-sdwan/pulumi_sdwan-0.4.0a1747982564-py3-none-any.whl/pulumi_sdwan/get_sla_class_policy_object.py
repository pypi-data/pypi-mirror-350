...
class GetSlaClassPolicyObjectResult:
    ...
    def app_probe_class_id(self) -> builtins.str:
        """
    ...
    def app_probe_class_version(self) -> builtins.int:
        """
    ...
    def fallback_best_tunnel_criteria(self) -> builtins.str:
        return pulumi.get(self, "fallback_best_tunnel_criteria")

    @property
    @pulumi.getter(name="fallbackBestTunnelJitter")
    def fallback_best_tunnel_jitter(self) -> builtins.int:
        """
    ...
    def fallback_best_tunnel_latency(self) -> builtins.int:
        """
    ...
    def fallback_best_tunnel_loss(self) -> builtins.int:
        """
...
def get_sla_class_policy_object(id: Optional[builtins.str] = None,
...
def get_sla_class_policy_object_output(id: Optional[pulumi.Input[builtins.str]] = None,
