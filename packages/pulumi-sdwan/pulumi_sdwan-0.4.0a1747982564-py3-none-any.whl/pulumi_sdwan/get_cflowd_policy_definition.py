...
class GetCflowdPolicyDefinitionResult:
    ...
    def active_flow_timeout(self) -> builtins.int:
        """
    ...
    def flow_refresh(self) -> builtins.int:
        """
    ...
    def inactive_flow_timeout(self) -> builtins.int:
        """
    ...
    def remarked_dscp(self) -> builtins.bool:
        """
    ...
    def sampling_interval(self) -> builtins.int:
        """
...
def get_cflowd_policy_definition(id: Optional[builtins.str] = None,
...
def get_cflowd_policy_definition_output(id: Optional[pulumi.Input[builtins.str]] = None,
