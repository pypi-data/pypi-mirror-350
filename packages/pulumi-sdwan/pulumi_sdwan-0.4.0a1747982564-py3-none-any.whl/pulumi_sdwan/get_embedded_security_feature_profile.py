...
def get_embedded_security_feature_profile(id: Optional[builtins.str] = None,
...
def get_embedded_security_feature_profile_output(id: Optional[pulumi.Input[builtins.str]] = None,
