...
def get_rewrite_rule_policy_definition(id: Optional[builtins.str] = None,
...
def get_rewrite_rule_policy_definition_output(id: Optional[pulumi.Input[builtins.str]] = None,
