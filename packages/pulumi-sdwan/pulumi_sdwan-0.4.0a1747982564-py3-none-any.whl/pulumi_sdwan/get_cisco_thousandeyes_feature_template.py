...
def get_cisco_thousandeyes_feature_template(id: Optional[builtins.str] = None,
...
def get_cisco_thousandeyes_feature_template_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
