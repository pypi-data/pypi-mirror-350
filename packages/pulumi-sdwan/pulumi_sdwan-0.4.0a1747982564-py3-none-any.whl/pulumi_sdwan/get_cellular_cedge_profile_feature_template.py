...
def get_cellular_cedge_profile_feature_template(id: Optional[builtins.str] = None,
...
def get_cellular_cedge_profile_feature_template_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
