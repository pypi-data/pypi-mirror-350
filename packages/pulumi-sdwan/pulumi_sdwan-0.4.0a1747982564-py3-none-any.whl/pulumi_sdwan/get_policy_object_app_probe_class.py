...
def get_policy_object_app_probe_class(feature_profile_id: Optional[builtins.str] = None,
...
def get_policy_object_app_probe_class_output(feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
