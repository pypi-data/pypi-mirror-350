...
def get_policer_policy_object(id: Optional[builtins.str] = None,
...
def get_policer_policy_object_output(id: Optional[pulumi.Input[builtins.str]] = None,
