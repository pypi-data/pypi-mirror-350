...
class GetFeatureDeviceTemplateResult:
    ...
    def device_role(self) -> builtins.str:
        """
        The device role
        """
    ...
    def security_policy_version(self) -> builtins.int:
        """
...
def get_feature_device_template(id: Optional[builtins.str] = None,
...
def get_feature_device_template_output(id: Optional[pulumi.Input[builtins.str]] = None,
