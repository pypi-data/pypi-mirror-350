...
def get_transport_routing_ospf_feature(feature_profile_id: Optional[builtins.str] = None,
...
def get_transport_routing_ospf_feature_output(feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
