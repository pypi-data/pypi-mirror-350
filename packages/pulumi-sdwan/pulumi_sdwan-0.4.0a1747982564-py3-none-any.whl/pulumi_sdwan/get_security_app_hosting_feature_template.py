...
def get_security_app_hosting_feature_template(id: Optional[builtins.str] = None,
...
def get_security_app_hosting_feature_template_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
