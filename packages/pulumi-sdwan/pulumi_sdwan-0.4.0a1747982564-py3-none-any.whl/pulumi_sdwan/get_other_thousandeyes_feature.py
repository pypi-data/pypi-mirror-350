...
def get_other_thousandeyes_feature(feature_profile_id: Optional[builtins.str] = None,
...
def get_other_thousandeyes_feature_output(feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
