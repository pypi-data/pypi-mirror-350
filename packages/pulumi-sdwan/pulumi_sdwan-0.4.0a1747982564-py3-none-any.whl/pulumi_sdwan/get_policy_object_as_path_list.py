...
class GetPolicyObjectAsPathListResult:
    ...
    def as_path_list_id(self) -> builtins.int:
        """
        As path List Number
        """
...
def get_policy_object_as_path_list(feature_profile_id: Optional[builtins.str] = None,
...
def get_policy_object_as_path_list_output(feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
