...
def get_policy_object_application_list(feature_profile_id: Optional[builtins.str] = None,
...
def get_policy_object_application_list_output(feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
