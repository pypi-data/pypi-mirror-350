...
def get_policy_object_preferred_color_group(feature_profile_id: Optional[builtins.str] = None,
...
def get_policy_object_preferred_color_group_output(feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
