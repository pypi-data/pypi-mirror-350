...
class GetConfigurationGroupResult:
    ...
    def feature_profile_ids(self) -> Sequence[builtins.str]:
        """
    ...
    def feature_versions(self) -> Sequence[builtins.str]:
        """
    ...
    def topology_site_devices(self) -> builtins.int:
        """
...
def get_configuration_group(id: Optional[builtins.str] = None,
...
def get_configuration_group_output(id: Optional[pulumi.Input[builtins.str]] = None,
