...
def get_policy_object_class_map(feature_profile_id: Optional[builtins.str] = None,
...
def get_policy_object_class_map_output(feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
