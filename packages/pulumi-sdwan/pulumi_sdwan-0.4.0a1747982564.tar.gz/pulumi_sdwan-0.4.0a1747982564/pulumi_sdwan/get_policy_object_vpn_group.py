...
def get_policy_object_vpn_group(feature_profile_id: Optional[builtins.str] = None,
...
def get_policy_object_vpn_group_output(feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
