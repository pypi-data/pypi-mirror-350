...
class GetServiceLanVpnInterfaceEthernetFeatureAssociateDhcpServerFeatureResult:
    ...
    def service_dhcp_server_feature_id(self) -> builtins.str:
        """
...
def get_service_lan_vpn_interface_ethernet_feature_associate_dhcp_server_feature(feature_profile_id: Optional[builtins.str] = None,
...
def get_service_lan_vpn_interface_ethernet_feature_associate_dhcp_server_feature_output(feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
