...
class GetTransportT1E1ControllerFeatureResult:
    ...
    def slot_variable(self) -> builtins.str:
        """
        Variable name
        """
...
def get_transport_t1_e1_controller_feature(feature_profile_id: Optional[builtins.str] = None,
...
def get_transport_t1_e1_controller_feature_output(feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
