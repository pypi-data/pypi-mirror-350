...
class GetEigrpFeatureTemplateResult:
    ...
    def route_policy_name(self) -> builtins.str:
        """
    ...
    def route_policy_name_variable(self) -> builtins.str:
        """
        Variable name
        """
...
def get_eigrp_feature_template(id: Optional[builtins.str] = None,
...
def get_eigrp_feature_template_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
