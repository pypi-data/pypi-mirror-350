...
def get_service_switchport_feature(feature_profile_id: Optional[builtins.str] = None,
...
def get_service_switchport_feature_output(feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
