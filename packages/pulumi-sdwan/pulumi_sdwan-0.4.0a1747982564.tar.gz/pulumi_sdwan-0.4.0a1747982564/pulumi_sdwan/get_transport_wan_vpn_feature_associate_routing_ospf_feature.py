...
class GetTransportWanVpnFeatureAssociateRoutingOspfFeatureResult:
    ...
    def transport_routing_ospf_feature_id(self) -> builtins.str:
        """
...
def get_transport_wan_vpn_feature_associate_routing_ospf_feature(feature_profile_id: Optional[builtins.str] = None,
...
def get_transport_wan_vpn_feature_associate_routing_ospf_feature_output(feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
