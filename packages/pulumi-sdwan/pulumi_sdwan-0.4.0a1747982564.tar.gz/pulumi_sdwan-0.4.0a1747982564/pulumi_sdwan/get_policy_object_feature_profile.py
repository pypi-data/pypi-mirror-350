...
def get_policy_object_feature_profile(id: Optional[builtins.str] = None,
...
def get_policy_object_feature_profile_output(id: Optional[pulumi.Input[builtins.str]] = None,
