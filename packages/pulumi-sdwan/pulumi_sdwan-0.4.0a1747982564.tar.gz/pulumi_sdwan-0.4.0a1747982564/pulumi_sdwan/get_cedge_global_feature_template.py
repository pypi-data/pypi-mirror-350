...
class GetCedgeGlobalFeatureTemplateResult:
    ...
    def bootp_variable(self) -> builtins.str:
        """
        Variable name
        """
    ...
    def ssh_version(self) -> builtins.int:
        """
        Set SSH version
        """
    ...
    def vty_logging(self) -> builtins.bool:
        """
    ...
    def vty_logging_variable(self) -> builtins.str:
        """
        Variable name
        """
...
def get_cedge_global_feature_template(id: Optional[builtins.str] = None,
...
def get_cedge_global_feature_template_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
