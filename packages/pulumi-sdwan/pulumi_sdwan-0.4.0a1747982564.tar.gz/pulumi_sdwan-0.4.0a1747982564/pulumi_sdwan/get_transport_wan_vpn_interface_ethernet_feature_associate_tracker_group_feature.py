...
class GetTransportWanVpnInterfaceEthernetFeatureAssociateTrackerGroupFeatureResult:
    ...
    def transport_tracker_group_feature_id(self) -> builtins.str:
        """
...
def get_transport_wan_vpn_interface_ethernet_feature_associate_tracker_group_feature(feature_profile_id: Optional[builtins.str] = None,
...
def get_transport_wan_vpn_interface_ethernet_feature_associate_tracker_group_feature_output(feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
