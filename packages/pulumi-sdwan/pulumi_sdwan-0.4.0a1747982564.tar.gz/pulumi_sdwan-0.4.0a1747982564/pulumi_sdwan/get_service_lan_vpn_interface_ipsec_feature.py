...
def get_service_lan_vpn_interface_ipsec_feature(feature_profile_id: Optional[builtins.str] = None,
...
def get_service_lan_vpn_interface_ipsec_feature_output(feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
