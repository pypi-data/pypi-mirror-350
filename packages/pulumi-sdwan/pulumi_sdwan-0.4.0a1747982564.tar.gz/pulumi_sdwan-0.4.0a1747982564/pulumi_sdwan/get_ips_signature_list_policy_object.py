...
def get_ips_signature_list_policy_object(id: Optional[builtins.str] = None,
...
def get_ips_signature_list_policy_object_output(id: Optional[pulumi.Input[builtins.str]] = None,
