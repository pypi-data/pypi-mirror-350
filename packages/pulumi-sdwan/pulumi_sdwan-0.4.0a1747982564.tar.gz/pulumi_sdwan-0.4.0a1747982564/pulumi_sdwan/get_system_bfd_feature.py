...
class GetSystemBfdFeatureResult:
    ...
    def default_dscp(self) -> builtins.int:
        return pulumi.get(self, "default_dscp")

    @property
    @pulumi.getter(name="defaultDscpVariable")
    def default_dscp_variable(self) -> builtins.str:
        """
        Variable name
        """
    ...
    def poll_interval_variable(self) -> builtins.str:
        """
        Variable name
        """
...
def get_system_bfd_feature(feature_profile_id: Optional[builtins.str] = None,
...
def get_system_bfd_feature_output(feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
