...
def get_cli_config_feature(feature_profile_id: Optional[builtins.str] = None,
...
def get_cli_config_feature_output(feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
