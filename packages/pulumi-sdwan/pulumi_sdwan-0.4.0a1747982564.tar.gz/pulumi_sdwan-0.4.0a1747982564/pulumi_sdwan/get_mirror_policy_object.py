...
class GetMirrorPolicyObjectResult:
    ...
    def remote_destination_ip(self) -> builtins.str:
        """
...
def get_mirror_policy_object(id: Optional[builtins.str] = None,
...
def get_mirror_policy_object_output(id: Optional[pulumi.Input[builtins.str]] = None,
