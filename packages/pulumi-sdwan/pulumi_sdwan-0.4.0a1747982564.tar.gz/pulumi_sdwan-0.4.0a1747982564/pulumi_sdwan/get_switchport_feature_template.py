...
class GetSwitchportFeatureTemplateResult:
    ...
    def age_out_time(self) -> builtins.int:
        """
    ...
    def age_out_time_variable(self) -> builtins.str:
        """
        Variable name
        """
    ...
    def module_type(self) -> builtins.str:
        """
        Module type
        """
    ...
    def sub_slot(self) -> builtins.int:
        """
        Number of Sub-Slots
        """
...
def get_switchport_feature_template(id: Optional[builtins.str] = None,
...
def get_switchport_feature_template_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
