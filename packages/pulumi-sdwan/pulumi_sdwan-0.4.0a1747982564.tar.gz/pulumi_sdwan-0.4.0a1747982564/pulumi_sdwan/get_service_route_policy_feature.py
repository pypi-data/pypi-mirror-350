...
def get_service_route_policy_feature(feature_profile_id: Optional[builtins.str] = None,
...
def get_service_route_policy_feature_output(feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
