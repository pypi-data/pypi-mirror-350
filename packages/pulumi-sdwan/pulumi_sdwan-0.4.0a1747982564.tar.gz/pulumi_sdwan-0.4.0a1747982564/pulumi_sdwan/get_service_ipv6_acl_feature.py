...
def get_service_ipv6_acl_feature(feature_profile_id: Optional[builtins.str] = None,
...
def get_service_ipv6_acl_feature_output(feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
