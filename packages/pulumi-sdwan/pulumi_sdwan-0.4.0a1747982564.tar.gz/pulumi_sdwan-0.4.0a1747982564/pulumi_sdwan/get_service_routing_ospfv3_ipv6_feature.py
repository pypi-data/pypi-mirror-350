...
def get_service_routing_ospfv3_ipv6_feature(feature_profile_id: Optional[builtins.str] = None,
...
def get_service_routing_ospfv3_ipv6_feature_output(feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
