...
class GetServiceLanVpnFeatureAssociateRoutingOspfv3Ipv6FeatureResult:
    ...
    def service_routing_ospfv3_ipv6_feature_id(self) -> builtins.str:
        """
...
def get_service_lan_vpn_feature_associate_routing_ospfv3_ipv6_feature(feature_profile_id: Optional[builtins.str] = None,
...
def get_service_lan_vpn_feature_associate_routing_ospfv3_ipv6_feature_output(feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
