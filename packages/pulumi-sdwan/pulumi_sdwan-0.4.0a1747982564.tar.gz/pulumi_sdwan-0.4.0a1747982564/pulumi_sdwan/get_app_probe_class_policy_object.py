...
class GetAppProbeClassPolicyObjectResult:
    ...
    def forwarding_class(self) -> builtins.str:
        """
...
def get_app_probe_class_policy_object(id: Optional[builtins.str] = None,
...
def get_app_probe_class_policy_object_output(id: Optional[pulumi.Input[builtins.str]] = None,
