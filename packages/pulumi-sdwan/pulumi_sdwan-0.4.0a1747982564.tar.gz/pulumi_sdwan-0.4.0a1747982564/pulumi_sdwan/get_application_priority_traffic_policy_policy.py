...
class GetApplicationPriorityTrafficPolicyPolicyResult:
    ...
    @property
    @pulumi.getter
    def vpns(self) -> Sequence[builtins.str]:
...
def get_application_priority_traffic_policy_policy(feature_profile_id: Optional[builtins.str] = None,
...
def get_application_priority_traffic_policy_policy_output(feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
