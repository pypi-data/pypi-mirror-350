...
def get_ipv4_device_acl_policy_definition(id: Optional[builtins.str] = None,
...
def get_ipv4_device_acl_policy_definition_output(id: Optional[pulumi.Input[builtins.str]] = None,
