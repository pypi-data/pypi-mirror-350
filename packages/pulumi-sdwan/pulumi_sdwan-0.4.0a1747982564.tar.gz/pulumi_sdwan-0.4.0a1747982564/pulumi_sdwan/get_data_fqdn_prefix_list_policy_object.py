...
def get_data_fqdn_prefix_list_policy_object(id: Optional[builtins.str] = None,
...
def get_data_fqdn_prefix_list_policy_object_output(id: Optional[pulumi.Input[builtins.str]] = None,
