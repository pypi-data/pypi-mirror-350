...
def get_policy_object_policer(feature_profile_id: Optional[builtins.str] = None,
...
def get_policy_object_policer_output(feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
