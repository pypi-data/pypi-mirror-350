...
def get_application_aware_routing_policy_definition(id: Optional[builtins.str] = None,
...
def get_application_aware_routing_policy_definition_output(id: Optional[pulumi.Input[builtins.str]] = None,
