...
def get_class_map_policy_object(id: Optional[builtins.str] = None,
...
def get_class_map_policy_object_output(id: Optional[pulumi.Input[builtins.str]] = None,
