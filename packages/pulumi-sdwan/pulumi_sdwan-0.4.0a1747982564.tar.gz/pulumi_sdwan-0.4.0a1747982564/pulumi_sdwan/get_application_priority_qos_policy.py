...
class GetApplicationPriorityQosPolicyResult:
    ...
    def target_interface_variable(self) -> builtins.str:
        """
        Variable name
        """
    ...
    def target_interfaces(self) -> Sequence[builtins.str]:
        """
        interfaces
        """
...
def get_application_priority_qos_policy(feature_profile_id: Optional[builtins.str] = None,
...
def get_application_priority_qos_policy_output(feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
