...
class GetCiscoSecureInternetGatewayFeatureTemplateResult:
    ...
    def tracker_source_ip(self) -> builtins.str:
        """
    ...
    def tracker_source_ip_variable(self) -> builtins.str:
        """
        Variable name
        """
...
def get_cisco_secure_internet_gateway_feature_template(id: Optional[builtins.str] = None,
...
def get_cisco_secure_internet_gateway_feature_template_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
