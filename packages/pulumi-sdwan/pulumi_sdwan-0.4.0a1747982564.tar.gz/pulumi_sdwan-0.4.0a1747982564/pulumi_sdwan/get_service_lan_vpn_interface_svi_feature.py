...
class GetServiceLanVpnInterfaceSviFeatureResult:
    ...
    def enable_dhcpv6_variable(self) -> builtins.str:
        """
        Variable name
        """
    ...
    def ipv4_dhcp_helpers_variable(self) -> builtins.str:
        """
        Variable name
        """
...
def get_service_lan_vpn_interface_svi_feature(feature_profile_id: Optional[builtins.str] = None,
...
def get_service_lan_vpn_interface_svi_feature_output(feature_profile_id: Optional[pulumi.Input[builtins.str]] = None,
