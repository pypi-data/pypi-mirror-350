...
def xmrchart(df, values, x_labels, xchart_title='', mrchart_title='', figsize=(15,6), 
             ...
             linestyle=True, label_fontsize=14, xtick_fontsize=10):
    """
    ...
    axs[0].set_ylabel('Individual Values (X)', fontsize=label_fontsize)
    ...
    axs[1].set_ylabel('Moving Range (mR)', fontsize=label_fontsize)
    ...
    if show_limit_values:
        ...
        limit_labels = ['UPL', 'LPL', 'Mean', 'URL', '$\overline{{R}}$']
...
def mrchart(df, values, x_labels, title='', figsize=(15,3), 
    ...
    ax.set_ylabel('Moving Range (mR)', fontsize=label_fontsize)
    ax.set_title(title, fontsize=14)
