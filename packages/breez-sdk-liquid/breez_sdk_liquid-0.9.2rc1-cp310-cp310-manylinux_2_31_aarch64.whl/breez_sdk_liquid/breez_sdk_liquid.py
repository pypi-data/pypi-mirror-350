...
class Config:
    ...
    def __str__(self):
        return "Config(liquid_explorer={}, bitcoin_explorer={}, working_dir={}, network={}, payment_timeout_sec={}, sync_service_url={}, breez_api_key={}, zero_conf_max_amount_sat={}, use_default_external_input_parsers={}, external_input_parsers={}, onchain_fee_rate_leeway_sat_per_vbyte={}, asset_metadata={}, sideswap_api_key={})".format(self.liquid_explorer, self.bitcoin_explorer, self.working_dir, self.network, self.payment_timeout_sec, self.sync_service_url, self.breez_api_key, self.zero_conf_max_amount_sat, self.use_default_external_input_parsers, self.external_input_parsers, self.onchain_fee_rate_leeway_sat_per_vbyte, self.asset_metadata, self.sideswap_api_key)
...
class PrepareSendRequest:
    ...
    comment: "typing.Optional[str]"
    def __init__(self, *, destination: "str", amount: "typing.Optional[PayAmount]" = _DEFAULT, comment: "typing.Optional[str]" = _DEFAULT):
        self.destination = destination
        if amount is _DEFAULT:
            self.amount = None
        else:
    ...
    def __str__(self):
        return "PrepareSendRequest(destination={}, amount={}, comment={})".format(self.destination, self.amount, self.comment)
...
class PrepareSendResponse:
    ...
    def __init__(self, *, destination: "SendDestination", amount: "typing.Optional[PayAmount]", fees_sat: "typing.Optional[int]", estimated_asset_fees: "typing.Optional[float]"):
        self.destination = destination
        self.amount = amount
        self.fees_sat = fees_sat
    ...
    def __str__(self):
        return "PrepareSendResponse(destination={}, amount={}, fees_sat={}, estimated_asset_fees={})".format(self.destination, self.amount, self.fees_sat, self.estimated_asset_fees)
...
class SendDestination:
    ...
    class BOLT12:
        ...
        def __init__(self,offer: "LnOffer", receiver_amount_sat: "int", bip353_address: "typing.Optional[str]", payer_note: "typing.Optional[str]"):
            self.offer = offer
            self.receiver_amount_sat = receiver_amount_sat
            self.bip353_address = bip353_address
        ...
        def __str__(self):
            return "SendDestination.BOLT12(offer={}, receiver_amount_sat={}, bip353_address={}, payer_note={})".format(self.offer, self.receiver_amount_sat, self.bip353_address, self.payer_note)
