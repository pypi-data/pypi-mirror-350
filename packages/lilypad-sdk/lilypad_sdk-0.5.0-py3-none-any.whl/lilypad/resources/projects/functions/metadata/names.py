...
from .....types.projects.functions.metadata.name_list_response import NameListResponse
from .....types.projects.functions.metadata.name_list_latest_versions_response import NameListLatestVersionsResponse
...
class NamesResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        return self._get(
            f"/projects/{project_uuid}/functions/metadata/names",
    ...
    def list_latest_versions(
        ...
        *,
        ...
        if not project_uuid:
            raise ValueError(f"Expected a non-empty value for `project_uuid` but received {project_uuid!r}")
        return self._get(
            f"/projects/{project_uuid}/functions/metadata/names/versions",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
