...
async function getScaphData() {
    const prometheusUrl = 'http://localhost:9090';
    const metrics = [];
    await getScaphMetrics(prometheusUrl).then(response => metrics.push(...response));
    ...
    for (const metricName of metrics) {
        const metricData = await getMetricData(prometheusUrl, metricName, start, end, step);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "webpack/sharing/consume/default/react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _visx_scale__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @visx/scale */ "webpack/sharing/consume/default/@visx/scale/@visx/scale?c1c6");
...
/* harmony import */ var _visx_shape__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @visx/shape */ "webpack/sharing/consume/default/@visx/shape/@visx/shape?e89a");
...
/* harmony import */ var _visx_group__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @visx/group */ "./node_modules/@visx/group/esm/Group.js");
...
function TimeSeriesLineChart({ rawData }) {
    ...
    const yMax = (_a = (0,d3_array__WEBPACK_IMPORTED_MODULE_9__["default"])(data, y)) !== null && _a !== void 0 ? _a : 0;
    ...
    const TooltipPortal = ({ tooltipData }) => TooltipInPortal({
        ...
        children: (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null,
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("strong", null, tooltipData === null || tooltipData === void 0 ? void 0 : tooltipData.value.toLocaleString())),
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { ref: containerRef, style: { position: 'relative' } },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("svg", { width: width, height: height },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_visx_group__WEBPACK_IMPORTED_MODULE_10__["default"], null,
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_visx_axis__WEBPACK_IMPORTED_MODULE_3__.AxisLeft, { scale: yScale, top: 0, left: margin.left, 
                // label="Value"
                tickFormat: v => v.toLocaleString(), stroke: "#888", tickStroke: "#888", tickLabelProps: () => ({
                    fill: '#333',
                    fontSize: 12,
                    textAnchor: 'end',
                    dx: '-0.25em',
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_visx_axis__WEBPACK_IMPORTED_MODULE_3__.AxisBottom, { scale: xScale, top: height - margin.bottom, left: 0, 
                // label="Time"
                numTicks: 6, tickFormat: date => date instanceof Date
...
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @mui/material */ "webpack/sharing/consume/default/@mui/material/@mui/material");
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_mui_material__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_ScaphChart__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/ScaphChart */ "./lib/components/ScaphChart.js");
/* harmony import */ var _api_getScaphData__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../api/getScaphData */ "./lib/api/getScaphData.js");
...
function GeneralDashboard() {
    ...
    const [dataMap, setDataMap] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(new Map());
    const [selectedMetric, setSelectedMetric] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('');
    const [loading, setLoading] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(true);
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        setLoading(true);
        (0,_api_getScaphData__WEBPACK_IMPORTED_MODULE_2__["default"])().then(results => {
            setDataMap(results);
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.main },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Paper, { key: "grid-element-main", style: { ...styles.grid, flexDirection: 'column', minWidth: 800 } }, loading ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.CircularProgress, null)) : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.FormControl, { variant: "outlined", size: "small", style: { margin: 16, minWidth: 200 } },
                ...
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Select, { labelId: "metric-label", value: selectedMetric, label: "Metric", onChange: e => setSelectedMetric(e.target.value) }, metrics.map(metric => (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.MenuItem, { key: metric, value: metric }, metric))))),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_ScaphChart__WEBPACK_IMPORTED_MODULE_3__["default"], { key: selectedMetric, rawData: dataMap.get(selectedMetric) || [] }))))));
}
...
function WelcomePage({ handleRealTimeClick, handlePredictionClick, handleGrafanaClick }) {
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Grid2, { sx: styles.main },
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Grid2, { sx: styles.buttonGrid },
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Button, { variant: "outlined", onClick: handleGrafanaClick }, "Grafana Dashboard")),
...
//# sourceMappingURL=lib_index_js.409cb95e6c623d9898bf.js.map