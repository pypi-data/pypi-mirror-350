...
function DateTimeRange({ startTime, endTime, onStartTimeChange, onEndTimeChange }) {
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Grid2, { sx: { width: '100%' } },
        ...
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_x_date_pickers_LocalizationProvider__WEBPACK_IMPORTED_MODULE_2__.LocalizationProvider, { dateAdapter: _mui_x_date_pickers_AdapterDayjs__WEBPACK_IMPORTED_MODULE_3__.AdapterDayjs },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_x_date_pickers_DateTimePicker__WEBPACK_IMPORTED_MODULE_4__.DateTimePicker, { slotProps: { textField: { size: 'small' } }, label: "End time", value: endTime, onChange: onEndTimeChange, minDateTime: startTime !== null && startTime !== void 0 ? startTime : undefined }))));
}
...
function GeneralDashboard() {
    const [startDate, setStartDate] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(startDateJs);
    const [endDate, setEndDate] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(endDateJs);
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        setLoading(true);
        (0,_api_getScaphData__WEBPACK_IMPORTED_MODULE_3__["default"])({ startTime: start, endTime: end }).then(results => {
            if (results.size === 0) {
    ...
    const Charts = [];
    for (let i = 0; i < NR_CHARTS; i++) {
        Charts.push(react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_2__.Grid2, { size: { xs: 12, sm: 6 } },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_2__.Paper, { elevation: 3, sx: { p: 2, width: '100%' } },
...
//# sourceMappingURL=lib_index_js-webpack_sharing_consume_default_dayjs_dayjs.47b9f319cbe49d051390.js.map