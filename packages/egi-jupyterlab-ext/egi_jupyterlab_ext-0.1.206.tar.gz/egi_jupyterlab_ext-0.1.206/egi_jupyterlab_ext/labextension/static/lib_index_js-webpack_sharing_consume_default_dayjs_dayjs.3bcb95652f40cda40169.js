"use strict";
(self["webpackChunkegi_jupyterlab_ext"] = self["webpackChunkegi_jupyterlab_ext"] || []).push([["lib_index_js-webpack_sharing_consume_default_dayjs_dayjs"],{
...
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @mui/material */ "webpack/sharing/consume/default/@mui/material/@mui/material");
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_mui_material__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _mui_x_date_pickers_AdapterDayjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @mui/x-date-pickers/AdapterDayjs */ "./node_modules/@mui/x-date-pickers/esm/AdapterDayjs/AdapterDayjs.js");
/* harmony import */ var _mui_x_date_pickers_LocalizationProvider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @mui/x-date-pickers/LocalizationProvider */ "./node_modules/@mui/x-date-pickers/esm/LocalizationProvider/LocalizationProvider.js");
/* harmony import */ var _mui_x_date_pickers_DateTimePicker__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @mui/x-date-pickers/DateTimePicker */ "./node_modules/@mui/x-date-pickers/esm/DateTimePicker/DateTimePicker.js");
...
function DateTimeRange({ startTime, endTime, onStartTimeChange, onEndTimeChange }) {
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Grid2, { sx: { width: '100%' } },
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_x_date_pickers_LocalizationProvider__WEBPACK_IMPORTED_MODULE_2__.LocalizationProvider, { dateAdapter: _mui_x_date_pickers_AdapterDayjs__WEBPACK_IMPORTED_MODULE_3__.AdapterDayjs },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_x_date_pickers_DateTimePicker__WEBPACK_IMPORTED_MODULE_4__.DateTimePicker, { slotProps: { textField: { size: 'small' } }, label: "Start time", value: startTime, onChange: onStartTimeChange })),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_x_date_pickers_LocalizationProvider__WEBPACK_IMPORTED_MODULE_2__.LocalizationProvider, { dateAdapter: _mui_x_date_pickers_AdapterDayjs__WEBPACK_IMPORTED_MODULE_3__.AdapterDayjs },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_x_date_pickers_DateTimePicker__WEBPACK_IMPORTED_MODULE_4__.DateTimePicker, { slotProps: { textField: { size: 'small' } }, label: "End time", value: endTime, onChange: onEndTimeChange }))));
}
...
function GeneralDashboard() {
    ...
    const [selectedMetric, setSelectedMetric] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(new Array(NR_CHARTS).fill(''));
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
        setLoading(true);
        (0,_api_getScaphData__WEBPACK_IMPORTED_MODULE_2__["default"])({ startTime: start, endTime: end }).then(results => {
            if (results.size === 0) {
    ...
    const Charts = [];
    for (let i = 0; i < NR_CHARTS; i++) {
        Charts.push(react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Grid2, { size: { xs: 12, sm: 6 } },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Paper, { elevation: 3, sx: { p: 2, width: '100%' } },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_MetricSelector__WEBPACK_IMPORTED_MODULE_3__["default"], { selectedMetric: selectedMetric[i], setSelectedMetric: newMetric => handleUpdateSelectedMetric(i, newMetric), metrics: metrics }),
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.main },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Paper, { key: "grid-element-main", style: {
                ...
                minWidth: '100%',
                minHeight: '300px'
            }, elevation: 3 }, loading ? (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.CircularProgress, null)) : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Grid2, { sx: { width: '100%', height: '100%' } },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Grid2, null,
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_DateTimeRange__WEBPACK_IMPORTED_MODULE_5__["default"], null)),
...
//# sourceMappingURL=lib_index_js-webpack_sharing_consume_default_dayjs_dayjs.3bcb95652f40cda40169.js.map