...
function DateTimeRange({ startTime, endTime, onStartTimeChange, onEndTimeChange }) {
    const [tempStartTime, setTempStartTime] = react__WEBPACK_IMPORTED_MODULE_0__.useState(startTime);
    const [tempEndTime, setTempEndTime] = react__WEBPACK_IMPORTED_MODULE_0__.useState(endTime);
    function handleAccept() {
        ...
        if (tempEndTime && tempStartTime && tempEndTime.isBefore(tempStartTime)) {
            setTempEndTime(tempStartTime);
        }
        if (tempStartTime && tempStartTime.isAfter(dayjs__WEBPACK_IMPORTED_MODULE_2___default()(new Date()))) {
            setTempStartTime(dayjs__WEBPACK_IMPORTED_MODULE_2___default()(new Date()));
        }
        if (tempEndTime && tempEndTime.isAfter(dayjs__WEBPACK_IMPORTED_MODULE_2___default()(new Date()))) {
            setTempEndTime(dayjs__WEBPACK_IMPORTED_MODULE_2___default()(new Date()));
        }
        if (tempStartTime && tempEndTime && tempStartTime.isAfter(tempEndTime)) {
            setTempEndTime(tempStartTime);
        }
        if (tempStartTime && tempStartTime.isAfter(dayjs__WEBPACK_IMPORTED_MODULE_2___default()(new Date()))) {
            setTempStartTime(dayjs__WEBPACK_IMPORTED_MODULE_2___default()(new Date()));
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Grid2, { sx: { width: '100%' } },
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_x_date_pickers_LocalizationProvider__WEBPACK_IMPORTED_MODULE_3__.LocalizationProvider, { dateAdapter: _mui_x_date_pickers_AdapterDayjs__WEBPACK_IMPORTED_MODULE_4__.AdapterDayjs },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_x_date_pickers_DateTimePicker__WEBPACK_IMPORTED_MODULE_5__.DateTimePicker, { slotProps: { textField: { size: 'small' } }, label: "Start time", value: startTime, onChange: setTempStartTime, onAccept: handleAccept })),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_x_date_pickers_LocalizationProvider__WEBPACK_IMPORTED_MODULE_3__.LocalizationProvider, { dateAdapter: _mui_x_date_pickers_AdapterDayjs__WEBPACK_IMPORTED_MODULE_4__.AdapterDayjs },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_x_date_pickers_DateTimePicker__WEBPACK_IMPORTED_MODULE_5__.DateTimePicker, { slotProps: { textField: { size: 'small' } }, label: "End time", value: endTime, onChange: setTempEndTime, onAccept: handleAccept, minDateTime: startTime !== null && startTime !== void 0 ? startTime : undefined, maxDateTime: dayjs__WEBPACK_IMPORTED_MODULE_2___default()(new Date()) }))));
}
...
//# sourceMappingURL=lib_index_js-webpack_sharing_consume_default_dayjs_dayjs.68c829466ff272c1f11f.js.map