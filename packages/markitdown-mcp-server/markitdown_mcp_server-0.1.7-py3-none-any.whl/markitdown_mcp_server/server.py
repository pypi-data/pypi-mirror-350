...
from mcp.server import models as mcp_models
...
@app.update_build_config()
async def update_build_config(
    build_config: mcp_models.BuildConfig,
) -> mcp_models.UpdateBuildConfigResult:
    """
    Respond to the client’s updateBuildConfig lifecycle call.
    We don’t persist anything here—just return an empty success result.
    """
    return mcp_models.UpdateBuildConfigResult()
