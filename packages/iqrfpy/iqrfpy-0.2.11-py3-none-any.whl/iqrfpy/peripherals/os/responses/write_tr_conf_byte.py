...
class WriteTrConfByteResponse(IResponseGetterMixin):
    """OS Write TR Configuration Byte response class."""
    ...
    def __init__(self, nadr: int, hwpid: int = dpa_constants.HWPID_MAX, rcode: int = 0, dpa_value: int = 0,
        ...
        """Write TR Configuration Byte response constructor.
        ...
        super().__init__(
            ...
            pcmd=OSResponseCommands.WRITE_CFG_BYTE,
