...
class IndicateResponse(IResponseGetterMixin):
    """OS Indicate response class."""
    ...
    def __init__(self, nadr: int, hwpid: int = dpa_constants.HWPID_MAX, rcode: int = 0, dpa_value: int = 0,
        ...
        super().__init__(
            ...
            pcmd=OSResponseCommands.INDICATE,
            m_type=OSMessages.INDICATE,
            hwpid=hwpid,
            rcode=rcode,
            dpa_value=dpa_value,
            msgid=msgid,
