"""OS Factory Settings response message."""
...
class FactorySettingsResponse(IResponseGetterMixin):
    """OS Factory Settings response class."""
    ...
    def __init__(self, nadr: int, hwpid: int = dpa_constants.HWPID_MAX, rcode: int = 0, dpa_value: int = 0,
        ...
        """Factory Settings response constructor.
        ...
        super().__init__(
            ...
            pcmd=OSResponseCommands.FACTORY_SETTINGS,
