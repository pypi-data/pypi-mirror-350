...
class SelectiveBatchResponse(IResponseGetterMixin):
    """OS Selective Batch response class."""
    ...
    def __init__(self, nadr: int, hwpid: int = dpa_constants.HWPID_MAX, rcode: int = 0, dpa_value: int = 0,
        ...
        """Selective Batch response constructor.
        ...
        super().__init__(
            ...
            pcmd=OSResponseCommands.SELECTIVE_BATCH,
