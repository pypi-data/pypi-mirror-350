"""OS Factory Settings request message."""
...
__all__ = ['FactorySettingsRequest']


class FactorySettingsRequest(IRequest):
    """OS Factory Settings request class."""
    ...
    def __init__(self, nadr: int, hwpid: int = dpa_constants.HWPID_MAX, dpa_rsp_time: Optional[float] = None,
        ...
        """Factory Settings request constructor.
        ...
        super().__init__(
            ...
            pcmd=OSRequestCommands.FACTORY_SETTINGS,
            m_type=OSMessages.FACTORY_SETTINGS,
            hwpid=hwpid,
