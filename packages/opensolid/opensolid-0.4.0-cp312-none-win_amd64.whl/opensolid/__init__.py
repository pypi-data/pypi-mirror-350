...
class Basis3d:
    ...
    world: Basis3d = None  # type: ignore[assignment]
    ...
    *eventually* that bolt will probably be placed in some other coordinate system
    ...
    def front_plane_basis(self) -> PlanarBasis3d:
        ...
        inputs = self._basis3d_ptr
        output = c_void_p()
        _lib.opensolid_Basis3d_frontPlaneBasis(
            ctypes.byref(inputs), ctypes.byref(output)
        )
        return PlanarBasis3d._new(output)

    def back_plane_basis(self) -> PlanarBasis3d:
        ...
        inputs = self._basis3d_ptr
        output = c_void_p()
        _lib.opensolid_Basis3d_backPlaneBasis(
            ctypes.byref(inputs), ctypes.byref(output)
        )
        return PlanarBasis3d._new(output)

    def right_plane_basis(self) -> PlanarBasis3d:
        ...
        inputs = self._basis3d_ptr
        output = c_void_p()
        _lib.opensolid_Basis3d_rightPlaneBasis(
            ctypes.byref(inputs), ctypes.byref(output)
        )
        return PlanarBasis3d._new(output)

    def left_plane_basis(self) -> PlanarBasis3d:
        ...
        inputs = self._basis3d_ptr
        output = c_void_p()
        _lib.opensolid_Basis3d_leftPlaneBasis(
            ctypes.byref(inputs), ctypes.byref(output)
        )
        return PlanarBasis3d._new(output)

    def bottom_plane_basis(self) -> PlanarBasis3d:
        ...
        inputs = self._basis3d_ptr
        output = c_void_p()
        _lib.opensolid_Basis3d_bottomPlaneBasis(
            ctypes.byref(inputs), ctypes.byref(output)
        )
        return PlanarBasis3d._new(output)

    def top_plane_basis(self) -> PlanarBasis3d:
        ...
        inputs = self._basis3d_ptr
        output = c_void_p()
        _lib.opensolid_Basis3d_topPlaneBasis(ctypes.byref(inputs), ctypes.byref(output))
        return PlanarBasis3d._new(output)

    def forward_basis(self) -> Basis3d:
        ...
        inputs = self._basis3d_ptr
        output = c_void_p()
        _lib.opensolid_Basis3d_forwardBasis(ctypes.byref(inputs), ctypes.byref(output))
        return Basis3d._new(output)

    def backward_basis(self) -> Basis3d:
        ...
        inputs = self._basis3d_ptr
        output = c_void_p()
        _lib.opensolid_Basis3d_backwardBasis(ctypes.byref(inputs), ctypes.byref(output))
        return Basis3d._new(output)

    def rightward_basis(self) -> Basis3d:
        ...
        inputs = self._basis3d_ptr
        output = c_void_p()
        _lib.opensolid_Basis3d_rightwardBasis(
            ctypes.byref(inputs), ctypes.byref(output)
        )
        return Basis3d._new(output)

    def leftward_basis(self) -> Basis3d:
        ...
        inputs = self._basis3d_ptr
        output = c_void_p()
        _lib.opensolid_Basis3d_leftwardBasis(ctypes.byref(inputs), ctypes.byref(output))
        return Basis3d._new(output)

    def upward_basis(self) -> Basis3d:
        ...
        inputs = self._basis3d_ptr
        output = c_void_p()
        _lib.opensolid_Basis3d_upwardBasis(ctypes.byref(inputs), ctypes.byref(output))
        return Basis3d._new(output)

    def downward_basis(self) -> Basis3d:
        ...
        inputs = self._basis3d_ptr
        output = c_void_p()
        _lib.opensolid_Basis3d_downwardBasis(ctypes.byref(inputs), ctypes.byref(output))
        return Basis3d._new(output)
...
def _basis3d_world() -> Basis3d:
    output = c_void_p()
    _lib.opensolid_Basis3d_world(c_void_p(), ctypes.byref(output))
    return Basis3d._new(output)


Basis3d.world = _basis3d_world()
...
"""
    ...
    def forward_frame(self) -> Frame3d:
        ...
        inputs = self._frame3d_ptr
        output = c_void_p()
        _lib.opensolid_Frame3d_forwardFrame(ctypes.byref(inputs), ctypes.byref(output))
        return Frame3d._new(output)
...
class World3d:
    """Helpers for working with global directions, axes etc."""
...
"""
    ...
    basis: Basis3d = None  # type: ignore[assignment]
...
def _world3d_basis() -> Basis3d:
    output = c_void_p()
    _lib.opensolid_World3d_basis(c_void_p(), ctypes.byref(output))
    return Basis3d._new(output)


World3d.basis = _world3d_basis()
