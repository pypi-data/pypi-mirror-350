...
from core.openobd import OpenOBDSession, OpenOBD
from core.stream_exceptions import OpenOBDStreamStoppedException
from core.stream_handler import StreamHandler, StreamState
...
class FunctionContextHandler:
    ...
    def run_function(self, function_id: str) -> FunctionContext:
        """
        ...
        """
        try:
            OpenOBD().run_function(function_id, self.get_session_info())
