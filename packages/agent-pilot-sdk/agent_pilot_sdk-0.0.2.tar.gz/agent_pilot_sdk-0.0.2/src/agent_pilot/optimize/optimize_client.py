...
def optimize_service_get_progress(
    optimize_job_id: str, api_key: Optional[str] = None, api_url: Optional[str] = None
) -> OptimizeServiceProgressResult:
    """
...
def optimize_service_get_report(
    task_id: str, base_version: str, ref_version: str, api_key: Optional[str] = None, api_url: Optional[str] = None
