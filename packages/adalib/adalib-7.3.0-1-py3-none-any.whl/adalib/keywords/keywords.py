...
def create_keywords(
    ...
    :param new_keywords: name (or names) of the keywords to be added
    :type new_keywords: str or list
    ...
    for new_keyword in new_keywords:
        ...
        new_keyword_ids.append({"keyword": new_keyword, "keyword_id": response["id"]})
