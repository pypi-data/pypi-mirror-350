...
class Order(Object):
    ...
    def __str__(self) -> str:
        s = f"{intMaxString(self.orderId)},{intMaxString(self.clientId)},{intMaxString(self.permId)}:"

        s += f" {self.orderType} {self.action} {decimalMaxString(self.totalQuantity)}@{floatMaxString(self.lmtPrice)}"
