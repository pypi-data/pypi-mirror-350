...
class HandleInfo(Object):
    def __init__(self, wrap=None, proc=None) -> None:
        ...
        if wrap is None and proc is None:
            msg = "both wrap and proc can't be None"
            raise ValueError(msg)

    def __str__(self) -> str:
        return (
            f"wrap:{self.wrapperMeth} meth:{self.processMeth} prms:{self.wrapperParams}"
        )
...
class Decoder(Object):
    ...
    def processTickOptionComputationMsg(self, fields) -> None:
        ...
        if version >= 6 or tickTypeInt in (
    ...
    def readLastTradeDate(
        self, fields, contract: ContractDetails, isBond: bool
    ) -> None:
