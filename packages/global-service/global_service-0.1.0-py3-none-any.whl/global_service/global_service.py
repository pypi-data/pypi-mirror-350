...
class GlobalServiceConfig:
    def __init__(self):
        self.GLOBAL_LOG_URL = os.getenv("GLOBAL_LOG_URL", "http://192.168.101.88:8000/web_logs")
        self.PROJECT_TYPE = "API"
        self.FAILED_LOG_FILE = "app_failed_logs.json"
        self.FLUSH_INTERVAL_SEC = 15
        self.APP_CODE = "L-PYW101"
        self.ORACLE_DSN = cx_Oracle.makedsn(
            os.getenv("ORACLE_DB_HOST", "192.168.100.233"),
            int(os.getenv("ORACLE_DB_PORT", 1521)),
            service_name=os.getenv("ORACLE_DB_SERVICE", "ORCLPDB")
        )
        self.ORACLE_USER = os.getenv("ORACLE_DB_USER", "LHS_PY_DEV")
        self.ORACLE_PASS = os.getenv("ORACLE_DB_PASS", "LHS_PY_DEV")
...
def build_global_log_payload(request, user_menu=None, logout_time=None, logout_method=None):
