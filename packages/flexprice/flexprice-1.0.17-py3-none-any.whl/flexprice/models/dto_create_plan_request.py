...
class DtoCreatePlanRequest(BaseModel):
    ...
    entitlements: Optional[List[DtoCreatePlanEntitlementRequest]] = None
    lookup_key: Optional[StrictStr] = None
    name: StrictStr
    prices: Optional[List[DtoCreatePlanPriceRequest]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entitlements": [DtoCreatePlanEntitlementRequest.from_dict(_item) for _item in obj["entitlements"]] if obj.get("entitlements") is not None else None,
            "lookup_key": obj.get("lookup_key"),
            "name": obj.get("name"),
            "prices": [DtoCreatePlanPriceRequest.from_dict(_item) for _item in obj["prices"]] if obj.get("prices") is not None else None
        })
        return _obj
