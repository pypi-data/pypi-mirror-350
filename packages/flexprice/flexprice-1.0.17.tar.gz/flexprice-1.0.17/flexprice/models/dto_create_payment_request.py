...
class DtoCreatePaymentRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["amount", "currency", "destination_id", "destination_type", "idempotency_key", "metadata", "payment_method_id", "payment_method_type", "process_payment"]
