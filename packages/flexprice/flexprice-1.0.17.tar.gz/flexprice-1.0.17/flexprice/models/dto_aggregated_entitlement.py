...
class DtoAggregatedEntitlement(BaseModel):
    ...
    static_values: Optional[List[StrictStr]] = Field(default=None, description="For static/SLA features")
    usage_limit: Optional[StrictInt] = None
    usage_reset_period: Optional[TypesBillingPeriod] = None
    __properties: ClassVar[List[str]] = ["is_enabled", "is_soft_limit", "static_values", "usage_limit", "usage_reset_period"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "static_values": obj.get("static_values"),
