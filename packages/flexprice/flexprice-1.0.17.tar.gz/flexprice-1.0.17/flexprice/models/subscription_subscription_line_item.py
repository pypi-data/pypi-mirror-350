...
class SubscriptionSubscriptionLineItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["billing_period", "created_at", "created_by", "currency", "customer_id", "display_name", "end_date", "environment_id", "id", "invoice_cadence", "metadata", "meter_display_name", "meter_id", "plan_display_name", "plan_id", "price_id", "price_type", "quantity", "start_date", "status", "subscription_id", "tenant_id", "trial_period", "updated_at", "updated_by"]
