...
class DtoUpdatePlanRequest(BaseModel):
    ...
    entitlements: Optional[List[DtoUpdatePlanEntitlementRequest]] = None
    lookup_key: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    prices: Optional[List[DtoUpdatePlanPriceRequest]] = None
    __properties: ClassVar[List[str]] = ["description", "entitlements", "lookup_key", "name", "prices"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entitlements": [DtoUpdatePlanEntitlementRequest.from_dict(_item) for _item in obj["entitlements"]] if obj.get("entitlements") is not None else None,
            "lookup_key": obj.get("lookup_key"),
            "name": obj.get("name"),
            "prices": [DtoUpdatePlanPriceRequest.from_dict(_item) for _item in obj["prices"]] if obj.get("prices") is not None else None
        })
        return _obj
