...
class DtoCreatePlanPriceRequest(BaseModel):
    """
    ...
    type: TypesPriceType
    __properties: ClassVar[List[str]] = ["amount", "billing_cadence", "billing_model", "billing_period", "billing_period_count", "currency", "description", "filter_values", "invoice_cadence", "lookup_key", "metadata", "meter_id", "plan_id", "tier_mode", "tiers", "transform_quantity", "trial_period", "type"]
