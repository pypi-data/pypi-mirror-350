...
function getJupyterHubUsername(): { username: string, fromJupyterHub: boolean } {
  ...
  if (fullUrlMatch && fullUrlMatch[1]) {
    ...
    console.log('Found JupyterHub username from full URL:', decodedUsername);
    return { username: decodedUsername, fromJupyterHub: true };
  }
  ...
  if (altMatch && altMatch[1]) {
    ...
    console.log('Found JupyterHub username from alternative pattern:', decodedUsername);
    return { username: decodedUsername, fromJupyterHub: true };
  }
  ...
  if (altFullMatch && altFullMatch[1]) {
    ...
    console.log('Found JupyterHub username from alternative pattern (URL):', decodedUsername);
    return { username: decodedUsername, fromJupyterHub: true };
  }
  ...
  if (emailMatch && emailMatch[1]) {
    ...
    console.log('Found JupyterHub username with email pattern:', decodedUsername);
    return { username: decodedUsername, fromJupyterHub: true };
  }
  ...
  async init() {
    ...
    if (isJupyterHub) {
      ...
      if (usernameInfo.fromJupyterHub) {
        ...
        console.log(`Using username from JupyterHub URL: ${this.settings.username}`);
      }
      ...
      if (usernameInfo.fromJupyterHub || !this.settings.username) {
        ...
        console.log(`Updated username: ${this.settings.username}`);
      }
    } else {
