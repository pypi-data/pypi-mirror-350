...
export class JupyterHubSettingsPage extends BaseSettingsPage {
  ...
  protected createContainer(): HTMLDivElement {
    ...
    modeIndicator.innerHTML = 'Running in JupyterHub Mode <span style="font-size: 0.8em; opacity: 0.8;">v0.1.58</span>';
...
export class PluginSettingsPage extends BaseSettingsPage {
  ...
  protected createContainer(): HTMLDivElement {
    ...
    const modeIndicator = document.createElement('div');
    modeIndicator.className = 'escobar-mode-indicator';
    modeIndicator.innerHTML = 'Running in Plugin Mode <span style="font-size: 0.8em; opacity: 0.8;">v0.1.58</span>';
