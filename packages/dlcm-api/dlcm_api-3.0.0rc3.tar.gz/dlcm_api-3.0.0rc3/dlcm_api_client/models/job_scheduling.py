...
class JobScheduling(BaseModel):
    ...
    month_day: Optional[StrictInt] = Field(default=None, alias="monthDay")
    week_day: Optional[StrictInt] = Field(default=None, alias="weekDay")
    __properties: ClassVar[List[str]] = ["hour", "month", "monthDay", "weekDay"]
