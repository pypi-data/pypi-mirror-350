...
class DepositDataFile(BaseModel):
    """
    DepositDataFile
    """ # noqa: E501
    ...
    info_package: Optional[Deposit] = Field(default=None, alias="infoPackage")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DepositDataFile from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DepositDataFile from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "infoPackage": Deposit.from_dict(obj["infoPackage"]) if obj.get("infoPackage") is not None else None,
