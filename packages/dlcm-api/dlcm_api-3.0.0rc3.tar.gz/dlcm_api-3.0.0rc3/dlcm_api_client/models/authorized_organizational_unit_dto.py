...
class AuthorizedOrganizationalUnitDto(BaseModel):
    """
    ...
    role_from_organizational_unit: Optional[Role] = Field(default=None, alias="roleFromOrganizationalUnit")
    role_from_institution: Optional[Role] = Field(default=None, alias="roleFromInstitution")
    ...
    __properties: ClassVar[List[str]] = ["creation", "lastUpdate", "resId", "closingDate", "defaultLicense", "defaultPreservationPolicy", "defaultSubmissionPolicy", "description", "institutions", "isEmpty", "keywords", "name", "openingDate", "url", "logo", "role", "roleFromOrganizationalUnit", "roleFromInstitution", "open", "_links"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AuthorizedOrganizationalUnitDto from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of role_from_organizational_unit
        if self.role_from_organizational_unit:
            _dict['roleFromOrganizationalUnit'] = self.role_from_organizational_unit.to_dict()
        # override the default output from pydantic by calling `to_dict()` of role_from_institution
        if self.role_from_institution:
            _dict['roleFromInstitution'] = self.role_from_institution.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AuthorizedOrganizationalUnitDto from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "roleFromOrganizationalUnit": Role.from_dict(obj["roleFromOrganizationalUnit"]) if obj.get("roleFromOrganizationalUnit") is not None else None,
            "roleFromInstitution": Role.from_dict(obj["roleFromInstitution"]) if obj.get("roleFromInstitution") is not None else None,
            "open": obj.get("open"),
            "_links": dict(
