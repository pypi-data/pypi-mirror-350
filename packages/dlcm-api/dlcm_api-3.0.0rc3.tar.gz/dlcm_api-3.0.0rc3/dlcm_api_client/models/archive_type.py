...
class ArchiveType(BaseModel):
    """
    Archive type based on DataCite notion.
    """ # noqa: E501
    ...
    master_type: Optional[ArchiveType] = Field(default=None, alias="masterType")
    type_name: Optional[StrictStr] = Field(default=None, description="The name of the archive type.", alias="typeName")
    master_archive_type: Optional[StrictBool] = Field(default=None, description="If the archive type is a master type.", alias="masterArchiveType")
    links: Optional[Dict[str, Link]] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["creation", "lastUpdate", "resId", "masterType", "typeName", "masterArchiveType", "_links"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ArchiveType from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of master_type
        if self.master_type:
            _dict['masterType'] = self.master_type.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ArchiveType from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "resId": obj.get("resId"),
            "masterType": ArchiveType.from_dict(obj["masterType"]) if obj.get("masterType") is not None else None,
            "typeName": obj.get("typeName"),
            "masterArchiveType": obj.get("masterArchiveType"),
            "_links": dict(
...
ArchiveType.model_rebuild(raise_errors=False)
