...
class OrgUnit(BaseModel):
    ...
    description: Optional[StrictStr] = Field(default=None, description="The description of the organizational unit.")
    last_update: Optional[ChangeInfo] = Field(default=None, alias="lastUpdate")
    name: Optional[StrictStr] = Field(default=None, description="The name of the organizational unit.")
    ...
    __properties: ClassVar[List[str]] = ["resId", "creation", "description", "lastUpdate", "name", "url", "openingDate", "closingDate", "logo", "_links"]
