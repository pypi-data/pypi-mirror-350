...
class DownloadToken(BaseModel):
    ...
    user_id: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=50)]] = Field(default=None, description="The user identifier of the download token.", alias="userId")
    resource_id: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=50)]] = Field(default=None, description="The resource identifier of the download token.", alias="resourceId")
    resource_type: Optional[StrictStr] = Field(default=None, description="The resource type of the download token.", alias="resourceType")
    token: Optional[StrictStr] = Field(default=None, description="The token of the download token.")
    links: Optional[Dict[str, Link]] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["creation", "lastUpdate", "resId", "userId", "resourceId", "resourceType", "token", "_links"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DownloadToken from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DownloadToken from a dict"""
        if obj is None:
            return None
