...
class SubmissionAgreementUser(BaseModel):
    """
    ...
    approbation_time: Optional[datetime] = Field(default=None, alias="approbationTime")
    links: Optional[Dict[str, Link]] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["creation", "lastUpdate", "submissionAgreement", "user", "approbationTime", "_links"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubmissionAgreementUser from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubmissionAgreementUser from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "approbationTime": obj.get("approbationTime"),
            "_links": dict(
