...
class RatingType(BaseModel):
    """
    The rating types is the type of grade for a dataset: Quality or Usefulness.
    """ # noqa: E501
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of the rating type.")
    links: Optional[Dict[str, Link]] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["creation", "lastUpdate", "resId", "name", "_links"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RatingType from a dict"""
        if obj is None:
            return None
