...
class SubmissionInfoPackage(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["creation", "lastUpdate", "resId", "dispositionApproval", "retention", "mainStorage", "aipId", "depositId", "info", "organizationalUnit", "submissionPolicy", "submissionPolicyId", "publicationDate", "ready", "organizationalUnitId", "dataFileNumber", "collectionSize", "packageStatus", "smartRetention", "_links"]
