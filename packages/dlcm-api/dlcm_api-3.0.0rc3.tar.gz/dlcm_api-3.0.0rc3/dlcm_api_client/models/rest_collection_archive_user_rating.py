...
class RestCollectionArchiveUserRating(BaseModel):
    """
    ...
    data: Optional[List[ArchiveUserRating]] = Field(default=None, alias="_data")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RestCollectionArchiveUserRating from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RestCollectionArchiveUserRating from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "_data": [ArchiveUserRating.from_dict(_item) for _item in obj["_data"]] if obj.get("_data") is not None else None,
