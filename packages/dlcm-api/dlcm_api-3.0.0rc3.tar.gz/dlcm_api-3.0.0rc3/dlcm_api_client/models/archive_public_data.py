...
class ArchivePublicData(BaseModel):
    """
    Archive public data are data files which stored in the archive but with a public access: - ARCHIVE_THUMBNAIL => Dataset Thumbnail - ARCHIVE_README    => Dataset README - ARCHIVE_DUA       => Dataset Data Use Agreement 
    """ # noqa: E501
    ...
    aip_id: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=50)]] = Field(default=None, description="The archive identifier of the archive public data.", alias="aipId")
    data_file_type: Optional[StrictStr] = Field(default=None, description="The data file type of the archive public data.", alias="dataFileType")
    data_file: Optional[ArchivePublicDataFile] = Field(default=None, alias="dataFile")
    links: Optional[Dict[str, Link]] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["creation", "lastUpdate", "resId", "aipId", "dataFileType", "dataFile", "_links"]
    ...
    def data_file_type_validate_enum(cls, value):
        ...
        if value not in set(['ARCHIVE_THUMBNAIL', 'ARCHIVE_README', 'ARCHIVE_DUA']):
            raise ValueError("must be one of enum values ('ARCHIVE_THUMBNAIL', 'ARCHIVE_README', 'ARCHIVE_DUA')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ArchivePublicData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ArchivePublicData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "resId": obj.get("resId"),
            "aipId": obj.get("aipId"),
            "dataFileType": obj.get("dataFileType"),
            "dataFile": ArchivePublicDataFile.from_dict(obj["dataFile"]) if obj.get("dataFile") is not None else None,
            "_links": dict(
