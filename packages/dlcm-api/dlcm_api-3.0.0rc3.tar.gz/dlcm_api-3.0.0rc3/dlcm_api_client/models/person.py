...
class Person(BaseModel):
    """
    A person is associated to a user on the platform. It contains information such as the personâs ORCID, institution and organizational units it belongs to.
    """ # noqa: E501
