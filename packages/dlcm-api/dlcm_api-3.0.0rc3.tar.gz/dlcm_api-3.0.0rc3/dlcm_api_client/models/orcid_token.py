...
class OrcidToken(BaseModel):
    ...
    access_token: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=4096)]] = Field(default=None, alias="accessToken")
    refresh_token: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=4096)]] = Field(default=None, alias="refreshToken")
    ...
    __properties: ClassVar[List[str]] = ["creation", "lastUpdate", "resId", "accessToken", "refreshToken", "scope", "name", "orcid", "expiresIn", "_links"]
