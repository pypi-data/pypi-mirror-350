...
class OrgUnitPersonRoleDTO(BaseModel):
    """
    ...
    join_resource: Optional[OrganizationalUnitPersonRole] = Field(default=None, alias="joinResource")
    links: Optional[Dict[str, Link]] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["creation", "lastUpdate", "resId", "name", "level", "joinResource", "_links"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrgUnitPersonRoleDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrgUnitPersonRoleDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "level": obj.get("level"),
            "joinResource": OrganizationalUnitPersonRole.from_dict(obj["joinResource"]) if obj.get("joinResource") is not None else None,
            "_links": dict(
