...
class DepositContributor(BaseModel):
    """
    DepositContributor
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["creation", "lastUpdate", "position", "compositeKey", "_links"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DepositContributor from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DepositContributor from a dict"""
        if obj is None:
            return None
