...
class OrganizationalUnitDisseminationPolicy(BaseModel):
    """
    ...
    dissemination_policy: Optional[DisseminationPolicy] = Field(default=None, alias="disseminationPolicy")
    ...
    composite_key: Optional[StrictStr] = Field(default=None, alias="compositeKey")
    links: Optional[Dict[str, Link]] = Field(default=None, alias="_links")
    __properties: ClassVar[List[str]] = ["creation", "lastUpdate", "organizationalUnit", "disseminationPolicy", "parameters", "compositeKey", "_links"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrganizationalUnitDisseminationPolicy from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of dissemination_policy
        if self.dissemination_policy:
            _dict['disseminationPolicy'] = self.dissemination_policy.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrganizationalUnitDisseminationPolicy from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "disseminationPolicy": DisseminationPolicy.from_dict(obj["disseminationPolicy"]) if obj.get("disseminationPolicy") is not None else None,
