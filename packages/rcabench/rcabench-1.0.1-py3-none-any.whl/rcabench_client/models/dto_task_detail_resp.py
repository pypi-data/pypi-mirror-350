...
class DtoTaskDetailResp(BaseModel):
    """
    DtoTaskDetailResp
    """ # noqa: E501
    logs: Optional[List[StrictStr]] = None
    task: Optional[DtoTaskItem] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["logs", "task"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "logs": obj.get("logs"),
            "task": DtoTaskItem.from_dict(obj["task"]) if obj.get("task") is not None else None
        })
