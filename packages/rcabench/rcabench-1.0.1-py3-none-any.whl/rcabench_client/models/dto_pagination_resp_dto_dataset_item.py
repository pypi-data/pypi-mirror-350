...
class DtoPaginationRespDtoDatasetItem(BaseModel):
    """
    DtoPaginationRespDtoDatasetItem
    """ # noqa: E501
    items: Optional[List[DtoDatasetItem]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DtoDatasetItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": obj.get("total"),
