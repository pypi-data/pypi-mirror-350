...
class DtoDatasetDeleteResp(BaseModel):
    """
    DtoDatasetDeleteResp
    """ # noqa: E501
    failed_names: Optional[List[StrictStr]] = None
    success_count: Optional[StrictInt] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["failed_names", "success_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "failed_names": obj.get("failed_names"),
