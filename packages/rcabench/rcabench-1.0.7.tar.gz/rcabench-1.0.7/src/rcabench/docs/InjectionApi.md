...
> DtoGenericResponseDtoPaginationRespDtoFaultInjectionNoIssuesResp api_v1_injections_analysis_no_issues_get(page_num=page_num, page_size=page_size)
...
with rcabench.openapi.ApiClient(configuration) as api_client:
    ...
    try:
        # 查询没有问题的故障注入记录
        api_response = api_instance.api_v1_injections_analysis_no_issues_get(page_num=page_num, page_size=page_size)
...
[**DtoGenericResponseDtoPaginationRespDtoFaultInjectionNoIssuesResp**](DtoGenericResponseDtoPaginationRespDtoFaultInjectionNoIssuesResp.md)
...
> DtoGenericResponseDtoPaginationRespDtoFaultInjectionWithIssuesResp api_v1_injections_analysis_with_issues_get(page_num=page_num, page_size=page_size)
...
with rcabench.openapi.ApiClient(configuration) as api_client:
    ...
    try:
        # 查询有问题的故障注入记录
        api_response = api_instance.api_v1_injections_analysis_with_issues_get(page_num=page_num, page_size=page_size)
...
[**DtoGenericResponseDtoPaginationRespDtoFaultInjectionWithIssuesResp**](DtoGenericResponseDtoPaginationRespDtoFaultInjectionWithIssuesResp.md)
