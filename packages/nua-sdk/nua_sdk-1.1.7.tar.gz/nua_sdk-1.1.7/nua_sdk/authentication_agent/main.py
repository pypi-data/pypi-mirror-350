...
class AuthenticationAgent:
    ...
    def authenticate(self):
        ...
        print("Auth agent started")
        for chunk in response:
            if hasattr(chunk, "data") and chunk.data != None:
                print(chunk.data)
                if hasattr(chunk.data, "session_details") and chunk.data.get("session_details") != None:
                    session_details = chunk.data.get("session_details")
            else:
                continue
            
        print("Auth agent finished")
