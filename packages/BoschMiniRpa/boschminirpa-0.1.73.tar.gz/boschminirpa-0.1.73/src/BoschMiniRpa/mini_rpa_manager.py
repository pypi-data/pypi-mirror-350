...
class MiniRpaManager(MiniRpaFunction):
    ...
    def start_bot(self):
        ...
        if self.process_data:
            ...
            from_server_name = self.process_dict.get('from_server_name', self.server_name)
            from_share_name = self.process_dict.get('from_share_name', self.share_name)
            ...
            update_server_name = self.process_dict.get('update_server_name', self.server_name)
            update_share_name = self.process_dict.get('update_server_name', self.share_name)
            ...
            if function_name == 'keep':
                ...
                to_folder_path = update_folder_path if update_folder_path else self.report_save_path
                self.copy_file_cross_public_folders(from_server_name, from_share_name, from_folder_path, from_file_name, update_server_name, update_share_name, to_folder_path,
                                                    update_file_name)
