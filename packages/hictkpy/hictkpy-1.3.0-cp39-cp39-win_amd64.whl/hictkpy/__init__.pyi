...
class Pixel:
    ...
    @overload
    def __init__(self, arg: "hictk::ThinPixel<unsigned __int64>", /) -> None:
        """Private constructor."""

    @overload
    def __init__(self, arg: "hictk::Pixel<unsigned __int64>", /) -> None:
        """Private constructor."""
    ...
    @overload
    def __init__(self, arg: "hictk::ThinPixel<__int64>", /) -> None:
        """Private constructor."""

    @overload
    def __init__(self, arg: "hictk::Pixel<__int64>", /) -> None:
        """Private constructor."""
    ...
    @overload
    def __init__(self, arg: "hictk::ThinPixel<long double>", /) -> None:
        """Private constructor."""

    @overload
    def __init__(self, arg: "hictk::Pixel<long double>", /) -> None:
        """Private constructor."""
...
class PixelSelector:
    ...
    @overload
    def __init__(self, arg0: "std::shared_ptr<hictk::cooler::PixelSelector const >", arg1: type, arg2: bool, arg3: int, /) -> None:
        """
        Private constructor. PixelSelector objects are supposed to be created by calling the fetch() method on hictkpy.File objects.
        """

    @overload
    def __init__(self, arg0: "std::shared_ptr<hictk::hic::PixelSelector const >", arg1: type, arg2: bool, arg3: int, /) -> None: ...

    @overload
    def __init__(self, arg0: "std::shared_ptr<hictk::hic::PixelSelectorAll const >", arg1: type, arg2: bool, arg3: int, /) -> None: ...

    def __repr__(self) -> str: ...

    def coord1(self) -> Optional[tuple[str, int, int]]:
        """
        Get query coordinates for the first dimension. Returns None when query spans the entire genome.
        """

    def coord2(self) -> Optional[tuple[str, int, int]]:
        """
...
class File:
    ...
    def fetch(self, range1: Optional[str] = None, range2: Optional[str] = None, normalization: Optional[str] = None, count_type: Union[type, str] = 'int32', join: bool = False, query_type: str = 'UCSC', diagonal_band_width: Optional[int] = None) -> PixelSelector:
