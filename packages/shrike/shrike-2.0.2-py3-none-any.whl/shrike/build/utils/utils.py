...
class TelemetryLogger:
    ...
    def __init__(
        ...
        self.instrumentation_key = (
            "3b7f42bf-028a-4251-9965-b4387e9d6617"
...
def get_component_name(spec, source_path):
    """
    Get component name from spec (dict) or source path. If spec doesn't have name, use the name of base directory.
    """
    # default name is the name of flow directory for promptflow component
    component_name = spec.get("name", Path(source_path).parent.name)
