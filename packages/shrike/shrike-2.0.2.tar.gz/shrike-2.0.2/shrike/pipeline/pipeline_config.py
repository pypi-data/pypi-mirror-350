...
class pipeline_cli_config:  # pylint: disable=invalid-name
    ...
    - `skip_update_dc` (bool): set to True to skip propagating the detonation chamber configuration to the graph (default to False)
    - `skip_pipeline_instance` (bool): set to True to skip creating a pipeline instance (default to False)
    ...
    skip_pipeline_instance: bool = False
