...
class BaseAdmin(admin.ModelAdmin):
    ...
    def get_fields(self, request, obj=None):
        ...
        custom_fields = self.model._meta.get_fields()
        custom_fields_result = []
        for custom_field in custom_fields:
            if isinstance(custom_field, (models.ManyToOneRel, models.ManyToManyRel)):
                continue
            if custom_field.name != 'id':
                custom_fields_result.append(custom_field.name)
    ...
    def formfield_for_dbfield(self, db_field, request, **kwargs):
        ...
        if isinstance(db_field, (models.ForeignKey, models.ManyToManyField)):
            ...
            if formfield and db_field.name not in self.raw_id_fields:
                ...
                wrapper_kwargs = {'can_add_related': False, 'can_change_related': False, 'can_delete_related': False, 'can_view_related': False}
