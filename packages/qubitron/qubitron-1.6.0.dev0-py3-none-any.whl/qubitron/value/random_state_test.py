...
def test_parse_random_state() -> None:
    ...
    prngs = [
        np.random,
        qubitron.value.parse_random_state(np.random),
        qubitron.value.parse_random_state(None),
    ]
    ...
    prngs1 = [
        ...
        qubitron.value.parse_random_state(np.random.RandomState(seed)),
        qubitron.value.parse_random_state(seed),
    ]
