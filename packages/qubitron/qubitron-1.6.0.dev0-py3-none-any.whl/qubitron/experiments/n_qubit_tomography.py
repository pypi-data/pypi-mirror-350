...
from qubitron import circuits, ops, protocols, study
from qubitron.experiments.qubit_characterizations import TomographyResult
...
class StateTomographyExperiment:
    ...
    def __init__(
        self, qubits: Sequence[qubitron.Qid], prerotations: Sequence[tuple[float, float]] | None = None
    ):
        ...
        Args:
            ...
            prerotations: Tuples of (phase_exponent, exponent) parameters for
                ...
                rotation applied will be `qubitron.PhasedXPowGate` with the
    ...
    def _make_state_tomography_matrix(self, qubits: Sequence[qubitron.Qid]) -> np.ndarray:
...
def state_tomography(
    ...
    """This performs n qubit tomography on a qubitron circuit
    ...
    Args:
        ...
        prerotations: Tuples of (phase_exponent, exponent) parameters for gates
            ...
            applied will be `qubitron.PhasedXPowGate` with the specified values
...
def get_state_tomography_data(
    ...
    qubits: Sequence[qubitron.Qid],
    circuit: qubitron.Circuit,
    rot_circuit: qubitron.Circuit,
    rot_sweep: qubitron.Sweep,
    repetitions: int = 1000,
) -> np.ndarray:
