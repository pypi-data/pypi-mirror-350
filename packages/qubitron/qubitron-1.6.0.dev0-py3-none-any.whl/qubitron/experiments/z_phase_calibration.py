...
from qubitron.experiments import xeb_fitting
from qubitron.experiments.two_qubit_xeb import parallel_xeb_workflow
...
def z_phase_calibration_workflow(
    ...
    two_qubit_gate: qubitron.Gate = ops.CZ,
...
def calibrate_z_phases(
    ...
    pairs: Sequence[tuple[qubitron.GridQubit, qubitron.GridQubit]] | None = None,
    tags: Sequence[Any] = (),
) -> dict[tuple[qubitron.Qid, qubitron.Qid], qubitron.PhasedFSimGate]:
    """Perform z-phase calibration for excitation-preserving gates.
...
def plot_z_phase_calibration_result(
    ...
    pairs: Sequence[tuple[qubitron.Qid, qubitron.Qid]] | None = None,
    *,
...
class CalibrationTransformer:
    ...
    def __init__(
        self,
        target: qubitron.Gate,
        calibration_map: dict[tuple[qubitron.Qid, qubitron.Qid], qubitron.PhasedFSimGate],
    ):
    ...
    def __call__(
        ...
        *,
        ...
        """
        new_moments: list[list[qubitron.Operation] | qubitron.Moment] = []
