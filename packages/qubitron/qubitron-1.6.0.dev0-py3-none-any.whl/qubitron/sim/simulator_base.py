...
"""Batteries-included class for Qubitron's built-in simulators."""
...
from qubitron import devices, ops, protocols, study, value
from qubitron.sim.simulation_product_state import SimulationProductState
...
class SimulatorBase(
    ...
    def __init__(
        ...
        *,
        ...
        noise: qubitron.NOISE_MODEL_LIKE = None,
    ...
    @property
    def noise(self) -> qubitron.NoiseModel:
        return self._noise
    ...
    def _core_iterator(
        ...
        measured: dict[tuple[qubitron.Qid, ...], bool] = collections.defaultdict(bool)
    ...
    def _run(
        ...
        """See definition in `qubitron.SimulatesSamples`."""
        ...
        records: dict[qubitron.MeasurementKey, list[Sequence[Sequence[int]]]] = {}
    ...
    def simulate_sweep_iter(
        ...
        def sweep_prefixable(op: qubitron.Operation):
    ...
    def _create_simulation_state(
        self, initial_state: Any, qubits: Sequence[qubitron.Qid]
        ...
        if self._split_untangled_states:
            args_map: dict[qubitron.Qid | None, TSimulationState] = {}
...
class SimulationTrialResultBase(
    ...
    def get_state_containing_qubit(self, qubit: qubitron.Qid) -> TSimulationState:
