...
from qubitron import ops, qis, sim
from qubitron.sim.simulation_state import SimulationState, TSimulationState
from qubitron.value import big_endian_int_to_bits
...
class ClassicalStateSimulator(
    ...
    def __init__(
        self, *, noise: qubitron.NOISE_MODEL_LIKE = None, split_untangled_states: bool = False
    ):
    ...
    def _create_simulator_trial_result(
        ...
        final_simulator_state: qubitron.SimulationStateBase[ClassicalBasisSimState],
    ) -> ClassicalStateTrialResult[ClassicalBasisSimState]:
    ...
    def _create_step_result(
        self, sim_state: qubitron.SimulationStateBase[ClassicalBasisSimState]
    ) -> ClassicalStateStepResult[ClassicalBasisSimState]:
