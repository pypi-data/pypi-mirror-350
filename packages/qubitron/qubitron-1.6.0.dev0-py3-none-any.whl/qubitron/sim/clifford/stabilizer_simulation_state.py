...
from qubitron import linalg, ops, protocols
from qubitron.ops import common_gates, global_phase_op, matrix_gates, swap_gates
from qubitron.ops.clifford_gate import SingleQubitCliffordGate
from qubitron.protocols import has_unitary, num_qubits, unitary
...
TStabilizerState = TypeVar('TStabilizerState', bound='qubitron.StabilizerState')
...
class StabilizerSimulationState(
    ...
    def _strat_apply_gate(self, val: Any, qubits: Sequence[qubitron.Qid]) -> bool:
    ...
    def _strat_apply_mixture(self, val: Any, qubits: Sequence[qubitron.Qid]) -> bool:
    ...
    def _strat_act_from_single_qubit_decompose(self, val: Any, qubits: Sequence[qubitron.Qid]) -> bool:
        if num_qubits(val) == 1:
    ...
    def _strat_decompose(self, val: Any, qubits: Sequence[qubitron.Qid]) -> bool:
        gate = val.gate if isinstance(val, ops.Operation) else val
