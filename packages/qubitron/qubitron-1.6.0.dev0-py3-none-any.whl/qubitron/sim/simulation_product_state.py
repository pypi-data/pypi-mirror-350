...
class SimulationProductState(
    ...
    def __init__(
        self,
        sim_states: dict[qubitron.Qid | None, TSimulationState],
    ...
    @property
    def sim_states(self) -> Mapping[qubitron.Qid | None, TSimulationState]:
    ...
    def copy(self, deep_copy_buffers: bool = True) -> qubitron.SimulationProductState[TSimulationState]:
    ...
    def __getitem__(self, item: qubitron.Qid | None) -> TSimulationState:
