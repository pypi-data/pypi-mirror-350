...
def document(value: Any, doc_string: str = ''):
    ...
    `qubitron._doc.RECORDED_CONST_DOCS`.
    ...
    try:
        ...
        # API docs. See https://github.com/amyssnippet/Qubitron/issues/3276 for
        # more info.

        # to list them, uncomment these lines and run `import qubitron`:
        # print(f"WARNING: {e}")
