...
from qubitron.neutral_atoms import neutral_atom_devices

if TYPE_CHECKING:
    import qubitron


def is_native_neutral_atom_op(operation: qubitron.Operation) -> bool:
...
def is_native_neutral_atom_gate(gate: qubitron.Gate) -> bool:
