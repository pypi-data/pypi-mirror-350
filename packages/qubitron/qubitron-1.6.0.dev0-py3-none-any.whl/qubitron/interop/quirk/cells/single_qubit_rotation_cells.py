...
from qubitron.interop.quirk.cells.parse import parse_formula
...
def _gate(identifier: str, gate: qubitron.Gate) -> CellMaker:
    return CellMaker(
...
def _formula_gate(
    identifier: str, default_formula: str, gate_func: Callable[[qubitron.TParamVal], qubitron.Gate]
) -> CellMaker:
    return CellMaker(
