...
from qubitron.interop.quirk.cells.cell import Cell
...
class CompositeCell(Cell):
    ...
    def with_input(self, letter: str, register: Sequence[qubitron.Qid] | int) -> CompositeCell:
        return self._transform_cells(lambda cell: cell.with_input(letter, register))

    def controlled_by(self, qubit: qubitron.Qid) -> CompositeCell:
        return self._transform_cells(lambda cell: cell.controlled_by(qubit))

    def circuit(self) -> qubitron.Circuit:
