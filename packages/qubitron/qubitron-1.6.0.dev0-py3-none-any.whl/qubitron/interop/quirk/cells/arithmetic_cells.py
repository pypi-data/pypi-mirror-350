...
from qubitron.interop.quirk.cells.cell import Cell, CELL_SIZES, CellMaker
...
class ArithmeticCell(Cell):
    def __init__(
        self,
        identifier: str,
        target: Sequence[qubitron.Qid],
        inputs: Sequence[None | Sequence[qubitron.Qid] | int],
    ):
        self.identifier = identifier
    ...
    def __repr__(self) -> str:
        return (
            f'qubitron.interop.quirk.cells.arithmetic_cells.ArithmeticCell('
            f'\n    {self.identifier!r},'
            f'\n    {self.target!r},'
            f'\n    {self.inputs!r})'
        )
    ...
    def with_input(self, letter: str, register: Sequence[qubitron.Qid] | int) -> ArithmeticCell:
        new_inputs = [
    ...
    def operations(self) -> qubitron.OP_TREE:
        ...
        inputs = cast(Sequence[Sequence['qubitron.Qid'] | int], self.inputs)
