...
import qubitron
from qubitron import linalg, ops, value
...
class InputRotationCell(Cell):
    ...
    def __init__(
        self,
        identifier: str,
        register: Sequence[qubitron.Qid] | None,
        base_operation: qubitron.Operation,
        exponent_sign: int,
    ):
    ...
    def __repr__(self) -> str:
        return (
            f'qubitron.interop.quirk.cells.input_rotation_cells.InputRotationCell('
            f'\n    {self.identifier!r},'
            f'\n    {self.register!r},'
...
class QuirkInputRotationOperation(ops.Operation):
    ...
    def __init__(
        self,
        identifier: str,
        register: Iterable[qubitron.Qid],
        base_operation: qubitron.Operation,
        exponent_sign: int,
    ):
    ...
    def _circuit_diagram_info_(self, args: qubitron.CircuitDiagramInfoArgs):
        sub_result = qubitron.circuit_diagram_info(self.base_operation)
    ...
    def _apply_unitary_(self, args: qubitron.ApplyUnitaryArgs):
        ...
        for i in range(control_max):
            assert isinstance(self.base_operation, qubitron.GateOperation)
    ...
    def __repr__(self) -> str:
        return (
            f'qubitron.interop.quirk.QuirkInputRotationOperation('
...
def _input_rotation_gate(identifier: str, gate: qubitron.Gate, exponent_sign: int) -> CellMaker:
    return CellMaker(
        identifier,
        gate.num_qubits(),
