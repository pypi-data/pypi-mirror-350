...
"""Protocols (structural subtyping) supported in Qubitron."""

from qubitron.protocols.act_on_protocol import (
    act_on as act_on,
    SupportsActOn as SupportsActOn,
    SupportsActOnQubits as SupportsActOnQubits,
)

from qubitron.protocols.apply_unitary_protocol import (
...
from qubitron.protocols.decompose_protocol import (
...
from qubitron.protocols.equal_up_to_global_phase_protocol import (
    equal_up_to_global_phase as equal_up_to_global_phase,
    SupportsEqualUpToGlobalPhase as SupportsEqualUpToGlobalPhase,
)

from qubitron.protocols.has_stabilizer_effect_protocol import (
    has_stabilizer_effect as has_stabilizer_effect,
)

from qubitron.protocols.has_unitary_protocol import (
    has_unitary as has_unitary,
    SupportsExplicitHasUnitary as SupportsExplicitHasUnitary,
)

from qubitron.protocols.inverse_protocol import inverse as inverse

from qubitron.protocols.json_serialization import (
    qubitron_type_from_json as qubitron_type_from_json,
    DEFAULT_RESOLVERS as DEFAULT_RESOLVERS,
    HasJSONNamespace as HasJSONNamespace,
    JsonResolver as JsonResolver,
    json_qubitron_type as json_qubitron_type,
...
from qubitron.protocols.measurement_key_protocol import (
...
from qubitron.protocols.mixture_protocol import (
...
from qubitron.protocols.mul_protocol import mul as mul

from qubitron.protocols.pauli_expansion_protocol import (
    pauli_expansion as pauli_expansion,
    SupportsPauliExpansion as SupportsPauliExpansion,
)

# pylint: disable=redefined-builtin
from qubitron.protocols.pow_protocol import pow as pow

# pylint: enable=redefined-builtin

from qubitron.protocols.qasm import (
    qasm as qasm,
...
from qubitron.protocols.trace_distance_bound import (
...
from qubitron.protocols.resolve_parameters import (
...
from qubitron.protocols.phase_protocol import phase_by as phase_by, SupportsPhase as SupportsPhase

from qubitron.protocols.qid_shape_protocol import (
...
from qubitron.protocols.unitary_protocol import SupportsUnitary as SupportsUnitary, unitary as unitary
