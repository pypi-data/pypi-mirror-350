...
@overload
def inverse(val: qubitron.Gate) -> qubitron.Gate:
    pass


@overload
def inverse(val: qubitron.Operation) -> qubitron.Operation:
    pass


@overload
def inverse(val: qubitron.Circuit) -> qubitron.Circuit:
    pass


@overload
def inverse(val: qubitron.OP_TREE) -> qubitron.OP_TREE:
    pass


@overload
def inverse(val: qubitron.Gate, default: TDefault) -> TDefault | qubitron.Gate:
    pass


@overload
def inverse(val: qubitron.Operation, default: TDefault) -> TDefault | qubitron.Operation:
    pass


@overload
def inverse(val: qubitron.Circuit, default: TDefault) -> TDefault | qubitron.Circuit:
    pass


@overload
def inverse(val: qubitron.OP_TREE, default: TDefault) -> TDefault | qubitron.OP_TREE:
    pass
