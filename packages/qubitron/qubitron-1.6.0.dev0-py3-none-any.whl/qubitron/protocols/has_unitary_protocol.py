...
from qubitron import qis
from qubitron._doc import doc_private
from qubitron.protocols import qid_shape_protocol
from qubitron.protocols.apply_unitary_protocol import ApplyUnitaryArgs
...
class SupportsExplicitHasUnitary(Protocol):
    ...
    def _has_unitary_(self) -> bool:
        ...
        This method is used preferentially by the global `qubitron.has_unitary`
