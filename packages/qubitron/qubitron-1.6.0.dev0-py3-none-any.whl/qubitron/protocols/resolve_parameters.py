...
def resolve_parameters(
    val: T, param_resolver: qubitron.ParamResolverOrSimilarType, recursive: bool = True
) -> T:
    ...
    Returns:
        ...
        given `qubitron.ParamResolver`. If `val` has no `_resolve_parameters_`
        ...
        for the much more common case of resolving parameters on qubitron
...
def resolve_parameters_once(val: Any, param_resolver: qubitron.ParamResolverOrSimilarType):
