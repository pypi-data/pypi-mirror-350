...
def test_act_on_errors() -> None:
    class Op(qubitron.Operation):
        @property
        def qubits(self) -> tuple[qubitron.Qid, ...]:  # type: ignore[empty-body]
            pass

        def with_qubits(self, *new_qubits: qubitron.Qid) -> Self:  # type: ignore[empty-body]
            pass
