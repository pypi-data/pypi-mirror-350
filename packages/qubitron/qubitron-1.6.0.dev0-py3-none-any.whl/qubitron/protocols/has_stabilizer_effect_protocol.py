...
import qubitron.protocols.decompose_protocol as decompose_protocol
import qubitron.protocols.has_unitary_protocol as has_unitary_protocol
import qubitron.protocols.qid_shape_protocol as qid_shape_protocol
import qubitron.protocols.unitary_protocol as unitary_protocol
...
pauli_string_decomposition = LazyLoader(
    ...
    globals(),
    "qubitron.transformers.analytical_decompositions.pauli_string_decomposition",
)
