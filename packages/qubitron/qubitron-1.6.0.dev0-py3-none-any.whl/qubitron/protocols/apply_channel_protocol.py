...
from qubitron.protocols.kraus_protocol import kraus
...
class SupportsApplyChannel(Protocol):
    ...
    def _apply_channel_(self, args: ApplyChannelArgs) -> np.ndarray | None | NotImplementedType:
        ...
        Args:
            args: A `qubitron.ApplyChannelArgs` object with the `args.target_tensor`
...
def apply_channel(
    ...
    returns a non-default channel with `qubitron.channel`, that channel will be
    ...
    Args:
        ...
        args: A mutable `qubitron.ApplyChannelArgs` object describing the target
