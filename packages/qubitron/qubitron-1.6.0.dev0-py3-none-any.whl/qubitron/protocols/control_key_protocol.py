...
from qubitron.protocols import measurement_key_protocol
...
class SupportsControlKey(Protocol):
    ...
    @doc_private
    def _control_keys_(self) -> frozenset[qubitron.MeasurementKey] | NotImplementedType | None:
...
def control_keys(val: Any) -> frozenset[qubitron.MeasurementKey]:
...
def measurement_keys_touched(val: Any) -> frozenset[qubitron.MeasurementKey]:
