...
class QasmArgs(string.Formatter):
    ...
    def __init__(
        ...
        precision: int = 10,
        version: str = '2.0',
        qubit_id_map: dict[qubitron.Qid, str] | None = None,
...
class SupportsQasmWithArgsAndQubits(Protocol):
    ...
    @doc_private
    def _qasm_(self, qubits: tuple[qubitron.Qid], args: QasmArgs) -> None | NotImplementedType | str:
        pass
...
def qasm(
    ...
    *,
    ...
    qubits: Iterable[qubitron.Qid] | None = None,
    ...
    Args:
        ...
        args: A `QasmArgs` object to pass into the value's `_qasm_` method.
            ...
            going on, e.g. a `qubitron.Operation` in a bigger `qubitron.Circuit`
        ...
        qubits: A list of qubits that the value is being applied to. This is
            needed for `qubitron.Gate` values, which otherwise wouldn't know what
    ...
    if method is not None:
        ...
        try:
            ...
            raise TypeError(
                "qubitron.qasm does not expect qubits or args to be specified"
