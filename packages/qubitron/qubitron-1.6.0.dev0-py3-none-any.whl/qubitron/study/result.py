...
T = TypeVar('T')
TMeasurementKey = Union[str, 'qubitron.Qid', Iterable['qubitron.Qid']]
...
class Result(abc.ABC):
    ...
    def data(self) -> pd.DataFrame:
        ...
        bits see `qubitron.big_endian_int_to_bits` and similar functions.
        """
    ...
    def __add__(self, other: qubitron.Result) -> qubitron.Result:
        if not isinstance(other, Result):
            return NotImplemented
...
class ResultDict(Result):
    ...
    def __repr__(self) -> str:
        return f'qubitron.ResultDict(params={self.params!r}, records={self._record_dict_repr()})'
