...
def pow_pauli_combination(
    ai: qubitron.TParamValComplex,
    ax: qubitron.TParamValComplex,
    ay: qubitron.TParamValComplex,
    az: qubitron.TParamValComplex,
    exponent: int,
) -> tuple[
    qubitron.TParamValComplex, qubitron.TParamValComplex, qubitron.TParamValComplex, qubitron.TParamValComplex
]:
