...
from qubitron.contrib import circuitdag
from qubitron.contrib.acquaintance.executor import AcquaintanceOperation, ExecutionStrategy
from qubitron.contrib.acquaintance.mutation_utils import expose_acquaintance_gates

if TYPE_CHECKING:
    import qubitron
    from qubitron.contrib.acquaintance.permutation import LogicalIndex, LogicalMapping
...
def get_acquaintance_dag(strategy: qubitron.Circuit, initial_mapping: LogicalMapping):
...
def get_logical_acquaintance_opportunities(
    strategy: qubitron.Circuit, initial_mapping: LogicalMapping
