...
import qubitron.contrib.acquaintance.inspection_utils as inspection_utils
...
def test_device() -> None:
    assert inspection_utils.LogicalAnnotator({}).device == qubitron.UNCONSTRAINED_DEVICE
