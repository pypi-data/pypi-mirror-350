...
from qubitron import circuits, ops, transformers
from qubitron.contrib.acquaintance.devices import get_acquaintance_size
from qubitron.contrib.acquaintance.gates import AcquaintanceOpportunityGate, SwapNetworkGate
from qubitron.contrib.acquaintance.permutation import PermutationGate
...
def rectify_acquaintance_strategy(circuit: qubitron.Circuit, acquaint_first: bool = True) -> None:
