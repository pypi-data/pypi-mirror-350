...
from qubitron import circuits, devices, ops
from qubitron.contrib.acquaintance.bipartite import BipartiteSwapNetworkGate
...
from qubitron.contrib.acquaintance.shift_swap_network import ShiftSwapNetworkGate
