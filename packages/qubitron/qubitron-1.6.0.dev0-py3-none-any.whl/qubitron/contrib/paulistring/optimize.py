...
from qubitron.contrib.paulistring.clifford_optimize import clifford_optimized_circuit
from qubitron.contrib.paulistring.pauli_string_optimize import pauli_string_optimized_circuit


class _CZTargetGateSet(transformers.CZTargetGateset):
    """Private implementation of `qubitron.CZTargetGateset` used for optimized_circuit method below.

    The implementation extends `qubitron.CZTargetGateset` by modifying decomposed operations using
