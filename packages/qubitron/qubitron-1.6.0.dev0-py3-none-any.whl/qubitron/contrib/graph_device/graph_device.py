...
from qubitron.contrib.graph_device.hypergraph import UndirectedHypergraph
...
class UndirectedGraphDevice(devices.Device):
    ...
    def qubits(self) -> tuple[qubitron.Qid, ...]:
        return cast(tuple['qubitron.Qid', ...], tuple(sorted(self.device_graph.vertices)))
    ...
    def validate_moment(self, moment: qubitron.Moment):
