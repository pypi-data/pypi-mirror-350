...
from qubitron.contrib.graph_device.hypergraph import UndirectedHypergraph as UndirectedHypergraph

from qubitron.contrib.graph_device.graph_device import (
...
from qubitron.contrib.graph_device.uniform_graph_device import (
