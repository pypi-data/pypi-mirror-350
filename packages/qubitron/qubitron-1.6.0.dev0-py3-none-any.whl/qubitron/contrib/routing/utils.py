...
from qubitron.contrib.circuitdag import CircuitDag

if TYPE_CHECKING:
    import qubitron
    from qubitron.contrib.routing import SwapNetwork
...
def get_circuit_connectivity(circuit: qubitron.Circuit) -> nx.Graph:
