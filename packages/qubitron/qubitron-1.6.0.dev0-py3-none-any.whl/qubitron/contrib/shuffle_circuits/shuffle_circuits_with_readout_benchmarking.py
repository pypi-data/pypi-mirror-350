...
from qubitron import circuits, ops, protocols, work
...
def _validate_input(
    ...
    # Check input_circuits type is qubitron.circuits
    if not all(isinstance(circuit, circuits.Circuit) for circuit in input_circuits):
        raise ValueError("Input circuits must be of type qubitron.Circuit.")
