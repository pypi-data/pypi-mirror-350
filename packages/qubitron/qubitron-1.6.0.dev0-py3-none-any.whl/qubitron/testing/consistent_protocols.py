...
from qubitron.testing.consistent_act_on import assert_all_implemented_act_on_effects_match_unitary
...
from qubitron.testing.consistent_phase_by import assert_phase_by_is_consistent_with_unitary
from qubitron.testing.consistent_qasm import assert_qasm_is_consistent_with_unitary
from qubitron.testing.consistent_resolve_parameters import assert_consistent_resolve_parameters
from qubitron.testing.consistent_specified_has_unitary import assert_specifies_has_unitary_if_unitary
from qubitron.testing.consistent_unitary import assert_unitary_is_consistent
from qubitron.testing.equivalent_repr_eval import assert_equivalent_repr
...
def assert_implements_consistent_protocols(
    ...
    *,
    ...
    setup_code: str = 'import qubitron\nimport numpy as np\nimport sympy',
