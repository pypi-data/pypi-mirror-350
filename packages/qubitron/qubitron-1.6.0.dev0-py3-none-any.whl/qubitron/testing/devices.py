...
class ValidatingTestDevice(devices.Device):
    ...
    Args:
        ...
        auto_decompose_gates: when set, for given gates it calls the qubitron.decompose protocol
    """
    ...
    def validate_operation(self, operation: ops.Operation) -> None:
        # This is pretty close to what the qubitron.google.XmonDevice has for validation
