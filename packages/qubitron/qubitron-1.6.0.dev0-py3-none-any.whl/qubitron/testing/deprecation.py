...
from qubitron._compat import ALLOW_DEPRECATION_IN_TEST
...
def assert_deprecated(*msgs: str, deadline: str, count: int | None = 1) -> Iterator[None]:
    ...
    >>> with assert_deprecated("use qubitron.x instead", deadline="v0.9"):
    ...
    from qubitron.testing import assert_logs
