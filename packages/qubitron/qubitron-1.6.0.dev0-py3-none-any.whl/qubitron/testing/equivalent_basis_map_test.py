...
def test_correct_mappings() -> None:
    ...
    qubitron.testing.assert_equivalent_computational_basis_map(
        maps={0b01: 0b01, 0b10: 0b10},
        circuit=circuits.Circuit(qubitron.IdentityGate(num_qubits=2).on(a, b)),
    )

    qubitron.testing.assert_equivalent_computational_basis_map(
        maps={0b001: 0b100, 0b010: 0b010, 0b100: 0b001},
        circuit=circuits.Circuit(qubitron.SWAP(a, c), qubitron.I(b)),
    )
