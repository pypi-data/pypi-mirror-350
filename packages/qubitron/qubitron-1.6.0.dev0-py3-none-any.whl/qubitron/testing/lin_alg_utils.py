...
from qubitron import linalg, value
...
def random_superposition(
    dim: int, *, random_state: qubitron.RANDOM_STATE_OR_SEED_LIKE = None
) -> np.ndarray:
...
def random_unitary(dim: int, *, random_state: qubitron.RANDOM_STATE_OR_SEED_LIKE = None) -> np.ndarray:
