...
class ParallelGate(raw_types.Gate):
    ...
    def __init__(self, sub_gate: qubitron.Gate, num_copies: int) -> None:
        """Inits ParallelGate.
    ...
    def with_gate(self, sub_gate: qubitron.Gate) -> ParallelGate:
    ...
    def __repr__(self) -> str:
        return f'qubitron.ParallelGate(sub_gate={self.sub_gate!r}, num_copies={self._num_copies})'
    ...
    def _resolve_parameters_(self, resolver: qubitron.ParamResolver, recursive: bool) -> ParallelGate:
...
def parallel_gate_op(gate: qubitron.Gate, *targets: qubitron.Qid) -> qubitron.Operation:
