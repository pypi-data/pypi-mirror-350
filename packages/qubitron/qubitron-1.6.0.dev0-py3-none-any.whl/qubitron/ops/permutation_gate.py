...
from qubitron.ops import raw_types, swap_gates
...
class QubitPermutationGate(raw_types.Gate):
    ...
    def __init__(self, permutation: Sequence[int]):
        """Create a `qubitron.QubitPermutationGate`.
    ...
    def __repr__(self) -> str:
        return f'qubitron.QubitPermutationGate(permutation={self.permutation!r})'
