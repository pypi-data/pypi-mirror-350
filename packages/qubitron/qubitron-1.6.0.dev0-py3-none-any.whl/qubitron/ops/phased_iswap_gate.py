...
from qubitron.ops import eigen_gate, swap_gates
...
class PhasedISwapPowGate(eigen_gate.EigenGate):
    ...
    def _decompose_(self, qubits: Sequence[qubitron.Qid]) -> Iterator[qubitron.OP_TREE]:
        ...
        yield qubitron.Z(a) ** self.phase_exponent
        yield qubitron.Z(b) ** -self.phase_exponent
        yield qubitron.ISwapPowGate(exponent=self.exponent, global_shift=self.global_shift).on(a, b)
        yield qubitron.Z(a) ** -self.phase_exponent
        yield qubitron.Z(b) ** self.phase_exponent
    ...
    def __repr__(self) -> str:
        ...
        return f'qubitron.PhasedISwapPowGate({arg_string})'
