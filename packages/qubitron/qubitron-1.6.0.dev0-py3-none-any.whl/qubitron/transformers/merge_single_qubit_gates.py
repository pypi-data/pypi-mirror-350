...
from qubitron.transformers import merge_k_qubit_gates, transformer_api, transformer_primitives
...
def merge_single_qubit_gates_to_phased_x_and_z(
    ...
    *,
    ...
    """Replaces runs of single qubit rotations with `qubitron.PhasedXPowGate` and `qubitron.ZPowGate`.
    ...
    def rewriter(op: qubitron.CircuitOperation) -> qubitron.OP_TREE:
...
def merge_single_qubit_gates_to_phxz(
    ...
    *,
    ...
    """Replaces runs of single qubit rotations with a single optional `qubitron.PhasedXZGate`.
...
def merge_single_qubit_moments_to_phxz(
    ...
    *,
    ...
    def can_merge_moment(m: qubitron.Moment):
        return all(
    ...
    def merge_func(m1: qubitron.Moment, m2: qubitron.Moment) -> qubitron.Moment | None:
