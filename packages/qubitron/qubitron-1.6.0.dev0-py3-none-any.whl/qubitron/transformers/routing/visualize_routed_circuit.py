...
class _SwapPrintGate(ops.Gate):
    ...
    def __init__(self, qubits: tuple[tuple[qubitron.Qid, qubitron.Qid], ...]) -> None:
        self.qubits = qubits
...
def routed_circuit_with_mapping(
    routed_circuit: qubitron.AbstractCircuit, initial_map: dict[qubitron.Qid, qubitron.Qid] | None = None
    ...
    def swap_print_moment() -> qubitron.Operation:
