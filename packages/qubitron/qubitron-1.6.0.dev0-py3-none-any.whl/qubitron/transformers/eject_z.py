...
def _is_swaplike(gate: qubitron.Gate):
...
def eject_z(
    ...
    *,
    ...
    def dump_tracked_phase(qubits: Iterable[ops.Qid]) -> Iterator[qubitron.OP_TREE]:
    ...
    def map_func(op: qubitron.Operation, moment_index: int) -> qubitron.OP_TREE:
