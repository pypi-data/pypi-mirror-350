...
def _rewrite_merged_k_qubit_unitaries(
    ...
    *,
    ...
    k: int = 0,
    rewriter: Callable[[qubitron.CircuitOperation], qubitron.OP_TREE] | None = None,
    merged_circuit_op_tag: str = "_merged_k_qubit_unitaries_component",
) -> qubitron.Circuit:
    deep = context.deep if context else False

    def map_func(op: qubitron.Operation, _) -> qubitron.OP_TREE:
...
def merge_k_qubit_unitaries(
    ...
    *,
    ...
    `qubitron.MatrixGate` containing unitary matrix of the merged component.
    ...
    Args:
        ...
        rewriter: Callable type that takes a `qubitron.CircuitOperation`, encapsulating a connected
            component of unitary operations acting on <= k qubits, and produces a `qubitron.OP_TREE`.
