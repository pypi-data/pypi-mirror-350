...
from qubitron import circuits, protocols
...
def find_terminal_measurements(circuit: qubitron.AbstractCircuit) -> list[tuple[int, qubitron.Operation]]:
    ...
    open_qubits: set[qubitron.Qid] = set(circuit.all_qubits())
    seen_control_keys: set[qubitron.MeasurementKey] = set()
    terminal_measurements: set[tuple[int, qubitron.Operation]] = set()
