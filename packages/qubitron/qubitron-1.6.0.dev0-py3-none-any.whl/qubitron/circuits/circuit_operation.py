...
from qubitron import circuits, ops, protocols, study, value
...
class CircuitOperation(ops.Operation):
    ...
    def __init__(
        ...
        qubit_map: dict[qubitron.Qid, qubitron.Qid] | None = None,
        ...
        extern_keys: frozenset[qubitron.MeasurementKey] = frozenset(),
        use_repetition_ids: bool | None = None,
        repeat_until: qubitron.Condition | None = None,
    ):
    ...
    @property
    def circuit(self) -> qubitron.FrozenCircuit:
    ...
    @property
    def repeat_until(self) -> qubitron.Condition | None:
        return self._repeat_until

    @property
    def qubit_map(self) -> Mapping[qubitron.Qid, qubitron.Qid]:
    ...
    def base_operation(self) -> qubitron.CircuitOperation:
    ...
    def replace(self, **changes) -> qubitron.CircuitOperation:
    ...
    @cached_property
    def _measurement_key_objs(self) -> frozenset[qubitron.MeasurementKey]:
    ...
    @cached_property
    def _control_keys(self) -> frozenset[qubitron.MeasurementKey]:
        keys = (
            frozenset()
    ...
    @cached_property
    def _mapped_any_loop(self) -> qubitron.Circuit:
    ...
    def _mapped_single_loop(self, repetition_id: str | None = None) -> qubitron.Circuit:
    ...
    @cached_property
    def _mapped_repeat_until(self) -> qubitron.Condition | None:
    ...
    def mapped_circuit(self, deep: bool = False) -> qubitron.Circuit:
        ...
        Returns:
            ...
            like `qubitron.decompose(self)`, but preserving moment structure.
        """
        self._ensure_deterministic_loop_count()
    ...
    def mapped_op(self, deep: bool = False) -> qubitron.CircuitOperation:
    ...
    def _decompose_(self) -> Iterator[qubitron.Operation]:
    ...
    def __repr__(self):
        ...
        return f'qubitron.CircuitOperation({indented_args[:-4]})'
    ...
    def __pow__(self, power: IntParam) -> qubitron.CircuitOperation:
    ...
    def with_key_path(self, path: tuple[str, ...]):
        """Alias for `qubitron.with_key_path(self, path)`.
    ...
    def with_repetition_ids(self, repetition_ids: list[str]) -> qubitron.CircuitOperation:
    ...
    def with_qubit_mapping(
        self, qubit_map: Mapping[qubitron.Qid, qubitron.Qid] | Callable[[qubitron.Qid], qubitron.Qid]
    ...
    def with_qubits(self, *new_qubits: qubitron.Qid) -> qubitron.CircuitOperation:
        """Returns a copy of this operation with an updated qubit mapping.
    ...
    def with_measurement_key_mapping(self, key_map: Mapping[str, str]) -> qubitron.CircuitOperation:
    ...
    def _with_measurement_key_mapping_(self, key_map: Mapping[str, str]) -> qubitron.CircuitOperation:
        return self.with_measurement_key_mapping(key_map)

    def with_params(
        self, param_values: qubitron.ParamResolverOrSimilarType, recursive: bool = False
    ) -> qubitron.CircuitOperation:
    ...
    def _resolve_parameters_(
        ...
        return resolved.replace(
            repetitions=resolver.value_of(cast('qubitron.TParamVal', self.repetitions), recursive)
        )
