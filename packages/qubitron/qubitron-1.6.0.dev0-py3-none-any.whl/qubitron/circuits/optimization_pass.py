...
class PointOptimizationSummary:
    ...
    def __init__(
        self,
        clear_span: int,
        clear_qubits: Iterable[qubitron.Qid],
        new_operations: qubitron.OP_TREE,
        ...
        Args:
            ...
            new_operations: The operations to replace the cleared out
                operations with.
            preserve_moments: If set, `qubitron.Moment` instances within
                ...
                see https://github.com/amyssnippet/Qubitron/issues/2406.
        """
    ...
    def __repr__(self) -> str:
        return (
            f'qubitron.PointOptimizationSummary({self.clear_span!r}, '
...
class PointOptimizer:
    ...
    def __init__(
        self,
        post_clean_up: Callable[[Sequence[qubitron.Operation]], qubitron.OP_TREE] = lambda op_list: op_list,
    ) -> None:
    ...
    def __call__(self, circuit: qubitron.Circuit):
    ...
    def optimization_at(
        ...
        PointOptimizationSummary(clear_span=2,
                                 ...
                                 new_operations=qubitron.Y(op.qubits[0]))
    ...
    def optimize_circuit(self, circuit: qubitron.Circuit):
