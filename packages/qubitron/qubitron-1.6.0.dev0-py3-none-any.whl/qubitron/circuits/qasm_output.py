...
class QasmUGate(ops.Gate):
    ...
    def _qasm_(self, qubits: tuple[qubitron.Qid, ...], args: qubitron.QasmArgs) -> str:
    ...
    def __repr__(self) -> str:
        return (
            f'qubitron.circuits.qasm_output.QasmUGate('
...
class QasmTwoQubitGate(ops.Gate):
    def __init__(self, kak: qubitron.KakDecomposition) -> None:
    ...
    def __repr__(self) -> str:
        return f'qubitron.circuits.qasm_output.QasmTwoQubitGate({self.kak!r})'
...
class QasmOutput:
    ...
    in Qubitron, are not yet supported.
    ...
    def _generate_qubit_ids(self) -> dict[qubitron.Qid, str]:
    ...
    def _write_operations(
        self,
        op_tree: qubitron.OP_TREE,
        output: Callable[[str], None],
        output_line_gap: Callable[[int], None],
    ) -> None:
        def keep(op: qubitron.Operation) -> bool:
