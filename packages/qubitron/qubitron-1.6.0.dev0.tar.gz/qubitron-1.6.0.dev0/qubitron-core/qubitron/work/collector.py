...
from qubitron import study, value
...
class CircuitSampleJob:
    ...
    def __init__(self, circuit: qubitron.AbstractCircuit, *, repetitions: int, tag: Any = None):
    ...
    def __repr__(self) -> str:
        return (
            f'qubitron.CircuitSampleJob(tag={self.tag!r}, '
...
class Collector(metaclass=abc.ABCMeta):
    ...
    def collect(
        self, sampler: qubitron.Sampler, *, concurrency: int = 2, max_total_samples: int | None = None
    ) -> None:
        ...
        Examples:
            ...
            ```
            collector = qubitron.PauliStringCollector(...)
    ...
    async def collect_async(
        ...
        Returns:
            ...
            collected.
        """
        results: duet.AsyncCollector[tuple[CircuitSampleJob, qubitron.Result]] = duet.AsyncCollector()
        job_error = None
        running_jobs = 0
