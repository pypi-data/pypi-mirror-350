...
class InitObsSetting:
    ...
    def __repr__(self):
        return (
            f'qubitron.work.InitObsSetting('
...
def zeros_state(qubits: Iterable[qubitron.Qid]):
...
def observables_to_settings(
    observables: Iterable[qubitron.PauliString], qubits: Iterable[qubitron.Qid]
...
class _MeasurementSpec:
    ...
    def __repr__(self):
        return (
            f'qubitron.work._MeasurementSpec(max_setting={self.max_setting!r}, '
