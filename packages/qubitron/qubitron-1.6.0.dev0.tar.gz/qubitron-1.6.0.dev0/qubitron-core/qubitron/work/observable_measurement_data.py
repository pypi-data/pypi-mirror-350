...
def _check_and_get_real_coef(observable: qubitron.PauliString, atol: float):
...
def _obs_vals_from_measurements(
    ...
    qubit_to_index: Mapping[qubitron.Qid, int],
    observable: qubitron.PauliString,
    atol: float,
):
...
class ObservableMeasuredResult:
    ...
    def __repr__(self):
        ...
        # we need to prefix our class name with `qubitron.work.`
        return (
            f'qubitron.work.ObservableMeasuredResult('
...
class BitstringAccumulator:
    ...
    def _from_json_dict_(
        ...
        **kwargs,
        ...
        from qubitron.study.result import _unpack_digits
    ...
    def __repr__(self):
        return (
            f'qubitron.work.BitstringAccumulator('
