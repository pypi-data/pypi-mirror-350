...
from qubitron.work import collector
...
class PauliSumCollector(collector.Collector):
    ...
    def __init__(
        ...
        observable: qubitron.PauliSumLike,
        *,
    ...
    def next_job(self) -> qubitron.CircuitSampleJob | None:
    ...
    def on_job_result(self, job: qubitron.CircuitSampleJob, result: qubitron.Result):
...
def _circuit_plus_pauli_string_measurements(
    circuit: qubitron.AbstractCircuit, pauli_string: qubitron.PauliString
