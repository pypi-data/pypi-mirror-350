...
from qubitron import sim, value
...
class _Simulate2qXEBTask:
    ...
    param_resolver: qubitron.ParamResolverOrSimilarType


class _Simulate_2q_XEB_Circuit:
    """Closure used in `simulate_2q_xeb_circuits` so it works with multiprocessing."""

    def __init__(self, simulator: qubitron.SimulatesIntermediateState):
...
def simulate_2q_xeb_circuits(
    ...
    simulator: qubitron.SimulatesIntermediateState | None = None,
):
    ...
    Args:
        ...
        simulator: A noiseless simulator used to simulate the circuits. By default, this is
            `qubitron.Simulator`. The simulator must support the `qubitron.SimulatesIntermediateState`
            interface.
    ...
    if simulator is None:
        ...
        # https://github.com/amyssnippet/Qubitron/issues/3717
