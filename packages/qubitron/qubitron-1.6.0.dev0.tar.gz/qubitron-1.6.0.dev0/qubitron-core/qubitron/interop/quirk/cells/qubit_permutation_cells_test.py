...
import qubitron
from qubitron.interop.quirk.cells.qubit_permutation_cells import QuirkQubitPermutationGate
...
def test_repr() -> None:
    qubitron.testing.assert_equivalent_repr(QuirkQubitPermutationGate('a', 'b', [0, 1]))
