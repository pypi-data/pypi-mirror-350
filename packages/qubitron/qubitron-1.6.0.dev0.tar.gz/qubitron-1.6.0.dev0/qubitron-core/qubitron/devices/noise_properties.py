...
from qubitron import _import, devices, ops, protocols
from qubitron.devices.noise_utils import PHYSICAL_GATE_TAG

circuits = _import.LazyLoader("circuits", globals(), "qubitron.circuits.circuit")
...
class NoiseModelFromNoiseProperties(devices.NoiseModel):
    ...
    def is_virtual(self, op: qubitron.Operation) -> bool:
