...
def get_seeded_initial_mapping(graph_seed, init_seed):
    ...
    logical_graph = nx.relabel_nodes(logical_graph, qubitron.LineQubit)
...
def test_initialization_reproducible_between_runs() -> None:
    ...
    expected_mapping = {
        qubitron.GridQubit(0, 0): qubitron.LineQubit(5),
        qubitron.GridQubit(0, 1): qubitron.LineQubit(0),
        qubitron.GridQubit(0, 2): qubitron.LineQubit(2),
        qubitron.GridQubit(1, 0): qubitron.LineQubit(3),
        qubitron.GridQubit(1, 1): qubitron.LineQubit(4),
        qubitron.GridQubit(1, 2): qubitron.LineQubit(1),
    }
