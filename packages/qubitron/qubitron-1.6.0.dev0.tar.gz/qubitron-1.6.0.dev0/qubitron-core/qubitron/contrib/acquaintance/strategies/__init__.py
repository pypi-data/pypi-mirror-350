...
from qubitron.contrib.acquaintance.strategies.complete import (
    complete_acquaintance_strategy as complete_acquaintance_strategy,
)
from qubitron.contrib.acquaintance.strategies.cubic import (
    cubic_acquaintance_strategy as cubic_acquaintance_strategy,
)
from qubitron.contrib.acquaintance.strategies.quartic_paired import (
