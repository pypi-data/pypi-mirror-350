...
from qubitron.contrib.acquaintance.permutation import LinearPermutationGate, SwapPermutationGate
...
def cubic_acquaintance_strategy(
    qubits: Iterable[qubitron.Qid], swap_gate: qubitron.Gate = ops.SWAP
) -> qubitron.Circuit:
