...
from qubitron.contrib.qcircuit.qcircuit_diagram_info import (
...
def qcircuit_qubit_namer(qubit: qubitron.Qid) -> str:
...
def circuit_to_latex_using_qcircuit(
    circuit: qubitron.Circuit, qubit_order: qubitron.QubitOrderOrList = ops.QubitOrder.DEFAULT
) -> str:
