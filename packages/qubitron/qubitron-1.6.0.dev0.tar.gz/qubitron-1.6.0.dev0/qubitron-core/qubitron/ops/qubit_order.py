...
class QubitOrder:
    ...
    def __init__(self, explicit_func: Callable[[Iterable[qubitron.Qid]], tuple[qubitron.Qid, ...]]) -> None:
    ...
    @staticmethod
    def explicit(
        fixed_qubits: Iterable[qubitron.Qid], fallback: QubitOrder | None = None
    ) -> QubitOrder:
    ...
    @staticmethod
    def sorted_by(key: Callable[[qubitron.Qid], Any]) -> QubitOrder:
    ...
    def order_for(self, qubits: Iterable[qubitron.Qid]) -> tuple[qubitron.Qid, ...]:
    ...
    @staticmethod
    def as_qubit_order(val: qubitron.QubitOrderOrList) -> QubitOrder:
