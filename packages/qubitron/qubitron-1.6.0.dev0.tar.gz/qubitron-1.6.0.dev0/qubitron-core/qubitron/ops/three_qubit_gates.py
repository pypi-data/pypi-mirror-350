...
class CCZPowGate(gate_features.InterchangeableQubitsGate, eigen_gate.EigenGate):
    ...
    def __repr__(self) -> str:
        if self._global_shift == 0:
            if self._exponent == 1:
                return 'qubitron.CCZ'
            return f'(qubitron.CCZ**{proper_repr(self._exponent)})'
        return (
            f'qubitron.CCZPowGate(exponent={proper_repr(self._exponent)}, '
...
class ThreeQubitDiagonalGate(raw_types.Gate):
    ...
    def __repr__(self) -> str:
        ...
        return f'qubitron.ThreeQubitDiagonalGate([{angles}])'
...
class CCXPowGate(gate_features.InterchangeableQubitsGate, eigen_gate.EigenGate):
    ...
    def __repr__(self) -> str:
        if self._global_shift == 0:
            if self._exponent == 1:
                return 'qubitron.TOFFOLI'
            return f'(qubitron.TOFFOLI**{proper_repr(self._exponent)})'
        return (
            f'qubitron.CCXPowGate(exponent={proper_repr(self._exponent)}, '
            f'global_shift={self._global_shift!r})'
        )
...
class CSwapGate(gate_features.InterchangeableQubitsGate, raw_types.Gate):
    ...
    def _decompose_inside_control(
        self, target1: qubitron.Qid, control: qubitron.Qid, target2: qubitron.Qid
    ...
    def _decompose_outside_control(
        self, control: qubitron.Qid, near_target: qubitron.Qid, far_target: qubitron.Qid
    ) -> Iterator[qubitron.OP_TREE]:
...
document(
    ...
    The `exponent=1` instance of `qubitron.CCZPowGate`.
...
document(
    ...
    The `exponent=1` instance of `qubitron.CCXPowGate`.
    ...
    Alternative names: `qubitron.CCNOT` and `qubitron.TOFFOLI`.
    """,
)
...
document(
    ...
    An instance of `qubitron.CSwapGate`.
    ...
    Alternative names: `qubitron.FREDKIN`.
    """,
)
