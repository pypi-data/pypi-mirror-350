...
from qubitron._compat import deprecated, proper_repr
...
class PauliStringPhasor(gate_operation.GateOperation):
    ...
    def __init__(
        ...
        *,
        exponent_neg: qubitron.TParamVal = 1,
        exponent_pos: qubitron.TParamVal = 0,
    ) -> None:
    ...
    @property
    def gate(self) -> qubitron.PauliStringPhasorGate:
        """The gate applied by the operation."""
        return cast(PauliStringPhasorGate, self._gate)

    @property
    def exponent_neg(self) -> qubitron.TParamVal:
        """The negative exponent."""
        return self.gate.exponent_neg

    @property
    def exponent_pos(self) -> qubitron.TParamVal:
        """The positive exponent."""
        return self.gate.exponent_pos

    @property
    def pauli_string(self) -> qubitron.PauliString:
        """The underlying pauli string."""
        return self._pauli_string

    @property
    def exponent_relative(self) -> qubitron.TParamVal:
    ...
    def conjugated_by(self, clifford: qubitron.OP_TREE) -> PauliStringPhasor:
    ...
    def __repr__(self) -> str:
        return (
            f'qubitron.PauliStringPhasor({self.pauli_string!r}, '
...
class PauliStringPhasorGate(raw_types.Gate):
    ...
    @property
    def dense_pauli_string(self) -> qubitron.DensePauliString:
    ...
    def equal_up_to_global_phase(self, other: qubitron.PauliStringPhasorGate) -> bool:
        """Checks equality of two PauliStringPhasors, up to global phase."""
    ...
    def _to_z_basis_ops(self, qubits: Sequence[qubitron.Qid]) -> Iterator[raw_types.Operation]:
    ...
    def __repr__(self) -> str:
        return (
            f'qubitron.PauliStringPhasorGate({self.dense_pauli_string!r}, '
            f'exponent_neg={proper_repr(self.exponent_neg)}, '
            f'exponent_pos={proper_repr(self.exponent_pos)})'
        )
    ...
    def on(self, *qubits: qubitron.Qid) -> qubitron.PauliStringPhasor:
...
def xor_nonlocal_decompose(
    qubits: Iterable[raw_types.Qid], onto_qubit: qubitron.Qid
