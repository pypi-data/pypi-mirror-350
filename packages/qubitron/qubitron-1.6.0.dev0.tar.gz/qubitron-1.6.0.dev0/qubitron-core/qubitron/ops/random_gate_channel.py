...
class RandomGateChannel(raw_types.Gate):
    ...
    def __init__(self, *, sub_gate: qubitron.Gate, probability: qubitron.TParamVal):
        if (
    ...
    @property
    def probability(self) -> qubitron.TParamVal:
    ...
    ) -> qubitron.CircuitDiagramInfo | None:
    ...
    def __repr__(self):
        if self.probability == 1:
            return f'qubitron.RandomGateChannel(sub_gate={self.sub_gate!r}, probability=1)'
