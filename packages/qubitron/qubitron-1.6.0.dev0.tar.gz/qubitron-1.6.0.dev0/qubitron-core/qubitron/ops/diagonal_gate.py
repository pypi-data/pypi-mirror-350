...
from qubitron.ops import common_gates, global_phase_op, raw_types
...
class DiagonalGate(raw_types.Gate):
    ...
    def __init__(self, diag_angles_radians: Sequence[qubitron.TParamVal]) -> None:
        ...
        """
        self._diag_angles_radians: tuple[qubitron.TParamVal, ...] = tuple(diag_angles_radians)

    @property
    def diag_angles_radians(self) -> tuple[qubitron.TParamVal, ...]:
    ...
    def _resolve_parameters_(self, resolver: qubitron.ParamResolver, recursive: bool) -> DiagonalGate:
        return DiagonalGate(
    ...
    def _decompose_for_basis(
        self, index: int, bit_flip: int, theta: qubitron.TParamVal, qubits: Sequence[qubitron.Qid]
    ) -> Iterator[qubitron.ZPowGate | qubitron.CXPowGate]:
        if index == 0:
            return
    ...
    def __repr__(self) -> str:
        ...
        return f'qubitron.DiagonalGate([{angles}])'
