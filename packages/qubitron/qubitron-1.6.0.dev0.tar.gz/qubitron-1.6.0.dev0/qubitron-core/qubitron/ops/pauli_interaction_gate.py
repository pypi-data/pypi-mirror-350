...
from qubitron.ops import common_gates, eigen_gate, gate_features, pauli_gates
...
class PauliInteractionGate(gate_features.InterchangeableQubitsGate, eigen_gate.EigenGate):
    ...
    @property
    def pauli0(self) -> qubitron.Pauli:
        return self._pauli0
    ...
    @property
    def pauli1(self) -> qubitron.Pauli:
        return self._pauli1
    ...
    def _circuit_diagram_info_(self, args: qubitron.CircuitDiagramInfoArgs) -> qubitron.CircuitDiagramInfo:
        labels: dict[qubitron.Pauli, str] = {pauli_gates.X: 'X', pauli_gates.Y: 'Y', pauli_gates.Z: '@'}
    ...
    def __repr__(self) -> str:
        base = (
            f'qubitron.PauliInteractionGate({self.pauli0!r}, {self.invert0!s}, '
