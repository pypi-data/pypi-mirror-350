...
class WaitGate(raw_types.Gate):
    ...
    def __init__(
        self,
        duration: qubitron.DURATION_LIKE,
        ...
        Args:
            duration: A constant or parameterized wait duration. This can be
                an instance of `datetime.timedelta` or `qubitron.Duration`.
    ...
    @property
    def duration(self) -> qubitron.Duration:
    ...
    def _resolve_parameters_(self, resolver: qubitron.ParamResolver, recursive: bool) -> WaitGate:
        return WaitGate(
    ...
    def __repr__(self) -> str:
        return f'qubitron.WaitGate({repr(self.duration)})'
...
def wait(
    *target: qubitron.Qid,
    duration: qubitron.DURATION_LIKE = None,
    picos: qubitron.TParamVal = 0,
    nanos: qubitron.TParamVal = 0,
    micros: qubitron.TParamVal = 0,
    millis: qubitron.TParamVal = 0,
) -> raw_types.Operation:
