...
class VirtualTag:
    """A `qubitron.TaggedOperation` tag indicating that the operation is virtual.
    ...
    a noisy gate in a `qubitron.NoiseModel`.
...
class RoutingSwapTag:
    """A 'qubitron.TaggedOperation' tag indicated that the operation is an inserted SWAP.
    ...
    def __repr__(self) -> str:
        return 'qubitron.RoutingSwapTag()'
