...
class MappingManager:
    ...
    def __init__(self, device_graph: nx.Graph, initial_mapping: dict[qubitron.Qid, qubitron.Qid]) -> None:
    ...
    def logical_to_physical(self) -> np.ndarray:
        ...
        Let `lq: qubitron.Qid` be a logical qubit. Then the corresponding physical qubit that it
    ...
    def physical_to_logical(self) -> np.ndarray:
        ...
        Let `pq: qubitron.Qid` be a physical qubit. Then the corresponding logical qubit that it
        maps to can be obtained by:
    ...
    def mapped_op(self, op: qubitron.Operation) -> qubitron.Operation:
