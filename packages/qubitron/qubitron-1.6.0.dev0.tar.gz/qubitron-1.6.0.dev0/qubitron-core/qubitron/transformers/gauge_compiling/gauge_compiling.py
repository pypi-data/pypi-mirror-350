...
"""Creates the abstraction for gauge compiling as a qubitron transformer."""
...
from qubitron.protocols.has_unitary_protocol import has_unitary
from qubitron.study.sweeps import Points, Zip
...
class GaugeTransformer:
    ...
    def as_sweep(
        ...
        *,
        ...
        context: transformer_api.TransformerContext | None = None,
        prng: np.random.Generator | None = None,
    ) -> tuple[circuits.AbstractCircuit, qubitron.Sweepable]:
        ...
        Args:
            ...
            context: A `qubitron.TransformerContext` storing common configurable options for
                the transformers.
