...
from qubitron.transformers.analytical_decompositions import two_qubit_to_sqrt_iswap
from qubitron.transformers.target_gatesets import compilation_target_gateset
...
class SqrtIswapTargetGateset(compilation_target_gateset.TwoQubitCompilationTargetGateset):
    ...
    By default, `qubitron.SqrtIswapTargetGateset` will accept and compile unknown gates to
    the following universal target gateset:
    - `qubitron.SQRT_ISWAP` / `qubitron.SQRT_ISWAP_INV`: The two qubit entangling gate.
    - `qubitron.PhasedXZGate`: Single qubit rotations.
    - `qubitron.MeasurementGate`: Measurements.
    - `qubitron.GlobalPhaseGate`: Global phase.
    ...
    this gateset, will be compiled to the default gateset (i.e. `qubitron.SQRT_ISWAP`/
    `qubitron.qubitron.SQRT_ISWAP_INV`, `qubitron.PhasedXZGate`, `qubitron.MeasurementGate`).
    """
    ...
    def __init__(
        ...
        *,
        ...
        additional_gates: Sequence[type[qubitron.Gate] | qubitron.Gate | qubitron.GateFamily] = (),
    ):
        """Initializes `qubitron.SqrtIswapTargetGateset`
        ...
        Args:
            ...
            use_sqrt_iswap_inv: If True, `qubitron.SQRT_ISWAP_INV` is used as part of the gateset,
                instead of `qubitron.SQRT_ISWAP`.
    ...
    def __repr__(self) -> str:
        return (
            f'qubitron.SqrtIswapTargetGateset('
            f'atol={self.atol}, '
