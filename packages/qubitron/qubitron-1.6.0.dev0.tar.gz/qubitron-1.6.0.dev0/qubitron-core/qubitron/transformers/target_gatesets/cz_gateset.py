...
from qubitron.transformers.analytical_decompositions import two_qubit_to_cz
...
class CZTargetGateset(compilation_target_gateset.TwoQubitCompilationTargetGateset):
    ...
    By default, `qubitron.CZTargetGateset` will accept and compile unknown gates to
    the following universal target gateset:
    - `qubitron.CZ` / `qubitron.CZPowGate`: The two qubit entangling gate.
    ...
    this gateset, will be compiled to the default gateset (i.e. `qubitron.CZ`/`qubitron.CZPowGate`,
    `qubitron.PhasedXZGate`, `qubitron.MeasurementGate`).
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            allow_partial_czs: If set, all powers of the form `qubitron.CZ**t`, and not just
             `qubitron.CZ`, are part of this gateset.
    ...
    def _decompose_two_qubit_operation(self, op: qubitron.Operation, _) -> qubitron.OP_TREE:
