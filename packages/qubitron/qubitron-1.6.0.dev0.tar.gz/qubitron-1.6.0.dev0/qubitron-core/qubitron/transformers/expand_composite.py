...
"""Transformer pass that expands composite operations via `qubitron.decompose`."""
...
def expand_composite(
    ...
    *,
    ...
    """A transformer that expands composite operations via `qubitron.decompose`.
    ...
    Transformation is applied using `qubitron.map_operations_and_unroll`, which preserves the
