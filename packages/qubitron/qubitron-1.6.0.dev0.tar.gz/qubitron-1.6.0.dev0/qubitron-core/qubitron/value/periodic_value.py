...
class PeriodicValue:
    ...
    def __init__(self, value: qubitron.TParamVal, period: qubitron.TParamVal):
    ...
    def _approx_eq_(self, other: Any, atol: float) -> bool:
        ...
        from qubitron.protocols import approx_eq
    ...
    def __repr__(self) -> str:
        ...
        return f'qubitron.PeriodicValue({v}, {p})'

    def _is_parameterized_(self) -> bool:
        # HACK: Avoids circular dependencies.
        from qubitron.protocols import is_parameterized

        return is_parameterized(self.value) or is_parameterized(self.period)

    def _parameter_names_(self) -> AbstractSet[str]:
        # HACK: Avoids circular dependencies.
        from qubitron.protocols import parameter_names

        return parameter_names(self.value) | parameter_names(self.period)

    def _resolve_parameters_(self, resolver: qubitron.ParamResolver, recursive: bool) -> PeriodicValue:
        # HACK: Avoids circular dependencies.
        from qubitron.protocols import resolve_parameters
