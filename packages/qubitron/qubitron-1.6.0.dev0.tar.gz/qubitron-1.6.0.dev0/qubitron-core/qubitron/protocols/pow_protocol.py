...
@overload
def pow(val: qubitron.Gate, exponent: Any) -> qubitron.Gate:
    pass


@overload
def pow(val: qubitron.Operation, exponent: Any) -> qubitron.Operation:
    pass


@overload
def pow(val: qubitron.Gate, exponent: Any, default: TDefault) -> TDefault | qubitron.Gate:
    pass


@overload
def pow(val: qubitron.Operation, exponent: Any, default: TDefault) -> TDefault | qubitron.Operation:
    pass


@overload
def pow(val: qubitron.Circuit, exponent: int, default: TDefault) -> TDefault | qubitron.Circuit:
    pass
