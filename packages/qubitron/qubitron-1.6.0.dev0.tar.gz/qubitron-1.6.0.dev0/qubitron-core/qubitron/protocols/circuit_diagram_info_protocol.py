...
LabelEntity = Union['qubitron.Qid', 'qubitron.MeasurementKey']
...
class CircuitDiagramInfo:
    ...
    def _wire_symbols_including_formatted_exponent(
        self, args: qubitron.CircuitDiagramInfoArgs, *, preferred_exponent_index: int | None = None
    ) -> list[str]:
    ...
    def _formatted_exponent(self, args: qubitron.CircuitDiagramInfoArgs) -> str | None:
...
class CircuitDiagramInfoArgs:
    ...
    def __init__(
        self,
        known_qubits: Iterable[qubitron.Qid] | None,
        known_qubit_count: int | None,
        use_unicode_characters: bool,
        precision: int | None,
        label_map: dict[qubitron.LabelEntity, int] | None,
    ...
    def format_complex(self, val: sympy.Basic | int | float | qubitron.TParamValComplex) -> str:
        if isinstance(val, sympy.Basic):
            return str(val)
        c = complex(val)
        joiner = '+'
...
class SupportsCircuitDiagramInfo(Protocol):
    ...
    def _circuit_diagram_info_(
        ...
        This method is used by the global `qubitron.diagram_info` method. If this
...
def _op_info_with_fallback(
    op: qubitron.Operation, args: qubitron.CircuitDiagramInfoArgs
) -> qubitron.CircuitDiagramInfo:
