...
from qubitron._doc import doc_private, document
...
class SupportsExplicitQidShape(Protocol):
    ...
    def _qid_shape_(self) -> tuple[int, ...] | NotImplementedType:
        ...
        This method is used by the global `qubitron.qid_shape` method (and by
        `qubitron.num_qubits` if `_num_qubits_` is not defined). If this
...
class SupportsExplicitNumQubits(Protocol):
    ...
    def _num_qubits_(self) -> int | NotImplementedType:
        ...
        This method is used by the global `qubitron.num_qubits` method (and by
        `qubitron.qid_shape` if `_qid_shape_` is not defined.  If this
