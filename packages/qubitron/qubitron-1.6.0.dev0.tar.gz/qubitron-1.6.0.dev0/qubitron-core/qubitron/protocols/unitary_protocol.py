...
from qubitron.protocols.apply_unitary_protocol import apply_unitaries, ApplyUnitaryArgs
...
class SupportsUnitary(Protocol):
    ...
    def _unitary_(self) -> np.ndarray | NotImplementedType:
        ...
        This method is used by the global `qubitron.unitary` method. If this method
        ...
        or default result when calling `qubitron.unitary` on it). (The ability to
        return NotImplemented is useful when a class cannot know if it has a
        matrix until runtime, e.g. qubitron.X**c normally has a matrix but
        qubitron.X**sympy.Symbol('a') doesn't.)
    ...
    def _has_unitary_(self) -> bool:
        ...
        This method is used by the global `qubitron.has_unitary` method.  If this
