...
import qubitron
from qubitron.json_resolver_cache import _class_resolver_dictionary
from qubitron.testing.json import ModuleJsonTestSpec

TestSpec = ModuleJsonTestSpec(
    name="qubitron",
    packages=[qubitron, qubitron.work],
    test_data_path=pathlib.Path(__file__).parent,
    custom_class_name_to_qubitron_type={"MSGate": "qubitron.MSGate"},
