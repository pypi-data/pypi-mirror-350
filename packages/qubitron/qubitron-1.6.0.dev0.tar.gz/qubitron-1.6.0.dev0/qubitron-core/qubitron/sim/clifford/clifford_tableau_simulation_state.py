...
from qubitron.sim.clifford.stabilizer_simulation_state import StabilizerSimulationState
...
class CliffordTableauSimulationState(StabilizerSimulationState[clifford_tableau.CliffordTableau]):
    ...
    def __init__(
        self,
        tableau: qubitron.CliffordTableau,
    ...
    @property
    def tableau(self) -> qubitron.CliffordTableau:
        return self.state
