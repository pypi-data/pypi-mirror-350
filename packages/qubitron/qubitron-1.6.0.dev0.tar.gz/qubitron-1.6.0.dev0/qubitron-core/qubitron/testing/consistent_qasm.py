...
from qubitron import devices, linalg, ops, protocols
...
"""
    ...
    try:
        ...
        raise AssertionError(
            'QASM not consistent with qubitron.unitary(op) up to global phase.\n\n'
            f'op:\n{_indent(repr(op))}\n\n'
            f'qubitron.unitary(op):\n{_indent(repr(unitary))}\n\n'
            f'Generated QASM:\n\n{_indent(qasm)}\n\n'
            f'Unitary of generated QASM:\n{_indent(repr(qasm_unitary))}\n\n'
            f'Phased matched qubitron.unitary(op):\n{_indent(repr(p_unitary))}\n\n'
