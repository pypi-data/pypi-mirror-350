...
from qubitron.circuits.circuit import Circuit
from qubitron.devices import LineQubit
from qubitron.ops import common_gates
from qubitron.qis import clifford_tableau
from qubitron.sim import final_state_vector, state_vector_simulation_state
...
def state_vector_has_stabilizer(
    state_vector: np.ndarray, stabilizer: qubitron.DensePauliString
) -> bool:
