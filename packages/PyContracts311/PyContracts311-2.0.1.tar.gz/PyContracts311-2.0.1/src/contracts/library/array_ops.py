...
np_types = {
    ...
    'np_complex64': np.complex64,  # Complex number, represented by two 32-bit floats
    'np_complex128': np.complex128,  # Complex number, represented by two 64-bit floats
    'np_bool': np.bool_,  # Boolean (True or False) stored as a byte
    'np_str': np.str_,  # Platform unicode type (normally either str32 or str64)
    'np_unicode': np.str_,  # Platform unicode type (normally either str32 or str64)
}
