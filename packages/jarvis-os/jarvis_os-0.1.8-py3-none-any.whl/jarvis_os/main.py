...
def main():
    ...
    def should_web_search(question):
        keywords = [
            ...
            # Questions
            "who is", "what is", "when is", "when did", "where is", "how to", "how do", "how does", "how many", "how long", "how much",
            "is it", "are there", "does", "did", "will", "should", "can", "could", "would", "why",
                    ...
                    try:
                        ...
                        if result:
                            ...
                            if any(result.endswith(p) for p in [".", "?", "!", ";"]):
                                ...
                                chat_history.append({"role": "assistant", "content": sentence.strip()})
                                sentence = ""
                                print()  # new line after each complete output
    ...
    while True:
        ...
        # if combined != "":
        #     print(combined)
        # if ("jarvis stop" in combined or "stop" in combined) and not state["is_stopped"]:
