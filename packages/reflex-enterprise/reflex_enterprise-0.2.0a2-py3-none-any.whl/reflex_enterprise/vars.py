...
# These libraries are always available on the __reflex object.
ALWAYS_BUNDLED_LIBRARIES = [
...
class LiteralLambdaVar(LambdaVar, LiteralVar):
    ...
    def _validate_and_extend_return_expr(
        ...
        if vd := return_expr._get_all_var_data():
            ...
            bundled_libraries = {*dynamic.bundled_libraries, *ALWAYS_BUNDLED_LIBRARIES}
