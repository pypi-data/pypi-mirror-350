...
from scale_gp_beta.pagination import SyncCursorPage, AsyncCursorPage, SyncAPIListPage, AsyncAPIListPage
...
class TestDatasetItems:
    ...
    def test_method_batch_create(self, client: SGPClient) -> None:
        ...
        assert_matches_type(SyncAPIListPage[DatasetItem], dataset_item, path=["response"])
...
class TestAsyncDatasetItems:
    ...
    async def test_method_batch_create(self, async_client: AsyncSGPClient) -> None:
        ...
        assert_matches_type(AsyncAPIListPage[DatasetItem], dataset_item, path=["response"])
