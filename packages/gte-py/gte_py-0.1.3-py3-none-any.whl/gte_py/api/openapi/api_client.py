...
import gte_py.api.openapi.models
from gte_py.api.openapi import rest
from gte_py.api.openapi.api_response import ApiResponse, T as ApiResponseT
from gte_py.api.openapi.configuration import Configuration
from gte_py.api.openapi.exceptions import (
    ApiException,
    ApiValueError,
)
...
class ApiClient:
    ...
    def deserialize(self, response_text: str, response_type: str, content_type: str | None):
        ...
        if content_type is None:
            ...
            raise ApiException(
                status=0, reason="Unsupported content type: {}".format(content_type)
            )
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(gte_py.api.openapi.models, klass)
    ...
    def __deserialize_date(self, string):
        ...
        try:
            ...
            raise rest.ApiException(
                status=0, reason="Failed to parse `{}` as date object".format(string)
            )
    ...
    def __deserialize_enum(self, data, klass):
        ...
        try:
            ...
            raise rest.ApiException(
                status=0, reason=("Failed to parse `{}` as `{}`".format(data, klass))
            )
