...
class TestCadesSignaturePostSignedBytesResponse(unittest.TestCase):
    """CadesSignaturePostSignedBytesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CadesSignaturePostSignedBytesResponse:
        """Test CadesSignaturePostSignedBytesResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CadesSignaturePostSignedBytesResponse`
        """
        model = CadesSignaturePostSignedBytesResponse()
        if include_optional:
    ...
    def testCadesSignaturePostSignedBytesResponse(self):
        """Test CadesSignaturePostSignedBytesResponse"""
