...
class TestErrorModelV2(unittest.TestCase):
    """ErrorModelV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ErrorModelV2:
        """Test ErrorModelV2
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ErrorModelV2`
        """
        model = ErrorModelV2()
        if include_optional:
            return ErrorModelV2(
