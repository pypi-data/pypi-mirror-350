...
class TestSignerBStampModel(unittest.TestCase):
    """SignerBStampModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignerBStampModel:
        """Test SignerBStampModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignerBStampModel`
        """
        model = SignerBStampModel()
        if include_optional:
            return SignerBStampModel(
    ...
    def testSignerBStampModel(self):
        """Test SignerBStampModel"""
