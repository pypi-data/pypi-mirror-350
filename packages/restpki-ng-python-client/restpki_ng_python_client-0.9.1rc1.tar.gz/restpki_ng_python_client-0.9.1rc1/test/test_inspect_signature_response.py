...
class TestInspectSignatureResponse(unittest.TestCase):
    """InspectSignatureResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InspectSignatureResponse:
        """Test InspectSignatureResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InspectSignatureResponse`
        """
        model = InspectSignatureResponse()
        if include_optional:
            return InspectSignatureResponse(
                success = True,
                failure = 'DataFileRequired',
                missing_data_hash = 'MD5',
                signers = [
                    restpki_ng_python_client.models.signer_model.SignerModel(
                        ...
                        is_document_timestamp = True, 
                        signature_field_name = '', 
                        validation_results = , 
                        has_ltv = True, 
                        xml_signed_entity_type = 'FullXml', 
                        xml_signed_element = restpki_ng_python_client.models.xml_element_model.XmlElementModel(
                            local_name = '', 
                            attributes = [
                        ...
                        attribute_certificates = [
                            restpki_ng_python_client.models.attribute_certificate_model.AttributeCertificateModel(
                                holder_type = 'EntityName', 
                                holder_certificate_serial_number = '', 
                                holder_display_name = '', 
                                holder_name = restpki_ng_python_client.models.general_name_model.GeneralNameModel(
                                    choice = 'OtherName', 
                                    directory_name = , 
                                    other_name = restpki_ng_python_client.models.other_name_model.OtherNameModel(
                                        type_id = '', 
                                        encoded = 'YQ==', 
                                        display_html = '', ), 
                                    uri = '', ), 
                ...
                document = restpki_ng_python_client.models.document_summary.DocumentSummary(
                    id = '', 
                    key = '', 
                    formatted_key = '', 
                    original_file = restpki_ng_python_client.models.document_file_model.DocumentFileModel(
                        mime_type = '', 
                        content = 'YQ==', 
                        blob_token = '', 
                        url = '', 
                        ...
                        content_type = '', 
                        location = '', ), 
                    marked_file = restpki_ng_python_client.models.document_file_model.DocumentFileModel(
                        mime_type = '', 
                        content = 'YQ==', 
                        blob_token = '', 
                        url = '', 
                    ...
                    signed_file = , 
                    signature_type = 'Pdf', 
                    available_until = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                has_encapsulated_content = True,
                encapsulated_content_type = 'Data',
                encapsulated_content = restpki_ng_python_client.models.file_reference_model.FileReferenceModel(
                    mime_type = '', 
                    content = 'YQ==', 
                    blob_token = '', 
                    url = '', 
    ...
    def testInspectSignatureResponse(self):
        """Test InspectSignatureResponse"""
