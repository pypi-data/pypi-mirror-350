...
class TestCreateSignatureSessionRequest(unittest.TestCase):
    """CreateSignatureSessionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateSignatureSessionRequest:
        """Test CreateSignatureSessionRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateSignatureSessionRequest`
        """
        model = CreateSignatureSessionRequest()
        if include_optional:
            return CreateSignatureSessionRequest(
                return_url = '',
                security_context_id = '',
                callback_argument = '',
                ...
                documents = [
                    restpki_ng_python_client.models.signature_session_document_data.SignatureSessionDocumentData(
                        id = '', 
                ...
                certificate_requirements = [
                    restpki_ng_python_client.models.certificate_requirement.CertificateRequirement(
                        type = 'CryptoDevice', 
                        argument = '', )
                    ],
                pdf_signature_options = restpki_ng_python_client.models.pdf_signature_options.PdfSignatureOptions(
    ...
    def testCreateSignatureSessionRequest(self):
        """Test CreateSignatureSessionRequest"""
