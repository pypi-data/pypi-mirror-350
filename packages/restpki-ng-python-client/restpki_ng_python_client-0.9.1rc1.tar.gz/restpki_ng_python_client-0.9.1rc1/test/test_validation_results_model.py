...
class TestValidationResultsModel(unittest.TestCase):
    """ValidationResultsModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidationResultsModel:
        """Test ValidationResultsModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidationResultsModel`
        """
    ...
    def testValidationResultsModel(self):
        """Test ValidationResultsModel"""
