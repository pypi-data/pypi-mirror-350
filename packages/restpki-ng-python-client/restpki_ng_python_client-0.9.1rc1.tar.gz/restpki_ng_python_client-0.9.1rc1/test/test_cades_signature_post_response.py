...
class TestCadesSignaturePostResponse(unittest.TestCase):
    """CadesSignaturePostResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CadesSignaturePostResponse:
        """Test CadesSignaturePostResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CadesSignaturePostResponse`
        """
        model = CadesSignaturePostResponse()
        if include_optional:
    ...
    def testCadesSignaturePostResponse(self):
        """Test CadesSignaturePostResponse"""
