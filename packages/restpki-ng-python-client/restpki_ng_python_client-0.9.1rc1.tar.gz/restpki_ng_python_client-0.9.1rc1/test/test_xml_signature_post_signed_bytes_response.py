...
class TestXmlSignaturePostSignedBytesResponse(unittest.TestCase):
    """XmlSignaturePostSignedBytesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XmlSignaturePostSignedBytesResponse:
        """Test XmlSignaturePostSignedBytesResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XmlSignaturePostSignedBytesResponse`
        """
        model = XmlSignaturePostSignedBytesResponse()
        if include_optional:
    ...
    def testXmlSignaturePostSignedBytesResponse(self):
        """Test XmlSignaturePostSignedBytesResponse"""
