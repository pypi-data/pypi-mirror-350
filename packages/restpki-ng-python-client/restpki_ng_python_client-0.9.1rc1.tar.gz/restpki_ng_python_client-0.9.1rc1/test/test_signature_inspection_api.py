...
class TestSignatureInspectionApi(unittest.TestCase):
    """SignatureInspectionApi unit test stubs"""

    def setUp(self) -> None:
        self.api = SignatureInspectionApi()

    def tearDown(self) -> None:
        pass

    def test_api_signature_inspection_put(self) -> None:
        """Test case for api_signature_inspection_put
