...
class TestCadesTimestampModel(unittest.TestCase):
    """CadesTimestampModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CadesTimestampModel:
        """Test CadesTimestampModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CadesTimestampModel`
        """
        model = CadesTimestampModel()
        if include_optional:
            return CadesTimestampModel(
    ...
    def testCadesTimestampModel(self):
        """Test CadesTimestampModel"""
