...
class TestStampPdfRequest(unittest.TestCase):
    """StampPdfRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StampPdfRequest:
        """Test StampPdfRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StampPdfRequest`
        """
        model = StampPdfRequest()
        if include_optional:
            return StampPdfRequest(
                file = restpki_ng_python_client.models.file_reference_model.FileReferenceModel(
                    ...
                    location = '', ),
                timestamp_tier = '',
                custom_signature_field_name = 'k$?x u&K}qz^sEC(lJ)=,j',
                reason = '',
