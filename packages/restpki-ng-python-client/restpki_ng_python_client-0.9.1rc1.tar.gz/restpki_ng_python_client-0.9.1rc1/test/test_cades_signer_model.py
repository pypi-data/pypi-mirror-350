...
class TestCadesSignerModel(unittest.TestCase):
    """CadesSignerModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CadesSignerModel:
        """Test CadesSignerModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CadesSignerModel`
        """
        model = CadesSignerModel()
        if include_optional:
            return CadesSignerModel(
