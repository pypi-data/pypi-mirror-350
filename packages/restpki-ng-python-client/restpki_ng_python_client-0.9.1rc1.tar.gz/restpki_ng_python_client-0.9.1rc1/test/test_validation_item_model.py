...
class TestValidationItemModel(unittest.TestCase):
    """ValidationItemModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidationItemModel:
        """Test ValidationItemModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidationItemModel`
        """
    ...
    def testValidationItemModel(self):
        """Test ValidationItemModel"""
