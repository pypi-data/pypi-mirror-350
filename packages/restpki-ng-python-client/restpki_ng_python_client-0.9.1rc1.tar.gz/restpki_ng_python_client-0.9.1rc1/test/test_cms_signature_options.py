...
class TestCmsSignatureOptions(unittest.TestCase):
    """CmsSignatureOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CmsSignatureOptions:
        """Test CmsSignatureOptions
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CmsSignatureOptions`
        """
        model = CmsSignatureOptions()
        if include_optional:
    ...
    def testCmsSignatureOptions(self):
        """Test CmsSignatureOptions"""
