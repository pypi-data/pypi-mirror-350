...
class TestCadesSignatureModel(unittest.TestCase):
    """CadesSignatureModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CadesSignatureModel:
        """Test CadesSignatureModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CadesSignatureModel`
        """
    ...
    def testCadesSignatureModel(self):
        """Test CadesSignatureModel"""
