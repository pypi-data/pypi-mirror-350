...
class TestPadesSignerModel(unittest.TestCase):
    """PadesSignerModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PadesSignerModel:
        """Test PadesSignerModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PadesSignerModel`
        """
        model = PadesSignerModel()
        if include_optional:
            return PadesSignerModel(
