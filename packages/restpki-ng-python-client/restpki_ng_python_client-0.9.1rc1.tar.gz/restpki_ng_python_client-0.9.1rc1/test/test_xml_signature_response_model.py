...
class TestXmlSignatureResponseModel(unittest.TestCase):
    """XmlSignatureResponseModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XmlSignatureResponseModel:
        """Test XmlSignatureResponseModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XmlSignatureResponseModel`
        """
        model = XmlSignatureResponseModel()
        if include_optional:
            return XmlSignatureResponseModel(
                signatures = [
                    restpki_ng_python_client.models.xml_signature_model.XmlSignatureModel(
                        type = 'FullXml', 
                ...
                b_stamp = restpki_ng_python_client.models.signature_b_stamp_model.SignatureBStampModel(
                    ...
                    index_file = restpki_ng_python_client.models.file_model.FileModel(
                        mime_type = '', 
                        content = 'YQ==', 
                        blob_token = '', 
                        url = '', ), 
    ...
    def testXmlSignatureResponseModel(self):
        """Test XmlSignatureResponseModel"""
