...
class TestPadesVisualRepresentationModel(unittest.TestCase):
    """PadesVisualRepresentationModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PadesVisualRepresentationModel:
        """Test PadesVisualRepresentationModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PadesVisualRepresentationModel`
        """
        model = PadesVisualRepresentationModel()
        if include_optional:
            return PadesVisualRepresentationModel(
                ...
                position = restpki_ng_python_client.models.pades_visual_positioning_model.PadesVisualPositioningModel(
                    ...
                    auto = restpki_ng_python_client.models.pades_visual_auto_positioning_model.PadesVisualAutoPositioningModel(
                        ...
                        row_spacing = 1.337, ), 
                    manual = restpki_ng_python_client.models.pades_visual_rectangle_model.PadesVisualRectangleModel(
                        left = 1.337, 
                        top = 1.337, 
                        right = 1.337, 
                        bottom = 1.337, 
    ...
    def testPadesVisualRepresentationModel(self):
        """Test PadesVisualRepresentationModel"""
