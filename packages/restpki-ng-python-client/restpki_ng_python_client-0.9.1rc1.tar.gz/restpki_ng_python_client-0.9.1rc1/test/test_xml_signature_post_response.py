...
class TestXmlSignaturePostResponse(unittest.TestCase):
    """XmlSignaturePostResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XmlSignaturePostResponse:
        """Test XmlSignaturePostResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XmlSignaturePostResponse`
        """
        model = XmlSignaturePostResponse()
        if include_optional:
    ...
    def testXmlSignaturePostResponse(self):
        """Test XmlSignaturePostResponse"""
