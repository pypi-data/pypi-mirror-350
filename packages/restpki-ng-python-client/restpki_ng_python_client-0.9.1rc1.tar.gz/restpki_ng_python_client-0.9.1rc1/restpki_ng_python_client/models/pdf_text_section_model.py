...
class PdfTextSectionModel(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PdfTextSectionModel from a JSON string"""
    ...
    def bold(self):
        self.style = PdfTextStyle.BOLD
        return self
    
    def italic(self):
        self.style = PdfTextStyle.ITALIC
        return self
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PdfTextSectionModel from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "text": obj.get("text"),
            "style": obj.get("style"),
            "color": ColorModel.from_dict(obj.get("color")) if obj.get("color") is not None else None,
