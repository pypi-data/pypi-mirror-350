...
class TestPadesSignaturePostRequestV2(unittest.TestCase):
    """PadesSignaturePostRequestV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PadesSignaturePostRequestV2:
        """Test PadesSignaturePostRequestV2
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PadesSignaturePostRequestV2`
        """
        model = PadesSignaturePostRequestV2()
        if include_optional:
            return PadesSignaturePostRequestV2(
                pdf_to_sign = restpki_ng_python_client.models.file_model.FileModel(
                    mime_type = '', 
                    content = 'YQ==', 
                    blob_token = '', 
                    url = '', ),
                visual_representation = restpki_ng_python_client.models.pades_visual_representation_model.PadesVisualRepresentationModel(
                    ...
                    position = restpki_ng_python_client.models.pades_visual_positioning_model.PadesVisualPositioningModel(
                        ...
                        manual = , ), ),
                pdf_marks = [
                    restpki_ng_python_client.models.pdf_mark_model.PdfMarkModel(
                        container = restpki_ng_python_client.models.pades_visual_rectangle_model.PadesVisualRectangleModel(
                            left = 1.337, 
                            top = 1.337, 
                            right = 1.337, 
                            ...
                            height = 1.337, ), 
                        border_width = 1.337, 
                        border_color = restpki_ng_python_client.models.color_model.ColorModel(
                            red = 56, 
                            green = 56, 
                            blue = 56, 
                            alpha = 1.337, ), 
                        background_color = restpki_ng_python_client.models.color_model.ColorModel(
                            red = 56, 
                            green = 56, 
                            blue = 56, 
                            alpha = 1.337, ), 
                        elements = [
                            restpki_ng_python_client.models.pdf_mark_element_model.PdfMarkElementModel(
                                element_type = 'Text', 
                                relative_container = restpki_ng_python_client.models.pades_visual_rectangle_model.PadesVisualRectangleModel(
                                    left = 1.337, 
                                    top = 1.337, 
                                    right = 1.337, 
                                    bottom = 1.337, 
                                ...
                                rotation = 56, 
                                text_sections = [
                                    restpki_ng_python_client.models.pdf_text_section_model.PdfTextSectionModel(
                                        text = '0', 
                                        style = 'Normal', 
                                        color = , 
                                        font_size = 1.337, )
                                    ], 
                                image = restpki_ng_python_client.models.pdf_mark_image_model.PdfMarkImageModel(
                                    opacity = 1.337, 
                                    resource = restpki_ng_python_client.models.resource_content_or_reference.ResourceContentOrReference(
                                        url = '', 
                                        content = 'YQ==', 
                ...
                certification_level = 'NotCertified',
                reason = '',
                certificate = 'YQ==',
                signature_policy_id = '',
                security_context_id = '',
                callback_argument = '',
                ignore_revocation_status_unknown = True
            )
        else:
            return PadesSignaturePostRequestV2(
                pdf_to_sign = restpki_ng_python_client.models.file_model.FileModel(
    ...
    def testPadesSignaturePostRequestV2(self):
        """Test PadesSignaturePostRequestV2"""
