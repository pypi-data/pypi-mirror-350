...
class TestPadesSignaturePostRequestV1(unittest.TestCase):
    """PadesSignaturePostRequestV1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PadesSignaturePostRequestV1:
        """Test PadesSignaturePostRequestV1
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PadesSignaturePostRequestV1`
        """
        model = PadesSignaturePostRequestV1()
        if include_optional:
            return PadesSignaturePostRequestV1(
                pdf_to_sign = 'YQ==',
    ...
    def testPadesSignaturePostRequestV1(self):
        """Test PadesSignaturePostRequestV1"""
