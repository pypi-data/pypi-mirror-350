...
class TestCompleteAuthenticationResponse(unittest.TestCase):
    """CompleteAuthenticationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompleteAuthenticationResponse:
        """Test CompleteAuthenticationResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompleteAuthenticationResponse`
        """
        model = CompleteAuthenticationResponse()
        if include_optional:
            return CompleteAuthenticationResponse(
                success = True,
                failure = 'CertificateFailedValidation',
    ...
    def testCompleteAuthenticationResponse(self):
        """Test CompleteAuthenticationResponse"""
