...
class TestSignatureResultModel(unittest.TestCase):
    """SignatureResultModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignatureResultModel:
        """Test SignatureResultModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignatureResultModel`
        """
        model = SignatureResultModel()
        if include_optional:
            return SignatureResultModel(
                signature_file = restpki_ng_python_client.models.file_model.FileModel(
                    mime_type = '', 
                    content = 'YQ==', 
                    blob_token = '', 
                    url = '', ),
    ...
    def testSignatureResultModel(self):
        """Test SignatureResultModel"""
