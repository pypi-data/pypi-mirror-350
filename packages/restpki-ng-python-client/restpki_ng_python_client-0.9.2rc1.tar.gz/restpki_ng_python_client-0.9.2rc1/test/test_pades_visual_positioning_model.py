...
class TestPadesVisualPositioningModel(unittest.TestCase):
    """PadesVisualPositioningModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PadesVisualPositioningModel:
        """Test PadesVisualPositioningModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PadesVisualPositioningModel`
        """
    ...
    def testPadesVisualPositioningModel(self):
        """Test PadesVisualPositioningModel"""
