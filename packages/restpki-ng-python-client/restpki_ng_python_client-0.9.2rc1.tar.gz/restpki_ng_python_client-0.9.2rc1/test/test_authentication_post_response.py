...
class TestAuthenticationPostResponse(unittest.TestCase):
    """AuthenticationPostResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthenticationPostResponse:
        """Test AuthenticationPostResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthenticationPostResponse`
        """
        model = AuthenticationPostResponse()
        if include_optional:
    ...
    def testAuthenticationPostResponse(self):
        """Test AuthenticationPostResponse"""
