...
class TestXmlSignatureOptions(unittest.TestCase):
    """XmlSignatureOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> XmlSignatureOptions:
        """Test XmlSignatureOptions
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `XmlSignatureOptions`
        """
        model = XmlSignatureOptions()
        if include_optional:
    ...
    def testXmlSignatureOptions(self):
        """Test XmlSignatureOptions"""
