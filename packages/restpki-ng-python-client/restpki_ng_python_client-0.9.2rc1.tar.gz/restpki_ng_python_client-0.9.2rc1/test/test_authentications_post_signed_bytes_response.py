...
class TestAuthenticationsPostSignedBytesResponse(unittest.TestCase):
    """AuthenticationsPostSignedBytesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuthenticationsPostSignedBytesResponse:
        """Test AuthenticationsPostSignedBytesResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthenticationsPostSignedBytesResponse`
        """
        model = AuthenticationsPostSignedBytesResponse()
        if include_optional:
    ...
    def testAuthenticationsPostSignedBytesResponse(self):
        """Test AuthenticationsPostSignedBytesResponse"""
