...
class TestPadesSignaturePostResponse(unittest.TestCase):
    """PadesSignaturePostResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PadesSignaturePostResponse:
        """Test PadesSignaturePostResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PadesSignaturePostResponse`
        """
        model = PadesSignaturePostResponse()
        if include_optional:
    ...
    def testPadesSignaturePostResponse(self):
        """Test PadesSignaturePostResponse"""
