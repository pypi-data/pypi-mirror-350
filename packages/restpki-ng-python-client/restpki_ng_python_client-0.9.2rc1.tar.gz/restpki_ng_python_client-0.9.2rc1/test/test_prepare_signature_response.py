...
class TestPrepareSignatureResponse(unittest.TestCase):
    """PrepareSignatureResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrepareSignatureResponse:
        """Test PrepareSignatureResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrepareSignatureResponse`
        """
        model = PrepareSignatureResponse()
        if include_optional:
            return PrepareSignatureResponse(
                success = True,
                failure = 'PdfAlreadySigned',
                state = '',
                to_sign_hash = restpki_ng_python_client.models.digest_algorithm_and_value_model.DigestAlgorithmAndValueModel(
                    algorithm = 'MD5', 
                    value = 'YQ==', 
                    hex_value = '', ),
    ...
    def testPrepareSignatureResponse(self):
        """Test PrepareSignatureResponse"""
