...
class TestTimestampIssueResponse(unittest.TestCase):
    """TimestampIssueResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimestampIssueResponse:
        """Test TimestampIssueResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimestampIssueResponse`
        """
        model = TimestampIssueResponse()
        if include_optional:
            return TimestampIssueResponse(
                encoded_value = 'YQ==',
                info = restpki_ng_python_client.models.cades_timestamp_model.CadesTimestampModel(
    ...
    def testTimestampIssueResponse(self):
        """Test TimestampIssueResponse"""
