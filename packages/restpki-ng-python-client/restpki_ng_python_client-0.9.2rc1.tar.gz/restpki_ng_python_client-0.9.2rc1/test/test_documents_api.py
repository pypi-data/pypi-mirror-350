...
class TestDocumentsApi(unittest.TestCase):
    ...
    def test_api_documents_id_signers_get(self) -> None:
        """Test case for api_documents_id_signers_get

        Retrieves the full information about each of a document's signers
        """
        pass

    def test_api_documents_keys_key_get(self) -> None:
        """Test case for api_documents_keys_key_get
