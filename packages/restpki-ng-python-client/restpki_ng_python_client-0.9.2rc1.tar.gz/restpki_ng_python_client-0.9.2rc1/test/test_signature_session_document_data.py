...
class TestSignatureSessionDocumentData(unittest.TestCase):
    """SignatureSessionDocumentData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignatureSessionDocumentData:
        """Test SignatureSessionDocumentData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignatureSessionDocumentData`
        """
        model = SignatureSessionDocumentData()
        if include_optional:
            return SignatureSessionDocumentData(
                id = '',
    ...
    def testSignatureSessionDocumentData(self):
        """Test SignatureSessionDocumentData"""
