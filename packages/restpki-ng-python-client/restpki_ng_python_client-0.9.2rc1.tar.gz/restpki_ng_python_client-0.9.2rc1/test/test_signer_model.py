...
class TestSignerModel(unittest.TestCase):
    """SignerModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignerModel:
        """Test SignerModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignerModel`
        """
        model = SignerModel()
        if include_optional:
            return SignerModel(
                ...
                attribute_certificates = [
                    restpki_ng_python_client.models.attribute_certificate_model.AttributeCertificateModel(
                        ...
                        holder_name = restpki_ng_python_client.models.general_name_model.GeneralNameModel(
                            choice = 'OtherName', 
                            directory_name = restpki_ng_python_client.models.name_model.NameModel(
                                country = '', 
                                organization = '', 
                                organization_unit = '', 
                                dn_qualifier = '', 
                            ...
                            uri = '', ), 
                        issuer_display_name = '', 
                        issuer = restpki_ng_python_client.models.name_model.NameModel(
                            country = '', 
                            organization = '', 
                            organization_unit = '', 
                            dn_qualifier = '', 
                        ...
                        validity_end = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        attributes = [
                            restpki_ng_python_client.models.certified_attribute_model.CertifiedAttributeModel(
                                type = 'Role', 
                                role = restpki_ng_python_client.models.role_attribute_model.RoleAttributeModel(
                                    authority = [
                                        restpki_ng_python_client.models.general_name_model.GeneralNameModel(
                                            uri = '', )
                                        ], 
                                    name = '', 
                                    alias = '', ), )
