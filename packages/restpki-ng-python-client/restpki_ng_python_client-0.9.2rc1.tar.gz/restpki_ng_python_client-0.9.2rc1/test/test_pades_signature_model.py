...
class TestPadesSignatureModel(unittest.TestCase):
    """PadesSignatureModel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PadesSignatureModel:
        """Test PadesSignatureModel
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PadesSignatureModel`
        """
        model = PadesSignatureModel()
        if include_optional:
            return PadesSignatureModel(
                signers = [
                    restpki_ng_python_client.models.pades_signer_model.PadesSignerModel(
    ...
    def testPadesSignatureModel(self):
        """Test PadesSignatureModel"""
