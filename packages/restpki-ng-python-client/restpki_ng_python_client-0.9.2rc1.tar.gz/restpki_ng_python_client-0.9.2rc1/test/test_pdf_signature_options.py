...
class TestPdfSignatureOptions(unittest.TestCase):
    """PdfSignatureOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PdfSignatureOptions:
        """Test PdfSignatureOptions
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PdfSignatureOptions`
        """
        model = PdfSignatureOptions()
        if include_optional:
    ...
    def testPdfSignatureOptions(self):
        """Test PdfSignatureOptions"""
