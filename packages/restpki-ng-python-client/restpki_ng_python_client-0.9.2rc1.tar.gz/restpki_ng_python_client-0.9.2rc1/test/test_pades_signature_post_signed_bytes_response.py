...
class TestPadesSignaturePostSignedBytesResponse(unittest.TestCase):
    """PadesSignaturePostSignedBytesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PadesSignaturePostSignedBytesResponse:
        """Test PadesSignaturePostSignedBytesResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PadesSignaturePostSignedBytesResponse`
        """
        model = PadesSignaturePostSignedBytesResponse()
        if include_optional:
    ...
    def testPadesSignaturePostSignedBytesResponse(self):
        """Test PadesSignaturePostSignedBytesResponse"""
