...
from remotivelabs.topology.frame import Frame
from remotivelabs.topology.namespace import NamespaceName
from remotivelabs.topology.namespaces import GenericNamespace, Namespace
    ...
    def __init__(
        ...
        router = Router(
            fallback_handler=Router(
                [
                    (str(ControlRequestType.ping_v1), self._ping_v1),
                    (str(ControlRequestType.reboot_v1), self._reboot_v1),
                ]
            )
        )
