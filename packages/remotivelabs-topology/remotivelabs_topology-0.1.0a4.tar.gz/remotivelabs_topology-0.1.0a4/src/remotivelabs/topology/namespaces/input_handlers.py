...
from remotivelabs.topology.frame import Frame, FrameInfo, FrameSubscription
from remotivelabs.topology.namespace import NamespaceName
from remotivelabs.topology.namespaces.filters import Filter, FrameFilter, SomeIPEventFilter, SomeIPRequestFilter
from remotivelabs.topology.signal import WriteSignal
from remotivelabs.topology.some_ip import RequestType, SomeIPError, SomeIPEvent, SomeIPRequest, SomeIPResponse
...
class FrameHandler(_BaseHandler):
    ...
    Args:
        filters: A sequence of FrameFilter used to match relevant frames.
