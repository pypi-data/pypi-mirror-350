...
class Namespace(ABC, Generic[F, C]):
    """
    See implementations in `remotivelabs.topology.namespaces`, e.g.
    `remotivelabs.topology.namespaces.some_ip.SomeIPNamespace`
    or `remotivelabs.topology.namespaces.can.CanNamespace`.
    """
