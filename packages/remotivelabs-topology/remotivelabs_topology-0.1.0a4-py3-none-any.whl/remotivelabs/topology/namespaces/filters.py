...
from remotivelabs.topology.frame import FrameInfo
from remotivelabs.topology.signal import SignalInfo
...
FrameFilter = Union[Sender, Receiver, Frame, AllFrames, Signal]
