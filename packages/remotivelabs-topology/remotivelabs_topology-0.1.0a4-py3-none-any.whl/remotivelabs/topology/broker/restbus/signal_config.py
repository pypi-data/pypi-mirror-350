...
from remotivelabs.topology.signal import SignalName, SignalValue
...
class SignalConfig:
    ...
    @classmethod
    def set(cls, name: SignalName, value: SignalValue) -> SignalConfig:
        """
    ...
    @classmethod
    def set_update_bit(cls, name: SignalName) -> SignalConfig:
        """
