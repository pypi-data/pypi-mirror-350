...
**splang** is an esoteric programming language written in the form of a playlist. A writeup of the language can be found in the [splang documentation](https://satish.dev/projects/splang/).

Programs, or splangs, are playlists whose track metadata encode operations. Take a look at the [splang helloworld](https://open.spotify.com/playlist/7cPsICy0U7WM8Q67SuYXds?si=c292b92145604f56) for a sample splang playlist. Use the splang interpreter to execute these playlists programmatically.

The most convenient way to run splang code is by creating a Spotify playlist and using a developer token. Refer to the [Spotify API documentation](https://developer.spotify.com/documentation/web-api/) and [Spotipy API documentation](https://spotipy.readthedocs.io/en/latest/) for environment setup. However, you can also run splang code using a local JSON file that contains the playlist data.

## 🛠️ Installation and Use

### 📦 Development Setup

To get started with development, clone the [splang repository](https://github.com/NamanSatish/splang) and set up your environment:
...
To install splang for general use, you can install it directly from PyPI:
...
```bash
splang helloworld.json
```

#### ▶️ Run the example helloworld:

```bash
splang -hello
```

#### ▶️ Run the example fibonacci:
...
| **Time/Opcode** | **Command**       | **Parameter(s)** | **Description**                                                                                                                    |
| -------- | ----------------- | ---------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
