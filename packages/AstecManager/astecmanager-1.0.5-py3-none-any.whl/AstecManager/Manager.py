        ...
        for drif_exp in drif_experiments:
            ...
            if found_iteration > -1:
                ...
                if os.path.isdir(score_path):
                    self.upload_on_omero(omero_config_file,embryo_name,"ITER"+str(found_iteration)+"-CO-SCORE",score_path)
                if os.path.isdir(transformations_path):
                    self.upload_on_omero(omero_config_file,embryo_name,"ITER"+str(found_iteration)+"-CO-TRSFS",transformations_path)
