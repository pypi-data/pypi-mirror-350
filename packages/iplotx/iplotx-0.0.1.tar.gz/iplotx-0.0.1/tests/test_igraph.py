...
class GraphTestRunner(unittest.TestCase):
    ...
    #    g = ig.Graph.Ring(5, directed=True)
    #    fig, ax = plt.subplots()
    #    ipx.plot(g, ax=ax, mark_groups=True, layout=self.layout_small_ring)
    ...
    #    g = ig.Graph.Ring(5)
    #    #    fig, ax = plt.subplots()
    #    ipx.plot(g, ax=ax, vertex_shape="o", layout=self.layout_small_ring)
...
#        fig, ax = plt.subplots()
#        ipx.plot(grouping=clu, ax=ax, layout=self.layout_small_ring)
#
