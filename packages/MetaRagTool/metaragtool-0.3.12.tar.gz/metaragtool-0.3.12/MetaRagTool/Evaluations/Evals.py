...
def all_encoders(sample_size=200, qa_sample_size=100, local_mode=False, multi_hop_hardness_factor=0,
    ...
    for n in names:
        god_eval(encoder_name=n, sample_size=sample_size, qa_sample_size=qa_sample_size,
                 multi_hop_hardness_factor=multi_hop_hardness_factor,
                 local_mode=local_mode, judged=judged, top_k=top_k)

#
# def embedding_steering_influence_factor(encoder_name, sample_size=250, qa_sample_size=100, local_mode=False):
