...
def tokenize_and_colorize(encoder_name, reranker_name, pdf_files, text, chunking_method, chunk_size, max_sentence_len, ignore_pfd_line_breaks, language_mode, gemini_api_key):
    global rag
