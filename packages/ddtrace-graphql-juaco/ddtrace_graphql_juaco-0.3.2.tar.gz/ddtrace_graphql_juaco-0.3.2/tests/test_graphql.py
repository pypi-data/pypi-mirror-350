...
import ddtrace_graphql_juaco
from ddtrace_graphql_juaco import (
    DATA_EMPTY, ERRORS, INVALID, QUERY, SERVICE, CLIENT_ERROR,
    TracedGraphQLSchema, patch, traced_graphql, unpatch
)
from ddtrace_graphql_juaco.base import traced_graphql_wrapped
...
class TestGraphQL:
    ...
    def test_service_from_env():
        ...
        os.environ['DDTRACE_GRAPHQL_JUACO_SERVICE'] = 'test.test'
