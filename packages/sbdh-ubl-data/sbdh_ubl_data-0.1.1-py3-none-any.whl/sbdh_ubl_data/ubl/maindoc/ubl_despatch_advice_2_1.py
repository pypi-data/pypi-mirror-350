...
class DespatchAdviceType:
    ...
    <ns1:ComponentType>ABIE</ns1:ComponentType> <ns1:DictionaryEntryName>Despatch
    Advice.

    Details</ns1:DictionaryEntryName> <ns1:Definition>A document used to
    describe the despatch or delivery of goods and
    services.</ns1:Definition> <ns1:ObjectClass>Despatch
    Advice</ns1:ObjectClass> <ns1:AlternativeBusinessTerms>Ship Note,
    Dispatch Advice, Consignment Note</ns1:AlternativeBusinessTerms>
    </ns1:Component>
    ...
    :ivar ublversion_id: <ns1:Component
        ...
        <ns1:DictionaryEntryName>Despatch Advice. UBL Version
        ...
        <ns1:ObjectClass>Despatch Advice</ns1:ObjectClass>
    ...
    :ivar customization_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Despatch Advice. Customization
        Identifier. Identifier</ns1:DictionaryEntryName>
    ...
    :ivar profile_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Despatch Advice. Profile Identifier.
    ...
    :ivar profile_execution_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Despatch Advice. Profile Execution
        Identifier. Identifier</ns1:DictionaryEntryName>
    ...
    :ivar id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Despatch Advice.
    ...
    :ivar copy_indicator: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Despatch Advice. Copy_ Indicator.
    ...
    :ivar uuid: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Despatch Advice. UUID.
    ...
    :ivar issue_date: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Despatch Advice. Issue Date.
    ...
    :ivar issue_time: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Despatch Advice. Issue Time.
    ...
    :ivar document_status_code: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Despatch Advice. Document Status Code.
        Code</ns1:DictionaryEntryName> <ns1:Definition>A code signifying
        the status of the Despatch Advice with respect to its original
    ...
    :ivar despatch_advice_type_code: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Despatch Advice. Despatch Advice Type
        Code. Code</ns1:DictionaryEntryName> <ns1:Definition>A code
        signifying the type of the Despatch Advice.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Despatch Advice</ns1:ObjectClass>
        <ns1:PropertyTerm>Despatch Advice Type Code</ns1:PropertyTerm>
        <ns1:RepresentationTerm>Code</ns1:RepresentationTerm>
        <ns1:DataType>Code. Type</ns1:DataType> </ns1:Component>
    :ivar note: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Despatch Advice. Note.
    ...
    :ivar line_count_numeric: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Despatch Advice. Line Count.
        Numeric</ns1:DictionaryEntryName> <ns1:Definition>The number of
        Despatch Lines in this document.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Despatch Advice</ns1:ObjectClass>
    ...
    :ivar order_reference: <ns1:Component
        ...
        <ns1:DictionaryEntryName>Despatch Advice. Order
        Reference</ns1:DictionaryEntryName> <ns1:Definition>A reference
        to an Order with which this Despatch Advice is
    ...
    :ivar additional_document_reference: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Despatch Advice. Additional_ Document
    ...
    :ivar despatch_supplier_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Despatch Advice. Despatch_ Supplier
        Party. Supplier Party</ns1:DictionaryEntryName>
        <ns1:Definition>The despatch party.</ns1:Definition>
        <ns1:Cardinality>1</ns1:Cardinality> <ns1:ObjectClass>Despatch
    ...
    :ivar delivery_customer_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Despatch Advice. Delivery_ Customer
        Party. Customer Party</ns1:DictionaryEntryName>
        <ns1:Definition>The delivery recipient.</ns1:Definition>
        <ns1:Cardinality>1</ns1:Cardinality> <ns1:ObjectClass>Despatch
        Advice</ns1:ObjectClass>
    ...
    :ivar buyer_customer_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Despatch Advice. Buyer_ Customer Party.
    ...
    :ivar seller_supplier_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Despatch Advice. Seller_ Supplier
        Party. Supplier Party</ns1:DictionaryEntryName>
    ...
    :ivar originator_customer_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Despatch Advice. Originator_ Customer
        Party. Customer Party</ns1:DictionaryEntryName>
        <ns1:Definition>A customer party as originator.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Despatch Advice</ns1:ObjectClass>
    ...
    :ivar despatch_line: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Despatch Advice. Despatch
        Line</ns1:DictionaryEntryName> <ns1:Definition>A Despatch Line
        associated with a kind of item delivered.</ns1:Definition>
        <ns1:Cardinality>1..n</ns1:Cardinality>
        <ns1:ObjectClass>Despatch Advice</ns1:ObjectClass>
        <ns1:PropertyTerm>Despatch Line</ns1:PropertyTerm>
        <ns1:AssociatedObjectClass>Despatch
        Line</ns1:AssociatedObjectClass>
        <ns1:RepresentationTerm>Despatch Line</ns1:RepresentationTerm>
        </ns1:Component>
    """
    ...
    despatch_line: list[DespatchLine] = field(
        default_factory=list,
        metadata={
            "name": "DespatchLine",
            "type": "Element",
