...
class TenderType:
    ...
    <ns1:ComponentType>ABIE</ns1:ComponentType> <ns1:DictionaryEntryName>Tender.

    Details</ns1:DictionaryEntryName> <ns1:Definition>A document whereby
    an economic operator (the tenderer) makes a formal offer (the
    tender) to a contracting authority to execute an order for the
    supply or purchase of goods, or for the execution of work, according
    to the terms of a proposed contract.</ns1:Definition>
    <ns1:ObjectClass>Tender</ns1:ObjectClass> </ns1:Component>
    ...
    :ivar ublversion_id: <ns1:Component
        ...
        <ns1:DictionaryEntryName>Tender. UBL Version Identifier.
        ...
        <ns1:ObjectClass>Tender</ns1:ObjectClass> <ns1:PropertyTerm>UBL
    ...
    :ivar profile_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Tender. Profile Identifier.
        Identifier</ns1:DictionaryEntryName> <ns1:Definition>Identifies
    ...
    :ivar profile_execution_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Tender. Profile Execution Identifier.
        Identifier</ns1:DictionaryEntryName> <ns1:Definition>Identifies
    ...
    :ivar id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Tender.
    ...
    :ivar copy_indicator: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Tender. Copy_ Indicator.
    ...
    :ivar uuid: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Tender. UUID.
        ...
        <ns1:RepresentationTerm>Identifier</ns1:RepresentationTerm>
        <ns1:DataType>Identifier. Type</ns1:DataType> </ns1:Component>
    :ivar tender_type_code: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Tender. Tender Type Code.
        Code</ns1:DictionaryEntryName> <ns1:Definition>A code to specify
        the type of tender (economical or objective criteria versus
        technical or subjective criteria)</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Tender</ns1:ObjectClass>
        <ns1:PropertyTerm>Tender Type Code</ns1:PropertyTerm>
    ...
    :ivar contract_folder_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Tender. Contract Folder Identifier.
        Identifier</ns1:DictionaryEntryName> <ns1:Definition>An
        identifier, assigned by the sender, for the process file (i.e.,
        record) to which this document belongs.</ns1:Definition>
    ...
    :ivar issue_date: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Tender. Issue Date.
    ...
    :ivar issue_time: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Tender. Issue Time.
    ...
    :ivar contract_name: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Tender. Contract Name.
        Text</ns1:DictionaryEntryName> <ns1:Definition>Short title of a
        contract associated with this Tender.</ns1:Definition>
        <ns1:Cardinality>0..n</ns1:Cardinality>
        <ns1:ObjectClass>Tender</ns1:ObjectClass>
        <ns1:PropertyTerm>Contract Name</ns1:PropertyTerm>
    ...
    :ivar note: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Tender. Note.
    ...
    :ivar validity_period: <ns1:Component
        ...
        <ns1:DictionaryEntryName>Tender. Validity_ Period.
        Period</ns1:DictionaryEntryName> <ns1:Definition>The period for
        which the Tender is valid.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Tender</ns1:ObjectClass>
    ...
    :ivar document_reference: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Tender. Document
    ...
    :ivar tenderer_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Tender. Tenderer_ Party.
        Party</ns1:DictionaryEntryName> <ns1:Definition>The primary
        tenderer.</ns1:Definition> <ns1:Cardinality>1</ns1:Cardinality>
        <ns1:ObjectClass>Tender</ns1:ObjectClass>
        <ns1:PropertyTermQualifier>Tenderer</ns1:PropertyTermQualifier>
    ...
    :ivar tenderer_qualification_document_reference: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Tender. Tenderer Qualification_
        Document Reference. Document Reference</ns1:DictionaryEntryName>
        <ns1:Definition>A reference to the tenderer qualification
        document that has been used to qualify the
        tenderer.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Tender</ns1:ObjectClass>
        <ns1:PropertyTermQualifier>Tenderer
        Qualification</ns1:PropertyTermQualifier>
        <ns1:PropertyTerm>Document Reference</ns1:PropertyTerm>
        <ns1:AssociatedObjectClass>Document
        Reference</ns1:AssociatedObjectClass>
        <ns1:RepresentationTerm>Document
        Reference</ns1:RepresentationTerm> </ns1:Component>
    :ivar subcontractor_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Tender. Subcontractor_ Party.
        Party</ns1:DictionaryEntryName> <ns1:Definition>A subcontractor
        or other tenderer participating in the same
        Tender.</ns1:Definition> <ns1:Cardinality>0..n</ns1:Cardinality>
        <ns1:ObjectClass>Tender</ns1:ObjectClass>
        <ns1:PropertyTermQualifier>Subcontractor</ns1:PropertyTermQualifier>
        <ns1:PropertyTerm>Party</ns1:PropertyTerm>
        <ns1:AssociatedObjectClass>Party</ns1:AssociatedObjectClass>
        <ns1:RepresentationTerm>Party</ns1:RepresentationTerm>
        </ns1:Component>
    :ivar contracting_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Tender. Contracting
    ...
    :ivar originator_customer_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Tender. Originator_ Customer Party.
        Customer Party</ns1:DictionaryEntryName> <ns1:Definition>The
        party originating the Tender.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Tender</ns1:ObjectClass>
    ...
    :ivar tendered_project: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Tender. Tendered
        Project</ns1:DictionaryEntryName> <ns1:Definition>A project with
        which this Tender is associated. A single Tender can be used to
        bid for one project, multiple projects, or the global
        project.</ns1:Definition>
        <ns1:Cardinality>1..n</ns1:Cardinality>
        <ns1:ObjectClass>Tender</ns1:ObjectClass>
        <ns1:PropertyTerm>Tendered Project</ns1:PropertyTerm>
        <ns1:AssociatedObjectClass>Tendered
        Project</ns1:AssociatedObjectClass>
        <ns1:RepresentationTerm>Tendered
