...
class TransportProgressStatusType:
    ...
    Details</ns1:DictionaryEntryName> <ns1:Definition>A document sent
    from a Transportation Network Manager to a Transport Service
    Provider giving the status of the whereabouts and schedule of the
    transport means involved in a transport service.</ns1:Definition>
    <ns1:ObjectClass>Transport Progress Status</ns1:ObjectClass>
    </ns1:Component>
    ...
    :ivar ublversion_id: <ns1:Component
        ...
        <ns1:DictionaryEntryName>Transport Progress Status. UBL Version
    ...
    :ivar customization_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transport Progress Status.
    ...
    :ivar profile_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transport Progress Status. Profile
        Identifier. Identifier</ns1:DictionaryEntryName>
    ...
    :ivar copy_indicator: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transport Progress Status. Copy_
    ...
    :ivar uuid: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transport Progress Status. UUID.
    ...
    :ivar issue_date: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transport Progress Status. Issue Date.
    ...
    :ivar issue_time: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transport Progress Status. Issue Time.
    ...
    :ivar note: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transport Progress Status. Note.
    ...
    :ivar status_available_indicator: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transport Progress Status. Status
        Available_ Indicator. Indicator</ns1:DictionaryEntryName>
        <ns1:Definition>Indicates whether transport progress information
        is available.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Transport Progress Status</ns1:ObjectClass>
        <ns1:PropertyTermQualifier>Status
        Available</ns1:PropertyTermQualifier>
        <ns1:PropertyTerm>Indicator</ns1:PropertyTerm>
        <ns1:RepresentationTerm>Indicator</ns1:RepresentationTerm>
        <ns1:DataType>Indicator. Type</ns1:DataType> </ns1:Component>
    ...
    :ivar sender_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transport Progress Status. Sender_
        Party. Party</ns1:DictionaryEntryName> <ns1:Definition>The party
        sending the Transport Progress Status.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Transport Progress Status</ns1:ObjectClass>
    ...
    :ivar receiver_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transport Progress Status. Receiver_
        Party. Party</ns1:DictionaryEntryName> <ns1:Definition>The party
        receiving the Transport Progress Status.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Transport Progress Status</ns1:ObjectClass>
    ...
    :ivar source_issuer_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transport Progress Status. Source
        Issuer_ Party. Party</ns1:DictionaryEntryName>
        <ns1:Definition>The party that is the source of the Transport
        Progress Status.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Transport Progress Status</ns1:ObjectClass>
        <ns1:PropertyTermQualifier>Source
        Issuer</ns1:PropertyTermQualifier>
        <ns1:PropertyTerm>Party</ns1:PropertyTerm>
        <ns1:AssociatedObjectClass>Party</ns1:AssociatedObjectClass>
        <ns1:RepresentationTerm>Party</ns1:RepresentationTerm>
        </ns1:Component>
    :ivar transport_progress_status_request_document_reference:
        <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transport Progress Status. Transport
        Progress Status Request_ Document Reference. Document
        Reference</ns1:DictionaryEntryName> <ns1:Definition>A reference
        to the Transport Progress Status Request document to which this
        status report is a response.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Transport Progress Status</ns1:ObjectClass>
        <ns1:PropertyTermQualifier>Transport Progress Status
    ...
    :ivar transport_means: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transport Progress Status. Transport
        Means</ns1:DictionaryEntryName> <ns1:Definition>The transport
        means by which the current transport service is
        effectuated.</ns1:Definition>
        <ns1:Cardinality>1</ns1:Cardinality> <ns1:ObjectClass>Transport
        Progress Status</ns1:ObjectClass> <ns1:PropertyTerm>Transport
        Means</ns1:PropertyTerm> <ns1:AssociatedObjectClass>Transport
        Means</ns1:AssociatedObjectClass>
        <ns1:RepresentationTerm>Transport Means</ns1:RepresentationTerm>
        </ns1:Component>
    :ivar transport_schedule: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transport Progress Status. Transport
        Schedule</ns1:DictionaryEntryName> <ns1:Definition>Describes the
        status and schedule of the transport means operating the
        transport service as well as the current location of the
        transport means.</ns1:Definition>
        <ns1:Cardinality>0..n</ns1:Cardinality>
        <ns1:ObjectClass>Transport Progress Status</ns1:ObjectClass>
        <ns1:PropertyTerm>Transport Schedule</ns1:PropertyTerm>
        <ns1:AssociatedObjectClass>Transport
        Schedule</ns1:AssociatedObjectClass>
        <ns1:RepresentationTerm>Transport
        Schedule</ns1:RepresentationTerm> </ns1:Component>
    """
    ...
    transport_progress_status_request_document_reference: Optional[
        TransportProgressStatusRequestDocumentReference
    ] = field(
        default=None,
        metadata={
