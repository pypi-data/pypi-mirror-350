...
class ContractAwardNoticeType:
    ...
    <ns1:ComponentType>ABIE</ns1:ComponentType> <ns1:DictionaryEntryName>Contract
    Award Notice.

    Details</ns1:DictionaryEntryName> <ns1:Definition>A document
    published by a Contracting Party to announce the awarding of a
    procurement project.</ns1:Definition> <ns1:ObjectClass>Contract
    Award Notice</ns1:ObjectClass> </ns1:Component>
    ...
    :ivar ublversion_id: <ns1:Component
        ...
        <ns1:DictionaryEntryName>Contract Award Notice. UBL Version
        ...
        <ns1:ObjectClass>Contract Award Notice</ns1:ObjectClass>
    ...
    :ivar customization_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Contract Award Notice. Customization
        Identifier. Identifier</ns1:DictionaryEntryName>
    ...
    :ivar profile_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Contract Award Notice. Profile
        Identifier. Identifier</ns1:DictionaryEntryName>
    ...
    :ivar id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Contract Award Notice.
    ...
    :ivar copy_indicator: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Contract Award Notice. Copy_ Indicator.
    ...
    :ivar uuid: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Contract Award Notice. UUID.
    ...
    :ivar contract_folder_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Contract Award Notice. Contract Folder
        Identifier. Identifier</ns1:DictionaryEntryName>
    ...
    :ivar issue_date: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Contract Award Notice. Issue Date.
    ...
    :ivar issue_time: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Contract Award Notice. Issue Time.
    ...
    :ivar note: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Contract Award Notice. Note.
    ...
    :ivar regulatory_domain: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Contract Award Notice. Regulatory
        Domain. Text</ns1:DictionaryEntryName>
        <ns1:Definition>Information about the law that defines the
        regulatory domain.</ns1:Definition>
        <ns1:Cardinality>0..n</ns1:Cardinality>
        <ns1:ObjectClass>Contract Award Notice</ns1:ObjectClass>
        <ns1:PropertyTerm>Regulatory Domain</ns1:PropertyTerm>
        <ns1:RepresentationTerm>Text</ns1:RepresentationTerm>
        <ns1:DataType>Text. Type</ns1:DataType> </ns1:Component>
    :ivar publish_award_indicator: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Contract Award Notice. Publish Award
        Indicator. Indicator</ns1:DictionaryEntryName>
        <ns1:Definition>An indicator specifying if the notice is
        published for service contracts within certain service
        categories (true) or not (false).</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Contract Award Notice</ns1:ObjectClass>
        <ns1:PropertyTerm>Publish Award Indicator</ns1:PropertyTerm>
        <ns1:RepresentationTerm>Indicator</ns1:RepresentationTerm>
        <ns1:DataType>Indicator. Type</ns1:DataType> </ns1:Component>
    :ivar previous_document_reference: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Contract Award Notice. Previous_
        Document Reference. Document Reference</ns1:DictionaryEntryName>
        <ns1:Definition>A reference to a previously sent
        document.</ns1:Definition>
        <ns1:Cardinality>0..n</ns1:Cardinality>
        <ns1:ObjectClass>Contract Award Notice</ns1:ObjectClass>
    ...
    :ivar minutes_document_reference: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Contract Award Notice. Minutes_
        Document Reference. Document Reference</ns1:DictionaryEntryName>
        <ns1:Definition>A reference to a set of
        minutes.</ns1:Definition>
        <ns1:Cardinality>0..n</ns1:Cardinality>
        <ns1:ObjectClass>Contract Award Notice</ns1:ObjectClass>
    ...
    :ivar contracting_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Contract Award Notice. Contracting
    ...
    :ivar originator_customer_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Contract Award Notice. Originator_
    ...
    :ivar receiver_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Contract Award Notice. Receiver_ Party.
    ...
    :ivar tendering_terms: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Contract Award Notice. Tendering
        Terms</ns1:DictionaryEntryName> <ns1:Definition>The tendering
        terms associated with this tendering process.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Contract Award Notice</ns1:ObjectClass>
        <ns1:PropertyTerm>Tendering Terms</ns1:PropertyTerm>
        <ns1:AssociatedObjectClass>Tendering
    ...
    :ivar tendering_process: <ns1:Component
        ...
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Contract Award Notice</ns1:ObjectClass>
        <ns1:PropertyTerm>Tendering Process</ns1:PropertyTerm>
        <ns1:AssociatedObjectClass>Tendering
    ...
    :ivar procurement_project: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Contract Award Notice. Procurement
        Project</ns1:DictionaryEntryName> <ns1:Definition>An overall
        definition of this procurement project.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Contract Award Notice</ns1:ObjectClass>
        <ns1:PropertyTerm>Procurement Project</ns1:PropertyTerm>
    ...
    :ivar procurement_project_lot: <ns1:Component
        ...
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Contract Award Notice. Procurement
        Project Lot</ns1:DictionaryEntryName> <ns1:Definition>One of the
    ...
    :ivar tender_result: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Contract Award Notice. Tender
        Result</ns1:DictionaryEntryName> <ns1:Definition>A result of the
        bid opening in the tendering process.</ns1:Definition>
        <ns1:Cardinality>1..n</ns1:Cardinality>
        <ns1:ObjectClass>Contract Award Notice</ns1:ObjectClass>
        <ns1:PropertyTerm>Tender Result</ns1:PropertyTerm>
        <ns1:AssociatedObjectClass>Tender
