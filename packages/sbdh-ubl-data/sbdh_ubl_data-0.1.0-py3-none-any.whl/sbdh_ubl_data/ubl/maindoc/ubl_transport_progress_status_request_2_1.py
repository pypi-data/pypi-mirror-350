...
class TransportProgressStatusRequestType:
    ...
    from a transport service provider to a transportation network
    manager requesting a Transport Progress Status.</ns1:Definition>
    <ns1:ObjectClass>Transport Progress Status Request</ns1:ObjectClass>
    </ns1:Component>
    ...
    :ivar ublversion_id: <ns1:Component
        ...
        <ns1:DictionaryEntryName>Transport Progress Status Request. UBL
        ...
        <ns1:ObjectClass>Transport Progress Status
    ...
    :ivar customization_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transport Progress Status Request.
    ...
    :ivar copy_indicator: <ns1:Component
        ...
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transport Progress Status Request.
        Copy_ Indicator. Indicator</ns1:DictionaryEntryName>
    ...
    :ivar sender_party: <ns1:Component
        ...
        <ns1:Definition>The party sending the Transport Progress Status
    ...
    :ivar receiver_party: <ns1:Component
        ...
        <ns1:Definition>The party receiving the Transport Progress
        Status Request.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Transport Progress Status
        Request</ns1:ObjectClass>
    ...
    :ivar transport_means: <ns1:Component
        ...
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transport Progress Status Request.
        Transport Means</ns1:DictionaryEntryName> <ns1:Definition>The
        transport means by which the current transport service is
        effectuated and for which status is requested.</ns1:Definition>
        <ns1:Cardinality>1</ns1:Cardinality> <ns1:ObjectClass>Transport
        Progress Status Request</ns1:ObjectClass>
        <ns1:PropertyTerm>Transport Means</ns1:PropertyTerm>
    ...
    :ivar status_location: <ns1:Component
        ...
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transport Progress Status Request.
        Status_ Location. Location</ns1:DictionaryEntryName>
