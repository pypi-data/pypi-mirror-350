...
class ForecastRevisionType:
    ...
    <ns1:ComponentType>ABIE</ns1:ComponentType> <ns1:DictionaryEntryName>Forecast
    Revision.

    Details</ns1:DictionaryEntryName> <ns1:Definition>A document used to
    revise a Forecast.</ns1:Definition> <ns1:ObjectClass>Forecast
    Revision</ns1:ObjectClass> <ns1:AlternativeBusinessTerms>Forecast
    Revision</ns1:AlternativeBusinessTerms> </ns1:Component>
    ...
    :ivar ublversion_id: <ns1:Component
        ...
        <ns1:DictionaryEntryName>Forecast Revision. UBL Version
        ...
        <ns1:ObjectClass>Forecast Revision</ns1:ObjectClass>
    ...
    :ivar customization_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Forecast Revision. Customization
        Identifier. Identifier</ns1:DictionaryEntryName>
    ...
    :ivar profile_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Forecast Revision. Profile Identifier.
    ...
    :ivar profile_execution_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Forecast Revision. Profile Execution
        Identifier. Identifier</ns1:DictionaryEntryName>
    ...
    :ivar id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Forecast Revision.
        ...
        <ns1:RepresentationTerm>Identifier</ns1:RepresentationTerm>
        <ns1:DataType>Identifier. Type</ns1:DataType>
        <ns1:AlternativeBusinessTerms>Forecast Revision
        Number</ns1:AlternativeBusinessTerms> </ns1:Component>
    :ivar copy_indicator: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Forecast Revision. Copy_ Indicator.
    ...
    :ivar uuid: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Forecast Revision. UUID.
    ...
    :ivar issue_date: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Forecast Revision. Issue Date.
        ...
        <ns1:AlternativeBusinessTerms>Forecast
        Date</ns1:AlternativeBusinessTerms> </ns1:Component>
    :ivar issue_time: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Forecast Revision. Issue Time.
    ...
    :ivar note: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Forecast Revision. Note.
    ...
    :ivar sequence_number_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Forecast Revision. Sequence Number.
        Identifier</ns1:DictionaryEntryName> <ns1:Definition>A sequence
        number, to ensure the proper sequencing of
        revisions.</ns1:Definition> <ns1:Cardinality>1</ns1:Cardinality>
        <ns1:ObjectClass>Forecast Revision</ns1:ObjectClass>
        <ns1:PropertyTerm>Sequence Number</ns1:PropertyTerm>
        <ns1:RepresentationTerm>Identifier</ns1:RepresentationTerm>
        <ns1:DataType>Identifier. Type</ns1:DataType> </ns1:Component>
    :ivar revision_status_code: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Forecast Revision. Revision_ Status
        Code. Code</ns1:DictionaryEntryName> <ns1:Definition>Indicates
        the revision status of this Forecast Revision.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Forecast Revision</ns1:ObjectClass>
        <ns1:PropertyTermQualifier>Revision</ns1:PropertyTermQualifier>
        <ns1:PropertyTerm>Status Code</ns1:PropertyTerm>
        <ns1:RepresentationTerm>Code</ns1:RepresentationTerm>
        <ns1:DataType>Code. Type</ns1:DataType> </ns1:Component>
    :ivar purpose_code: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Forecast Revision. Purpose Code.
        Code</ns1:DictionaryEntryName> <ns1:Definition>Indicates the
        purpose of the revision.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Forecast Revision</ns1:ObjectClass>
        <ns1:PropertyTerm>Purpose Code</ns1:PropertyTerm>
        <ns1:RepresentationTerm>Code</ns1:RepresentationTerm>
        <ns1:DataType>Code. Type</ns1:DataType> </ns1:Component>
    :ivar forecast_period: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Forecast Revision. Forecast_ Period.
        Period</ns1:DictionaryEntryName> <ns1:Definition>The period to
        which the Forecast applies.</ns1:Definition>
        <ns1:Cardinality>1</ns1:Cardinality> <ns1:ObjectClass>Forecast
        Revision</ns1:ObjectClass>
        <ns1:PropertyTermQualifier>Forecast</ns1:PropertyTermQualifier>
    ...
    :ivar original_document_reference: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Forecast Revision. Original_ Document
        Reference. Document Reference</ns1:DictionaryEntryName>
        <ns1:Definition>The Forecast document being
    ...
    :ivar sender_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Forecast Revision. Sender_ Party.
    ...
    :ivar receiver_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Forecast Revision. Receiver_ Party.
        Party</ns1:DictionaryEntryName> <ns1:Definition>The party
    ...
    :ivar buyer_customer_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Forecast Revision. Buyer_ Customer
    ...
    :ivar seller_supplier_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Forecast Revision. Seller_ Supplier
    ...
    :ivar forecast_revision_line: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Forecast Revision. Forecast Revision
        Line</ns1:DictionaryEntryName> <ns1:Definition>A line that
        revises a line in the Forecast.</ns1:Definition>
        <ns1:Cardinality>1..n</ns1:Cardinality>
        <ns1:ObjectClass>Forecast Revision</ns1:ObjectClass>
        <ns1:PropertyTerm>Forecast Revision Line</ns1:PropertyTerm>
        <ns1:AssociatedObjectClass>Forecast Revision
        Line</ns1:AssociatedObjectClass>
        <ns1:RepresentationTerm>Forecast Revision
    ...
    forecast_revision_line: list[ForecastRevisionLine] = field(
        default_factory=list,
        metadata={
