...
class FreightInvoiceType:
    ...
    <ns1:ComponentType>ABIE</ns1:ComponentType> <ns1:DictionaryEntryName>Freight
    Invoice.

    Details</ns1:DictionaryEntryName> <ns1:Definition>A document stating
    the charges incurred for a logistics service.</ns1:Definition>
    <ns1:ObjectClass>Freight Invoice</ns1:ObjectClass> </ns1:Component>
    ...
    :ivar ublversion_id: <ns1:Component
        ...
        <ns1:DictionaryEntryName>Freight Invoice. UBL Version
        ...
        <ns1:Cardinality>0..1</ns1:Cardinality> <ns1:ObjectClass>Freight
        Invoice</ns1:ObjectClass> <ns1:PropertyTerm>UBL Version
    ...
    :ivar customization_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Customization
        Identifier. Identifier</ns1:DictionaryEntryName>
        <ns1:Definition>Identifies a user-defined customization of UBL
        for a specific use.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality> <ns1:ObjectClass>Freight
        Invoice</ns1:ObjectClass> <ns1:PropertyTerm>Customization
        Identifier</ns1:PropertyTerm>
        <ns1:RepresentationTerm>Identifier</ns1:RepresentationTerm>
        <ns1:DataType>Identifier. Type</ns1:DataType>
    ...
    :ivar profile_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Profile Identifier.
        ...
        <ns1:ObjectClass>Freight Invoice</ns1:ObjectClass>
    ...
    :ivar profile_execution_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Profile Execution
        Identifier. Identifier</ns1:DictionaryEntryName>
        ...
        <ns1:Cardinality>0..1</ns1:Cardinality> <ns1:ObjectClass>Freight
        Invoice</ns1:ObjectClass> <ns1:PropertyTerm>Profile Execution
        Identifier</ns1:PropertyTerm>
        <ns1:RepresentationTerm>Identifier</ns1:RepresentationTerm>
        <ns1:DataType>Identifier. Type</ns1:DataType>
    ...
    :ivar id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice.
    ...
    :ivar copy_indicator: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Copy_ Indicator.
    ...
    :ivar uuid: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. UUID.
    ...
    :ivar issue_date: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Issue Date.
    ...
    :ivar issue_time: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Issue Time.
    ...
    :ivar invoice_type_code: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Invoice Type Code.
        Code</ns1:DictionaryEntryName> <ns1:Definition>A code signifying
        the type of the Freight Invoice.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality> <ns1:ObjectClass>Freight
        Invoice</ns1:ObjectClass> <ns1:PropertyTerm>Invoice Type
    ...
    :ivar note: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Note.
        ...
        <ns1:Cardinality>0..n</ns1:Cardinality> <ns1:ObjectClass>Freight
        Invoice</ns1:ObjectClass>
    ...
    :ivar tax_point_date: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Tax Point Date.
        Date</ns1:DictionaryEntryName> <ns1:Definition>The date of the
        Freight Invoice, used to indicate the point at which tax becomes
        applicable.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality> <ns1:ObjectClass>Freight
        Invoice</ns1:ObjectClass> <ns1:PropertyTerm>Tax Point
    ...
    :ivar document_currency_code: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Document_ Currency
    ...
    :ivar tax_currency_code: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Tax_ Currency Code.
        Code</ns1:DictionaryEntryName> <ns1:Definition>A code signifying
        the currency used for tax amounts in the Freight
    ...
    :ivar pricing_currency_code: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Pricing_ Currency
        Code. Code</ns1:DictionaryEntryName> <ns1:Definition>A code
        signifying the currency used for prices in the Freight
        Invoice.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality> <ns1:ObjectClass>Freight
        Invoice</ns1:ObjectClass>
    ...
    :ivar payment_currency_code: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Payment_ Currency
        Code. Code</ns1:DictionaryEntryName> <ns1:Definition>A code
        signifying the currency used for payment in the Freight
        Invoice.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality> <ns1:ObjectClass>Freight
        Invoice</ns1:ObjectClass>
    ...
    :ivar payment_alternative_currency_code: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Payment Alternative_
        ...
        Freight Invoice.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality> <ns1:ObjectClass>Freight
        Invoice</ns1:ObjectClass> <ns1:PropertyTermQualifier>Payment
    ...
    :ivar accounting_cost_code: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Accounting Cost Code.
        Code</ns1:DictionaryEntryName> <ns1:Definition>The buyer's
        accounting code, applied to the Freight Invoice as a
    ...
    :ivar accounting_cost: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Accounting Cost.
        Text</ns1:DictionaryEntryName> <ns1:Definition>The buyer's
        accounting cost centre, applied to the Freight Invoice as a
        whole, expressed as text.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality> <ns1:ObjectClass>Freight
        Invoice</ns1:ObjectClass> <ns1:PropertyTerm>Accounting
    ...
    :ivar line_count_numeric: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Line Count.
        Numeric</ns1:DictionaryEntryName> <ns1:Definition>The number of
        Invoice Lines in the document.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality> <ns1:ObjectClass>Freight
        Invoice</ns1:ObjectClass> <ns1:PropertyTerm>Line
    ...
    :ivar invoice_period: <ns1:Component
        ...
        <ns1:DictionaryEntryName>Freight Invoice. Invoice_ Period.
        Period</ns1:DictionaryEntryName> <ns1:Definition>The time
        periods to which the Freight Invoice applies.</ns1:Definition>
        <ns1:Cardinality>0..n</ns1:Cardinality> <ns1:ObjectClass>Freight
        Invoice</ns1:ObjectClass>
    ...
    :ivar shipment: <ns1:Component
        ...
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice.
        Shipment</ns1:DictionaryEntryName> <ns1:Definition>Details about
        one or more shipments covered by this Freight
        Invoice.</ns1:Definition>
        <ns1:Cardinality>1..n</ns1:Cardinality> <ns1:ObjectClass>Freight
        Invoice</ns1:ObjectClass>
    ...
    :ivar order_reference: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Order
        Reference</ns1:DictionaryEntryName> <ns1:Definition>Reference to
        an Order associated with this Freight Invoice.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality> <ns1:ObjectClass>Freight
        Invoice</ns1:ObjectClass> <ns1:PropertyTerm>Order
    ...
    :ivar despatch_document_reference: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Despatch_ Document
    ...
    :ivar receipt_document_reference: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Receipt_ Document
        Reference. Document Reference</ns1:DictionaryEntryName>
    ...
    :ivar originator_document_reference: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Originator_ Document
        Reference. Document Reference</ns1:DictionaryEntryName>
    ...
    :ivar contract_document_reference: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Contract_ Document
        Reference. Document Reference</ns1:DictionaryEntryName>
    ...
    :ivar additional_document_reference: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Additional_ Document
        Reference. Document Reference</ns1:DictionaryEntryName>
    ...
    :ivar accounting_supplier_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Accounting_ Supplier
        Party. Supplier Party</ns1:DictionaryEntryName>
        <ns1:Definition>The accounting supplier party.</ns1:Definition>
        <ns1:Cardinality>1</ns1:Cardinality> <ns1:ObjectClass>Freight
        Invoice</ns1:ObjectClass>
    ...
    :ivar accounting_customer_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Accounting_ Customer
    ...
    :ivar payee_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Payee_ Party.
    ...
    :ivar tax_representative_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Tax Representative_
        Party. Party</ns1:DictionaryEntryName> <ns1:Definition>The tax
        representative.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality> <ns1:ObjectClass>Freight
        Invoice</ns1:ObjectClass> <ns1:PropertyTermQualifier>Tax
    ...
    :ivar payment_means: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Payment
        Means</ns1:DictionaryEntryName> <ns1:Definition>Expected means
        of payment.</ns1:Definition>
        <ns1:Cardinality>0..n</ns1:Cardinality> <ns1:ObjectClass>Freight
        Invoice</ns1:ObjectClass> <ns1:PropertyTerm>Payment
    ...
    :ivar prepaid_payment: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Prepaid_ Payment.
    ...
    :ivar tax_exchange_rate: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Tax_ Exchange Rate.
    ...
    :ivar pricing_exchange_rate: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Pricing_ Exchange
    ...
    :ivar payment_exchange_rate: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Payment_ Exchange
        Rate. Exchange Rate</ns1:DictionaryEntryName>
        <ns1:Definition>The exchange rate between the document currency
    ...
    :ivar legal_monetary_total: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Legal_ Monetary Total.
        Monetary Total</ns1:DictionaryEntryName> <ns1:Definition>The
        total amount payable on the Freight Invoice, including
        Allowances, Charges, and Taxes.</ns1:Definition>
        <ns1:Cardinality>1</ns1:Cardinality> <ns1:ObjectClass>Freight
        Invoice</ns1:ObjectClass>
    ...
    :ivar invoice_line: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Freight Invoice. Invoice
        Line</ns1:DictionaryEntryName> <ns1:Definition>An Invoice
