...
class TradeItemLocationProfileType:
    ...
    <ns1:ComponentType>ABIE</ns1:ComponentType> <ns1:DictionaryEntryName>Trade Item
    Location Profile.

    Details</ns1:DictionaryEntryName> <ns1:Definition>A document
    specifying trade item attributes relating to replenishment
    policies.</ns1:Definition> <ns1:ObjectClass>Trade Item Location
    Profile</ns1:ObjectClass> <ns1:AlternativeBusinessTerms>TradeItem
    ...
    :ivar ublversion_id: <ns1:Component
        ...
        <ns1:DictionaryEntryName>Trade Item Location Profile. UBL
        ...
        <ns1:Cardinality>0..1</ns1:Cardinality> <ns1:ObjectClass>Trade
        Item Location Profile</ns1:ObjectClass> <ns1:PropertyTerm>UBL
    ...
    :ivar customization_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Trade Item Location Profile.
        ...
        <ns1:Cardinality>0..1</ns1:Cardinality> <ns1:ObjectClass>Trade
        Item Location Profile</ns1:ObjectClass>
    ...
    :ivar profile_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Trade Item Location Profile. Profile
    ...
    :ivar id: <ns1:Component
        ...
        <ns1:ObjectClass>Trade Item Location Profile</ns1:ObjectClass>
    ...
    :ivar copy_indicator: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Trade Item Location Profile. Copy_
    ...
    :ivar uuid: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Trade Item Location Profile. UUID.
    ...
    :ivar issue_date: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Trade Item Location Profile. Issue
    ...
    :ivar note: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Trade Item Location Profile. Note.
        ...
        <ns1:Cardinality>0..n</ns1:Cardinality> <ns1:ObjectClass>Trade
        Item Location Profile</ns1:ObjectClass>
    ...
    :ivar profile_status_code: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Trade Item Location Profile. Profile_
        Status Code. Code</ns1:DictionaryEntryName> <ns1:Definition>A
        code signifying the status of this Trade Item Location
        Profile.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality> <ns1:ObjectClass>Trade
        Item Location Profile</ns1:ObjectClass>
        <ns1:PropertyTermQualifier>Profile</ns1:PropertyTermQualifier>
    ...
    :ivar period: <ns1:Component
        ...
        <ns1:DictionaryEntryName>Trade Item Location Profile.
        Period</ns1:DictionaryEntryName> <ns1:Definition>An association
        to Period.</ns1:Definition> <ns1:Cardinality>1</ns1:Cardinality>
        <ns1:ObjectClass>Trade Item Location Profile</ns1:ObjectClass>
    ...
    :ivar document_reference: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Trade Item Location Profile. Document
    ...
    :ivar sender_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Trade Item Location Profile. Sender_
    ...
    :ivar receiver_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Trade Item Location Profile. Receiver_
        Party. Party</ns1:DictionaryEntryName> <ns1:Definition>The
        receiver.</ns1:Definition> <ns1:Cardinality>1</ns1:Cardinality>
        <ns1:ObjectClass>Trade Item Location Profile</ns1:ObjectClass>
    ...
    :ivar buyer_customer_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Trade Item Location Profile. Buyer_
    ...
    :ivar seller_supplier_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Trade Item Location Profile. Seller_
    ...
    :ivar item_management_profile: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Trade Item Location Profile. Item
        Management Profile</ns1:DictionaryEntryName> <ns1:Definition>A
        profile specifying replenishment policies for a particular trade
        item.</ns1:Definition> <ns1:Cardinality>1..n</ns1:Cardinality>
        <ns1:ObjectClass>Trade Item Location Profile</ns1:ObjectClass>
        <ns1:PropertyTerm>Item Management Profile</ns1:PropertyTerm>
        <ns1:AssociatedObjectClass>Item Management
        Profile</ns1:AssociatedObjectClass> <ns1:RepresentationTerm>Item
        Management Profile</ns1:RepresentationTerm> </ns1:Component>
    """
    ...
    item_management_profile: list[ItemManagementProfile] = field(
        default_factory=list,
        metadata={
