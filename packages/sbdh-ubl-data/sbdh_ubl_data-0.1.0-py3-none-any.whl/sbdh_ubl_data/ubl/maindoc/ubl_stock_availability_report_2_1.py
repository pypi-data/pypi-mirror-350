...
class StockAvailabilityReportType:
    ...
    <ns1:ComponentType>ABIE</ns1:ComponentType> <ns1:DictionaryEntryName>Stock
    Availability Report.

    Details</ns1:DictionaryEntryName> <ns1:Definition>A report on the
    quantities of each item that are, or will be, in stock. This
    document is sent by a Seller (for example a producer) to a Buyer
    (for example a retailer).</ns1:Definition> <ns1:ObjectClass>Stock
    Availability Report</ns1:ObjectClass>
    ...
    :ivar ublversion_id: <ns1:Component
        ...
        <ns1:DictionaryEntryName>Stock Availability Report. UBL Version
        ...
        <ns1:Cardinality>0..1</ns1:Cardinality> <ns1:ObjectClass>Stock
        Availability Report</ns1:ObjectClass> <ns1:PropertyTerm>UBL
    ...
    :ivar customization_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Stock Availability Report.
    ...
    :ivar profile_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Stock Availability Report. Profile
        Identifier. Identifier</ns1:DictionaryEntryName>
        <ns1:Definition>Identifies a user-defined profile of the
        customization of UBL being used.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality> <ns1:ObjectClass>Stock
        Availability Report</ns1:ObjectClass> <ns1:PropertyTerm>Profile
    ...
    :ivar id: <ns1:Component
        ...
        <ns1:ObjectClass>Stock Availability Report</ns1:ObjectClass>
    ...
    :ivar copy_indicator: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Stock Availability Report. Copy_
    ...
    :ivar uuid: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Stock Availability Report. UUID.
    ...
    :ivar issue_date: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Stock Availability Report. Issue Date.
    ...
    :ivar issue_time: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Stock Availability Report. Issue Time.
    ...
    :ivar note: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Stock Availability Report. Note.
        ...
        <ns1:Cardinality>0..n</ns1:Cardinality> <ns1:ObjectClass>Stock
        Availability Report</ns1:ObjectClass>
    ...
    :ivar document_currency_code: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Stock Availability Report. Document_
    ...
    :ivar inventory_period: <ns1:Component
        ...
        <ns1:DictionaryEntryName>Stock Availability Report. Inventory_
        Period. Period</ns1:DictionaryEntryName> <ns1:Definition>The
        inventory period covered by the Report.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality> <ns1:ObjectClass>Stock
        Availability Report</ns1:ObjectClass>
    ...
    :ivar document_reference: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Stock Availability Report. Document
        Reference</ns1:DictionaryEntryName> <ns1:Definition>A reference
        to another document associated with this
        document.</ns1:Definition>
        <ns1:Cardinality>0..n</ns1:Cardinality> <ns1:ObjectClass>Stock
        Availability Report</ns1:ObjectClass> <ns1:PropertyTerm>Document
    ...
    :ivar seller_supplier_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Stock Availability Report. Seller_
        Supplier Party. Supplier Party</ns1:DictionaryEntryName>
        <ns1:Definition>The seller.</ns1:Definition>
        <ns1:Cardinality>1</ns1:Cardinality> <ns1:ObjectClass>Stock
        Availability Report</ns1:ObjectClass>
    ...
    :ivar retailer_customer_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Stock Availability Report. Retailer_
    ...
    :ivar inventory_reporting_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Stock Availability Report. Inventory
        Reporting_ Party. Party</ns1:DictionaryEntryName>
        <ns1:Definition>The party that will receive and use the Stock
        Availability Report (normally the branch for which the stock is
    ...
    :ivar stock_availability_report_line: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Stock Availability Report. Stock
        Availability Report Line</ns1:DictionaryEntryName>
        <ns1:Definition>A line representing a particular item of sale
        and associated with a line in the Catalogue.</ns1:Definition>
        <ns1:Cardinality>1..n</ns1:Cardinality> <ns1:ObjectClass>Stock
        Availability Report</ns1:ObjectClass> <ns1:PropertyTerm>Stock
        Availability Report Line</ns1:PropertyTerm>
        <ns1:AssociatedObjectClass>Stock Availability Report
        Line</ns1:AssociatedObjectClass> <ns1:RepresentationTerm>Stock
        Availability Report Line</ns1:RepresentationTerm>
        </ns1:Component>
    """
