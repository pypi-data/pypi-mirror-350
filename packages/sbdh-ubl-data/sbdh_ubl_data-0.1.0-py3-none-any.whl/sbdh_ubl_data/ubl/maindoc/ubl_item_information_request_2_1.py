...
class ItemInformationRequestType:
    ...
    <ns1:ComponentType>ABIE</ns1:ComponentType> <ns1:DictionaryEntryName>Item
    Information Request.

    Details</ns1:DictionaryEntryName> <ns1:Definition>A document used to
    request product activity, forecast, or performance
    data.</ns1:Definition> <ns1:ObjectClass>Item Information
    Request</ns1:ObjectClass> <ns1:AlternativeBusinessTerms>Item
    Information Request</ns1:AlternativeBusinessTerms> </ns1:Component>
    ...
    :ivar ublversion_id: <ns1:Component
        ...
        <ns1:DictionaryEntryName>Item Information Request. UBL Version
        ...
        <ns1:Cardinality>0..1</ns1:Cardinality> <ns1:ObjectClass>Item
        Information Request</ns1:ObjectClass> <ns1:PropertyTerm>UBL
    ...
    :ivar customization_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Item Information Request. Customization
        Identifier. Identifier</ns1:DictionaryEntryName>
        <ns1:Definition>Identifies a user-defined customization of UBL
        for a specific use.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality> <ns1:ObjectClass>Item
        Information Request</ns1:ObjectClass>
    ...
    :ivar profile_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Item Information Request. Profile
        Identifier. Identifier</ns1:DictionaryEntryName>
        <ns1:Definition>Identifies a user-defined profile of the
        customization of UBL being used.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality> <ns1:ObjectClass>Item
        Information Request</ns1:ObjectClass> <ns1:PropertyTerm>Profile
    ...
    :ivar id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Item Information Request.
        ...
        <ns1:ObjectClass>Item Information Request</ns1:ObjectClass>
        <ns1:PropertyTerm>Identifier</ns1:PropertyTerm>
        <ns1:RepresentationTerm>Identifier</ns1:RepresentationTerm>
        <ns1:DataType>Identifier. Type</ns1:DataType>
        <ns1:AlternativeBusinessTerms>Item Information Request
        Number</ns1:AlternativeBusinessTerms> </ns1:Component>
    :ivar copy_indicator: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Item Information Request. Copy_
    ...
    :ivar uuid: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Item Information Request. UUID.
    ...
    :ivar issue_date: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Item Information Request. Issue Date.
    ...
    :ivar issue_time: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Item Information Request. Issue Time.
    ...
    :ivar note: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Item Information Request. Note.
        ...
        <ns1:Cardinality>0..n</ns1:Cardinality> <ns1:ObjectClass>Item
        Information Request</ns1:ObjectClass>
    ...
    :ivar period: <ns1:Component
        ...
        <ns1:DictionaryEntryName>Item Information Request.
        Period</ns1:DictionaryEntryName> <ns1:Definition>The period of
        time to which the Item Information Request
        applies.</ns1:Definition> <ns1:Cardinality>1</ns1:Cardinality>
        <ns1:ObjectClass>Item Information Request</ns1:ObjectClass>
    ...
    :ivar document_reference: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Item Information Request. Document
        Reference</ns1:DictionaryEntryName> <ns1:Definition>A reference
        to another document associated with this
        document.</ns1:Definition>
        <ns1:Cardinality>0..n</ns1:Cardinality> <ns1:ObjectClass>Item
        Information Request</ns1:ObjectClass> <ns1:PropertyTerm>Document
    ...
    :ivar sender_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Item Information Request. Sender_
    ...
    :ivar receiver_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Item Information Request. Receiver_
        Party. Party</ns1:DictionaryEntryName> <ns1:Definition>The
    ...
    :ivar buyer_customer_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Item Information Request. Buyer_
    ...
    :ivar seller_supplier_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Item Information Request. Seller_
    ...
    :ivar item_information_request_line: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Item Information Request. Item
        Information Request Line</ns1:DictionaryEntryName>
        <ns1:Definition>A line requesting information regarding an item
        of sale.</ns1:Definition>
        <ns1:Cardinality>1..n</ns1:Cardinality> <ns1:ObjectClass>Item
        Information Request</ns1:ObjectClass> <ns1:PropertyTerm>Item
        Information Request Line</ns1:PropertyTerm>
        <ns1:AssociatedObjectClass>Item Information Request
        Line</ns1:AssociatedObjectClass> <ns1:RepresentationTerm>Item
        Information Request Line</ns1:RepresentationTerm>
        </ns1:Component>
    """
    ...
    item_information_request_line: list[ItemInformationRequestLine] = field(
        default_factory=list,
        metadata={
...
@dataclass
class ItemInformationRequest(ItemInformationRequestType):
    """
    ...
    class Meta:
        namespace = "urn:oasis:names:specification:ubl:schema:xsd:ItemInformationRequest-2"
