...
class PriorInformationNoticeType:
    ...
    <ns1:ComponentType>ABIE</ns1:ComponentType> <ns1:DictionaryEntryName>Prior
    Information Notice.

    Details</ns1:DictionaryEntryName> <ns1:Definition>A document used by
    a contracting party to declare the intention to buy goods, services,
    or works during a specified period.</ns1:Definition>
    <ns1:ObjectClass>Prior Information Notice</ns1:ObjectClass>
    </ns1:Component>
    ...
    :ivar ublversion_id: <ns1:Component
        ...
        <ns1:DictionaryEntryName>Prior Information Notice. UBL Version
        ...
        <ns1:Cardinality>0..1</ns1:Cardinality> <ns1:ObjectClass>Prior
        Information Notice</ns1:ObjectClass> <ns1:PropertyTerm>UBL
    ...
    :ivar customization_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Prior Information Notice. Customization
        Identifier. Identifier</ns1:DictionaryEntryName>
        <ns1:Definition>Identifies a user-defined customization of UBL
        for a specific use.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality> <ns1:ObjectClass>Prior
        Information Notice</ns1:ObjectClass>
    ...
    :ivar profile_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Prior Information Notice. Profile
        Identifier. Identifier</ns1:DictionaryEntryName>
        <ns1:Definition>Identifies a user-defined profile of the
        customization of UBL being used.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality> <ns1:ObjectClass>Prior
        Information Notice</ns1:ObjectClass> <ns1:PropertyTerm>Profile
    ...
    :ivar id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Prior Information Notice.
    ...
    :ivar copy_indicator: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Prior Information Notice. Copy_
    ...
    :ivar uuid: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Prior Information Notice. UUID.
    ...
    :ivar contract_folder_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Prior Information Notice. Contract
        Folder Identifier. Identifier</ns1:DictionaryEntryName>
        <ns1:Definition>An identifier, assigned by the sender, for the
        process file (i.e., record) to which this document
        belongs.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality> <ns1:ObjectClass>Prior
        Information Notice</ns1:ObjectClass> <ns1:PropertyTerm>Contract
        Folder Identifier</ns1:PropertyTerm>
        <ns1:RepresentationTerm>Identifier</ns1:RepresentationTerm>
        <ns1:DataType>Identifier. Type</ns1:DataType> </ns1:Component>
    :ivar issue_date: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Prior Information Notice. Issue Date.
    ...
    :ivar issue_time: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Prior Information Notice. Issue Time.
    ...
    :ivar note: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Prior Information Notice. Note.
        ...
        <ns1:Cardinality>0..n</ns1:Cardinality> <ns1:ObjectClass>Prior
        Information Notice</ns1:ObjectClass>
    ...
    :ivar planned_date: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Prior Information Notice. Planned Date.
        Date</ns1:DictionaryEntryName> <ns1:Definition>The date planned
        by the Contracting Party for publication of the contract
        notice.</ns1:Definition> <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Prior Information Notice</ns1:ObjectClass>
        <ns1:PropertyTerm>Planned Date</ns1:PropertyTerm>
        <ns1:RepresentationTerm>Date</ns1:RepresentationTerm>
        <ns1:DataType>Date. Type</ns1:DataType> </ns1:Component>
    :ivar document_reference: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Prior Information Notice. Document
        Reference</ns1:DictionaryEntryName> <ns1:Definition>A reference
        to another document associated with this
        document.</ns1:Definition>
        <ns1:Cardinality>0..n</ns1:Cardinality> <ns1:ObjectClass>Prior
        Information Notice</ns1:ObjectClass> <ns1:PropertyTerm>Document
    ...
    :ivar contracting_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Prior Information Notice. Contracting
    ...
    :ivar originator_customer_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Prior Information Notice. Originator_
        Customer Party. Customer Party</ns1:DictionaryEntryName>
        <ns1:Definition>A party who originated the tendering
    ...
    :ivar receiver_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Prior Information Notice. Receiver_
    ...
    :ivar tendering_terms: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Prior Information Notice. Tendering
        Terms</ns1:DictionaryEntryName> <ns1:Definition>The tendering
        terms associated with this tendering process.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality> <ns1:ObjectClass>Prior
        Information Notice</ns1:ObjectClass> <ns1:PropertyTerm>Tendering
    ...
    :ivar procurement_project: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Prior Information Notice. Procurement
    ...
    planned_date: Optional[PlannedDate] = field(
        default=None,
        metadata={
            "name": "PlannedDate",
            "type": "Element",
