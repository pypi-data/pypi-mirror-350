...
class CatalogueItemSpecificationUpdateType:
    ...
    Item Specification Update.

    Details</ns1:DictionaryEntryName> <ns1:Definition>A document used to
    update information (e.g., technical descriptions and properties)
    about Items in an existing Catalogue.</ns1:Definition>
    <ns1:ObjectClass>Catalogue Item Specification
    ...
    :ivar ublversion_id: <ns1:Component
        ...
        <ns1:DictionaryEntryName>Catalogue Item Specification Update.
        UBL Version Identifier. Identifier</ns1:DictionaryEntryName>
        ...
        <ns1:ObjectClass>Catalogue Item Specification
        Update</ns1:ObjectClass> <ns1:PropertyTerm>UBL Version
    ...
    :ivar customization_id: <ns1:Component
        ...
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Catalogue Item Specification
        Update</ns1:ObjectClass> <ns1:PropertyTerm>Customization
        Identifier</ns1:PropertyTerm>
        <ns1:RepresentationTerm>Identifier</ns1:RepresentationTerm>
        <ns1:DataType>Identifier. Type</ns1:DataType>
    ...
    :ivar profile_id: <ns1:Component
        ...
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Catalogue Item Specification
        Update</ns1:ObjectClass> <ns1:PropertyTerm>Profile
        Identifier</ns1:PropertyTerm>
        <ns1:RepresentationTerm>Identifier</ns1:RepresentationTerm>
        <ns1:DataType>Identifier. Type</ns1:DataType>
    ...
    :ivar profile_execution_id: <ns1:Component
        ...
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Catalogue Item Specification
        Update</ns1:ObjectClass> <ns1:PropertyTerm>Profile Execution
        Identifier</ns1:PropertyTerm>
        <ns1:RepresentationTerm>Identifier</ns1:RepresentationTerm>
    ...
    :ivar uuid: <ns1:Component
        ...
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Catalogue Item Specification Update.
        UUID. Identifier</ns1:DictionaryEntryName> <ns1:Definition>A
    ...
    :ivar name: <ns1:Component
        ...
        <ns1:DataType>Name. Type</ns1:DataType> <ns1:Examples>electrical
        goods - new energy ratings. </ns1:Examples> </ns1:Component>
    :ivar issue_date: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Catalogue Item Specification Update.
        Issue Date. Date</ns1:DictionaryEntryName> <ns1:Definition>The
        date, assigned by the sender, on which this document was
        issued.</ns1:Definition> <ns1:Cardinality>1</ns1:Cardinality>
        <ns1:ObjectClass>Catalogue Item Specification
        Update</ns1:ObjectClass> <ns1:PropertyTerm>Issue
    ...
    :ivar issue_time: <ns1:Component
        ...
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Catalogue Item Specification Update.
        Issue Time. Time</ns1:DictionaryEntryName> <ns1:Definition>The
        time, assigned by the sender, at which this document was
    ...
    :ivar revision_date: <ns1:Component
        ...
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Catalogue Item Specification Update.
        Revision Date. Date</ns1:DictionaryEntryName>
        <ns1:Definition>The date, assigned by the seller, on which the
        Catalogue was revised.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Catalogue Item Specification
        Update</ns1:ObjectClass> <ns1:PropertyTerm>Revision
        Date</ns1:PropertyTerm>
        <ns1:RepresentationTerm>Date</ns1:RepresentationTerm>
        <ns1:DataType>Date. Type</ns1:DataType> </ns1:Component>
    :ivar revision_time: <ns1:Component
        ...
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Catalogue Item Specification Update.
        Revision Time. Time</ns1:DictionaryEntryName>
        <ns1:Definition>The time, assigned by the seller, at which the
        Catalogue was revised.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Catalogue Item Specification
        Update</ns1:ObjectClass> <ns1:PropertyTerm>Revision
    ...
    :ivar note: <ns1:Component
        ...
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Catalogue Item Specification Update.
        Note. Text</ns1:DictionaryEntryName> <ns1:Definition>Free-form
        text pertinent to this document, conveying information that is
        not contained explicitly in other structures.</ns1:Definition>
    ...
    :ivar description: <ns1:Component
        ...
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Catalogue Item Specification Update.
        Description. Text</ns1:DictionaryEntryName>
        <ns1:Definition>Textual description of the document
        instance.</ns1:Definition>
        <ns1:Cardinality>0..n</ns1:Cardinality>
        <ns1:ObjectClass>Catalogue Item Specification
        Update</ns1:ObjectClass>
        ...
        <ns1:RepresentationTerm>Text</ns1:RepresentationTerm>
        <ns1:DataType>Text. Type</ns1:DataType> <ns1:Examples>ratings
        based on new environmental standards for EU </ns1:Examples>
        </ns1:Component>
    :ivar version_id: <ns1:Component
        ...
        <ns1:Definition>Identifies the current version of the
    ...
    :ivar line_count_numeric: <ns1:Component
        ...
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Catalogue Item Specification Update.
        Line Count. Numeric</ns1:DictionaryEntryName>
        <ns1:Definition>The number of Catalogue Item Specification
        Update Lines in this document.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Catalogue Item Specification
        Update</ns1:ObjectClass> <ns1:PropertyTerm>Line
    ...
    :ivar validity_period: <ns1:Component
        ...
        <ns1:Definition>A period, assigned by the seller, during which
        the information in the Catalogue Revision is effective. This may
        be given as start and end dates or as a
    ...
    :ivar related_catalogue_reference: <ns1:Component
        ...
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Catalogue Item Specification Update.
        Related_ Catalogue Reference. Catalogue
        ...
        Item Specification Update</ns1:ObjectClass>
    ...
    :ivar referenced_contract: <ns1:Component
        ...
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Catalogue Item Specification Update.
        Referenced_ Contract. Contract</ns1:DictionaryEntryName>
        <ns1:Definition>A contract or framework agreement with which the
    ...
    :ivar provider_party: <ns1:Component
        ...
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Catalogue Item Specification Update.
        Provider_ Party. Party</ns1:DictionaryEntryName>
        <ns1:Definition>The party sending the Catalogue Item
        Specification Update.</ns1:Definition>
        <ns1:Cardinality>1</ns1:Cardinality> <ns1:ObjectClass>Catalogue
        Item Specification Update</ns1:ObjectClass>
    ...
    :ivar receiver_party: <ns1:Component
        ...
        <ns1:Definition>The party receiving the Catalogue Item
        Specification Update.</ns1:Definition>
        <ns1:Cardinality>1</ns1:Cardinality> <ns1:ObjectClass>Catalogue
        Item Specification Update</ns1:ObjectClass>
    ...
    :ivar seller_supplier_party: <ns1:Component
        ...
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Catalogue Item Specification Update.
        Seller_ Supplier Party. Supplier Party</ns1:DictionaryEntryName>
    ...
    :ivar contractor_customer_party: <ns1:Component
        ...
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Catalogue Item Specification Update.
        Contractor_ Customer Party. Customer
        Party</ns1:DictionaryEntryName> <ns1:Definition>The customer
        party responsible for the contracts with which the Catalogue is
    ...
    :ivar trading_terms: <ns1:Component
        ...
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Catalogue Item Specification Update.
        Trading Terms</ns1:DictionaryEntryName> <ns1:Definition>The
        trading terms associated with the Catalogue.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Catalogue Item Specification
        Update</ns1:ObjectClass> <ns1:PropertyTerm>Trading
        Terms</ns1:PropertyTerm> <ns1:AssociatedObjectClass>Trading
    ...
    :ivar default_language: <ns1:Component
        ...
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Catalogue Item Specification Update.
        Default_ Language. Language</ns1:DictionaryEntryName>
        <ns1:Definition>The default language for the item
    ...
    :ivar catalogue_item_specification_update_line: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Catalogue Item Specification Update.
        Catalogue Item Specification Update
        Line</ns1:DictionaryEntryName> <ns1:Definition>One or more lines
        in the Catalogue Item Specification Update, each line updating a
        specific catalogue item.</ns1:Definition>
        <ns1:Cardinality>1..n</ns1:Cardinality>
        <ns1:ObjectClass>Catalogue Item Specification
        Update</ns1:ObjectClass> <ns1:PropertyTerm>Catalogue Item
        Specification Update Line</ns1:PropertyTerm>
        <ns1:AssociatedObjectClass>Catalogue Item Specification Update
        Line</ns1:AssociatedObjectClass>
        <ns1:RepresentationTerm>Catalogue Item Specification Update
    ...
    catalogue_item_specification_update_line: list[
        CatalogueItemSpecificationUpdateLine
    ] = field(
        default_factory=list,
        metadata={
