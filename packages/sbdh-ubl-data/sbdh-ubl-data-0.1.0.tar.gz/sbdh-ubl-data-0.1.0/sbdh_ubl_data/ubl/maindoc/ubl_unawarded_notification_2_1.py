...
class UnawardedNotificationType:
    ...
    <ns1:ComponentType>ABIE</ns1:ComponentType> <ns1:DictionaryEntryName>Unawarded
    Notification.

    Details</ns1:DictionaryEntryName> <ns1:Definition>A document
    communicating to a tenderer that the contract has been awarded to
    different tenderer.</ns1:Definition> <ns1:ObjectClass>Unawarded
    Notification</ns1:ObjectClass> </ns1:Component>
    ...
    :ivar ublversion_id: <ns1:Component
        ...
        <ns1:DictionaryEntryName>Unawarded Notification. UBL Version
        ...
        <ns1:ObjectClass>Unawarded Notification</ns1:ObjectClass>
    ...
    :ivar customization_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Unawarded Notification. Customization
        Identifier. Identifier</ns1:DictionaryEntryName>
    ...
    :ivar profile_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Unawarded Notification. Profile
        Identifier. Identifier</ns1:DictionaryEntryName>
    ...
    :ivar id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Unawarded Notification.
    ...
    :ivar copy_indicator: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Unawarded Notification. Copy_
    ...
    :ivar uuid: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Unawarded Notification. UUID.
    ...
    :ivar contract_folder_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Unawarded Notification. Contract Folder
        Identifier. Identifier</ns1:DictionaryEntryName>
    ...
    :ivar issue_date: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Unawarded Notification. Issue Date.
    ...
    :ivar issue_time: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Unawarded Notification. Issue Time.
    ...
    :ivar contract_name: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Unawarded Notification. Contract Name.
    ...
    :ivar note: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Unawarded Notification. Note.
    ...
    :ivar sender_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Unawarded Notification. Sender_ Party.
        Party</ns1:DictionaryEntryName> <ns1:Definition>The party
        sending this document.</ns1:Definition>
        <ns1:Cardinality>1</ns1:Cardinality> <ns1:ObjectClass>Unawarded
    ...
    :ivar receiver_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Unawarded Notification. Receiver_
    ...
    :ivar minutes_document_reference: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Unawarded Notification. Minutes_
    ...
    :ivar additional_document_reference: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Unawarded Notification. Additional_
        Document Reference. Document Reference</ns1:DictionaryEntryName>
        <ns1:Definition>A reference to an additional document associated
        with this document. It can be used to include annex documents
        such as the minutes of the awarding process
        meetings.</ns1:Definition>
        <ns1:Cardinality>0..n</ns1:Cardinality>
        <ns1:ObjectClass>Unawarded Notification</ns1:ObjectClass>
    ...
    :ivar tender_result: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Unawarded Notification. Tender
        Result</ns1:DictionaryEntryName> <ns1:Definition>An association
        to the Tender Result being notified</ns1:Definition>
    ...
    :ivar appeal_terms: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Unawarded Notification. Appeal
        Terms</ns1:DictionaryEntryName> <ns1:Definition>Terms of appeal
        for this tendering process.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Unawarded Notification</ns1:ObjectClass>
        <ns1:PropertyTerm>Appeal Terms</ns1:PropertyTerm>
        <ns1:AssociatedObjectClass>Appeal
