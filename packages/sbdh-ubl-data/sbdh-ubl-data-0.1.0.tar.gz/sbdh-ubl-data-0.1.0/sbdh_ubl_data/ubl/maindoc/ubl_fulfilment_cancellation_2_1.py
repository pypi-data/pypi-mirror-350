...
class FulfilmentCancellationType:
    ...
    <ns1:ComponentType>ABIE</ns1:ComponentType> <ns1:DictionaryEntryName>Fulfilment
    Cancellation.

    Details</ns1:DictionaryEntryName> <ns1:Definition>A document used to
    cancel an entire fulfilment document (Despatch Advice or Receipt
    Advice).</ns1:Definition> <ns1:ObjectClass>Fulfilment
    Cancellation</ns1:ObjectClass> </ns1:Component>
    ...
    :ivar ublversion_id: <ns1:Component
        ...
        <ns1:DictionaryEntryName>Fulfilment Cancellation. UBL Version
        ...
        <ns1:ObjectClass>Fulfilment Cancellation</ns1:ObjectClass>
    ...
    :ivar customization_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Fulfilment Cancellation. Customization
        Identifier. Identifier</ns1:DictionaryEntryName>
    ...
    :ivar profile_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Fulfilment Cancellation. Profile
        Identifier. Identifier</ns1:DictionaryEntryName>
    ...
    :ivar id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Fulfilment Cancellation.
    ...
    :ivar copy_indicator: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Fulfilment Cancellation. Copy_
    ...
    :ivar uuid: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Fulfilment Cancellation. UUID.
    ...
    :ivar issue_date: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Fulfilment Cancellation. Issue Date.
    ...
    :ivar issue_time: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Fulfilment Cancellation. Issue Time.
    ...
    :ivar note: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Fulfilment Cancellation. Note.
    ...
    :ivar cancellation_note: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Fulfilment Cancellation. Cancellation_
        Note. Text</ns1:DictionaryEntryName> <ns1:Definition>The reason
        for cancellation of the referenced document.</ns1:Definition>
        <ns1:Cardinality>1..n</ns1:Cardinality>
        <ns1:ObjectClass>Fulfilment Cancellation</ns1:ObjectClass>
        <ns1:PropertyTermQualifier>Cancellation</ns1:PropertyTermQualifier>
        <ns1:PropertyTerm>Note</ns1:PropertyTerm>
        <ns1:RepresentationTerm>Text</ns1:RepresentationTerm>
        <ns1:DataType>Text. Type</ns1:DataType> </ns1:Component>
    :ivar despatch_document_reference: <ns1:Component
        ...
        <ns1:DictionaryEntryName>Fulfilment Cancellation. Despatch_
    ...
    :ivar receipt_document_reference: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Fulfilment Cancellation. Receipt_
        Document Reference. Document Reference</ns1:DictionaryEntryName>
    ...
    :ivar order_reference: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Fulfilment Cancellation. Order
        Reference</ns1:DictionaryEntryName> <ns1:Definition>A reference
        to an Order document associated with the referenced Despatch or
        Receipt Advice(s).</ns1:Definition>
        <ns1:Cardinality>0..n</ns1:Cardinality>
        <ns1:ObjectClass>Fulfilment Cancellation</ns1:ObjectClass>
    ...
    :ivar additional_document_reference: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Fulfilment Cancellation. Additional_
        Document Reference. Document Reference</ns1:DictionaryEntryName>
    ...
    :ivar contract: <ns1:Component
        ...
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Fulfilment Cancellation.
        Contract</ns1:DictionaryEntryName> <ns1:Definition>The contracts
        or framework agreements with which the referenced fulfilment
        document is associated.</ns1:Definition>
        <ns1:Cardinality>0..n</ns1:Cardinality>
        <ns1:ObjectClass>Fulfilment Cancellation</ns1:ObjectClass>
    ...
    :ivar buyer_customer_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Fulfilment Cancellation. Buyer_
        Customer Party. Customer Party</ns1:DictionaryEntryName>
        <ns1:Definition>The buyer.</ns1:Definition>
        <ns1:Cardinality>1</ns1:Cardinality> <ns1:ObjectClass>Fulfilment
        Cancellation</ns1:ObjectClass>
    ...
    :ivar seller_supplier_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Fulfilment Cancellation. Seller_
    ...
    :ivar delivery_customer_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Fulfilment Cancellation. Delivery_
        Customer Party. Customer Party</ns1:DictionaryEntryName>
        <ns1:Definition>The delivery party.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Fulfilment Cancellation</ns1:ObjectClass>
    ...
    :ivar originator_customer_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Fulfilment Cancellation. Originator_
        Customer Party. Customer Party</ns1:DictionaryEntryName>
        <ns1:Definition>The originator party</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Fulfilment Cancellation</ns1:ObjectClass>
