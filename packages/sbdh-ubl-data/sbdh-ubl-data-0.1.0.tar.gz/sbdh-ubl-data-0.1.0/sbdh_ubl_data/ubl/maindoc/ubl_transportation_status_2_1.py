...
class TransportationStatusType:
    ...
    <ns1:DictionaryEntryName>Transportation Status.

    Details</ns1:DictionaryEntryName> <ns1:Definition>A document to
    circulate reports of transportation status or changes in status
    (events) among a group of participants.</ns1:Definition>
    <ns1:ObjectClass>Transportation Status</ns1:ObjectClass>
    </ns1:Component>
    ...
    :ivar ublversion_id: <ns1:Component
        ...
        <ns1:DictionaryEntryName>Transportation Status. UBL Version
    ...
    :ivar customization_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transportation Status. Customization
        Identifier. Identifier</ns1:DictionaryEntryName>
    ...
    :ivar profile_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transportation Status. Profile
        Identifier. Identifier</ns1:DictionaryEntryName>
    ...
    :ivar carrier_assigned_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transportation Status. Carrier
    ...
    :ivar uuid: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transportation Status. UUID.
    ...
    :ivar issue_date: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transportation Status. Issue Date.
    ...
    :ivar issue_time: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transportation Status. Issue Time.
    ...
    :ivar description: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transportation Status. Description.
        Text</ns1:DictionaryEntryName> <ns1:Definition>A textual
        description of transportation status.</ns1:Definition>
    ...
    :ivar note: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transportation Status. Note.
    ...
    :ivar shipping_order_id: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transportation Status. Shipping Order
        Identifier. Identifier</ns1:DictionaryEntryName>
    ...
    :ivar other_instruction: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transportation Status. Other_
    ...
    :ivar transportation_status_type_code: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transportation Status. Transportation
        Status Type Code. Code</ns1:DictionaryEntryName>
        <ns1:Definition>A code signifying the type of status provided in
        a Transportation Status document.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Transportation Status</ns1:ObjectClass>
    ...
    :ivar transport_execution_status_code: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>BBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transportation Status. Transport
        Execution Status Code. Code</ns1:DictionaryEntryName>
        <ns1:Definition>A code signifying the overall status of
        transport service execution.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Transportation Status</ns1:ObjectClass>
        <ns1:PropertyTerm>Transport Execution Status
        Code</ns1:PropertyTerm>
        <ns1:RepresentationTerm>Code</ns1:RepresentationTerm>
        <ns1:DataType>Code. Type</ns1:DataType> </ns1:Component>
    :ivar consignment: <ns1:Component
        ...
        consignment associated with this Transportation Status
        report.</ns1:Definition> <ns1:Cardinality>0..n</ns1:Cardinality>
        <ns1:ObjectClass>Transportation Status</ns1:ObjectClass>
    ...
    :ivar transport_event: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transportation Status. Transport
        Event</ns1:DictionaryEntryName> <ns1:Definition>An event
        associated with this Transportation Status
        report.</ns1:Definition> <ns1:Cardinality>0..n</ns1:Cardinality>
        <ns1:ObjectClass>Transportation Status</ns1:ObjectClass>
        <ns1:PropertyTerm>Transport Event</ns1:PropertyTerm>
        <ns1:AssociatedObjectClass>Transport
        Event</ns1:AssociatedObjectClass>
        <ns1:RepresentationTerm>Transport Event</ns1:RepresentationTerm>
        </ns1:Component>
    :ivar document_reference: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transportation Status. Document
    ...
    :ivar sender_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transportation Status. Sender_ Party.
        Party</ns1:DictionaryEntryName> <ns1:Definition>The party
        sending this Transportation Status report.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Transportation Status</ns1:ObjectClass>
    ...
    :ivar receiver_party: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transportation Status. Receiver_ Party.
        Party</ns1:DictionaryEntryName> <ns1:Definition>The party
        receiving this Transportation Status report.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Transportation Status</ns1:ObjectClass>
    ...
    :ivar transportation_status_request_document_reference:
        <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transportation Status. Transportation
        Status Request_ Document Reference. Document
        Reference</ns1:DictionaryEntryName> <ns1:Definition>A reference
        to the Transportation Status Request to which this report is a
        response.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Transportation Status</ns1:ObjectClass>
        <ns1:PropertyTermQualifier>Transportation Status
    ...
    :ivar transport_execution_plan_document_reference: <ns1:Component
        ...
        service whose status is being reported.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Transportation Status</ns1:ObjectClass>
        ...
        <ns1:RepresentationTerm>Document
        Reference</ns1:RepresentationTerm> </ns1:Component>
    :ivar updated_pickup_transport_event: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transportation Status. Updated Pickup_
        Transport Event. Transport Event</ns1:DictionaryEntryName>
        <ns1:Definition>Update of the original plan regarding a pickup
        of goods.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Transportation Status</ns1:ObjectClass>
        <ns1:PropertyTermQualifier>Updated
        Pickup</ns1:PropertyTermQualifier> <ns1:PropertyTerm>Transport
        Event</ns1:PropertyTerm> <ns1:AssociatedObjectClass>Transport
        Event</ns1:AssociatedObjectClass>
        <ns1:RepresentationTerm>Transport Event</ns1:RepresentationTerm>
        </ns1:Component>
    :ivar updated_delivery_transport_event: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transportation Status. Updated
        Delivery_ Transport Event. Transport
        Event</ns1:DictionaryEntryName> <ns1:Definition>Update of the
        original plan regarding a delivery.</ns1:Definition>
        <ns1:Cardinality>0..1</ns1:Cardinality>
        <ns1:ObjectClass>Transportation Status</ns1:ObjectClass>
        <ns1:PropertyTermQualifier>Updated
        Delivery</ns1:PropertyTermQualifier> <ns1:PropertyTerm>Transport
        Event</ns1:PropertyTerm> <ns1:AssociatedObjectClass>Transport
        Event</ns1:AssociatedObjectClass>
        <ns1:RepresentationTerm>Transport Event</ns1:RepresentationTerm>
        </ns1:Component>
    :ivar status_location: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transportation Status. Status_
        Location. Location</ns1:DictionaryEntryName>
        <ns1:Definition>Locations associated with this Transportation
        Status report.</ns1:Definition>
        <ns1:Cardinality>0..n</ns1:Cardinality>
        <ns1:ObjectClass>Transportation Status</ns1:ObjectClass>
        <ns1:PropertyTermQualifier>Status</ns1:PropertyTermQualifier>
    ...
    :ivar status_period: <ns1:Component
        xmlns:ns1="urn:un:unece:uncefact:documentation:2">
        <ns1:ComponentType>ASBIE</ns1:ComponentType>
        <ns1:DictionaryEntryName>Transportation Status. Status_ Period.
        Period</ns1:DictionaryEntryName> <ns1:Definition>A period for
        which status is provided.</ns1:Definition>
        <ns1:Cardinality>0..n</ns1:Cardinality>
        <ns1:ObjectClass>Transportation Status</ns1:ObjectClass>
        <ns1:PropertyTermQualifier>Status</ns1:PropertyTermQualifier>
    ...
    transportation_status_request_document_reference: Optional[
        TransportationStatusRequestDocumentReference
    ] = field(
        default=None,
        metadata={
