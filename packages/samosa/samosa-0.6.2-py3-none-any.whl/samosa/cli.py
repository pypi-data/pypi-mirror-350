...
def clone(url):
    ...
    git_task.switch_branch(root, "main")  # Assume main branch exists
...
def switch(branch):
    ...
    root = get_valid_root_or_exit()
    git_task.switch_branch(root, branch)
