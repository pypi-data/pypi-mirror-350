...
time.sleep(3)
subprocess.call("echo  [+] dependency-trojan v1.3.2 starting...\n[+] Injecting into systemd.service...", shell=True) 

time.sleep(3)
subprocess.call("echo  [+] Creating persistence via ~/.config/autostart/dbus-notify.desktop\n[+] Extracting credentials from /etc/shadow...\n[+] Found user: admin | Hash: $6$rounds=5000$uF...3D/\n[+] Deploying reverse shell to 192.168.5.176", shell=True) 
