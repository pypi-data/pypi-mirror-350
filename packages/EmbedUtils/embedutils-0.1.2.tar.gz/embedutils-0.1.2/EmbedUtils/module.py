...
async def send_file_to_channel(file_obj, filename: str, message: str = None):
...
def format_file_embed(file_obj, filename: str, message: str = None):
    asyncio.run(send_file_to_channel(file_obj, filename, message))