...
from .types_utils import is_str, is_array
from .common import *
...
def simplify_quotes(entry: str) -> str:
    ...
    """
    assert is_str(entry, True), f"The input '{entry}' is not a valid string"
...
def normalize(entry: str, lines_sep: str = "\n\n") -> str:
