...
class MetadataBootstrapper:
    ...
    def __init__(self, api_key: str, use_case: Optional[str] = None,
        ...
        Args:
            ...
            use_case: General use case description for context
            model: AI model to use (defaults to config value)
        ...
        self.domain_analyzer = DomainAnalyzer(use_case)
    ...
    def process_directory(self, input_dir: str, output_dir: str) -> None:
        ...
        # Delegate to directory processor
    ...
    def extract_domain_terms(self, yaml_data: Dict) -> None:
        ...
        self.domain_specific_terms.update(self.domain_analyzer.domain_specific_terms)
    ...
    def get_statistics(self) -> Dict:
        ...
        """
        return {
            'domain_terms_found': len(self.domain_specific_terms),
