...
class FileProcessor:
    ...
    def process_file(self, input_file: str, output_file: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if metadata.get('entities'):
                relationship_map = self._build_single_file_relationship_map(metadata, relative_path)
    ...
    def _build_single_file_relationship_map(self, metadata: Dict, file_path: str) -> Dict[str, Any]:
        ...
        relationship_map = self.relationship_mapper.build_relationship_map(schema_metadata)
    ...
    def _calculate_processing_statistics(self, original_documents: List[Dict],
        ...
        stats = {
            ...
            'domain_terms_extracted': len(self.domain_analyzer.domain_specific_terms),
