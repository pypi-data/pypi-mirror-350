...
class ResourceSnapshot:
    ...
    def __exit__(self, exc_type: Optional[object], exc_value: Optional[object], traceback: Optional[object]) -> None: ...
...
class BindingTraits:
    ...
    @property
    def imageTraits(self) -> Optional[ImageBindingTraits]:
...
class Tensor(Resource):
    ...
    def flush(self, offset: int = 0, size: Optional[int] = None) -> None:
        """
    ...
    def invalidate(self, offset: int = 0, size: Optional[int] = None) -> None:
        """
...
class RetrieveTensorCommand(Command):
    ...
    def __init__(self, src: Tensor, dst: Buffer, bufferOffset: Optional[int] = None, tensorOffset: Optional[int] = None, size: Optional[int] = None, unsafe: bool = False) -> None: ...

def retrieveTensor(src: Tensor, dst: Buffer, bufferOffset: Optional[int] = None, tensorOffset: Optional[int] = None, size: Optional[int] = None, unsafe: bool = False) -> RetrieveTensorCommand:
    """
...
class UpdateTensorCommand(Command):
    ...
    def __init__(self, src: Buffer, dst: Tensor, bufferOffset: Optional[int] = None, tensorOffset: Optional[int] = None, size: Optional[int] = None, unsafe: bool = False) -> None: ...

def updateTensor(src: Buffer, dst: Tensor, bufferOffset: Optional[int] = None, tensorOffset: Optional[int] = None, size: Optional[int] = None, unsafe: bool = False) -> UpdateTensorCommand:
    """
...
class ClearTensorCommand(Command):
    ...
    def __init__(self, tensor: Tensor, offset: Optional[int] = None, size: Optional[int] = None, data: Optional[int] = None, unsafe: bool = False) -> None:
        """
        Creates a command for filling a tensor with constant data over a given range. Defaults to zeroing the complete tensor
        """

def clearTensor(tensor: Tensor, offset: Optional[int] = None, size: Optional[int] = None, data: Optional[int] = None, unsafe: bool = False) -> ClearTensorCommand:
    """
    Creates a command for filling a tensor with constant data over a given range. Defaults to zeroing the complete tensor
...
class AccelerationStructure(Resource):
    ...
    def __init__(self, instances: GeometryInstanceVector) -> None:
        """
...
def getSupportedTypes(id: Optional[int] = None) -> TypeSupport:
...
def configureDebug(enablePrint: bool = False, enableGPUValidation: bool = False, enableSynchronizationValidation: bool = False, enableThreadSafetyValidation: bool = False, enableAPIValidation: bool = False, callback: Optional[Callable[[DebugMessage], None]] = None) -> None:
