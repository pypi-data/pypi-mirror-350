...
class P2PNode:
    ...
    def start(self):
        ...
        self.server_socket.bind((self.host, 5000))  # Usar puerto fijo 5000
        self.server_socket.listen(5)
        self.port = 5000  # Establecer el puerto fijo
        self.running = True
    ...
    def send_message(self, target_id, message, file_path=None):
        ...
        # Usar un puerto fijo para la comunicación
        port = 5000  # Puerto fijo para todos los nodos
