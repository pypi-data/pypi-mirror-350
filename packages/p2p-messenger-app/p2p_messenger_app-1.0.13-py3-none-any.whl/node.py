...
def main():
    print("Bienvenido al Chat P2P")
    print("\n1. Crear una nueva sala")
    print("2. Unirse a una sala existente")
    print("3. Salir")
    ...
    while True:
        try:
            ...
            if option == "1":
                ...
                print(f"\nSala creada: {room_id}")
                print(f"Puerto del servidor: {server.port}")
                print("Comparte estos datos para que otros se unan a tu sala")
