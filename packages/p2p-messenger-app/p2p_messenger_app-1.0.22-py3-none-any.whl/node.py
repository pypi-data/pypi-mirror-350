...
class ChatServer:
    def __init__(self, host='0.0.0.0', port=0):
        ...
        self.known_nodes = set()  # Conjunto de nodos conocidos
    ...
    def start(self):
        ...
        print(f"Servidor iniciado en {self.public_ip}:{self.port}")
        print("Este servidor es accesible desde cualquier parte del mundo")
        ...
        # Iniciar thread para descubrir nodos
        discovery_thread = threading.Thread(target=self._discovery_loop)
        discovery_thread.daemon = True
        discovery_thread.start()

    def _discovery_loop(self):
        """Loop para descubrir otros nodos en la red"""
        while self.running:
            try:
    ...
    while True:
        try:
            ...
            if option == "1":
                ...
                print("Comparte el código y la IP para que otros se unan desde cualquier parte del mundo")
                ...
                try:
                    ...
                    client_socket.connect((server_ip, 5000))  # Puerto fijo para el servidor
