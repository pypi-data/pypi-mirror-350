# Largely taken from https://github.com/jbloomAus/SAELens/blob/main/sae_lens/analysis/hooked_sae_transformer.py#L53
from ..util import is_sae_lens_availible
