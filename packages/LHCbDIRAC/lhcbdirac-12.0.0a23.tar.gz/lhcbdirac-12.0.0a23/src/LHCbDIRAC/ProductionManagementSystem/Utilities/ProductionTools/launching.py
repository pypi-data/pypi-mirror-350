...
def start_replication_transformation(logbook, issue: RepoIssue, request_id: int):
    ...
    replication_trans.setTransformationGroup("LHCbDSTBroadcast")
    replication_trans.setPlugin("LHCbDSTBroadcast")
    long_name = f"LHCbDSTBroadcast for issue {issue.issue.iid}"
