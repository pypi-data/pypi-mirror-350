...
#
# RESULT int:        4670098495760950388
# RESULT bin:  MSB   01000000 11001111 10000101 11010110 10110001 11101010 11100100 01110100   LSB
# RESULT hex:  LE    74 e4 ea b1 d6 85 cf 40
#
...
# value_reverse             uf11p2    11         518  01000000110
...
class SmpmUlDeviceWaterMeter08BDailyNewData(Packet):
    ...
    def serialize(self) -> bytes:
        ...
        result |= ((int(round(float(data.value_reverse) * 100.0, 0)) & 2047) & (2 ** (11) - 1)) << size
        size += 11
    ...
    def parse(cls, buf: BufRef) -> 'SmpmUlDeviceWaterMeter08BDailyNewData':
        ...
        result__el_tmp1["value_reverse"] = round(buf.shift(11) / 100.0, 2)
