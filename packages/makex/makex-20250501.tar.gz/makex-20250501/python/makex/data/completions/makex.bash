...
_shtab_makex_subparsers=('run' 'path' 'dot' 'affected' 'inputs' 'outputs' 'evaluate' 'tasks' 'targets' 'completions' 'workspace' 'complete' 'version' 'fix' 'evolve')
...
_shtab_makex_pos_0_choices=('run' 'path' 'dot' 'affected' 'inputs' 'outputs' 'evaluate' 'tasks' 'targets' 'completions' 'workspace' 'complete' 'version' 'fix' 'evolve')
