...
class Adapter:
    ...
    def script(self, id_session: str = None, language:str ='groovy',script: str = 'print("Compilare il parametro script o nameScript")',nameScript:str=None, param_list:dict=None,
              background: bool = False) -> 'str , ServiceResponse':
        """
