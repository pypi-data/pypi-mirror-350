...
from IA import Voices
from IA import Acessos
from IA import Terminal


class AI:
    def __init__(self, name : str, personalidade : str, api_key : str, fala = True, model='gemini-1.5-flash', debug = False) -> None:
        self.name = name
