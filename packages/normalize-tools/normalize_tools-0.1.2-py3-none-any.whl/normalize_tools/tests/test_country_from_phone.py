import pytest
from normalize_tools.countries import get_country_es_flat
...
def test_valid_numbers(phone_number, expected_country):
    assert get_country_es_flat(phone_number) == expected_country
...
def test_valid_formats(phone_number, expected_country):
    assert get_country_es_flat(phone_number.strip()) == expected_country
...
def test_invalid_inputs(phone_number):
    assert get_country_es_flat(phone_number) == ""
