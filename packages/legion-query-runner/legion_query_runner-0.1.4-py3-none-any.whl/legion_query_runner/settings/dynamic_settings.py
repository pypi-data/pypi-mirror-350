...
class DynamicSettings:
    """Class to handle dynamic settings that can be modified at runtime."""
    
    def __init__(self):
        self._ssh_tunnel_auth = {}

    def ssh_tunnel_auth(self):
        """Get SSH tunnel authentication settings.
        
        Returns:
            dict: SSH tunnel authentication settings
        """
        return self._ssh_tunnel_auth

    def set_ssh_tunnel_auth(self, auth_settings):
        """Set SSH tunnel authentication settings.
        
        Args:
            auth_settings (dict): SSH tunnel authentication settings
        """
        self._ssh_tunnel_auth = auth_settings
