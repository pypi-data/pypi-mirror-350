...
from medici._base_client import DEFAULT_TIMEOUT, HTTPX_DEFAULT_TIMEOUT, BaseClient, make_request_options
...
def _get_open_connections(client: Medici | AsyncMedici) -> int:
...
class TestMedici:
    client = Medici(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_client_timeout_option(self) -> None:
        client = Medici(base_url=base_url, api_key=api_key, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    def test_validate_headers(self) -> None:
        ...
        with update_env(**{"MEDICI_API_KEY": Omit()}):
            client2 = Medici(base_url=base_url, api_key=None, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, client: Medici) -> None:
        request = client._build_request(
    ...
    def test_base_url_setter(self) -> None:
        client = Medici(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(MEDICI_BASE_URL="http://localhost:5000/from/env"):
            client = Medici(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

    @pytest.mark.parametrize(
        "client",
        [
            Medici(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True),
            Medici(
    ...
    def test_base_url_trailing_slash(self, client: Medici) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Medici) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Medici) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            Medici(base_url=base_url, api_key=api_key, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Medici(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Medici(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/api/v1/deidentify/roberta_i2b2").mock(side_effect=retry_handler)

        response = client.v1.with_raw_response.deidentify(pipeline="roberta_i2b2", content="x")
    ...
    def test_omit_retry_count_header(
        self, client: Medici, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.v1.with_raw_response.deidentify(
            pipeline="roberta_i2b2", content="x", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.v1.with_raw_response.deidentify(
            pipeline="roberta_i2b2", content="x", extra_headers={"x-stainless-retry-count": "42"}
        )

        assert response.http_request.headers.get("x-stainless-retry-count") == "42"


class TestAsyncMedici:
    client = AsyncMedici(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with update_env(**{"MEDICI_API_KEY": Omit()}):
            client2 = AsyncMedici(base_url=base_url, api_key=None, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, async_client: AsyncMedici) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(MEDICI_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncMedici(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncMedici) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncMedici) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncMedici) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncMedici(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncMedici(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        ...
        response = await client.v1.with_raw_response.deidentify(pipeline="roberta_i2b2", content="x")
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncMedici, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
        ...
        response = await client.v1.with_raw_response.deidentify(
            pipeline="roberta_i2b2", content="x", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_get_platform(self) -> None:
        ...
        from medici._utils import asyncify
        from medici._base_client import get_platform
