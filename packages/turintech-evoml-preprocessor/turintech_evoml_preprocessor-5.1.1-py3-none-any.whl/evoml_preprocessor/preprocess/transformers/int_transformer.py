...
from evoml_utils.convertors.detected_types import to_int_column
...
class IntTransformer(Transformer):
    ...
    def __init__(
        ...
        self.impute_setting = DetectedType.integer
        self.scaler = None
        self.encoder = None
        self.block = Block.INTEGER
