...
class QuantileEncoder(Encoder[dtype.Float64, dtype.Float64]):
    """
    Encoder for performing quantile encoding.
    ...
    def __init__(self) -> None:
        self._encoder: Optional[QuantileTransformer] = None

    @property
    def encoder(self) -> QuantileTransformer:
    ...
    def fit(self, X: Series[dtype.Float64], y: Optional[SeriesTarget] = None) -> None:
        self._encoder = QuantileTransformer(n_quantiles=10)
        # @data: no copy
