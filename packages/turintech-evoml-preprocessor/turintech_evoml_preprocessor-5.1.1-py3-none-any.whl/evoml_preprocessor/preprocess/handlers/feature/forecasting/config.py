...
class ForecastingFeatureHandlerConfig(BaseModel):
...
def forecasting_feature_handler_config_adapter(
    config: PreprocessConfig,
    info_map: Dict[str, ColumnInfo],
    config_options: Optional[ConfigOptions] = None,
) -> ForecastingFeatureHandlerConfig:

    if config_options is None:
        config_options = ConfigOptions()

    return ForecastingFeatureHandlerConfig(
