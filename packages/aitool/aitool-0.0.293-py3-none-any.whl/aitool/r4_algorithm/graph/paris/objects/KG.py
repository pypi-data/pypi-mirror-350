...
import numpy as np
from aitool import Entity, Relation
...
class KG:
    ...
    def get_entity(self, name: str):
        if self.entity_dict_by_name.__contains__(name):
            ...
            entity = Entity(idx=len(self.literal_set) + len(self.entity_set),
                            name=name,
                            preprocess_func=self.ent_pre_func,
                            affiliation=self)
    ...
    def get_relation(self, name: str):
        if self.relation_dict_by_name.__contains__(name):
            ...
            relation = Relation(idx=len(self.attribute_set) + len(self.relation_set),
                                name=name,
                                preprocess_func=self.rel_pre_func,
                                affiliation=self)
    ...
    def get_attribute(self, name: str):
        if self.attribute_dict_by_name.__contains__(name):
            ...
            attribute = Relation(idx=len(self.attribute_set) + len(self.relation_set),
                                 name=name,
                                 preprocess_func=self.attr_pre_func,
                                 affiliation=self,
                                 is_attribute=True)
    ...
    def get_literal(self, name: str):
        if self.literal_dict_by_name.__contains__(name):
            ...
            literal = Entity(idx=len(self.literal_set) + len(self.entity_set),
                             name=name,
                             preprocess_func=self.lite_pre_func,
                             affiliation=self,
                             is_literal=True)
