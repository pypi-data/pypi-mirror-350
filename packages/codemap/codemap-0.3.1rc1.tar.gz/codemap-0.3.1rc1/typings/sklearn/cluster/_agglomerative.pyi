...
def ward_tree(X, *, connectivity=..., n_clusters=..., return_distance=...): # -> tuple[Any, Literal[1], int, None, Any] | tuple[Any, Literal[1], int, None] | tuple[NDArray[Any], Any, int, _Array1D[signedinteger[_NBitIntP]], NDArray[Any]] | tuple[NDArray[Any], Any, int, _Array1D[signedinteger[_NBitIntP]]]:
...
def linkage_tree(X, connectivity=..., n_clusters=..., linkage=..., affinity=..., return_distance=...): # -> tuple[Any, Literal[1], int, None, Any] | tuple[Any, Literal[1], int, None] | tuple[Any, Any, int, _Array1D[signedinteger[_NBitIntP]], Any] | tuple[Any, Any, int, _Array1D[signedinteger[_NBitIntP]]] | tuple[ndarray[_Shape, dtype[Any]], Any, int, _Array1D[signedinteger[_NBitIntP]], _Array1D[float64] | ndarray[_Shape, dtype[float64]] | Any | None] | tuple[ndarray[_Shape, dtype[Any]], Any, int, _Array1D[signedinteger[_NBitIntP]]]:
