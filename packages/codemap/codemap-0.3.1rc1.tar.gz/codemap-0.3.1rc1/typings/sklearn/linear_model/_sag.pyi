...
def sag_solver(X, y, sample_weight=..., loss=..., alpha=..., beta=..., max_iter=..., tol=..., verbose=..., random_state=..., check_input=..., max_squared_sum=..., warm_start_mem=..., is_saga=...): # -> tuple[NDArray[Any] | Any, Any, dict[str, Any]]:
