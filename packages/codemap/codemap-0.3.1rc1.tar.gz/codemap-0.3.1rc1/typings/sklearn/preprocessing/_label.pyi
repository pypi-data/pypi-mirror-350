...
class LabelEncoder(TransformerMixin, BaseEstimator, auto_wrap_output_keys=None):
    ...
    def fit_transform(self, y): # -> Any | NDArray[Any] | NDArray[intp] | None:
    ...
    def transform(self, y): # -> NDArray[Any] | Any:
    ...
    def inverse_transform(self, y): # -> NDArray[Any] | Any:
...
class LabelBinarizer(TransformerMixin, BaseEstimator, auto_wrap_output_keys=None):
    ...
    def inverse_transform(self, Y, threshold=...): # -> csr_matrix | ndarray[_Shape, dtype[Any]] | NDArray[Any]:
