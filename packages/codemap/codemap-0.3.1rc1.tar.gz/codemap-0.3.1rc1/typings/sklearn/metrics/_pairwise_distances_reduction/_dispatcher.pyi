...
def sqeuclidean_row_norms(X, num_threads): # -> NDArray[Any]:
...
class BaseDistancesReductionDispatcher:
    ...
    @classmethod
    @abstractmethod
    def compute(cls, X, Y, **kwargs): # -> None:
...
class ArgKmin(BaseDistancesReductionDispatcher):
    ...
    """
    @classmethod
    def compute(cls, X, Y, k, metric=..., chunk_size=..., metric_kwargs=..., strategy=..., return_distance=...):
...
class RadiusNeighbors(BaseDistancesReductionDispatcher):
    ...
    """
    @classmethod
    def compute(cls, X, Y, radius, metric=..., chunk_size=..., metric_kwargs=..., strategy=..., return_distance=..., sort_results=...):
...
class ArgKminClassMode(BaseDistancesReductionDispatcher):
    ...
    @classmethod
    def compute(cls, X, Y, k, weights, Y_labels, unique_Y_labels, metric=..., chunk_size=..., metric_kwargs=..., strategy=...):
        """Compute the argkmin reduction.
...
class RadiusNeighborsClassMode(BaseDistancesReductionDispatcher):
    ...
    @classmethod
    def compute(cls, X, Y, radius, weights, Y_labels, unique_Y_labels, outlier_label, metric=..., chunk_size=..., metric_kwargs=..., strategy=...):
        """Return the results of the reduction for the given arguments.
        Parameters
        ----------
        X : ndarray of shape (n_samples_X, n_features)
