...
@validate_params({ "labels_true": ["array-like"],"labels_pred": ["array-like"] }, prefer_skip_nested_validation=True)
def rand_score(labels_true, labels_pred): # -> float | Any:
    """Rand index.
...
def homogeneity_completeness_v_measure(labels_true, labels_pred, *, beta=...): # -> tuple[float, float, float] | tuple[float | Any, float | Any, float | Any]:
...
@validate_params({ "labels_true": ["array-like"],"labels_pred": ["array-like"] }, prefer_skip_nested_validation=True)
def homogeneity_score(labels_true, labels_pred): # -> float | Any:
...
@validate_params({ "labels_true": ["array-like"],"labels_pred": ["array-like"] }, prefer_skip_nested_validation=True)
def completeness_score(labels_true, labels_pred): # -> float | Any:
...
@validate_params({ "labels_true": ["array-like"],"labels_pred": ["array-like"],"beta": [Interval(Real, 0, None, closed="left")] }, prefer_skip_nested_validation=True)
def v_measure_score(labels_true, labels_pred, *, beta=...): # -> float | Any:
...
def mutual_info_score(labels_true, labels_pred, *, contingency=...): # -> float | Any:
...
@validate_params({ "labels_true": ["array-like"],"labels_pred": ["array-like"],"average_method": [StrOptions("arithmetic", "max", "min", "geometric")] }, prefer_skip_nested_validation=True)
def normalized_mutual_info_score(labels_true, labels_pred, *, average_method=...): # -> float | Any | floating[Any] | float64:
...
def fowlkes_mallows_score(labels_true, labels_pred, *, sparse=...): # -> Any | float:
