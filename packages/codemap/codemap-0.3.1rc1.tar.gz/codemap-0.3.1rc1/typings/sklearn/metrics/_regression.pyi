...
def mean_absolute_error(y_true, y_pred, *, sample_weight=..., multioutput=...): # -> NDArray[Any] | Any | float:
...
def mean_pinball_loss(y_true, y_pred, *, sample_weight=..., alpha=..., multioutput=...): # -> Incomplete:
...
@validate_params({ "y_true": ["array-like"],"y_pred": ["array-like"],"sample_weight": ["array-like", None],"multioutput": [StrOptions("raw_values", "uniform_average"), "array-like"] }, prefer_skip_nested_validation=True)
def mean_absolute_percentage_error(y_true, y_pred, *, sample_weight=..., multioutput=...): # -> NDArray[Any] | Any | float:
...
@validate_params({ "y_true": ["array-like"],"y_pred": ["array-like"],"sample_weight": ["array-like", None],"multioutput": [StrOptions("raw_values", "uniform_average"), "array-like"] }, prefer_skip_nested_validation=True)
def mean_squared_error(y_true, y_pred, *, sample_weight=..., multioutput=...): # -> NDArray[Any] | Any | float:
...
@validate_params({ "y_true": ["array-like"],"y_pred": ["array-like"],"sample_weight": ["array-like", None],"multioutput": [StrOptions("raw_values", "uniform_average"), "array-like"] }, prefer_skip_nested_validation=True)
def mean_squared_log_error(y_true, y_pred, *, sample_weight=..., multioutput=...): # -> NDArray[Any] | Any | float:
...
def median_absolute_error(y_true, y_pred, *, multioutput=..., sample_weight=...): # -> Any:
...
def explained_variance_score(y_true, y_pred, *, sample_weight=..., multioutput=..., force_finite=...): # -> float | NDArray[Any] | Any:
...
def r2_score(y_true, y_pred, *, sample_weight=..., multioutput=..., force_finite=...): # -> float | NDArray[Any] | Any:
...
def max_error(y_true, y_pred): # -> Any:
    """
...
@validate_params({ "y_true": ["array-like"],"y_pred": ["array-like"],"sample_weight": ["array-like", None],"alpha": [Interval(Real, 0, 1, closed="both")],"multioutput": [StrOptions("raw_values", "uniform_average"), "array-like"] }, prefer_skip_nested_validation=True)
def d2_pinball_score(y_true, y_pred, *, sample_weight=..., alpha=..., multioutput=...): # -> float | NDArray[float64] | floating[Any]:
    """
...
@validate_params({ "y_true": ["array-like"],"y_pred": ["array-like"],"sample_weight": ["array-like", None],"multioutput": [StrOptions("raw_values", "uniform_average"), "array-like"] }, prefer_skip_nested_validation=True)
def d2_absolute_error_score(y_true, y_pred, *, sample_weight=..., multioutput=...): # -> float | NDArray[float64] | floating[Any]:
    """
