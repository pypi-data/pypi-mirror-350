...
Welcome to `opensemantic.base` contributor's guide.
...
If you experience bugs or general issues with `opensemantic.base`, please have a look
...
You can help improve `opensemantic.base` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`opensemantic.base` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `opensemantic.base`'s files. While this mechanism can
...
```
conda create -n opensemantic.base python=3 six virtualenv pytest pytest-cov
conda activate opensemantic.base
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/opensemantic.base.git
   cd opensemantic.base
   ```
...
5. Install [pre-commit]:
   ...
   `opensemantic.base` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/opensemantic.base
[issue tracker]: https://github.com/<USERNAME>/opensemantic.base/issues
