...
public:
  ...
  virtual double trialPDFratio(BeamParticlePtr beamAPtr,
    BeamParticlePtr beamBPtr, int iSys, int idA, int idB, double eA, double eB,
...
public:
  ...
  // Trial PDF ratio.
  virtual double trialPDFratio(BeamParticlePtr beamAPtr,
    BeamParticlePtr beamBPtr, int iSys, int idA, int idK, double eA, double eK,
    double Qt2A, double Qt2B) override;
...
public:
  ...
  void init(BeamParticlePtr beamAPtrIn, BeamParticlePtr beamBPtrIn) override;
