...
mcp_server = FastMCP(
    ...
    description="A server providing tools to interact with structured long Markdown documents (composed of chapters) via HTTP SSE or stdio.",
    host=DEFAULT_HOST,
    port=DEFAULT_PORT
)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Long Document MCP Server")
    parser.add_argument(
        "transport", 
        choices=["sse", "stdio"], 
        default="sse",
