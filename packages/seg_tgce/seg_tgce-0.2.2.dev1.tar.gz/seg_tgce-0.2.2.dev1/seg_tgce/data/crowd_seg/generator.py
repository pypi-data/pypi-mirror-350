...
class CrowdSegDataGenerator(Sequence):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(  # pylint: disable=too-many-arguments
        ...
        *,
        ...
        self._cache: dict[str, Tuple[np.ndarray, dict[int, np.ndarray], np.ndarray]] = (
            {}
        )
    ...
    def _load_sample(self, filename: str) -> Tuple[np.ndarray, np.ndarray, np.ndarray]:
        ...
        if self.use_cache and filename in self._cache:
            ...
            cached_image, cached_masks, cached_expert = self._cache[filename]
            ...
            return cached_image, full_masks, cached_expert
        ...
        if self.use_cache:
            ...
            self._cache[filename] = (image, active_masks, expert_mask)
            self._cache_order.append(filename)
