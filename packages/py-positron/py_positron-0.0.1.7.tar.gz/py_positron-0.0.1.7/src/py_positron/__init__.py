...
def openUI(html_path, functions=None, width=900, height=700, title="Python UI"):
    ...
    thread = threading.Thread(target=process_html, daemon=True)
    thread.start()
    return window
def start():
