...
def main():
    ...
    parser.add_argument("command", help="Command to run. Available commands: help, create, start, install, pip, activate, venv", type=str,choices=["help","create","start","install","activate","venv","pip"])
