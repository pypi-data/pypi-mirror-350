                        ...
                        for scope in semantic_scopes:
                            if scope.start_line >= next_line:
                                ...
                                # apply to the entire semantic structure
                                    ...
                                    not directive.scope
                                    and not directive.compound_scope
                                    and directive.line_count is None
                                ):
            ...
            if line_num in directive_map:  # Check comment line
                for directive in directive_map[line_num]:
                    ...
                    if directive.line_count is not None:
                        ...
                        guard_stack.append(GuardStackEntry(directive, start_line, end_line, None))
                        ...
                        for scope in semantic_scopes:
                            ...
                            guard_stack.append(GuardStackEntry(directive, start_line, None, None))
                    else:
