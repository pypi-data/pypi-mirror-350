...
class OrcaCalculation:
    ...
    def is_cached(self) -> bool:
        ...
        current_input_str = self._get_cache_relevant_input_content(self.build_input_string())
    ...
    def run(self) -> Tuple[bool, float]:
        ...
        with timer:
            ...
            try:
                ...
                if self.directory.exists() and not self.overwrite and not self.is_cached():
                    debug(f"Cleaning up auxiliary files from previous failed run in {self.directory}")
