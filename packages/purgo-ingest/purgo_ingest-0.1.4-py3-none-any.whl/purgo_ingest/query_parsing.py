...
from purgo_ingest.schemas import IngestionQuery
from purgo_ingest.utils.exceptions import InvalidPatternError
from purgo_ingest.utils.git_utils import check_repo_exists, fetch_remote_branch_list
from purgo_ingest.utils.ignore_patterns import DEFAULT_IGNORE_PATTERNS
from purgo_ingest.utils.query_parser_utils import (
    KNOWN_GIT_HOSTS,
