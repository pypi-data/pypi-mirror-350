...
def _render_technique_yaml(technique: Technique) -> None:
    ...
    console.print(Panel(yaml_output, title=f"[bold cyan]{technique.mitre_id}[/bold cyan]", 
...
def _render_technique_json(technique: Technique) -> None:
    ...
    console.print(Panel(json_output, title=f"[bold cyan]{technique.mitre_id}[/bold cyan]", 
                       title_align="left", border_style="cyan"))


def _render_technique_markdown(technique: Technique) -> None:
    """Render technique as Markdown."""
    md_content = f"""# {technique.name} ({technique.mitre_id})
...
def render_technique_summary(technique: Technique) -> None:
    ...
    header = Text()
    header.append(technique.mitre_id, style="bold cyan")
