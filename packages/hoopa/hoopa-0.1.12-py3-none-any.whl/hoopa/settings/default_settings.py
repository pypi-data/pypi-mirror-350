...
from hoopa.downloadermiddlewares.handle_http_error import \
    HandleHttpErrorMiddleware
from hoopa.downloadermiddlewares.handle_http_success import \
...
from hoopa.spidermiddlewares.handle_parse_error import \
...
SPIDER_MIDDLEWARES_BASE = [HandleParseErrorMiddleware]

# pipelines
# 执行顺序：DOWNLOADER_MIDDLEWARES
PIPELINES = []

PIPELINES_BASE = [DefaultPipeline, HandleProcessError]


# redis配置信息
# REDIS_SETTING = "redis://127.0.0.1:6379/0?encoding=utf-8"
REDIS_SETTING = {"host": "127.0.0.1", "port": 6379, "db": 0, "password": ""}
