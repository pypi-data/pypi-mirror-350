...
class FullAction(argparse.Action):
    ...
    def __init__(
        ...
        super(FullAction, self).__init__(
...
class CreateCommand:
    ...
    def add_arguments(self):
        ...
        group.add_argument(
            ...
            "--project",
            nargs=1,
            help="创建项目 如 hoopa create -p <project_name>",
        )

        parser.add_argument(
            "-f",
            "--full",
            help="full spider 如 hoopa create -s <spider_name> -f",
            default=False,
            action=FullAction,
        )
    ...
    def create_spider(self, template_path, spider_name, project=None):
        ...
        spider_template = spider_template.replace(
