...
from ekko_cli.utils import EkkoUtils, SessionUtils, LabelUtils
...
def ekko():
    ...
    global label_utils
    from ekko_cli.utils.singleton_utils import get_ekko_utils, get_session_utils, get_label_utils
