...
def main():
    ...
    setup(
        name="reportlab-qpython",
        version=get_version(),
        license="BSD license (see license.txt for details), Copyright (c) 2000-2025, ReportLab Inc.",
        description="The Reportlab Toolkit",
        long_description="""This project is a branch of [reportlab](https://pypi.org/project/reportlab/) on [QPython](https://www.qpython.org).
        ...
        url="https://qpypi.qpython.org/project/reportlab-qpython/",
        packages=[
                'reportlab',
    ...
    "Topic :: Software Development",
        ...
        install_requires=['pillow-qpython','chardet'],
