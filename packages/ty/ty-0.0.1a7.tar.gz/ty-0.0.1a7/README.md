...
For other ways to install ty, see the [installation](https://github.com/astral-sh/ty/blob/0.0.1-alpha.7/docs/README.md#installation) documentation.

If you do not provide a subcommand, ty will list available commands — for detailed information about
command-line options, see the [CLI reference](https://github.com/astral-sh/ty/blob/0.0.1-alpha.7/docs/reference/cli.md).
...
with `--python`. See the [module discovery](https://github.com/astral-sh/ty/blob/0.0.1-alpha.7/docs/README.md#module-discovery) documentation for
details.

## Learning more

To learn more about using ty, see the [documentation](https://github.com/astral-sh/ty/blob/0.0.1-alpha.7/docs/README.md).
...
See the
[contributing guide](https://github.com/astral-sh/ty/blob/0.0.1-alpha.7/CONTRIBUTING.md) for more details.

## License

ty is licensed under the MIT license ([LICENSE](https://github.com/astral-sh/ty/blob/0.0.1-alpha.7/LICENSE) or
