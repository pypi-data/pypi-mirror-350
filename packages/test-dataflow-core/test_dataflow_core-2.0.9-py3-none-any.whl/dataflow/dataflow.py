...
class Dataflow:
    ...
    def variable(self, variable_name: str):
        ...
        try:
            ...
            session_cookie = {
                "dataflow_session": host_name.replace("jupyter-", ""),
                "jupyterhub-hub-login": ""
            }
            response = requests.get(
                variable_api,
                params={"variable_key": variable_name},
    ...
    def secret(self, secret_name: str):
        ...
        try:
            ...
            vault_path = "secrets"
            secret_data = self.secrets_manager.get_secret_by_key(vault_path, user_name, secret_name)
