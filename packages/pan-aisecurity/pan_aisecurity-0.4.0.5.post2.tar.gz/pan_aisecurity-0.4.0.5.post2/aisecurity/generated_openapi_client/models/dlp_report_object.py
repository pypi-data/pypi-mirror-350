...
class DlpReportObject(BaseModel):
    ...
    dlp_report_id: Optional[StrictStr] = Field(
        default=None, description="Unique identifier for the DLP report"
    )
    dlp_profile_name: Optional[StrictStr] = Field(
        default=None, description="DLP profile name used for the scan"
    )
