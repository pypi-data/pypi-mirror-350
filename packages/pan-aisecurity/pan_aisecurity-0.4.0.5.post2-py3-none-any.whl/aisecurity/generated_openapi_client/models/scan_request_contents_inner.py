...
class ScanRequestContentsInner(BaseModel):
    ...
    prompt: Optional[StrictStr] = Field(
        default=None, description="The prompt content that you want to scan"
    )
    response: Optional[StrictStr] = Field(
        default=None, description="The response content that you want to scan"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"prompt": obj.get("prompt"), "response": obj.get("response")}
        )
        return _obj
