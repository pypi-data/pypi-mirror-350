...
try:
    ...
    pkg_dir = os.path.dirname(__file__)           # e.g. .../site-packages/quantum_platform
...
class MainPage:
    def __init__(self, page: ft.Page):
        ...
        self.menu_items = [
            ...
            ("量子谐振子", ft.Icons.TRENDING_UP, self.show_oscillator),
            ("氢原子R方向向波函数", ft.Icons.IMAGE, self.show_hydrogen_radial),
