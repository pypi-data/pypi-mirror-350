...
if TYPE_CHECKING:
    from ..models.soa_enrollment_account import SOAEnrollmentAccount


T = TypeVar("T", bound="SOAEnrollmentAccountApiResult")


@_attrs_define
class SOAEnrollmentAccountApiResult:
    """
    Attributes:
        ...
        data (Union[Unset, SOAEnrollmentAccount]):
    """
    ...
    data: Union[Unset, "SOAEnrollmentAccount"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = SOAEnrollmentAccount.from_dict(_data)

        soa_enrollment_account_api_result = cls(
        ...
        return soa_enrollment_account_api_result
