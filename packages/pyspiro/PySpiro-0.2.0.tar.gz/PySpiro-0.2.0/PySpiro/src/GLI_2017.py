...
class GLI_2017(Reference):
    """
    This global lung function was published in 2017 by Stanojevic and includes as variable sex, age, height and ethnicity,
    providing functions for TLCO, DLCO, KCO and VA.
