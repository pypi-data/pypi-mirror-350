...
class GetOrders:
    ...
    @staticmethod
    def save_cache_data(data: dict[BrokerClient, dict[str, ResponseOrderListingData_Type]]) -> None:
    ...
    @staticmethod
    def get_data_from_local_file() -> dict[BrokerClient, list[ResponseOrderListingData_Type]]:
