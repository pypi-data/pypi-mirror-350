...
def load_dataset(path, tokenizer, block_size=64):
...
# Load training and optional eval datasets
try:
    train_dataset = load_dataset("/content/domain_train.txt", tokenizer)
except Exception as e:
    print(e); exit()
try:
    eval_dataset = load_dataset("/content/domain_eval.txt", tokenizer)
except Exception as e:
