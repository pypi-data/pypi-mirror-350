...
from pytest_celery_py37.defaults import DEFAULT_WORKER_APP_NAME
from pytest_celery_py37.defaults import RESULT_TIMEOUT
from pytest_celery_py37.vendors.worker.tasks import ping
