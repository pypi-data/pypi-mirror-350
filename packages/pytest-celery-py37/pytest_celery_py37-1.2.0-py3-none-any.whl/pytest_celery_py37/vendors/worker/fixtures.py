...
from pytest_celery_py37.vendors.worker.defaults import DEFAULT_WORKER_CONTAINER_TIMEOUT
from pytest_celery_py37.vendors.worker.defaults import DEFAULT_WORKER_VOLUME
from pytest_celery_py37.vendors.worker.defaults import WORKER_DOCKERFILE_ROOTDIR
