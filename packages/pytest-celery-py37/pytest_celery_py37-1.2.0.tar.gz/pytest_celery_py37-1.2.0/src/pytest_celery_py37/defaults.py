...
from pytest_celery_py37.vendors.localstack.defaults import CELERY_LOCALSTACK_BROKER
from pytest_celery_py37.vendors.localstack.defaults import *
from pytest_celery_py37.vendors.memcached.defaults import CELERY_MEMCACHED_BACKEND
from pytest_celery_py37.vendors.memcached.defaults import *
from pytest_celery_py37.vendors.rabbitmq.defaults import CELERY_RABBITMQ_BROKER
from pytest_celery_py37.vendors.rabbitmq.defaults import *
from pytest_celery_py37.vendors.redis.backend.defaults import CELERY_REDIS_BACKEND
from pytest_celery_py37.vendors.redis.backend.defaults import *
from pytest_celery_py37.vendors.redis.broker.defaults import CELERY_REDIS_BROKER
from pytest_celery_py37.vendors.redis.broker.defaults import *
from pytest_celery_py37.vendors.redis.defaults import *
from pytest_celery_py37.vendors.worker.defaults import CELERY_SETUP_WORKER
from pytest_celery_py37.vendors.worker.defaults import *
