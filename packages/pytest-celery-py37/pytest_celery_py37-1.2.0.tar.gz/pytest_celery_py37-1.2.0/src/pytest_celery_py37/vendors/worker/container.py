...
from pytest_celery_py37.vendors.worker.defaults import DEFAULT_WORKER_ENV
from pytest_celery_py37.vendors.worker.defaults import DEFAULT_WORKER_LOG_LEVEL
from pytest_celery_py37.vendors.worker.defaults import DEFAULT_WORKER_NAME
from pytest_celery_py37.vendors.worker.defaults import DEFAULT_WORKER_PORTS
from pytest_celery_py37.vendors.worker.defaults import DEFAULT_WORKER_QUEUE
from pytest_celery_py37.vendors.worker.defaults import DEFAULT_WORKER_VERSION
...
class CeleryWorkerContainer(CeleryTestContainer):
    ...
    def tasks_modules(cls) -> set:
        """Tasks modules."""
        from pytest_celery_py37.vendors.worker import tasks as default_tasks
