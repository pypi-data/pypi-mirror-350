...
_locked_methods = ('_meta_', 'to_dict', 'keys', 'values', 'items', 'get', 'pop', 'popitem', 'clear', 'copy', 'update', 'save')
...
class Config(SimpleNamespace):
	...
	def to_dict(self): return _to_dict(self)
	...
	def pop(self, key, *args): return self.__dict__.pop(key, *args)
