...
def get_traffic_steering_rule_list(folder: Optional[builtins.str] = None,
...
def get_traffic_steering_rule_list_output(folder: Optional[pulumi.Input[Optional[builtins.str]]] = None,
