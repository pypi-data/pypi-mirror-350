...
def get_authentication_sequence_list(device: Optional[builtins.str] = None,
...
def get_authentication_sequence_list_output(device: Optional[pulumi.Input[Optional[builtins.str]]] = None,
