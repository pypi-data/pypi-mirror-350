...
def get_authentication_rule_list(device: Optional[builtins.str] = None,
    ...
    :param builtins.str position: The Position param. String must be one of these: `"pre"`, `"post"`. Default: `"pre"`.
...
def get_authentication_rule_list_output(device: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        ...
                                        position: Optional[pulumi.Input[Optional[builtins.str]]] = None,
