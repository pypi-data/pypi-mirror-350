...
def get_ocsp_responder_list(device: Optional[builtins.str] = None,
...
def get_ocsp_responder_list_output(device: Optional[pulumi.Input[Optional[builtins.str]]] = None,
