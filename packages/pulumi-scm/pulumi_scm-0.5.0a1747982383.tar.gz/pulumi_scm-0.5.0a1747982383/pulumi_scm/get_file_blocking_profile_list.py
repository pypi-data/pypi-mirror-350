...
def get_file_blocking_profile_list(device: Optional[builtins.str] = None,
...
def get_file_blocking_profile_list_output(device: Optional[pulumi.Input[Optional[builtins.str]]] = None,
