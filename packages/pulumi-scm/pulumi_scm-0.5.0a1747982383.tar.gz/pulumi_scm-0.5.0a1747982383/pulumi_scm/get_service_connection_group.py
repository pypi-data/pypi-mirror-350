...
class GetServiceConnectionGroupResult:
    ...
    def disable_snat(self) -> builtins.bool:
        """
    ...
    def pbf_only(self) -> builtins.bool:
        """
        The PbfOnly param.
        """
...
def get_service_connection_group(folder: Optional[builtins.str] = None,
...
def get_service_connection_group_output(folder: Optional[pulumi.Input[Optional[builtins.str]]] = None,
