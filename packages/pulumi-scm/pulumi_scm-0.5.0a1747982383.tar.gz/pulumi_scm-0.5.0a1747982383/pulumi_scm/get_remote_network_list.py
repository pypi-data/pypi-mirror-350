...
def get_remote_network_list(folder: Optional[builtins.str] = None,
...
def get_remote_network_list_output(folder: Optional[pulumi.Input[Optional[builtins.str]]] = None,
