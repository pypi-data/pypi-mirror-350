...
class GetIpsecTunnelResult:
    ...
    def anti_replay(self) -> builtins.bool:
        """
    ...
    def copy_tos(self) -> builtins.bool:
        """
    ...
    def enable_gre_encapsulation(self) -> builtins.bool:
        """
...
def get_ipsec_tunnel(folder: Optional[builtins.str] = None,
...
def get_ipsec_tunnel_output(folder: Optional[pulumi.Input[Optional[builtins.str]]] = None,
