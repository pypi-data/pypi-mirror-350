...
def get_ipsec_crypto_profile(device: Optional[builtins.str] = None,
...
def get_ipsec_crypto_profile_output(device: Optional[pulumi.Input[Optional[builtins.str]]] = None,
