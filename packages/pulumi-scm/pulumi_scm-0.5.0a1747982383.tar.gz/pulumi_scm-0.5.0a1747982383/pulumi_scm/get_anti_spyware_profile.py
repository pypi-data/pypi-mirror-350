...
class GetAntiSpywareProfileResult:
    ...
    def cloud_inline_analysis(self) -> builtins.bool:
        """
    ...
    def inline_exception_edl_urls(self) -> Sequence[builtins.str]:
        """
    ...
    def inline_exception_ip_addresses(self) -> Sequence[builtins.str]:
        """
...
def get_anti_spyware_profile(id: Optional[builtins.str] = None,
...
def get_anti_spyware_profile_output(id: Optional[pulumi.Input[builtins.str]] = None,
