...
def get_app_override_rule_list(device: Optional[builtins.str] = None,
...
def get_app_override_rule_list_output(device: Optional[pulumi.Input[Optional[builtins.str]]] = None,
