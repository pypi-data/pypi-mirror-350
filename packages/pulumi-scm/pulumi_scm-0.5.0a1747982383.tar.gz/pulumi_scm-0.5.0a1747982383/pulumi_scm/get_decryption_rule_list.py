...
def get_decryption_rule_list(device: Optional[builtins.str] = None,
...
def get_decryption_rule_list_output(device: Optional[pulumi.Input[Optional[builtins.str]]] = None,
