...
class GetAddressGroupResult:
    ...
    def static_lists(self) -> Sequence[builtins.str]:
        """
...
def get_address_group(id: Optional[builtins.str] = None,
...
def get_address_group_output(id: Optional[pulumi.Input[builtins.str]] = None,
