...
def get_external_dynamic_list_list(device: Optional[builtins.str] = None,
...
def get_external_dynamic_list_list_output(device: Optional[pulumi.Input[Optional[builtins.str]]] = None,
