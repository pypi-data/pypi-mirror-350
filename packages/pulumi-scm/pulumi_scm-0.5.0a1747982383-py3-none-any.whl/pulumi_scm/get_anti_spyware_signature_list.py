...
def get_anti_spyware_signature_list(device: Optional[builtins.str] = None,
...
def get_anti_spyware_signature_list_output(device: Optional[pulumi.Input[Optional[builtins.str]]] = None,
