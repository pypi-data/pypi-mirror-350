...
def get_ike_crypto_profile_list(device: Optional[builtins.str] = None,
...
def get_ike_crypto_profile_list_output(device: Optional[pulumi.Input[Optional[builtins.str]]] = None,
