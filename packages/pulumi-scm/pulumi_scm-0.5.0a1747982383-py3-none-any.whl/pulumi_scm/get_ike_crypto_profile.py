...
class GetIkeCryptoProfileResult:
    ...
    def authentication_multiple(self) -> builtins.int:
        """
    ...
    def dh_groups(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def encryptions(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def hashes(self) -> Sequence[builtins.str]:
        """
...
def get_ike_crypto_profile(device: Optional[builtins.str] = None,
...
def get_ike_crypto_profile_output(device: Optional[pulumi.Input[Optional[builtins.str]]] = None,
