...
def get_address_object_list(device: Optional[builtins.str] = None,
...
def get_address_object_list_output(device: Optional[pulumi.Input[Optional[builtins.str]]] = None,
