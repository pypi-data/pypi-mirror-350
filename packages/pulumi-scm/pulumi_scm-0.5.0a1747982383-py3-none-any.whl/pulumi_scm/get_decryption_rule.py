...
class GetDecryptionRuleResult:
    ...
    def log_fail(self) -> builtins.bool:
        """
        The LogFail param.
        """
    ...
    def log_success(self) -> builtins.bool:
        """
...
def get_decryption_rule(id: Optional[builtins.str] = None,
...
def get_decryption_rule_output(id: Optional[pulumi.Input[builtins.str]] = None,
