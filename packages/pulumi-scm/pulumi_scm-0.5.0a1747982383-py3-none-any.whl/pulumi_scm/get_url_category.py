...
class GetUrlCategoryResult:
    ...
    @property
    @pulumi.getter
    def lists(self) -> Sequence[builtins.str]:
        """
        The List param.
        """
...
def get_url_category(id: Optional[builtins.str] = None,
...
def get_url_category_output(id: Optional[pulumi.Input[builtins.str]] = None,
