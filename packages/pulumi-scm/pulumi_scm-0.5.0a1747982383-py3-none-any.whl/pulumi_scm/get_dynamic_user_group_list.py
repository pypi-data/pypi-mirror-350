...
def get_dynamic_user_group_list(device: Optional[builtins.str] = None,
...
def get_dynamic_user_group_list_output(device: Optional[pulumi.Input[Optional[builtins.str]]] = None,
