...
class GetTacacsServerProfileResult:
    ...
    def use_single_connection(self) -> builtins.bool:
        """
...
def get_tacacs_server_profile(id: Optional[builtins.str] = None,
...
def get_tacacs_server_profile_output(id: Optional[pulumi.Input[builtins.str]] = None,
