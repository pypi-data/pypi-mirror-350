...
class ElasticSearch:
    ...
    def prepare_scroll(self, index_name: str, query: dict = None, size: int = 10000, source_fields: list = None,
                       scroll_ttl: str = "2m"):
        """
        ...
        Args:
            ...
            source_fields: 가져올 _source 필드 목록 (None이면 모든 필드, False 이면 없음).
        ...
        try:
            ...
            if self._scroll_id is None:
                ...
                search_body = {
                    ...
                    "_source": self._scroll_source_fields if self._scroll_source_fields is not None else True
                }
            ...
            if self._scroll_source_fields is False:
                id_list = [doc['_id'] for doc in doc_list]
                return id_list
            else:
                source_list = [doc['_source'] for doc in doc_list]
                return source_list
        except NotFoundError:
    ...
    def to_dataframe(self, result_list) -> pd.DataFrame:
