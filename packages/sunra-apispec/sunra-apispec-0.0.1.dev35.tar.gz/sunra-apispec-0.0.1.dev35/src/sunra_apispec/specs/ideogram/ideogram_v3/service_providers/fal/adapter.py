...
class FalTextToImageAdapter(IFalAdapter):
    ...
    def convert_input(self, data: dict, skip_validation: bool = True) -> dict:
        ...
        if not skip_validation:
            ...
            input_model = TextToImageInput.model_construct(**data)
...
class FalEditAdapter(IFalAdapter):
    ...
    def convert_input(self, data: dict, skip_validation: bool = True) -> dict:
        ...
        if not skip_validation:
            ...
            input_model = EditInput.model_construct(**data)
...
class FalReframeAdapter(IFalAdapter):
    ...
    def convert_input(self, data: dict, skip_validation: bool = True) -> dict:
        ...
        if not skip_validation:
            ...
            input_model = ReframeInput.model_construct(**data)
...
class FalRemixAdapter(IFalAdapter):
    ...
    def convert_input(self, data: dict, skip_validation: bool = True) -> dict:
        ...
        if not skip_validation:
            ...
            input_model = RemixInput.model_construct(**data)
...
class FalReplaceBackgroundAdapter(IFalAdapter):
    ...
    def convert_input(self, data: dict, skip_validation: bool = True) -> dict:
        ...
        if not skip_validation:
            ...
            input_model = ReplaceBackgroundInput.model_construct(**data)
