...
from .service_providers.replicate.adapter import (
    TextToVideoAdapter as ReplicateTextToVideoAdapter,
    ImageToVideoAdapter as ReplicateImageToVideoAdapter,
    ReferenceImagesToVideoAdapter as ReplicateReferenceImagesToVideoAdapter,
    VideoToVideoAdapter as ReplicateVideoToVideoAdapter,
    VideoInpaintingAdapter as ReplicateVideoInpaintingAdapter,
)
