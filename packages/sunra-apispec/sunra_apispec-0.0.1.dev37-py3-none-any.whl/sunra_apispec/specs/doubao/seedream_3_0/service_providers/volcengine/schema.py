...
class ImageSizeEnum(str, Enum):
    """Predefined image size enumeration"""
    SQUARE_1024 = "1024x1024"  # 1:1
    PORTRAIT_864_1152 = "864x1152"  # 3:4
    LANDSCAPE_1152_864 = "1152x864"  # 4:3
    LANDSCAPE_1280_720 = "1280x720"  # 16:9
    PORTRAIT_720_1280 = "720x1280"  # 9:16
    PORTRAIT_832_1248 = "832x1248"  # 2:3
    LANDSCAPE_1248_832 = "1248x832"  # 3:2
    ULTRAWIDE_1512_648 = "1512x648"  # 21:9
...
class VolcengineTextToImageInput(BaseModel):
    ...
    response_format: Optional[ResponseFormatEnum] = Field(
        default=ResponseFormatEnum.URL,
        description=(
    ...
    size: Optional[Union[ImageSizeEnum, str]] = Field(
        default=ImageSizeEnum.SQUARE_1024,
        description=(
