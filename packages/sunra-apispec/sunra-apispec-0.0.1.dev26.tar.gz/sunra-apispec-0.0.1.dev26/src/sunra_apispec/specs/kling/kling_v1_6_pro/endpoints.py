...
from .sunra_schema import ReferenceImages2VideoInput, Text2VideoInput, Image2VideoInput
...
def reference_images_to_video(body: ReferenceImages2VideoInput) -> SubmitResponse:
    pass
