...
class DurationEnum(int, Enum):
    """Video duration enumeration in seconds"""
    FIVE_SECONDS = 5
    TEN_SECONDS = 10
...
class TextCommandParameters(BaseModel):
    ...
    ratio: Optional[RatioEnum] = Field(
    ...
    duration: Optional[DurationEnum] = Field(
        default=DurationEnum.FIVE_SECONDS,
        description="Video duration in seconds (5 or 10). Short form: dur"
    )
    
    framepersecond: Optional[FrameRateEnum] = Field(
        default=None,
        description=(
