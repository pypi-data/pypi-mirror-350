...
import threading
import asyncio
from piedata.config_loader import load_config
from piedata.server import main as start_server
...
class PieDataWindowsService(win32serviceutil.ServiceFramework):
    ...
    def _run(self):
        ...
        try:
            loop.run_until_complete(start_server(host=host, port=port, path=db_path))
