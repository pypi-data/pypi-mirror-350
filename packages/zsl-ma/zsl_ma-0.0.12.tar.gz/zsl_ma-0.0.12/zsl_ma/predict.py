...
def parse_args():
    ...
    parser.add_argument('--save_dir', type=str, default=r'D:\Code\2-ZSL\Zero-Shot-Learning\data\output')
    ...
    parser.add_argument('--model', type=str, default=r'D:\Code\2-ZSL\Zero-Shot-Learning\data\output\checkpoints\best.pth')
