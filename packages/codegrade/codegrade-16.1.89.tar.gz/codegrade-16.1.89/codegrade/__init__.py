...
@wraps(AuthenticatedClient.get_from_cli_for_course)
def login_from_cli_for_course(*args, **kwargs):
    return AuthenticatedClient.get_from_cli_for_course(*args, **kwargs)
