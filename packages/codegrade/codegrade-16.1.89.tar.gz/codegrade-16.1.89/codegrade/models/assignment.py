...
class Assignment(TimeframeLike):
    ...
    #: `grade_availability` fields, it will be removed in Q3 2023.
        ...
        lambda: TimeframeLike.data_parser.parser.combine(
            rqa.FixedMapping(
                ...
                rqa.RequiredArgument(
                    ...
                    doc="Current state of the assignment. Deprecated: use `availability` and `grade_availability` fields, it will be removed in Q3 2023.",
                ),
                rqa.RequiredArgument(
                    "description",
                    rqa.Nullable(rqa.SimpleValue.str),
                    doc="Description of the assignment. Deprecated, use available routes to upload and retrieve a description file instead. It will be removed in Q3 2023.",
                ),
                rqa.RequiredArgument(
                    "has_description",
                ...
                rqa.RequiredArgument(
                    ...
                    doc="The time the assignment will become available (i.e. the state will switch from 'hidden' to 'open'). If the state is not 'hidden' this value has no meaning. If this value is not `None` you cannot change to state to 'hidden' or 'open'. Deprecated: use `availability` and `grade_availability` fields, it will be removed in Q3 2023.",
                ),
                rqa.RequiredArgument(
                    "send_login_links",
                    rqa.SimpleValue.bool,
                ...
                rqa.RequiredArgument(
                    ...
                    rqa.SimpleValue.bool,
                    doc="Can you connect git to this assignment. Deprecated, use `webhook_configuration` instead.",
                ),
                rqa.RequiredArgument(
                ...
                rqa.RequiredArgument(
                    ...
                    doc="The ids of the analytics workspaces connected to this assignment. WARNING: This API is still in beta, and might change in the future.",
                ),
                rqa.RequiredArgument(
                    "kind",
